...
#define BL2_MAX_SIZE		(0x00055000 + MAX_XLAT_TABLES * PAGE_SIZE)
#else /* TRUSTED_BOARD_BOOT */
#define BL2_MAX_SIZE		(0x00053000 + MAX_XLAT_TABLES * PAGE_SIZE)
#endif /* TRUSTED_BOARD_BOOT */
#define BL2_BASE		(BL2_LIMIT - BL2_MAX_SIZE)

#define ARM_TRACE_SECURE_BUFFER
#define PLAT_ARMTRACEBUF_SIZE_MIN 0x4000
#define PLAT_ARMTRACEBUF_SIZE	0x20000
#define PLAT_ARMTRACEBUF_CACHE_LOCK /* Enable LLC lock */
#define PLAT_ARMTRACEBUF_NO_WT

#define BL31_LIMIT		BL2_BASE

#ifdef ATF_ENABLE_MAC_ADV_CMDS
#define BL31_MAX_SIZE		(0x001FE000 + \
				 MAX_XLAT_TABLES * PAGE_SIZE)
#else
#define BL31_MAX_SIZE		(0x001AC000 + \
				 MAX_XLAT_TABLES * PAGE_SIZE)
#endif
