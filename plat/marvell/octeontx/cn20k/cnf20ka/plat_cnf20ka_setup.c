...
void plat_add_mmio(void)
{
	...
	add_map_record(CAVM_AUX_GPIO_BAR_E_AUX_GPIO_PF_BAR0, CAVM_AUX_GPIO_BAR_E_AUX_GPIO_PF_BAR0_SIZE, attr);
	add_map_record(CAVM_AUX_GPIO_BAR_E_AUX_GPIO_PF_BAR4, CAVM_AUX_GPIO_BAR_E_AUX_GPIO_PF_BAR4_SIZE, attr);
	...
	for (i = 0; i < device_type_count; i++) {
		add_map_record(CAVM_ECAM_BAR_E_ECAMX_PF_BAR0_CNF20KA(i), CAVM_ECAM_BAR_E_ECAMX_PF_BAR0_CNF20KA_SIZE, attr);
		add_map_record(FIXED_ECAM_BAR, CAVM_ECAM_BAR_E_ECAMX_PF_BAR2_CNF20KA_SIZE, attr);
	}
	 ...
	 */
	for (int core_id = 0; core_id < PLATFORM_CORE_PER_CLUSTER; core_id++) {
