...
static const portm_mode_desc_t portm_mode_desc_list[] = {
	/* Ethernet modes */
	/* Portm_mode                  FEC's supported       SN MN AP FA MAC_Type   Speed       PCS Type 		Mode bitmask              Mode group */
	{PORTM_MODE_SGMII,            PORTM_FEC_DISABLED,    1, 1, 0, 0, PORTM_ETH, 1000,   PORTM_PCS_1000BASE_X, (1ULL << ETH_MODE_SGMII_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_1000BASE_X,       PORTM_FEC_DISABLED,    1, 1, 0, 0, PORTM_ETH, 1000,   PORTM_PCS_1000BASE_X, (1ULL << ETH_MODE_1000_BASEX_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_SFI_1G,           PORTM_FEC_DISABLED,    1, 1, 0, 0, PORTM_ETH, 1000,   PORTM_PCS_1000BASE_X, (1ULL << ETH_MODE_SFI_1G_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_2500BASE_X,       PORTM_FEC_DISABLED,    1, 1, 0, 0, PORTM_ETH, 2500,   PORTM_PCS_1000BASE_X, (1ULL << ETH_MODE_2500_BASEX_BIT), MODE_GROUP_ETH1},
	{PORTM_MODE_5000BASE_X,       PORTM_FEC_DISABLED,    1, 1, 0, 0, PORTM_ETH, 5000,   PORTM_PCS_1000BASE_X, (1ULL << ETH_MODE_5000_BASEX_BIT), MODE_GROUP_ETH1},
	{PORTM_MODE_QSGMII,           PORTM_FEC_DISABLED,    1, 4, 0, 0, PORTM_ETH, 5000,   PORTM_PCS_QSGMII, (1ULL << ETH_MODE_QSGMII_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_XFI,              PORTM_FEC_BASER,       1, 1, 0, 0, PORTM_ETH, 10000,  PORTM_PCS_10GBASE_R, (1ULL << ETH_MODE_10G_C2C_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_SFI,              PORTM_FEC_BASER,       1, 1, 0, 0, PORTM_ETH, 10000,  PORTM_PCS_10GBASE_R, (1ULL << ETH_MODE_10G_C2M_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_10GBASE_KR,       PORTM_FEC_BASER,       1, 1, 1, 1, PORTM_ETH, 10000,  PORTM_PCS_10GBASE_R, (1ULL << ETH_MODE_10G_KR_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_25GAUI_C2C,       PORTM_FEC_BASER_RS,    1, 1, 0, 0, PORTM_ETH, 25000,  PORTM_PCS_25GBASE_R, (1ULL << ETH_MODE_25G_C2C_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_25GAUI_C2M,       PORTM_FEC_BASER_RS,    1, 1, 0, 0, PORTM_ETH, 25000,  PORTM_PCS_25GBASE_R, (1ULL << ETH_MODE_25G_C2M_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_25GBASE_USR,      PORTM_FEC_BASER_RS,    1, 1, 0, 0, PORTM_ETH, 25000,  PORTM_PCS_25GBASE_R, (1ULL << ETH_MODE_25G_C2C_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_25GBASE_CR,       PORTM_FEC_BASER_RS,    1, 1, 1, 0, PORTM_ETH, 25000,  PORTM_PCS_25GBASE_R, (1ULL << ETH_MODE_25G_CR_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_25GBASE_KR,       PORTM_FEC_BASER_RS,    1, 1, 1, 0, PORTM_ETH, 25000,  PORTM_PCS_25GBASE_R, (1ULL << ETH_MODE_25G_KR_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_25GBASE_CR_C,     PORTM_FEC_BASER_RS,    1, 1, 1, 1, PORTM_ETH, 25000,  PORTM_PCS_25GBASE_R, (1ULL << ETH_MODE_25GBASE_CR_C_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_25GBASE_KR_C,     PORTM_FEC_BASER_RS,    1, 1, 1, 1, PORTM_ETH, 25000,  PORTM_PCS_25GBASE_R, (1ULL << ETH_MODE_25GBASE_KR_C_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_XLAUI,            PORTM_FEC_BASER,       4, 1, 0, 0, PORTM_ETH, 40000,  PORTM_PCS_40GBASE_R4, (1ULL << ETH_MODE_40G_C2C_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_XLAUI_C2M,        PORTM_FEC_BASER,       4, 1, 0, 0, PORTM_ETH, 40000,  PORTM_PCS_40GBASE_R4, (1ULL << ETH_MODE_40G_C2M_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_40GBASE_CR4,      PORTM_FEC_BASER,       4, 1, 1, 1, PORTM_ETH, 40000,  PORTM_PCS_40GBASE_R4, (1ULL << ETH_MODE_40G_CR4_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_40GBASE_KR4,      PORTM_FEC_BASER,       4, 1, 1, 1, PORTM_ETH, 40000,  PORTM_PCS_40GBASE_R4, (1ULL << ETH_MODE_40G_KR4_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_LAUI_2_C2C,       PORTM_FEC_DISABLED,    2, 1, 0, 0, PORTM_ETH, 50000,  PORTM_PCS_50GBASE_R2, (1ULL << ETH_MODE_50GAUI_2_C2C_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_LAUI_2_C2M,       PORTM_FEC_DISABLED,    2, 1, 0, 0, PORTM_ETH, 50000,  PORTM_PCS_50GBASE_R2, (1ULL << ETH_MODE_50GAUI_2_C2M_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_50GBASE_CR2_C,    PORTM_FEC_BASER_RS,    2, 1, 1, 1, PORTM_ETH, 50000,  PORTM_PCS_50GBASE_R2, (1ULL << ETH_MODE_50GBASE_CR2_C_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_50GBASE_KR2_C,    PORTM_FEC_BASER_RS,    2, 1, 1, 1, PORTM_ETH, 50000,  PORTM_PCS_50GBASE_R2, (1ULL << ETH_MODE_50GBASE_KR2_C_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_50GAUI_1_C2C,     PORTM_FEC_RS_544_ONLY, 1, 1, 0, 0, PORTM_ETH, 50000,  PORTM_PCS_50GBASE_R1, (1ULL << ETH_MODE_50G_C2C_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_50GAUI_1_C2M,     PORTM_FEC_RS_544_ONLY, 1, 1, 0, 0, PORTM_ETH, 50000,  PORTM_PCS_50GBASE_R1, (1ULL << ETH_MODE_50G_C2M_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_50GBASE_USR,      PORTM_FEC_RS_544_ONLY, 1, 1, 0, 0, PORTM_ETH, 50000,  PORTM_PCS_50GBASE_R1, (1ULL << ETH_MODE_50G_C2C_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_50GBASE_CR,       PORTM_FEC_RS_544_ONLY, 1, 1, 1, 0, PORTM_ETH, 50000,  PORTM_PCS_50GBASE_R1, (1ULL << ETH_MODE_50G_CR_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_50GBASE_KR,       PORTM_FEC_RS_544_ONLY, 1, 1, 1, 0, PORTM_ETH, 50000,  PORTM_PCS_50GBASE_R1, (1ULL << ETH_MODE_50G_KR_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_CAUI_4_C2C,       PORTM_FEC_RS,          4, 1, 0, 0, PORTM_ETH, 100000, PORTM_PCS_100GBASE_R4, (1ULL << ETH_MODE_100G_C2C_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_CAUI_4_C2M,       PORTM_FEC_RS,          4, 1, 0, 0, PORTM_ETH, 100000, PORTM_PCS_100GBASE_R4, (1ULL << ETH_MODE_100G_C2M_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_100GBASE_CR4,     PORTM_FEC_RS_528_ONLY, 4, 1, 1, 0, PORTM_ETH, 100000, PORTM_PCS_100GBASE_R4, (1ULL << ETH_MODE_100G_CR4_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_100GBASE_KR4,     PORTM_FEC_RS_528_ONLY, 4, 1, 1, 0, PORTM_ETH, 100000, PORTM_PCS_100GBASE_R4, (1ULL << ETH_MODE_100G_KR4_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_100GAUI_2_C2C,    PORTM_FEC_RS_544_ONLY, 2, 1, 0, 0, PORTM_ETH, 100000, PORTM_PCS_100GBASE_R2, (1ULL << ETH_MODE_100GAUI_2_C2C_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_100GAUI_2_C2M,    PORTM_FEC_RS_544_ONLY, 2, 1, 0, 0, PORTM_ETH, 100000, PORTM_PCS_100GBASE_R2, (1ULL << ETH_MODE_100GAUI_2_C2M_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_100GBASE_USR2,    PORTM_FEC_RS_544_ONLY, 2, 1, 0, 0, PORTM_ETH, 100000, PORTM_PCS_100GBASE_R2, (1ULL << ETH_MODE_100GAUI_2_C2C_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_100GBASE_CR2,     PORTM_FEC_RS_544_ONLY, 2, 1, 1, 0, PORTM_ETH, 100000, PORTM_PCS_100GBASE_R2, (1ULL << ETH_MODE_100GBASE_CR2_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_100GBASE_KR2,     PORTM_FEC_RS_544_ONLY, 2, 1, 1, 0, PORTM_ETH, 100000, PORTM_PCS_100GBASE_R2, (1ULL << ETH_MODE_100GBASE_KR2_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_802_3AP,          PORTM_FEC_BASER_RS,    1, 1, 0, 0, PORTM_ETH, 0,      PORTM_PCS_NONE, (1ULL << ETH_MODE_MAX_BIT), MODE_GROUP_ETH0},
	{PORTM_MODE_2_5G_SXGMII,      PORTM_FEC_DISABLED,    1, 1, 0, 0, PORTM_ETH, 2500,   PORTM_PCS_USXGMII, (1ULL << ETH_MODE_2_5G_USXGMII_BIT), MODE_GROUP_ETH1},
	{PORTM_MODE_5G_SXGMII,        PORTM_FEC_DISABLED,    1, 1, 0, 0, PORTM_ETH, 5000,   PORTM_PCS_USXGMII, (1ULL << ETH_MODE_5G_USXGMII_BIT), MODE_GROUP_ETH1},
	{PORTM_MODE_10G_SXGMII,       PORTM_FEC_DISABLED,    1, 1, 0, 0, PORTM_ETH, 10000,  PORTM_PCS_USXGMII, (1ULL << ETH_MODE_10G_SXGMII_BIT), MODE_GROUP_ETH1},
	{PORTM_MODE_10G_DXGMII,       PORTM_FEC_DISABLED,    1, 2, 0, 0, PORTM_ETH, 10000,  PORTM_PCS_USXGMII, (1ULL << ETH_MODE_10G_DXGMII_BIT), MODE_GROUP_ETH1},
	{PORTM_MODE_10G_QXGMII,       PORTM_FEC_DISABLED,    1, 4, 0, 0, PORTM_ETH, 10000,  PORTM_PCS_USXGMII, (1ULL << ETH_MODE_10G_QXGMII_BIT), MODE_GROUP_ETH1},
	{PORTM_MODE_Q_USGMII,         PORTM_FEC_DISABLED,    1, 4, 0, 0, PORTM_ETH, 5000,   PORTM_PCS_USGMII, (1ULL << ETH_MODE_O_USGMII_BIT), MODE_GROUP_ETH1},
	{PORTM_MODE_O_USGMII,         PORTM_FEC_DISABLED,    1, 8, 0, 0, PORTM_ETH, 10000,  PORTM_PCS_USGMII, (1ULL << ETH_MODE_Q_USGMII_BIT), MODE_GROUP_ETH1},

	{PORTM_MODE_DISABLED,         PORTM_FEC_DISABLED,    1, 1, 1, 0, PORTM_DIS,  0,     PORTM_PCS_NONE, (1ULL << ETH_MODE_MAX_BIT), MODE_GROUP_ETH0}
};
...
static const portm_modes_t portm_4_lane[] = {
	/* Ethernet - 1 lane */
	PORTM_MODE_SGMII,
...
static const portm_modes_t portm_2_lane[] = {
	/* Ethernet - 1 lane */
	PORTM_MODE_SGMII,
	PORTM_MODE_1000BASE_X,
	PORTM_MODE_SFI_1G,
...
static const portm_modes_t portm_1_lane[] = {
	/* 1 lane */
	PORTM_MODE_SGMII,
	PORTM_MODE_1000BASE_X,
	PORTM_MODE_SFI_1G,
...
static const portm_gserm_mac_map_t portm_gserm_mac_map_cnf20ka[] = {
...
const portm_gserm_mac_map_t *portm_get_gserm_mac_map(void)
{
	if (cavm_is_model(OCTEONTX_CN20KA))
		...
		return portm_gserm_mac_map_cnf20ka;
...
/**
 * Get ethernet mode bitmask for a PORTM mode
 *
 * @param  mode  PORTM mode to query
 *
 * @return PORTM bitmask
 */
uint64_t portm_get_mode_bitmask(portm_modes_t mode)
{
	int i = 0;
	portm_modes_t mode_temp;
	...
	do {
		...
		if (mode == mode_temp) {
			return portm_mode_desc_list[i].mode_bitmask;
		}
		i++;
	} while (mode_temp != PORTM_MODE_DISABLED);
...
/**
 * Get ethernet mode group for a PORTM mode
 *
 * @param  mode  PORTM mode to query
 *
 * @return PORTM bitmask group
 */
mode_group_t portm_get_mode_group(portm_modes_t mode)
{
	int i = 0;
	portm_modes_t mode_temp;
	...
	do {
		mode_temp = portm_mode_desc_list[i].mode;
		if (mode == mode_temp) {
			return portm_mode_desc_list[i].mode_group;
		}
		i++;
	} while (mode_temp != PORTM_MODE_DISABLED);
