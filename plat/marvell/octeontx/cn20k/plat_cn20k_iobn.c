...
void octeontx_init_iobn(uint64_t config_base, uint64_t config_size)
{
	...
	const struct cn20k_stream_security_setting common_streams[] = {
	...
	const struct cn20k_stream_security_setting *stream_settings;
	...
	plat_streams = plat_get_cn20k_stream_security(&j);
