...
#define PLATFORM_CORE_PER_CLUSTER	8
...
#define SERDES_PRBS_DATA_END		(SERDES_PRBS_DATA_BASE + SERDES_PRBS_DATA_SIZE)
...
#define SPI_0_LOCK_DATA_BASE		(PORTM_MODE_BOOT_CFG_DATA_BASE + PORTM_MODE_BOOT_CFG_DATA_SIZE)
#define SPI_0_LOCK_DATA_SIZE		0x1000
#define SPI_1_LOCK_DATA_BASE		(SPI_0_LOCK_DATA_BASE + SPI_0_LOCK_DATA_SIZE)
#define SPI_1_LOCK_DATA_SIZE		0x1000
