...
#define END_OF_BPHY_IRQS		(BPHY_PSM_MTO_HI_IRQ_BASE + BPHY_PSM_MTO_HI_IRQS)
...
#define GTI_CWD_SPI_IRQ_BASE		(BPHY_PSM_MTO_HI_IRQ_BASE + BPHY_PSM_MTO_HI_IRQS)
...
/* PEM MISC interrupts (for EACH PEM): INT_SUM, RST_INT (range 0x95 .. 0x95 + (PEM_SPI_IRQ_DEVS * 2 - 1)) */
...
/* APA watchdog interrupts */
#define APA_WDOG_SPI_IRQS	PLATFORM_CORE_PER_CLUSTER
#define APA_WDOG_SPI_BASE	(PEM_SPI_MISC_IRQ_BASE + (PEM_SPI_MISC_IRQ_DEVS * PEM_SPI_MISC_IRQS_PER_DEV))
#define APA_WDOG_SPI_IRQ(core)	((core) + APA_WDOG_SPI_BASE)

/* Global CWD GTI interrupt 0xa5 */
#define GTI_CWD_GBL_SPI_IRQS		0x1
#define GTI_CWD_GBL_SPI_IRQ_BASE	(APA_WDOG_SPI_BASE + APA_WDOG_SPI_IRQS)
#define GTI_CWD_GBL_SPI_IRQ(irq)	GTI_CWD_GBL_SPI_IRQ_BASE

#define RAS_GIC_SPI_IRQS		0x1
