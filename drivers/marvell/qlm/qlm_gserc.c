...
static void qlm_gserc_init_reset(void);
...
//	eye_state.node = node;
	...
	printf("GSERC%d.%d: Measured TX clock %llu.%llu MHz\n", qlm, lane,
 ...
 */
static int qlm_gserc_get_trace(int module, int lane, int trace_type, uint64_t *data, int data_size)
{
