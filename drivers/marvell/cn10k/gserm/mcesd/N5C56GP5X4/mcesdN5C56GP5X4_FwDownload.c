...
)
{
    *errCode = MCESD_IO_ERROR;
    ...
    MCESD_ATTEMPT(API_N5C56GP5X4_UpdateRamCode(devPtr, 255 /* ignored */, fwCodePtr, fwCodeSizeDW, N5C56GP5X4_FW_MAX_SIZE, N5C56GP5X4_FW_BASE_ADDR, errCode));
...
)
{
    ...
    *******************************************************************************/
    ...
    {
        MCESD_ATTEMPT(API_N5C56GP5X4_WriteReg(devPtr, lane, address, code[index]));
        address += 4;
    }
