...
#define ETH_LINK_STATE_CASE(m) case m: str = ((const char *)#m)+15
	...
	break;
	ETH_LINK_STATE_CASE(ETH_LINK_STATE_RCI_REG_WRITE_FIRST);
	break;
	ETH_LINK_STATE_CASE(ETH_LINK_STATE_RCI_REG_WRITE_ADDR_ACK);
	break;
	ETH_LINK_STATE_CASE(ETH_LINK_STATE_RCI_REG_WRITE_MASK_ACK);
	break;
	ETH_LINK_STATE_CASE(ETH_LINK_STATE_RCI_REG_WRITE_DATA_ACK);
	break;
	ETH_LINK_STATE_CASE(ETH_LINK_STATE_RCI_REG_READ_FIRST);
	break;
	ETH_LINK_STATE_CASE(ETH_LINK_STATE_RCI_REG_READ_ADDR_ACK);
	break;
	ETH_LINK_STATE_CASE(ETH_LINK_STATE_RCI_REG_READ_DATA_ACK);
	break;
	ETH_LINK_STATE_CASE(ETH_LINK_STATE_CDR_LOCK_START);
	break;
	ETH_LINK_STATE_CASE(ETH_LINK_STATE_CDR_LOCK_READ);
	break;
	ETH_LINK_STATE_CASE(ETH_LINK_STATE_CDR_LOCK_READ_DONE);
	break;
