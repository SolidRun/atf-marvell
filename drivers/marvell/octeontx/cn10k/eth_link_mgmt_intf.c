...
#define ETH_LINK_STATE_CASE(m) case m: str = ((const char *)#m)+15
	...
	break;
	ETH_LINK_STATE_CASE(ETH_LINK_STATE_CDR_LOCK_UPDATE_FIRST);
	break;
	ETH_LINK_STATE_CASE(ETH_LINK_STATE_CDR_LOCK_UPDATE_SECOND);
	break;
	ETH_LINK_STATE_CASE(ETH_LINK_STATE_CDR_LOCK_UPDATE_IN_PROGRESS);
	break;
