/*******************************************************************************
Copyright (C) 2019, Marvell. and its affiliates
...
#define C112GX4_WRITE_FIELD(xDevPtr, xField, xLane, xData)          MCESD_ATTEMPT(API_C112GX4_WriteField(xDevPtr, xLane, &(MCESD_FIELD)xField, xData));
#define C112GX4_READ_FIELD(xDevPtr, xField, xLane, xData)           MCESD_ATTEMPT(API_C112GX4_ReadField(xDevPtr, xLane, &(MCESD_FIELD)xField, &xData));
#define C112GX4_POLL_FIELD(xDevPtr, xField, xLane, xData, xTimeout) MCESD_ATTEMPT(API_C112GX4_PollField(xDevPtr, xLane, &(MCESD_FIELD)xField, xData, xTimeout))
