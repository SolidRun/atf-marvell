...
@param[in]  devPtr - pointer to MCESD_DEV initialized by mcesdLoadDriver() call
@param[in]  lane - lane number 0, 1, etc.
@param[in]  txSpeed - enum that represents the TX bitrate
@param[in]  rxSpeed - enum that represents the RX bitrate

@note [Normal] Sets bitrate using pins (PIN_PHY_GEN_TX, PIN_PHY_GEN_RX)
@note [Isolation] Sets bitrate using fields (PHY_GEN_TX, PHY_GEN_RX)
...
(
    IN MCESD_DEV_PTR devPtr,
    IN MCESD_U8 lane,
    IN E_C112GX4_SERDES_SPEED txSpeed,
    IN E_C112GX4_SERDES_SPEED rxSpeed
);
