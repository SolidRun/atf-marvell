 ...
 * PCC_DEV_CON_S.
 */
#define CAVM_PCC_DEV_CON_E_APAX(a) (0x480 + (a))
...
#define CAVM_PCC_DEV_CON_E_GTI (0x38)
...
#define CAVM_PCC_DEV_CON_E_MIO_PTP (0x50)
#define CAVM_PCC_DEV_CON_E_MIO_PWM (0x10d)
#define CAVM_PCC_DEV_CON_E_MIO_TWSX(a) (0x1b0 + (a))
...
#define CAVM_PCC_DEV_CON_E_PBUS (0xa0)
...
#define CAVM_PCC_DEV_CON_E_RBH (0x102)
#define CAVM_PCC_DEV_CON_E_RGMII_RMIIX(a) (0x90 + (a))
...
#define CAVM_PCC_DEV_CON_E_SPIX(a) (0x40 + 8 * (a))
#define CAVM_PCC_DEV_CON_E_TADX(a) (0x380 + (a))
#define CAVM_PCC_DEV_CON_E_TSNX(a) (0x401 + (a))
#define CAVM_PCC_DEV_CON_E_UAAX(a) (0x1d0 + (a))
...
#define CAVM_PCC_DEV_IDL_E_RGMII_RMII (0xa6)
