 ...
 * PCC_DEV_CON_S.
 */
#define CAVM_PCC_DEV_CON_E_APAX_CHEETAH(a) (0x480 + (a))
#define CAVM_PCC_DEV_CON_E_APAX_ODINMP(a) (0x440 + (a))
#define CAVM_PCC_DEV_CON_E_AVS (0xf8)
#define CAVM_PCC_DEV_CON_E_AVS_TEMPX(a) (0xf9 + (a))
...
#define CAVM_PCC_DEV_CON_E_FUS_CHEETAH (0x108)
#define CAVM_PCC_DEV_CON_E_FUS_ODINMP (0x103)
#define CAVM_PCC_DEV_CON_E_GIC (0x30)
#define CAVM_PCC_DEV_CON_E_GPIO (0x88)
#define CAVM_PCC_DEV_CON_E_GPIO_TEMP (0x89)
#define CAVM_PCC_DEV_CON_E_GSERMX(a) (0x110 + (a))
#define CAVM_PCC_DEV_CON_E_GSERPX(a) (0x1e0 + (a))
#define CAVM_PCC_DEV_CON_E_GSERP_32GX(a) (0x1e0 + (a))
#define CAVM_PCC_DEV_CON_E_GTI_CHEETAH (0x38)
#define CAVM_PCC_DEV_CON_E_GTI_ODINMP (0x28)
#define CAVM_PCC_DEV_CON_E_I3C (0x420)
#define CAVM_PCC_DEV_CON_E_I3CMOX(a) (0x4f0 + (a))
#define CAVM_PCC_DEV_CON_E_I3CSMX(a) (0x4f4 + (a))
#define CAVM_PCC_DEV_CON_E_IOBNX(a) (0x150 + (a))
#define CAVM_PCC_DEV_CON_E_IOBPCX(a) (0x158 + (a))
#define CAVM_PCC_DEV_CON_E_LBKX(a) (0x178 + (a))
#define CAVM_PCC_DEV_CON_E_MCSX(a) (0x1f0 + (a))
#define CAVM_PCC_DEV_CON_E_MDC (0x160)
#define CAVM_PCC_DEV_CON_E_MIO_I2CX(a) (0x1c0 + (a))
#define CAVM_PCC_DEV_CON_E_MIO_PTP_CHEETAH (0x50)
#define CAVM_PCC_DEV_CON_E_MIO_PTP_ODINMP (0x40)
#define CAVM_PCC_DEV_CON_E_MIO_PWMX(a) (0x104 + (a))
#define CAVM_PCC_DEV_CON_E_MIO_TWSX_CHEETAH(a) (0x1b0 + (a))
#define CAVM_PCC_DEV_CON_E_MIO_TWSX_ODINMP(a) (0x1c0 + (a))
#define CAVM_PCC_DEV_CON_E_ML0 (0x80)
#define CAVM_PCC_DEV_CON_E_MRML (0x100)
#define CAVM_PCC_DEV_CON_E_MRMLB1 (0x200)
#define CAVM_PCC_DEV_CON_E_MRMLB2 (0x300)
#define CAVM_PCC_DEV_CON_E_MRMLB3 (0x400)
#define CAVM_PCC_DEV_CON_E_NCBX(a) (0x1a0 + (a))
#define CAVM_PCC_DEV_CON_E_NCBPCX(a) (0x140 + (a))
#define CAVM_PCC_DEV_CON_E_OCLAX_CHEETAH(a) (0x301 + (a))
#define CAVM_PCC_DEV_CON_E_OCLAX_ODINMP(a) (0x480 + (a))
#define CAVM_PCC_DEV_CON_E_P2CMX(a) (0x1c8 + (a))
#define CAVM_PCC_DEV_CON_E_PBUS_CHEETAH (0xa0)
#define CAVM_PCC_DEV_CON_E_PBUS_ODINMP (0x10f)
...
#define CAVM_PCC_DEV_CON_E_PCCBR_MRMLB2 (0x68)
#define CAVM_PCC_DEV_CON_E_PCCBR_MRMLB3 (0x70)
#define CAVM_PCC_DEV_CON_E_PCCBR_RNM (0x78)
#define CAVM_PCC_DEV_CON_E_PCCBR_RVUX(a) (0x20000 + 8 * (a))
#define CAVM_PCC_DEV_CON_E_PCCBR_SDP0 (0xb8)
#define CAVM_PCC_DEV_CON_E_PCIERCX(a) (0x30000 + 0x10000 * (a))
#define CAVM_PCC_DEV_CON_E_PEMX(a) (0x10080 + 8 * (a))
#define CAVM_PCC_DEV_CON_E_PEMSECX(a) (0x10000 + 8 * (a))
#define CAVM_PCC_DEV_CON_E_RBH (0x101)
#define CAVM_PCC_DEV_CON_E_RGMX(a) (0x90 + (a))
#define CAVM_PCC_DEV_CON_E_RNM (0x500)
#define CAVM_PCC_DEV_CON_E_RPMX(a) (0x180 + (a))
#define CAVM_PCC_DEV_CON_E_RST (0x101)
#define CAVM_PCC_DEV_CON_E_RSTX(a) (0x102 + (a))
#define CAVM_PCC_DEV_CON_E_RTT (0xb0)
#define CAVM_PCC_DEV_CON_E_RVUX(a) (0x20100 + 0x100 * (a))
#define CAVM_PCC_DEV_CON_E_SDP0 (0x900)
#define CAVM_PCC_DEV_CON_E_SMI (0x10b)
#define CAVM_PCC_DEV_CON_E_SMIX(a) (0x10b + (a))
#define CAVM_PCC_DEV_CON_E_SMMU0 (0x10)
#define CAVM_PCC_DEV_CON_E_SMMU1 (0x18)
#define CAVM_PCC_DEV_CON_E_SMMU2 (0x20)
#define CAVM_PCC_DEV_CON_E_SMMU3 (0x28)
#define CAVM_PCC_DEV_CON_E_SPIX_CHEETAH(a) (0x40 + 8 * (a))
#define CAVM_PCC_DEV_CON_E_SPIX_ODINMP(a) (0x30 + 8 * (a))
#define CAVM_PCC_DEV_CON_E_TADX(a) (0x380 + (a))
#define CAVM_PCC_DEV_CON_E_TSNX_CHEETAH(a) (0x401 + (a))
#define CAVM_PCC_DEV_CON_E_TSNX_ODINMP(a) (0x340 + (a))
#define CAVM_PCC_DEV_CON_E_UAAX_CHEETAH(a) (0x1d0 + (a))
#define CAVM_PCC_DEV_CON_E_UAAX_ODINMP(a) (0x1d8 + (a))
...
#define CAVM_PCC_DEV_IDL_E_APA (0x93)
...
#define CAVM_PCC_DEV_IDL_E_CDB (0xa4)
...
#define CAVM_PCC_DEV_IDL_E_CST (0x9d)
...
#define CAVM_PCC_DEV_IDL_E_GSERM (0x9a)
#define CAVM_PCC_DEV_IDL_E_GSERN (0x28)
#define CAVM_PCC_DEV_IDL_E_GSERP (0x3a)
#define CAVM_PCC_DEV_IDL_E_GSERP_32G (0x3e)
#define CAVM_PCC_DEV_IDL_E_GSERP_64G (0x3f)
#define CAVM_PCC_DEV_IDL_E_GSERR (0x39)
#define CAVM_PCC_DEV_IDL_E_GTI (0x17)
#define CAVM_PCC_DEV_IDL_E_I3C (0x9c)
#define CAVM_PCC_DEV_IDL_E_I3CMO (0xa0)
#define CAVM_PCC_DEV_IDL_E_I3CSM (0xa1)
#define CAVM_PCC_DEV_IDL_E_IOBN (0x27)
#define CAVM_PCC_DEV_IDL_E_IOBN5 (0x6b)
#define CAVM_PCC_DEV_IDL_E_IOBN6 (0x94)
#define CAVM_PCC_DEV_IDL_E_IOBPC (0xa3)
...
#define CAVM_PCC_DEV_IDL_E_MCS (0x96)
...
#define CAVM_PCC_DEV_IDL_E_MIO_I2C (0xa9)
#define CAVM_PCC_DEV_IDL_E_MIO_PTP (0xc)
#define CAVM_PCC_DEV_IDL_E_MIO_PTP5 (0x9e)
#define CAVM_PCC_DEV_IDL_E_MIO_PWM (0xa8)
...
#define CAVM_PCC_DEV_IDL_E_NCB (0x97)
#define CAVM_PCC_DEV_IDL_E_NCBPC (0xa2)
...
#define CAVM_PCC_DEV_IDL_E_P2CM (0xa7)
...
#define CAVM_PCC_DEV_IDL_E_PEMSEC (0x28)
...
#define CAVM_PCC_DEV_IDL_E_RTT (0x8a)
...
#define CAVM_PCC_DEV_IDL_E_SPI (0x9b)
...
#define CAVM_PCC_DEV_IDL_E_SW_RVU_IPSEC_INLINE_PF (0xf0)
#define CAVM_PCC_DEV_IDL_E_SW_RVU_IPSEC_INLINE_VF (0xf1)
...
#define CAVM_PCC_DEV_IDL_E_TAD (0x91)
...
#define CAVM_PCC_DEV_IDL_E_XSR (0x39)
...
union cavm_pccpf_xxx_bar0l
{
    ...
    /* struct cavm_pccpf_xxx_bar0l_s cn; */
};
...
union cavm_pccpf_xxx_bar2l
{
    ...
    /* struct cavm_pccpf_xxx_bar2l_s cn; */
};
...
union cavm_pccpf_xxx_bar4l
{
    ...
    /* struct cavm_pccpf_xxx_bar4l_s cn; */
};
...
union cavm_pccpf_xxx_e_cap_hdr
{
    ...
    /* struct cavm_pccpf_xxx_e_cap_hdr_s cn; */
};
...
union cavm_pccpf_xxx_msix_cap_hdr
{
    ...
    /* struct cavm_pccpf_xxx_msix_cap_hdr_s cn; */
};
...
union cavm_pccpf_xxx_sriov_bar0l
{
    ...
    /* struct cavm_pccpf_xxx_sriov_bar0l_s cn; */
};
...
union cavm_pccpf_xxx_sriov_bar2l
{
    ...
    /* struct cavm_pccpf_xxx_sriov_bar2l_s cn; */
};
...
union cavm_pccpf_xxx_sriov_bar4l
{
    ...
    /* struct cavm_pccpf_xxx_sriov_bar4l_s cn; */
};
...
union cavm_pccpf_xxx_vsec_cap_hdr
{
    ...
    /* struct cavm_pccpf_xxx_vsec_cap_hdr_s cn; */
};
...
union cavm_pccpf_xxx_vsec_ctl
{
    ...
    struct cavm_pccpf_xxx_vsec_ctl_s
    {
        ...
        uint32_t poison_tlp            : 1;  /**< [  8:  8](R/W1S/H) Poisoned TLP received. Writing a one to this bit sets
                                                                 ...
                                                                 reads as zero. */
        uint32_t inst_num              : 8;  /**< [  7:  0](RO/H) Instance number. For blocks with multiple instances, indicates which instance number,
...
union cavm_pccpf_xxx_vsec_sctl
{
    ...
    /* struct cavm_pccpf_xxx_vsec_sctl_s cn; */
};
 ...
 * This register is reset on a chip domain reset.
 */
union cavm_pccpf_xxx_vsec_sctl2
{
    uint32_t u;
    struct cavm_pccpf_xxx_vsec_sctl2_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_16_31        : 16;
        uint32_t ssid                  : 16; /**< [ 15:  0](SR/W) Subsystem ID.
    ...
    /* struct cavm_pccpf_xxx_vsec_sctl2_s cn; */
};
typedef union cavm_pccpf_xxx_vsec_sctl2 cavm_pccpf_xxx_vsec_sctl2_t;

#define CAVM_PCCPF_XXX_VSEC_SCTL2 CAVM_PCCPF_XXX_VSEC_SCTL2_FUNC()
static inline uint64_t CAVM_PCCPF_XXX_VSEC_SCTL2_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_PCCPF_XXX_VSEC_SCTL2_FUNC(void)
{
    return 0x110;
}

#define typedef_CAVM_PCCPF_XXX_VSEC_SCTL2 cavm_pccpf_xxx_vsec_sctl2_t
#define bustype_CAVM_PCCPF_XXX_VSEC_SCTL2 CSR_TYPE_PCCPF
#define basename_CAVM_PCCPF_XXX_VSEC_SCTL2 "PCCPF_XXX_VSEC_SCTL2"
#define busnum_CAVM_PCCPF_XXX_VSEC_SCTL2 0
#define arguments_CAVM_PCCPF_XXX_VSEC_SCTL2 -1,-1,-1,-1
