...
#define CAVM_PCC_DEV_CON_E_GSERP_32GX(a) (0x90000 + (a))
#define CAVM_PCC_DEV_CON_E_GTI_CHEETAH (0x38)
#define CAVM_PCC_DEV_CON_E_GTI_ODINMP (0x28)
#define CAVM_PCC_DEV_CON_E_I2CX(a) (0x1c0 + (a))
...
#define CAVM_PCC_DEV_CON_E_RSTX_CHEETAH(a) (0x102 + (a))
#define CAVM_PCC_DEV_CON_E_RSTX_ODINMP(a) (0x101 + (a))
...
#define CAVM_PCC_DEV_IDL_E_I2C (0xa9)
