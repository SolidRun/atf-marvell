...
union cavm_cpc_permit
{
    ...
    struct cavm_cpc_permit_s
    {
        ...
        uint32_t permitdis             : 5;  /**< [  4:  0](R/W) Access permission of each access group.
                                                                 ...
                                                                 _ \<2\> if set disallows non-CCP/MCP/SCP (e.g. AP, NCSI, JTAG) secure access.
                                                                 _ \<3\> if set disallows non-CCP/MCP/SCP (e.g. AP, NCSI, JTAG) nonsecure access.
...
union cavm_cpc_ram_permitx
{
    ...
    struct cavm_cpc_ram_permitx_s
    {
        ...
        uint32_t pci_dis               : 4;  /**< [ 27: 24](R/W) Reserved. */
        uint32_t reserved_22_23        : 2;
        uint32_t wrdis                 : 6;  /**< [ 21: 16](R/W) Write permission of each access group.
                                                                 _ \<0\> if set disallows SCP access.
                                                                 _ \<1\> if set disallows MCP access.
                                                                 _ \<2\> if set disallows non-EHSM/CCP/MCP/SCP (e.g. AP) secure access.
                                                                 _ \<3\> if set disallows non-EHSM/CCP/MCP/SCP (e.g. AP) nonsecure access.
                                                                 _ \<4\> if set disallows CCP access.
...
union cavm_cpc_xcpx_gibx_lint_permit
{
    ...
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t lock                  : 1;  /**< [ 31: 31](R/W) When Set CPC_XCP(0..2)_GIB(0..2)_LINT_PERMIT register is locked for writes and becomes a Read
        ...
        uint32_t permitdis             : 5;  /**< [  4:  0](R/W) Access permission of each access group.
                                                                 _ \<0\> if set disallows SCP access.
                                                                 _ \<1\> if set disallows MCP access.
                                                                 _ \<2\> if set disallows non-CCP/MCP/SCP (e.g. AP) secure access.
                                                                 _ \<3\> if set disallows non-CCP/MCP/SCP (e.g. AP) nonsecure access.
                                                                 _ \<4\> if set disallows CCP access. */
#else /* Word 0 - Little Endian */
        uint32_t permitdis             : 5;  /**< [  4:  0](R/W) Access permission of each access group.
                                                                 _ \<0\> if set disallows SCP access.
...
union cavm_cpc_xcpx_permit
{
    ...
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t lock                  : 1;  /**< [ 31: 31](R/W) When Set CPC_XCP(0..2)_PERMIT register is locked for writes and becomes a Read
                                                                 Only Register, until this CSR is reset. */
        uint32_t reserved_5_30         : 26;
        uint32_t permitdis             : 5;  /**< [  4:  0](R/W) Access permission of each access group.
                                                                 _ \<0\> if set disallows SCP access.
