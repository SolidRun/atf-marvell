...
/**
 * Enumeration rdec_bar_e
 */
#define CAVM_RDEC_BAR_E_RDECX_PF_BAR2(a) (0xc00840e00000ll + 0x100000000ll * (a))
#define CAVM_RDEC_BAR_E_RDECX_PF_BAR2_SIZE 0x40000ull
...
union cavm_rdec_task_cfg_s
{
    ...
    struct cavm_rdec_task_cfg_s_s
    {
        ...
        uint64_t nr_table_idx          : 3;  /**< [ 23: 21] General Mode table index for RM decoder.
                                                                 0 = LTE/NR table
                                                                 1 = General Mode A table, configured via RDEC(0..2)_NR_S/MTBL_A
                                                                 2 = General Mode B table, configured via RDEC(0..2)_NR_S/MTBL_B
                                                                 3-7 = Reserved */
        uint64_t uci_bits              : 5;  /**< [ 20: 16] Number of UCI information bits to be decoded.
                                                                 In LTE/NR mode, must meet the following limits.
...
{
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=2) && (b<=2)))
        return 0xc00840e02000ll + 0x100000000ll * ((a) & 0x3) + 0x10000ll * ((b) & 0x3);
...
#define device_bar_CAVM_RDECX_ABX_CONFIGURATION(a,b) 0x2 /* PF_BAR2 */
...
{
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=2) && (b<=2)))
        return 0xc00840e00000ll + 0x100000000ll * ((a) & 0x3) + 0x10000ll * ((b) & 0x3);
...
#define device_bar_CAVM_RDECX_ABX_CONTROL(a,b) 0x2 /* PF_BAR2 */
...
{
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=2) && (b<=2)))
        return 0xc00840e00040ll + 0x100000000ll * ((a) & 0x3) + 0x10000ll * ((b) & 0x3);
...
#define device_bar_CAVM_RDECX_ABX_ERROR_ENABLE0(a,b) 0x2 /* PF_BAR2 */
...
{
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=2) && (b<=2)))
        return 0xc00840e00030ll + 0x100000000ll * ((a) & 0x3) + 0x10000ll * ((b) & 0x3);
...
#define device_bar_CAVM_RDECX_ABX_ERROR_SOURCE0(a,b) 0x2 /* PF_BAR2 */
...
{
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=2) && (b<=2) && (c<=127)))
        return 0xc00840e03000ll + 0x100000000ll * ((a) & 0x3) + 0x10000ll * ((b) & 0x3) + 8ll * ((c) & 0x7f);
...
#define device_bar_CAVM_RDECX_ABX_NR_MTBL_AX(a,b,c) 0x2 /* PF_BAR2 */
...
{
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=2) && (b<=2) && (c<=127)))
        return 0xc00840e03400ll + 0x100000000ll * ((a) & 0x3) + 0x10000ll * ((b) & 0x3) + 8ll * ((c) & 0x7f);
...
#define device_bar_CAVM_RDECX_ABX_NR_MTBL_BX(a,b,c) 0x2 /* PF_BAR2 */
...
{
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=2) && (b<=2) && (c<=31)))
        return 0xc00840e04000ll + 0x100000000ll * ((a) & 0x3) + 0x10000ll * ((b) & 0x3) + 8ll * ((c) & 0x1f);
...
#define device_bar_CAVM_RDECX_ABX_NR_RTBL_AX(a,b,c) 0x2 /* PF_BAR2 */
...
{
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=2) && (b<=2) && (c<=31)))
        return 0xc00840e04400ll + 0x100000000ll * ((a) & 0x3) + 0x10000ll * ((b) & 0x3) + 8ll * ((c) & 0x1f);
...
#define device_bar_CAVM_RDECX_ABX_NR_RTBL_BX(a,b,c) 0x2 /* PF_BAR2 */
...
{
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=2) && (b<=2) && (c<=31)))
        return 0xc00840e03800ll + 0x100000000ll * ((a) & 0x3) + 0x10000ll * ((b) & 0x3) + 8ll * ((c) & 0x1f);
...
#define device_bar_CAVM_RDECX_ABX_NR_STBL_AX(a,b,c) 0x2 /* PF_BAR2 */
...
{
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=2) && (b<=2) && (c<=31)))
        return 0xc00840e03c00ll + 0x100000000ll * ((a) & 0x3) + 0x10000ll * ((b) & 0x3) + 8ll * ((c) & 0x1f);
...
#define device_bar_CAVM_RDECX_ABX_NR_STBL_BX(a,b,c) 0x2 /* PF_BAR2 */
...
{
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=2) && (b<=2)))
        return 0xc00840e00018ll + 0x100000000ll * ((a) & 0x3) + 0x10000ll * ((b) & 0x3);
...
#define device_bar_CAVM_RDECX_ABX_STATUS(a,b) 0x2 /* PF_BAR2 */
