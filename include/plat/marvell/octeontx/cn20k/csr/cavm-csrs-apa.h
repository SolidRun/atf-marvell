 ...
 */
#define CAVM_APA_BAR_E_APAX_PF_BAR0(a) (0xc50040000000ll + 0x1000000ll * (a))
#define CAVM_APA_BAR_E_APAX_PF_BAR0_SIZE 0x100000ull
#define CAVM_APA_BAR_E_APAX_PF_BAR4(a) (0xc50040100000ll + 0x1000000ll * (a))
...
static inline uint64_t CAVM_APAX_APAT_INT_ENA_W1C(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001e10ll + 0x1000000ll * ((a) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001e18ll + 0x1000000ll * ((a) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001e00ll + 0x1000000ll * ((a) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001e08ll + 0x1000000ll * ((a) & 0x1f);
...
static inline uint64_t CAVM_APAX_APAT_RDATX(uint64_t a, uint64_t b)
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=23) && (b<=3)))
        return 0xc50040001240ll + 0x1000000ll * ((a) & 0x1f) + 8ll * ((b) & 0x3);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001200ll + 0x1000000ll * ((a) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001208ll + 0x1000000ll * ((a) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001210ll + 0x1000000ll * ((a) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=23) && (b<=31)))
        return 0xc50040001000ll + 0x1000000ll * ((a) & 0x1f) + 0x10ll * ((b) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=23) && (b<=31)))
        return 0xc50040001008ll + 0x1000000ll * ((a) & 0x1f) + 0x10ll * ((b) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=23) && (b<=3)))
        return 0xc50040001220ll + 0x1000000ll * ((a) & 0x1f) + 8ll * ((b) & 0x3);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001218ll + 0x1000000ll * ((a) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001e70ll + 0x1000000ll * ((a) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001e78ll + 0x1000000ll * ((a) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001e60ll + 0x1000000ll * ((a) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001e68ll + 0x1000000ll * ((a) & 0x1f);
...
union cavm_apax_ctl
{
    ...
    struct cavm_apax_ctl_s
    {
        ...
        uint64_t pfc_ns_access         : 1;  /**< [ 13: 13](SR/W) Set to enable non-secure software access to:
                                                                 - APA()_PRF
                                                                 - APA()_PFC() */
        uint64_t dis_cbusy_override    : 1;  /**< [ 12: 12](SR/W) Disable override of CBUSY[2] into AP. For diagnostic use only. */
        uint64_t cbusy_override_value  : 1;  /**< [ 11: 11](SR/W) Override value of CBUSY[2] if [DIS_CBUSY_OVERRIDE] is not set. For diagnostic use only. */
        uint64_t dis_wdog_during_apat  : 1;  /**< [ 10: 10](SR/W) Disable all watchdogs when an APAT is pending. For diagnostic use only. */
        uint64_t dvm_filter            : 2;  /**< [  9:  8](SR/W) APA filter to prevent certain DVM snoops from reaching the core.
                                                                 APA responds to them instead.   For diagnostic use only.
        ...
        uint64_t dis_wdog_struct_crd_clean : 1;/**< [  7:  7](SR/W) Disable cleaning of stale CRD entries. For diagnostic use only. */
        uint64_t dis_wdog_struct_txnid_clean : 1;/**< [  6:  6](SR/W) Disable cleaning of stale TXNID entries. For diagnostic use only. */
        uint64_t dis_wdog_struct_rqb_clean : 1;/**< [  5:  5](SR/W) Disable cleaning of stale RQB entries. For diagnostic use only. */
        uint64_t dis_wdog_struct_dat_clean : 1;/**< [  4:  4](SR/W) Disable cleaning of stale DAT entries. For diagnostic use only. */
        uint64_t dis_wdog_core_clean   : 1;  /**< [  3:  3](SR/W) Disable injection of missing responses to core. For diagnostic use only. */
        uint64_t dis_gwc               : 1;  /**< [  2:  2](SR/W) Disable SSO get work cache. For diagnostic use only. */
        uint64_t dis_lmtst             : 1;  /**< [  1:  1](SR/W) Disable LMTST. For diagnostic use only. */
        uint64_t dis_accel             : 1;  /**< [  0:  0](SR/W) Disable I/O acceleration. For diagnostic use only. */
#else /* Word 0 - Little Endian */
        uint64_t dis_accel             : 1;  /**< [  0:  0](SR/W) Disable I/O acceleration. For diagnostic use only. */
        uint64_t dis_lmtst             : 1;  /**< [  1:  1](SR/W) Disable LMTST. For diagnostic use only. */
        uint64_t dis_gwc               : 1;  /**< [  2:  2](SR/W) Disable SSO get work cache. For diagnostic use only. */
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001500ll + 0x1000000ll * ((a) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001530ll + 0x1000000ll * ((a) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001700ll + 0x1000000ll * ((a) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001508ll + 0x1000000ll * ((a) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001e50ll + 0x1000000ll * ((a) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001e58ll + 0x1000000ll * ((a) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001e40ll + 0x1000000ll * ((a) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001e48ll + 0x1000000ll * ((a) & 0x1f);
 ...
 */
union cavm_apax_gti_offset
{
    uint64_t u;
    struct cavm_apax_gti_offset_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_8_63         : 56;
        uint64_t offset                : 8;  /**< [  7:  0](SR/W) Offset. */
#else /* Word 0 - Little Endian */
        uint64_t offset                : 8;  /**< [  7:  0](SR/W) Offset. */
        uint64_t reserved_8_63         : 56;
#endif /* Word 0 - End */
    } s;
    /* struct cavm_apax_gti_offset_s cn; */
};
typedef union cavm_apax_gti_offset cavm_apax_gti_offset_t;

static inline uint64_t CAVM_APAX_GTI_OFFSET(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_APAX_GTI_OFFSET(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001708ll + 0x1000000ll * ((a) & 0x1f);
    __cavm_csr_fatal("APAX_GTI_OFFSET", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_APAX_GTI_OFFSET(a) cavm_apax_gti_offset_t
#define bustype_CAVM_APAX_GTI_OFFSET(a) CSR_TYPE_RSL
#define basename_CAVM_APAX_GTI_OFFSET(a) "APAX_GTI_OFFSET"
#define device_bar_CAVM_APAX_GTI_OFFSET(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_APAX_GTI_OFFSET(a) (a)
#define arguments_CAVM_APAX_GTI_OFFSET(a) (a),-1,-1,-1
...
union cavm_apax_lsax_diag_counts
{
    ...
    struct cavm_apax_lsax_diag_counts_s
    {
        ...
        uint64_t init_tail             : 6;  /**< [  5:  0](SRO/H) The dat buffer tail pointer for the first LMTLINE in a burst. */
#else /* Word 0 - Little Endian */
        uint64_t init_tail             : 6;  /**< [  5:  0](SRO/H) The dat buffer tail pointer for the first LMTLINE in a burst. */
        uint64_t reserved_6_9          : 4;
        uint64_t ro_cnt                : 5;  /**< [ 14: 10](SRO/H) Number of ReadOnce for LMTLINEs issued. */
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=23) && (b<=1)))
        return 0xc50040001608ll + 0x1000000ll * ((a) & 0x1f) + 0x40ll * ((b) & 0x1);
...
union cavm_apax_lsax_diag_lmtmap
{
    ...
    struct cavm_apax_lsax_diag_lmtmap_cn
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=23) && (b<=1)))
        return 0xc50040001618ll + 0x1000000ll * ((a) & 0x1f) + 0x40ll * ((b) & 0x1);
...
union cavm_apax_lsax_diag_req
{
    ...
    struct cavm_apax_lsax_diag_req_s
    {
        ...
        uint64_t lmtid                 : 11; /**< [ 44: 34](SRO/H) LMTID field in the STEOR dat flit. */
        uint64_t txnid                 : 12; /**< [ 33: 22](SRO/H) TXNID of the STEOR req flit. */
        uint64_t not_secure            : 1;  /**< [ 21: 21](SRO/H) NS field in the STEOR req flit. */
        uint64_t first_size_m1         : 3;  /**< [ 20: 18](SRO/H) Size minus 1 of the first LMTLINE in a burst LMTST. */
        uint64_t rvu_blk               : 5;  /**< [ 17: 13](SRO/H) RVU_BLK field in the STEOR req flit. */
        uint64_t func                  : 8;  /**< [ 12:  5](SRO/H) FUNC field in the STEOR req flit. */
        uint64_t pf                    : 5;  /**< [  4:  0](SRO/H) PF field in the STEOR req flit. */
#else /* Word 0 - Little Endian */
        uint64_t pf                    : 5;  /**< [  4:  0](SRO/H) PF field in the STEOR req flit. */
        uint64_t func                  : 8;  /**< [ 12:  5](SRO/H) FUNC field in the STEOR req flit. */
        uint64_t rvu_blk               : 5;  /**< [ 17: 13](SRO/H) RVU_BLK field in the STEOR req flit. */
    ...
    struct cavm_apax_lsax_diag_req_cn
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=23) && (b<=1)))
        return 0xc50040001610ll + 0x1000000ll * ((a) & 0x1f) + 0x40ll * ((b) & 0x1);
...
union cavm_apax_lsax_diag_status
{
    ...
    struct cavm_apax_lsax_diag_status_s
    {
        ...
        uint64_t thread_status         : 26; /**< [ 25:  0](SRO/H) Status of each of 13 LSA threads. For each thread:
                                                                 0x0 = Not started.
                                                                 0x1 = Active.
                                                                 0x2 = Done.
                                                                 0x3 = Reserved. */
    ...
    struct cavm_apax_lsax_diag_status_cn
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t st_dat_err            : 1;  /**< [ 63: 63](SRO/H) Saw an error in the Store data from the core. */
        uint64_t pa_dat_err            : 1;  /**< [ 62: 62](SRO/H) Saw an error in the CompData fetching the physical address. */
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=23) && (b<=1)))
        return 0xc50040001600ll + 0x1000000ll * ((a) & 0x1f) + 0x40ll * ((b) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040004008ll + 0x1000000ll * ((a) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=23) && (b==0)))
        return 0xc500401f0000ll + 0x1000000ll * ((a) & 0x1f) + 8ll * ((b) & 0x0);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=23) && (b<=7)))
        return 0xc50040100000ll + 0x1000000ll * ((a) & 0x1f) + 0x10ll * ((b) & 0x7);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=23) && (b<=7)))
        return 0xc50040100008ll + 0x1000000ll * ((a) & 0x1f) + 0x10ll * ((b) & 0x7);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001528ll + 0x1000000ll * ((a) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=23) && (b<=5)))
        return 0xc50040010000ll + 0x1000000ll * ((a) & 0x1f) + 8ll * ((b) & 0x7);
...
union cavm_apax_pll
{
    ...
    struct cavm_apax_pll_s
    {
        ...
        uint64_t no_auto_pgm           : 1;  /**< [ 56: 56](SRO/H) No Automatic PLL Programming on Cold or Chip Reset.
                                                                 0 = On a cold or chip domain reset, the PLL will switch to runt_clk and then
                                                                     automatically program and switch to the frequency indicated by [INIT_MUL].
                                                                 1 = On a cold or chip domain reset, the PLL will select the runt_clk
                                                                     until programmed by software. */
        uint64_t no_rst_chip           : 1;  /**< [ 55: 55](SRO/H) No PLL Reset on Chip Reset.
                                                                 0 = On a chip domain reset, the PLL will switch to runt_clk and then
                                                                     automatically program and switch to the frequency indicated by [INIT_MUL].
                                                                 1 = On a chip domain reset, the PLL will continue using clock selected by
                                                                     [CUR_SEL] and the PLL logic will not be reset. */
        ...
        uint64_t next_switch           : 16; /**< [ 15:  0](SR/W/H) Switch the PLL specified by [NEXT_PLL_SEL] after delaying this number of 100 MHz clocks.
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040004000ll + 0x1000000ll * ((a) & 0x1f);
 ...
 */
union cavm_apax_pllro_status
{
    uint64_t u;
    struct cavm_apax_pllro_status_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_33_63        : 31;
        uint64_t droop                 : 1;  /**< [ 32: 32](SRO/H) Droop event detected. */
        uint64_t status                : 32; /**< [ 31:  0](SRO/H) Status word from PLLRO. */
#else /* Word 0 - Little Endian */
        uint64_t status                : 32; /**< [ 31:  0](SRO/H) Status word from PLLRO. */
        uint64_t droop                 : 1;  /**< [ 32: 32](SRO/H) Droop event detected. */
        uint64_t reserved_33_63        : 31;
    ...
    /* struct cavm_apax_pllro_status_s cn; */
};
typedef union cavm_apax_pllro_status cavm_apax_pllro_status_t;

static inline uint64_t CAVM_APAX_PLLRO_STATUS(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_APAX_PLLRO_STATUS(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001f00ll + 0x1000000ll * ((a) & 0x1f);
    __cavm_csr_fatal("APAX_PLLRO_STATUS", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_APAX_PLLRO_STATUS(a) cavm_apax_pllro_status_t
#define bustype_CAVM_APAX_PLLRO_STATUS(a) CSR_TYPE_RSL
#define basename_CAVM_APAX_PLLRO_STATUS(a) "APAX_PLLRO_STATUS"
#define device_bar_CAVM_APAX_PLLRO_STATUS(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_APAX_PLLRO_STATUS(a) (a)
#define arguments_CAVM_APAX_PLLRO_STATUS(a) (a),-1,-1,-1
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040010100ll + 0x1000000ll * ((a) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001400ll + 0x1000000ll * ((a) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040004010ll + 0x1000000ll * ((a) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001300ll + 0x1000000ll * ((a) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001310ll + 0x1000000ll * ((a) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001e30ll + 0x1000000ll * ((a) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001e38ll + 0x1000000ll * ((a) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001e20ll + 0x1000000ll * ((a) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001e28ll + 0x1000000ll * ((a) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001308ll + 0x1000000ll * ((a) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001318ll + 0x1000000ll * ((a) & 0x1f);
...
union cavm_apax_wdog_struct_dat_diag
{
    ...
    struct cavm_apax_wdog_struct_dat_diag_cn
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t multi                 : 1;  /**< [ 63: 63](SR/W1C/H) Another stale entry was detected but not recorded because [STALE] was already set. */
        uint64_t stale                 : 1;  /**< [ 62: 62](SR/W1C/H) Stale entry was detected and recorded. */
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001330ll + 0x1000000ll * ((a) & 0x1f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001328ll + 0x1000000ll * ((a) & 0x1f);
...
union cavm_apax_wdog_struct_txnid_diag
{
    ...
    struct cavm_apax_wdog_struct_txnid_diag_s
    {
        ...
        uint64_t stale                 : 1;  /**< [ 30: 30](SR/W1C/H) Stale entry was detected and recorded. */
        uint64_t reserved_20_29        : 10;
        uint64_t txnid_new             : 8;  /**< [ 19: 12](SRO/H) Stale entry new transaction ID (low 7 bits). */
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=23))
        return 0xc50040001320ll + 0x1000000ll * ((a) & 0x1f);
