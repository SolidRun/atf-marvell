...
/**
 * Enumeration prchn_bar_e
 */
#define CAVM_PRCHN_BAR_E_PRCHNX_PF_BAR2(a) (0x87e042180000ll + 0ll * (a))
#define CAVM_PRCHN_BAR_E_PRCHNX_PF_BAR2_SIZE 0x40000ull
...
#define device_bar_CAVM_PRCHX_ABX_CONTROL0(a,b) 0x2 /* PF_BAR2 */
...
#define device_bar_CAVM_PRCHX_ABX_ERROR_ENABLE0(a,b) 0x2 /* PF_BAR2 */
...
#define device_bar_CAVM_PRCHX_ABX_ERROR_SOURCE0(a,b) 0x2 /* PF_BAR2 */
...
{
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a==0) && (b<=2) && (c<=75)))
...
#define device_bar_CAVM_PRCHX_ABX_HAB_JCFG0_DATAX(a,b,c) 0x2 /* PF_BAR2 */
...
#define device_bar_CAVM_PRCHX_ABX_HAB_JCFG1_DATAX(a,b,c) 0x2 /* PF_BAR2 */
...
#define device_bar_CAVM_PRCHX_ABX_HAB_JCFG2_DATAX(a,b,c) 0x2 /* PF_BAR2 */
...
#define device_bar_CAVM_PRCHX_ABX_STATUS(a,b) 0x2 /* PF_BAR2 */
