...
union cavm_dmap_jd_lte_cfg_s
{
    ...
    /* struct cavm_dmap_jd_lte_cfg_s_s cn20; */
    /* struct cavm_dmap_jd_lte_cfg_s_s cn20ka; */
    struct cavm_dmap_jd_lte_cfg_s_cnf20ka
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_38_63        : 26;
        uint64_t ri_scomb_bypass       : 1;  /**< [ 37: 37] Set to 1 for RI soft-combining bypass (for LTE only). This feature is
...
union cavm_dmap_jd_nr_cfg_s
{
    ...
    /* struct cavm_dmap_jd_nr_cfg_s_s cn20; */
    struct cavm_dmap_jd_nr_cfg_s_cn20ka
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_62_63        : 2;
        uint64_t csi1_extract_bypass   : 1;  /**< [ 61: 61] Set to 1 for CSI1 extraction bypass. */
    ...
    struct cavm_dmap_jd_nr_cfg_s_cnf20ka
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_62_63        : 2;
...
union cavm_dmapx_abx_jdx_cfg0
{
    ...
    struct cavm_dmapx_abx_jdx_cfg0_s
    {
        ...
        uint64_t psinr_scale           : 3;  /**< [ 25: 23](R/W) PSINR scaling factor. Legal values are 0, 1, 2.
                                                                 Programming illegal values will cause unpredictable results to be generated. */
        uint64_t configured_sinr       : 5;  /**< [ 22: 18](R/W) Parameter used in WH (Norm-gain-based) pSINR calculation. */
        uint64_t reserved_11_17        : 7;
    ...
    /* struct cavm_dmapx_abx_jdx_cfg0_s cn20; */
    struct cavm_dmapx_abx_jdx_cfg0_cn20ka
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_63           : 1;
        uint64_t sinr_calc_bypass      : 1;  /**< [ 62: 62](R/W) Set to 1 for SINR calculation bypass. */
    ...
    struct cavm_dmapx_abx_jdx_cfg0_cnf20ka
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_62_63        : 2;
...
union cavm_dmapx_abx_jdx_cfg1
{
    ...
    /* struct cavm_dmapx_abx_jdx_cfg1_s cn20; */
    struct cavm_dmapx_abx_jdx_cfg1_cn20ka
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_61_63        : 3;
        uint64_t q_saturate_n_bit      : 5;  /**< [ 60: 56](R/W) Scaling and Saturation Function.
    ...
    struct cavm_dmapx_abx_jdx_cfg1_cnf20ka
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
union cavm_dmapx_abx_jdx_cfg2
{
    ...
    /* struct cavm_dmapx_abx_jdx_cfg2_s cn20; */
    struct cavm_dmapx_abx_jdx_cfg2_cn20ka
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t phi_imag_1            : 16; /**< [ 63: 48](R/W) Phase imaginary part of Stream 1 for [DU_MMU_MODE] == 1,2,3 */
        uint64_t phi_real_1            : 16; /**< [ 47: 32](R/W) Phase real part of Stream 1 for [DU_MMU_MODE] == 1,2,3 */
    ...
    struct cavm_dmapx_abx_jdx_cfg2_cnf20ka
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
union cavm_dmapx_abx_jdx_du_cfg0
{
    ...
    /* struct cavm_dmapx_abx_jdx_du_cfg0_s cn20; */
    struct cavm_dmapx_abx_jdx_du_cfg0_cn20ka
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_61_63        : 3;
        uint64_t dft_bypass            : 1;  /**< [ 60: 60](R/W) Set to 1 for IDFT/DFT bypass. */
        ...
        uint64_t bpsk_freq_rot         : 2;  /**< [ 37: 36](R/W) The only legal values are 0, 1, 2.
                                                                 Set to 2 for I+Q odd  subcarrier LLR generation and -I+Q even subcarrier LLR generation.
                                                                 Set to 1 for I+Q even subcarrier LLR generation and -I+Q odd  subcarrier LLR generation.
                                                                 Set to 0 for only I+Q based LLR generation.
                                                                 Programming illegal values will cause unpredictable results to be generated. */
        uint64_t dmp_special           : 1;  /**< [ 35: 35](R/W) Set to 1 for demapper to treat 1-bit and 2-bit ACK/RICSI1 REs a special way,
    ...
    struct cavm_dmapx_abx_jdx_du_cfg0_cnf20ka
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b<=1) && (c<=3)))
...
union cavm_dmapx_abx_jdx_du_cfg1
{
    ...
    /* struct cavm_dmapx_abx_jdx_du_cfg1_s cn20; */
    /* struct cavm_dmapx_abx_jdx_du_cfg1_s cn20ka; */
    struct cavm_dmapx_abx_jdx_du_cfg1_cnf20ka
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b<=1) && (c<=3) && (d<=15)))
