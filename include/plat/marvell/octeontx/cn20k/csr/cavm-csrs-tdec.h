...
/**
 * Enumeration tdec_bar_e
 */
#define CAVM_TDEC_BAR_E_TDECX_PF_BAR2(a) (0x87e042100000ll + 0x80000ll * (a))
#define CAVM_TDEC_BAR_E_TDECX_PF_BAR2_SIZE 0x40000ull
...
union cavm_tdec_lte_report_s
{
    ...
    struct cavm_tdec_lte_report_s_s
    {
        ...
        uint64_t reserved_287_319      : 33;
        uint64_t cum_corr              : 15; /**< [286:272] Accumulated correlation estimation. In per-TB processing mode, the accumulation is over all
                                                                 decoded CBs. For each code block, the correlation is calculated on the coded bits after
                                                                 re-encoding of the hard decisions. It is computed by computing the correlation between the
                                                                 re-encoded sequence and the sign of the input LLRs. */
        uint64_t reserved_271          : 1;
        uint64_t max_corr              : 15; /**< [270:256] Maximal correlation value. In per-TB processing mode, correlation associated with
                                                                 each CB is calculated and the maximum correlation among all decoded CBs is reported
                                                                 in this field. For each code block, the correlation is calculated on the coded bits
                                                                 after re-encoding of the hard decisions. It is computed by computing the correlation
                                                                 between the re-encoded sequence and the sign of the input LLRs. */
...
union cavm_tdec_lte_task_cfg_s
{
    ...
    struct cavm_tdec_lte_task_cfg_s_s
    {
        ...
        uint64_t mod_order             : 4;  /**< [ 37: 34] Modulation order:
                                                                 ...
                                                                 0xA = 1024QAM.
                                                                 Others = Reserved.
                                                                 Important Note: channel deinterleaver does NOT support Qm = 10. If Qm = 10,
                                                                 channel deinterleaver SHALL
                                                                                 be in bypass mode and only the Core functionalities are supported. */
        ...
        uint64_t byps_tb_proc          : 1;  /**< [ 96: 96] When set to one, bypasses the following transport block processing:
                                                                 ...
                                                                 * Scrambling.
                                                                 ...
                                                                 [BYPS_TB_PROC] = 1. */
        uint64_t algo_ml_en            : 2;  /**< [ 95: 94] Flag to enable/disable ML decoding algorithm. When enabled, number of decoding
                                                                 engines selected by "SW_SPEED" and algorithm chosen by "ALGO_SELECT" will be
                                                                 ignored.
                                                                 0 = disable ML decoding.
                                                                 1 = enable ML decoding.

                                                                 When ALGO_ML_EN = 1:
                                                                 - soft output cannot be generated and generate_so shall be equal to 0.
                                                                 - CB_CRC_SELECT cannot be equal to 0 when BYPASS_TB_PROC = 1. */
        ...
        uint64_t ml_cand_scale         : 5;  /**< [271:267] It is a parameter of ML decoding algorithm that will depend on coding rate. Range [0:31] */
        uint64_t ml_num_cand           : 7;  /**< [266:260] Number of candidates used in ML decoding. Will be ignored when ML decoding is not chosen. */
...
/**
 * Register (RSL) tdec#_ab#_control
 *
 * TDEC Control Register
 */
union cavm_tdecx_abx_control
{
    uint64_t u;
    struct cavm_tdecx_abx_control_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_tdecx_abx_control_s cn; */
};
typedef union cavm_tdecx_abx_control cavm_tdecx_abx_control_t;
...
{
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a==0) && (b<=2)))
        return 0x87e042100000ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x3);
    __cavm_csr_fatal("TDECX_ABX_CONTROL", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_TDECX_ABX_CONTROL(a,b) cavm_tdecx_abx_control_t
#define bustype_CAVM_TDECX_ABX_CONTROL(a,b) CSR_TYPE_RSL
#define basename_CAVM_TDECX_ABX_CONTROL(a,b) "TDECX_ABX_CONTROL"
#define device_bar_CAVM_TDECX_ABX_CONTROL(a,b) 0x2 /* PF_BAR2 */
#define busnum_CAVM_TDECX_ABX_CONTROL(a,b) (a)
#define arguments_CAVM_TDECX_ABX_CONTROL(a,b) (a),(b),-1,-1

/**
 * Register (RSL) tdec#_ab#_error_enable0
 *
 * TDEC Error Enable 0 Register
 * This register enables error reporting for read overflow/underflow errors.
 */
union cavm_tdecx_abx_error_enable0
{
    uint64_t u;
    struct cavm_tdecx_abx_error_enable0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_tdecx_abx_error_enable0_s cn; */
};
typedef union cavm_tdecx_abx_error_enable0 cavm_tdecx_abx_error_enable0_t;
...
#define typedef_CAVM_TDECX_ABX_ERROR_ENABLE0(a,b) cavm_tdecx_abx_error_enable0_t
#define bustype_CAVM_TDECX_ABX_ERROR_ENABLE0(a,b) CSR_TYPE_RSL
#define basename_CAVM_TDECX_ABX_ERROR_ENABLE0(a,b) "TDECX_ABX_ERROR_ENABLE0"
#define device_bar_CAVM_TDECX_ABX_ERROR_ENABLE0(a,b) 0x2 /* PF_BAR2 */
#define busnum_CAVM_TDECX_ABX_ERROR_ENABLE0(a,b) (a)
#define arguments_CAVM_TDECX_ABX_ERROR_ENABLE0(a,b) (a),(b),-1,-1

/**
 * Register (RSL) tdec#_ab#_error_source0
 *
 * TDEC Error Source 0 Register
 * This register indicates the source of read overflow/underflow errors.
 */
union cavm_tdecx_abx_error_source0
{
    uint64_t u;
    struct cavm_tdecx_abx_error_source0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_tdecx_abx_error_source0_s cn; */
};
typedef union cavm_tdecx_abx_error_source0 cavm_tdecx_abx_error_source0_t;
...
#define typedef_CAVM_TDECX_ABX_ERROR_SOURCE0(a,b) cavm_tdecx_abx_error_source0_t
#define bustype_CAVM_TDECX_ABX_ERROR_SOURCE0(a,b) CSR_TYPE_RSL
#define basename_CAVM_TDECX_ABX_ERROR_SOURCE0(a,b) "TDECX_ABX_ERROR_SOURCE0"
#define device_bar_CAVM_TDECX_ABX_ERROR_SOURCE0(a,b) 0x2 /* PF_BAR2 */
#define busnum_CAVM_TDECX_ABX_ERROR_SOURCE0(a,b) (a)
#define arguments_CAVM_TDECX_ABX_ERROR_SOURCE0(a,b) (a),(b),-1,-1

/**
 * Register (RSL) tdec#_ab#_hab_jcfg0_ram#_data
 *
...
{
    uint64_t u;
    struct cavm_tdecx_abx_hab_jcfg0_ramx_data_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_tdecx_abx_hab_jcfg0_ramx_data_s cn; */
};
typedef union cavm_tdecx_abx_hab_jcfg0_ramx_data cavm_tdecx_abx_hab_jcfg0_ramx_data_t;
...
{
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a==0) && (b<=2) && (c<=255)))
...
#define typedef_CAVM_TDECX_ABX_HAB_JCFG0_RAMX_DATA(a,b,c) cavm_tdecx_abx_hab_jcfg0_ramx_data_t
#define bustype_CAVM_TDECX_ABX_HAB_JCFG0_RAMX_DATA(a,b,c) CSR_TYPE_RSL
#define basename_CAVM_TDECX_ABX_HAB_JCFG0_RAMX_DATA(a,b,c) "TDECX_ABX_HAB_JCFG0_RAMX_DATA"
#define device_bar_CAVM_TDECX_ABX_HAB_JCFG0_RAMX_DATA(a,b,c) 0x2 /* PF_BAR2 */
#define busnum_CAVM_TDECX_ABX_HAB_JCFG0_RAMX_DATA(a,b,c) (a)
#define arguments_CAVM_TDECX_ABX_HAB_JCFG0_RAMX_DATA(a,b,c) (a),(b),(c),-1

/**
 * Register (RSL) tdec#_ab#_hab_jcfg1_ram#_data
 *
 * TDEC HAB Job Configuration 1 RAM Register
 * This register range accesses the job configuration RAM for slot 1.
 */
union cavm_tdecx_abx_hab_jcfg1_ramx_data
{
    uint64_t u;
    struct cavm_tdecx_abx_hab_jcfg1_ramx_data_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t entry                 : 64; /**< [ 63:  0](R/W/H) Job configuration RAM entry. */
#else /* Word 0 - Little Endian */
    ...
    /* struct cavm_tdecx_abx_hab_jcfg1_ramx_data_s cn; */
};
typedef union cavm_tdecx_abx_hab_jcfg1_ramx_data cavm_tdecx_abx_hab_jcfg1_ramx_data_t;
...
#define typedef_CAVM_TDECX_ABX_HAB_JCFG1_RAMX_DATA(a,b,c) cavm_tdecx_abx_hab_jcfg1_ramx_data_t
#define bustype_CAVM_TDECX_ABX_HAB_JCFG1_RAMX_DATA(a,b,c) CSR_TYPE_RSL
#define basename_CAVM_TDECX_ABX_HAB_JCFG1_RAMX_DATA(a,b,c) "TDECX_ABX_HAB_JCFG1_RAMX_DATA"
#define device_bar_CAVM_TDECX_ABX_HAB_JCFG1_RAMX_DATA(a,b,c) 0x2 /* PF_BAR2 */
#define busnum_CAVM_TDECX_ABX_HAB_JCFG1_RAMX_DATA(a,b,c) (a)
#define arguments_CAVM_TDECX_ABX_HAB_JCFG1_RAMX_DATA(a,b,c) (a),(b),(c),-1

/**
 * Register (RSL) tdec#_ab#_hab_jcfg2_ram#_data
 *
 * TDEC HAB Job Configuration 2 RAM Register
 * This register range accesses the job configuration RAM for slot 2.
 */
union cavm_tdecx_abx_hab_jcfg2_ramx_data
{
    uint64_t u;
    struct cavm_tdecx_abx_hab_jcfg2_ramx_data_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t entry                 : 64; /**< [ 63:  0](R/W/H) Job configuration RAM entry. */
#else /* Word 0 - Little Endian */
    ...
    /* struct cavm_tdecx_abx_hab_jcfg2_ramx_data_s cn; */
};
typedef union cavm_tdecx_abx_hab_jcfg2_ramx_data cavm_tdecx_abx_hab_jcfg2_ramx_data_t;
...
#define typedef_CAVM_TDECX_ABX_HAB_JCFG2_RAMX_DATA(a,b,c) cavm_tdecx_abx_hab_jcfg2_ramx_data_t
#define bustype_CAVM_TDECX_ABX_HAB_JCFG2_RAMX_DATA(a,b,c) CSR_TYPE_RSL
#define basename_CAVM_TDECX_ABX_HAB_JCFG2_RAMX_DATA(a,b,c) "TDECX_ABX_HAB_JCFG2_RAMX_DATA"
#define device_bar_CAVM_TDECX_ABX_HAB_JCFG2_RAMX_DATA(a,b,c) 0x2 /* PF_BAR2 */
#define busnum_CAVM_TDECX_ABX_HAB_JCFG2_RAMX_DATA(a,b,c) (a)
#define arguments_CAVM_TDECX_ABX_HAB_JCFG2_RAMX_DATA(a,b,c) (a),(b),(c),-1

/**
 * Register (RSL) tdec#_ab#_status
 *
 * TDEC Status Register
 */
union cavm_tdecx_abx_status
{
    uint64_t u;
    struct cavm_tdecx_abx_status_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_tdecx_abx_status_s cn; */
};
typedef union cavm_tdecx_abx_status cavm_tdecx_abx_status_t;
...
#define typedef_CAVM_TDECX_ABX_STATUS(a,b) cavm_tdecx_abx_status_t
#define bustype_CAVM_TDECX_ABX_STATUS(a,b) CSR_TYPE_RSL
#define basename_CAVM_TDECX_ABX_STATUS(a,b) "TDECX_ABX_STATUS"
#define device_bar_CAVM_TDECX_ABX_STATUS(a,b) 0x2 /* PF_BAR2 */
#define busnum_CAVM_TDECX_ABX_STATUS(a,b) (a)
#define arguments_CAVM_TDECX_ABX_STATUS(a,b) (a),(b),-1,-1

/**
 * Register (RSL) tdec#_ab#_tc_cfg_err_flags_reg
 *
 ...
 */
union cavm_tdecx_abx_tc_cfg_err_flags_reg
{
    uint64_t u;
    struct cavm_tdecx_abx_tc_cfg_err_flags_reg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_tdecx_abx_tc_cfg_err_flags_reg_s cn; */
};
typedef union cavm_tdecx_abx_tc_cfg_err_flags_reg cavm_tdecx_abx_tc_cfg_err_flags_reg_t;
...
#define typedef_CAVM_TDECX_ABX_TC_CFG_ERR_FLAGS_REG(a,b) cavm_tdecx_abx_tc_cfg_err_flags_reg_t
#define bustype_CAVM_TDECX_ABX_TC_CFG_ERR_FLAGS_REG(a,b) CSR_TYPE_RSL
#define basename_CAVM_TDECX_ABX_TC_CFG_ERR_FLAGS_REG(a,b) "TDECX_ABX_TC_CFG_ERR_FLAGS_REG"
#define device_bar_CAVM_TDECX_ABX_TC_CFG_ERR_FLAGS_REG(a,b) 0x2 /* PF_BAR2 */
#define busnum_CAVM_TDECX_ABX_TC_CFG_ERR_FLAGS_REG(a,b) (a)
#define arguments_CAVM_TDECX_ABX_TC_CFG_ERR_FLAGS_REG(a,b) (a),(b),-1,-1

/**
 * Register (RSL) tdec#_ab#_tc_control_reg
 *
 * TDEC Decoder Control Register
 * This register configures the TDEC internal decoder core.
 */
union cavm_tdecx_abx_tc_control_reg
{
    uint64_t u;
    struct cavm_tdecx_abx_tc_control_reg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_5_63         : 59;
    ...
    /* struct cavm_tdecx_abx_tc_control_reg_s cn; */
};
typedef union cavm_tdecx_abx_tc_control_reg cavm_tdecx_abx_tc_control_reg_t;
...
#define typedef_CAVM_TDECX_ABX_TC_CONTROL_REG(a,b) cavm_tdecx_abx_tc_control_reg_t
#define bustype_CAVM_TDECX_ABX_TC_CONTROL_REG(a,b) CSR_TYPE_RSL
#define basename_CAVM_TDECX_ABX_TC_CONTROL_REG(a,b) "TDECX_ABX_TC_CONTROL_REG"
#define device_bar_CAVM_TDECX_ABX_TC_CONTROL_REG(a,b) 0x2 /* PF_BAR2 */
#define busnum_CAVM_TDECX_ABX_TC_CONTROL_REG(a,b) (a)
#define arguments_CAVM_TDECX_ABX_TC_CONTROL_REG(a,b) (a),(b),-1,-1

/**
 * Register (RSL) tdec#_ab#_tc_error_mask_reg
 *
 ...
 */
union cavm_tdecx_abx_tc_error_mask_reg
{
    uint64_t u;
    struct cavm_tdecx_abx_tc_error_mask_reg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
    ...
    /* struct cavm_tdecx_abx_tc_error_mask_reg_s cn; */
};
typedef union cavm_tdecx_abx_tc_error_mask_reg cavm_tdecx_abx_tc_error_mask_reg_t;
...
#define typedef_CAVM_TDECX_ABX_TC_ERROR_MASK_REG(a,b) cavm_tdecx_abx_tc_error_mask_reg_t
#define bustype_CAVM_TDECX_ABX_TC_ERROR_MASK_REG(a,b) CSR_TYPE_RSL
#define basename_CAVM_TDECX_ABX_TC_ERROR_MASK_REG(a,b) "TDECX_ABX_TC_ERROR_MASK_REG"
#define device_bar_CAVM_TDECX_ABX_TC_ERROR_MASK_REG(a,b) 0x2 /* PF_BAR2 */
#define busnum_CAVM_TDECX_ABX_TC_ERROR_MASK_REG(a,b) (a)
#define arguments_CAVM_TDECX_ABX_TC_ERROR_MASK_REG(a,b) (a),(b),-1,-1

/**
 * Register (RSL) tdec#_ab#_tc_error_reg
 *
 ...
 * the error(s).
 */
union cavm_tdecx_abx_tc_error_reg
{
    uint64_t u;
    struct cavm_tdecx_abx_tc_error_reg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_tdecx_abx_tc_error_reg_s cn; */
};
typedef union cavm_tdecx_abx_tc_error_reg cavm_tdecx_abx_tc_error_reg_t;
...
#define typedef_CAVM_TDECX_ABX_TC_ERROR_REG(a,b) cavm_tdecx_abx_tc_error_reg_t
#define bustype_CAVM_TDECX_ABX_TC_ERROR_REG(a,b) CSR_TYPE_RSL
#define basename_CAVM_TDECX_ABX_TC_ERROR_REG(a,b) "TDECX_ABX_TC_ERROR_REG"
#define device_bar_CAVM_TDECX_ABX_TC_ERROR_REG(a,b) 0x2 /* PF_BAR2 */
#define busnum_CAVM_TDECX_ABX_TC_ERROR_REG(a,b) (a)
#define arguments_CAVM_TDECX_ABX_TC_ERROR_REG(a,b) (a),(b),-1,-1

/**
 * Register (RSL) tdec#_ab#_tc_main_reset_reg
 *
 * TDEC Decoder Reset Register
 * Internal decoder core reset register.
 */
union cavm_tdecx_abx_tc_main_reset_reg
{
    uint64_t u;
    struct cavm_tdecx_abx_tc_main_reset_reg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_tdecx_abx_tc_main_reset_reg_s cn; */
};
typedef union cavm_tdecx_abx_tc_main_reset_reg cavm_tdecx_abx_tc_main_reset_reg_t;
...
#define typedef_CAVM_TDECX_ABX_TC_MAIN_RESET_REG(a,b) cavm_tdecx_abx_tc_main_reset_reg_t
#define bustype_CAVM_TDECX_ABX_TC_MAIN_RESET_REG(a,b) CSR_TYPE_RSL
#define basename_CAVM_TDECX_ABX_TC_MAIN_RESET_REG(a,b) "TDECX_ABX_TC_MAIN_RESET_REG"
#define device_bar_CAVM_TDECX_ABX_TC_MAIN_RESET_REG(a,b) 0x2 /* PF_BAR2 */
#define busnum_CAVM_TDECX_ABX_TC_MAIN_RESET_REG(a,b) (a)
#define arguments_CAVM_TDECX_ABX_TC_MAIN_RESET_REG(a,b) (a),(b),-1,-1

/**
 * Register (RSL) tdec#_ab#_tc_status0_reg
 *
 * TDEC Decoder Status Register
 * This register reports status from the internal decoder core.
 */
union cavm_tdecx_abx_tc_status0_reg
{
    uint64_t u;
    struct cavm_tdecx_abx_tc_status0_reg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_tdecx_abx_tc_status0_reg_s cn; */
};
typedef union cavm_tdecx_abx_tc_status0_reg cavm_tdecx_abx_tc_status0_reg_t;
...
#define typedef_CAVM_TDECX_ABX_TC_STATUS0_REG(a,b) cavm_tdecx_abx_tc_status0_reg_t
#define bustype_CAVM_TDECX_ABX_TC_STATUS0_REG(a,b) CSR_TYPE_RSL
#define basename_CAVM_TDECX_ABX_TC_STATUS0_REG(a,b) "TDECX_ABX_TC_STATUS0_REG"
#define device_bar_CAVM_TDECX_ABX_TC_STATUS0_REG(a,b) 0x2 /* PF_BAR2 */
#define busnum_CAVM_TDECX_ABX_TC_STATUS0_REG(a,b) (a)
#define arguments_CAVM_TDECX_ABX_TC_STATUS0_REG(a,b) (a),(b),-1,-1
