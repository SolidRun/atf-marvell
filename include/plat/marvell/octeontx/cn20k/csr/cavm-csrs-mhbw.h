...
{
    if (cavm_is_model(OCTEONTX_ODINMP) && ((a<=95) && (b<=3)))
...
{
    if (cavm_is_model(OCTEONTX_ODINMP) && ((a<=95) && (b<=3) && (c<=3)))
...
{
    if (cavm_is_model(OCTEONTX_ODINMP) && (a<=95))
...
{
    if (cavm_is_model(OCTEONTX_ODINMP) && ((a<=95) && (b<=1)))
