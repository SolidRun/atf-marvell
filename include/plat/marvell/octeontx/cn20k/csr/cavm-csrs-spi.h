...
union cavm_spix_clk_ctrl
{
    ...
    /* struct cavm_spix_clk_ctrl_s cheetah; */
    /* struct cavm_spix_clk_ctrl_s cn20; */
    struct cavm_spix_clk_ctrl_odinmp
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
/**
 * Register (NCB) spi#_soft_reset
 *
 * SPI SOFT RESET Register
 * This register is used as soft reset
 */
union cavm_spix_soft_reset
{
    uint64_t u;
    struct cavm_spix_soft_reset_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_spix_soft_reset_s cn; */
};
typedef union cavm_spix_soft_reset cavm_spix_soft_reset_t;

static inline uint64_t CAVM_SPIX_SOFT_RESET(uint64_t a) __attribute__ ((pure, always_inline));
...
#define typedef_CAVM_SPIX_SOFT_RESET(a) cavm_spix_soft_reset_t
#define bustype_CAVM_SPIX_SOFT_RESET(a) CSR_TYPE_NCB
#define basename_CAVM_SPIX_SOFT_RESET(a) "SPIX_SOFT_RESET"
#define device_bar_CAVM_SPIX_SOFT_RESET(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_SPIX_SOFT_RESET(a) (a)
#define arguments_CAVM_SPIX_SOFT_RESET(a) (a),-1,-1,-1
...
/**
 * Register (NCB) spi#_tie_off
 *
 * SPI TIE OFF Register
 * This register is used to tie any ports with 0 or 1.
 */
union cavm_spix_tie_off
{
    uint64_t u;
    struct cavm_spix_tie_off_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_spix_tie_off_s cn; */
};
typedef union cavm_spix_tie_off cavm_spix_tie_off_t;

static inline uint64_t CAVM_SPIX_TIE_OFF(uint64_t a) __attribute__ ((pure, always_inline));
...
#define typedef_CAVM_SPIX_TIE_OFF(a) cavm_spix_tie_off_t
#define bustype_CAVM_SPIX_TIE_OFF(a) CSR_TYPE_NCB
#define basename_CAVM_SPIX_TIE_OFF(a) "SPIX_TIE_OFF"
#define device_bar_CAVM_SPIX_TIE_OFF(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_SPIX_TIE_OFF(a) (a)
#define arguments_CAVM_SPIX_TIE_OFF(a) (a),-1,-1,-1
...
{
    if (cavm_is_model(OCTEONTX_CHEETAH) && ((a<=1) && (b<=31)))
