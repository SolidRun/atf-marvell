...
/**
 * Enumeration pnb_bar_e
 */
#define CAVM_PNB_BAR_E_PNBX_PF_BAR2(a) (0x87e043000000ll + 0x10000ll * (a))
#define CAVM_PNB_BAR_E_PNBX_PF_BAR2_SIZE 0x10000ull
...
#define device_bar_CAVM_PNBX_AP_PUSH_ARB_WT(a) 0x2 /* PF_BAR2 */
...
union cavm_pnbx_config
{
    ...
    struct cavm_pnbx_config_s
    {
        ...
        uint64_t force_ldd             : 1;  /**< [  2:  2](R/W) Force LDWB to LDD conversion when set to 1. */
...
#define device_bar_CAVM_PNBX_CONFIG(a) 0x2 /* PF_BAR2 */
#define busnum_CAVM_PNBX_CONFIG(a) (a)
#define arguments_CAVM_PNBX_CONFIG(a) (a),-1,-1,-1

/**
 * Register (RSL) pnb#_dma_gmid#_strid
 *
 * PNB DMA GMID StreamID Register
 */
union cavm_pnbx_dma_gmidx_strid
{
    uint64_t u;
    struct cavm_pnbx_dma_gmidx_strid_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_8_63         : 56;
        uint64_t func                  : 8;  /**< [  7:  0](R/W) Bottom bits of the IOVA stream ID for requests from DMA.
                                                                 When the 3-bit GMID from DMA is set to 0, the stream ID mapping is done
                                                                 by the PNB_DMA_STRID register. When the GMID is set between 1 and 7,
                                                                 the stream ID is taken from this register. */
#else /* Word 0 - Little Endian */
        uint64_t func                  : 8;  /**< [  7:  0](R/W) Bottom bits of the IOVA stream ID for requests from DMA.
                                                                 When the 3-bit GMID from DMA is set to 0, the stream ID mapping is done
                                                                 by the PNB_DMA_STRID register. When the GMID is set between 1 and 7,
    ...
    /* struct cavm_pnbx_dma_gmidx_strid_s cn; */
};
typedef union cavm_pnbx_dma_gmidx_strid cavm_pnbx_dma_gmidx_strid_t;
...
{
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=1) && ((b>=1)&&(b<=7))))
        return 0x87e043000480ll + 0x10000ll * ((a) & 0x1) + 8ll * ((b) & 0x7);
    __cavm_csr_fatal("PNBX_DMA_GMIDX_STRID", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_PNBX_DMA_GMIDX_STRID(a,b) cavm_pnbx_dma_gmidx_strid_t
#define bustype_CAVM_PNBX_DMA_GMIDX_STRID(a,b) CSR_TYPE_RSL
#define basename_CAVM_PNBX_DMA_GMIDX_STRID(a,b) "PNBX_DMA_GMIDX_STRID"
#define device_bar_CAVM_PNBX_DMA_GMIDX_STRID(a,b) 0x2 /* PF_BAR2 */
#define busnum_CAVM_PNBX_DMA_GMIDX_STRID(a,b) (a)
#define arguments_CAVM_PNBX_DMA_GMIDX_STRID(a,b) (a),(b),-1,-1
...
#define device_bar_CAVM_PNBX_DMA_STRID(a) 0x2 /* PF_BAR2 */
 ...
 *
 * PNB GHAB Read and Write Pull Arbitration Weight Register
...
{
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=1) && (b<=15)))
...
#define device_bar_CAVM_PNBX_GHABX_PULL_ARB_WT(a,b) 0x2 /* PF_BAR2 */
...
#define device_bar_CAVM_PNBX_GHABX_RRSP_ARB_WT(a,b) 0x2 /* PF_BAR2 */
...
#define device_bar_CAVM_PNBX_GHAB_INB_ARB_WT(a) 0x2 /* PF_BAR2 */
...
#define device_bar_CAVM_PNBX_GHAB_PULL_BUSHOG_MAX(a) 0x2 /* PF_BAR2 */
...
#define device_bar_CAVM_PNBX_GHAB_RRSP_BUSHOG_MAX(a) 0x2 /* PF_BAR2 */
#define busnum_CAVM_PNBX_GHAB_RRSP_BUSHOG_MAX(a) (a)
#define arguments_CAVM_PNBX_GHAB_RRSP_BUSHOG_MAX(a) (a),-1,-1,-1

/**
 * Register (RSL) pnb#_ghb_gmid#_strid
 *
 * PNB GHB GMID StreamID Register
 */
union cavm_pnbx_ghb_gmidx_strid
{
    uint64_t u;
    struct cavm_pnbx_ghb_gmidx_strid_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_8_63         : 56;
        uint64_t func                  : 8;  /**< [  7:  0](R/W) Bottom bits of the IOVA stream ID for requests from GHB.
                                                                 When the 3-bit GMID from a GHB port is set to 0, the stream ID mapping is done
                                                                 by the PNB_MAB(0..127)_STRID register. When the GMID is set between 1 and 7,
                                                                 the stream ID is taken from this register. */
#else /* Word 0 - Little Endian */
        uint64_t func                  : 8;  /**< [  7:  0](R/W) Bottom bits of the IOVA stream ID for requests from GHB.
                                                                 When the 3-bit GMID from a GHB port is set to 0, the stream ID mapping is done
    ...
    /* struct cavm_pnbx_ghb_gmidx_strid_s cn; */
};
typedef union cavm_pnbx_ghb_gmidx_strid cavm_pnbx_ghb_gmidx_strid_t;
...
#define typedef_CAVM_PNBX_GHB_GMIDX_STRID(a,b) cavm_pnbx_ghb_gmidx_strid_t
#define bustype_CAVM_PNBX_GHB_GMIDX_STRID(a,b) CSR_TYPE_RSL
#define basename_CAVM_PNBX_GHB_GMIDX_STRID(a,b) "PNBX_GHB_GMIDX_STRID"
#define device_bar_CAVM_PNBX_GHB_GMIDX_STRID(a,b) 0x2 /* PF_BAR2 */
#define busnum_CAVM_PNBX_GHB_GMIDX_STRID(a,b) (a)
#define arguments_CAVM_PNBX_GHB_GMIDX_STRID(a,b) (a),(b),-1,-1
...
#define device_bar_CAVM_PNBX_INB_ARB_BUSHOG_MAX(a) 0x2 /* PF_BAR2 */
...
{
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=1) && (b<=127)))
...
#define device_bar_CAVM_PNBX_MABX_RRSP_HP(a,b) 0x2 /* PF_BAR2 */
...
#define device_bar_CAVM_PNBX_MABX_STRID(a,b) 0x2 /* PF_BAR2 */
#define busnum_CAVM_PNBX_MABX_STRID(a,b) (a)
#define arguments_CAVM_PNBX_MABX_STRID(a,b) (a),(b),-1,-1

/**
 * Register (RSL) pnb#_psm_gmid#_strid
 *
 * PNB PSM GMID StreamID Register
 */
union cavm_pnbx_psm_gmidx_strid
{
    uint64_t u;
    struct cavm_pnbx_psm_gmidx_strid_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_8_63         : 56;
        uint64_t func                  : 8;  /**< [  7:  0](R/W) Bottom bits of the IOVA stream ID for requests from PSM.
                                                                 When the 3-bit GMID from PSM is set to 0, the stream ID mapping is done
                                                                 by the PNB_PSM_STRID register. When the GMID is set between 1 and 7,
                                                                 the stream ID is taken from this register. */
#else /* Word 0 - Little Endian */
        uint64_t func                  : 8;  /**< [  7:  0](R/W) Bottom bits of the IOVA stream ID for requests from PSM.
                                                                 When the 3-bit GMID from PSM is set to 0, the stream ID mapping is done
    ...
    /* struct cavm_pnbx_psm_gmidx_strid_s cn; */
};
typedef union cavm_pnbx_psm_gmidx_strid cavm_pnbx_psm_gmidx_strid_t;
...
#define typedef_CAVM_PNBX_PSM_GMIDX_STRID(a,b) cavm_pnbx_psm_gmidx_strid_t
#define bustype_CAVM_PNBX_PSM_GMIDX_STRID(a,b) CSR_TYPE_RSL
#define basename_CAVM_PNBX_PSM_GMIDX_STRID(a,b) "PNBX_PSM_GMIDX_STRID"
#define device_bar_CAVM_PNBX_PSM_GMIDX_STRID(a,b) 0x2 /* PF_BAR2 */
#define busnum_CAVM_PNBX_PSM_GMIDX_STRID(a,b) (a)
#define arguments_CAVM_PNBX_PSM_GMIDX_STRID(a,b) (a),(b),-1,-1
...
#define device_bar_CAVM_PNBX_PSM_INB_ARB_WT(a) 0x2 /* PF_BAR2 */
...
#define device_bar_CAVM_PNBX_PSM_PUSH_ARB_WT(a) 0x2 /* PF_BAR2 */
...
#define device_bar_CAVM_PNBX_PSM_STRID(a) 0x2 /* PF_BAR2 */
...
#define device_bar_CAVM_PNBX_SMEM_PUSH_BUSHOG_MAX(a) 0x2 /* PF_BAR2 */
