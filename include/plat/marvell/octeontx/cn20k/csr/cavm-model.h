...
#define OCTEONTX_CN20KA_PASS1_0         __OM_BUILD(0xC2, 1, 0)
#define OCTEONTX_CN20KA                 (OCTEONTX_CN20KA_PASS1_0 | __OM_IGNORE_REVISION)
#define OCTEONTX_CN20KA_PASS1_X         (OCTEONTX_CN20KA_PASS1_0 | __OM_IGNORE_MINOR_REVISION)

#define OCTEONTX_CNF20KA_PASS1_0        __OM_BUILD(0xC3, 1, 0)
#define OCTEONTX_CNF20KA                (OCTEONTX_CNF20KA_PASS1_0 | __OM_IGNORE_REVISION)
#define OCTEONTX_CNF20KA_PASS1_X        (OCTEONTX_CNF20KA_PASS1_0 | __OM_IGNORE_MINOR_REVISION)
 ...
 *         0 = Normal package
 *         1 = Alternate package 1
 *         2 = Alternate package 2
 */
extern int cavm_is_altpkg(uint32_t arg_model);

#define EBF_MODEL_MAX_SKU 32 /* Maximum length of SKU is 31 plus zero terminator */
 ...
 * @return Chip's SKU
 */
extern const char* cavm_model_get_sku();
