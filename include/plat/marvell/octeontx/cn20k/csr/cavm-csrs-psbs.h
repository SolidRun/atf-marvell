...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=11) && (b<=3)))
        return 0x87e0df800600ll + 0x10000ll * ((a) & 0xf) + 8ll * ((b) & 0x3);
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=14) && (b<=3)))
        return 0x87e0df800600ll + 0x10000ll * ((a) & 0xf) + 8ll * ((b) & 0x3);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=11) && (b<=63)))
        return 0x87e0df800200ll + 0x10000ll * ((a) & 0xf) + 8ll * ((b) & 0x3f);
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=14) && (b<=63)))
        return 0x87e0df800200ll + 0x10000ll * ((a) & 0xf) + 8ll * ((b) & 0x3f);
