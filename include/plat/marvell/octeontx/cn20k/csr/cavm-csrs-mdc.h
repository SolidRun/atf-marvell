...
union cavm_mdc_bist_config
{
    ...
    struct cavm_mdc_bist_config_s
    {
        ...
        uint64_t skip_enumeration_disable : 1;/**< [ 27: 27](R/W) When clear, MDC Chain enumeration is skipped every time a mbist is run, once the
                                                                 chip has been enumerated.
                                                                 1 --\> 10xx implementation where fresh enumeration would happen
                                                                 0 --\> 20xxx implementation where it would skip emumeration */
    ...
    /* struct cavm_mdc_bist_config_s cheetah; */
    /* struct cavm_mdc_bist_config_s cn20; */
    struct cavm_mdc_bist_config_odinmp
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
union cavm_mdc_bist_control
{
    ...
    struct cavm_mdc_bist_control_s
    {
        ...
        uint64_t disable_diag_rdwr     : 1;  /**< [  3:  3](R/W1) Disable Diagnostic access for all Memories. This bit will only be updated during
                                                                 cold reset and hold until
                                                                 the next cold reset. */
    ...
    /* struct cavm_mdc_bist_control_s cheetah; */
    /* struct cavm_mdc_bist_control_s cn20; */
    struct cavm_mdc_bist_control_odinmp
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
union cavm_mdc_bist_failx
{
    ...
    struct cavm_mdc_bist_failx_cheetah
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
        uint64_t chain_id              : 3;  /**< [ 31: 29](RO/H) Chain number. */
        uint64_t hub_id                : 8;  /**< [ 28: 21](RO/H) MDH identifier. */
        uint64_t node_id               : 9;  /**< [ 20: 12](RO/H) MDN identifier. */
        uint64_t info                  : 12; /**< [ 11:  0](RO/H) Contains MDN_BISR_REPAIR[REPAIR]. For repairable memories, this value is the
                                                                 defect location in the RAM. */
#else /* Word 0 - Little Endian */
        uint64_t info                  : 12; /**< [ 11:  0](RO/H) Contains MDN_BISR_REPAIR[REPAIR]. For repairable memories, this value is the
    ...
    /* struct cavm_mdc_bist_failx_s cn20; */
    struct cavm_mdc_bist_failx_odinmp
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
        uint64_t chain_id              : 3;  /**< [ 31: 29](RO/H) Chain number. */
...
static inline uint64_t CAVM_MDC_BIST_FAILX(uint64_t a) __attribute__ ((pure, always_inline));
...
union cavm_mdc_bist_status
{
    ...
    struct cavm_mdc_bist_status_s
    {
        ...
        uint64_t rst_dis_diag_req      : 1;  /**< [  4:  4](RO/H) Reset requested a global DISABLE DIAGNOSTIC READ/WRTE request. Asserted when
                                                                 the RESET block has requested MDC to disable all diagnostic access across all
                                                                 memories via tie_diag_disable fuse/jtg */
    ...
    /* struct cavm_mdc_bist_status_s cheetah; */
    /* struct cavm_mdc_bist_status_s cn20; */
    struct cavm_mdc_bist_status_odinmp
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_38_63        : 26;
        uint64_t sm_state              : 6;  /**< [ 37: 32](RO/H) BIST state machine state. For diagnostic use only. */
...
union cavm_mdc_const
{
    ...
    struct cavm_mdc_const_cheetah
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_37_63        : 27;
        uint64_t max_chain_id          : 4;  /**< [ 36: 33](RO/H) Maximum allowed value for MDC_WIN_CMD[CHAIN_ID]. */
        uint64_t max_hub_id            : 8;  /**< [ 32: 25](RO/H) Maximum allowed value for MDC_WIN_CMD[HUB_ID]. */
        uint64_t max_node_id           : 9;  /**< [ 24: 16](RO/H) Maximum allowed value for MDC_WIN_CMD[NODE_ID]. */
    ...
    /* struct cavm_mdc_const_s cn20; */
    struct cavm_mdc_const_odinmp
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
union cavm_mdc_ecc_status
{
    ...
    struct cavm_mdc_ecc_status_s
    {
        ...
        uint64_t reserved_4_32         : 29;
        uint64_t dbe_plus              : 1;  /**< [  3:  3](RO/H) Asserted when ECC detects another double-bit/uncorrectable error is detected
                                                                 before the first error was processed by the interrupt handler. */
        uint64_t sbe_plus              : 1;  /**< [  2:  2](RO/H) Asserted when another single-bit/correctable error is detected
                                                                 before the first error was processed by the interrupt handler. */
        uint64_t dbe                   : 1;  /**< [  1:  1](RO/H) Asserted when a double-bit/uncorrectable error is detected. */
        uint64_t sbe                   : 1;  /**< [  0:  0](RO/H) Asserted when a single-bit/correctable error is detected. */
#else /* Word 0 - Little Endian */
        uint64_t sbe                   : 1;  /**< [  0:  0](RO/H) Asserted when a single-bit/correctable error is detected. */
        uint64_t dbe                   : 1;  /**< [  1:  1](RO/H) Asserted when a double-bit/uncorrectable error is detected. */
        uint64_t sbe_plus              : 1;  /**< [  2:  2](RO/H) Asserted when another single-bit/correctable error is detected
    ...
    struct cavm_mdc_ecc_status_cheetah
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_62_63        : 2;
        uint64_t row                   : 16; /**< [ 61: 46](RO/H) SRAM row address of the most recent double-bit/uncorrectable error (DBE) if
        ...
        uint64_t chain_id              : 3;  /**< [ 35: 33](RO/H) Chain identifier. */
        uint64_t hub_id                : 8;  /**< [ 32: 25](RO/H) Hub identifier. */
        uint64_t node_id               : 9;  /**< [ 24: 16](RO/H) Node identifier. */
        uint64_t reserved_4_15         : 12;
        uint64_t dbe_plus              : 1;  /**< [  3:  3](RO/H) Asserted when ECC detects another double-bit/uncorrectable error is detected
                                                                 before the first error was processed by the interrupt handler. */
        uint64_t sbe_plus              : 1;  /**< [  2:  2](RO/H) Asserted when another single-bit/correctable error is detected
    ...
    /* struct cavm_mdc_ecc_status_s cn20; */
    struct cavm_mdc_ecc_status_odinmp
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_62_63        : 2;
...
/**
 * Register (RSL) mdc_glb_dbe_count#
 *
 * MDC Global DBE Failures Count Register
 * This register holds the count for each chain on the number of Double Bit Errors
 * detected in memories.
 */
union cavm_mdc_glb_dbe_countx
{
    uint64_t u;
    struct cavm_mdc_glb_dbe_countx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t glb_dbe_count         : 64; /**< [ 63:  0](RO/H) Per chain one DBE count register capturing the number of DBEs reported via this chain by all nodes. */
#else /* Word 0 - Little Endian */
        uint64_t glb_dbe_count         : 64; /**< [ 63:  0](RO/H) Per chain one DBE count register capturing the number of DBEs reported via this chain by all nodes. */
#endif /* Word 0 - End */
    } s;
    /* struct cavm_mdc_glb_dbe_countx_s cn; */
};
typedef union cavm_mdc_glb_dbe_countx cavm_mdc_glb_dbe_countx_t;

static inline uint64_t CAVM_MDC_GLB_DBE_COUNTX(uint64_t a) __attribute__ ((pure, always_inline));
...
#define typedef_CAVM_MDC_GLB_DBE_COUNTX(a) cavm_mdc_glb_dbe_countx_t
#define bustype_CAVM_MDC_GLB_DBE_COUNTX(a) CSR_TYPE_RSL
#define basename_CAVM_MDC_GLB_DBE_COUNTX(a) "MDC_GLB_DBE_COUNTX"
#define device_bar_CAVM_MDC_GLB_DBE_COUNTX(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_MDC_GLB_DBE_COUNTX(a) (a)
#define arguments_CAVM_MDC_GLB_DBE_COUNTX(a) (a),-1,-1,-1

/**
 * Register (RSL) mdc_glb_sbe_count#
 *
 * MDC Global SBE Failures Count Register
 * This register holds the count for each chain on the number of Single Bit Errors
 * detected in memories.
 */
union cavm_mdc_glb_sbe_countx
{
    uint64_t u;
    struct cavm_mdc_glb_sbe_countx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t glb_sbe_count         : 64; /**< [ 63:  0](RO/H) Per chain one SBE count register capturing the number of SBEs reported via this chain by all nodes. */
#else /* Word 0 - Little Endian */
        uint64_t glb_sbe_count         : 64; /**< [ 63:  0](RO/H) Per chain one SBE count register capturing the number of SBEs reported via this chain by all nodes. */
#endif /* Word 0 - End */
    } s;
    /* struct cavm_mdc_glb_sbe_countx_s cn; */
};
typedef union cavm_mdc_glb_sbe_countx cavm_mdc_glb_sbe_countx_t;

static inline uint64_t CAVM_MDC_GLB_SBE_COUNTX(uint64_t a) __attribute__ ((pure, always_inline));
...
#define typedef_CAVM_MDC_GLB_SBE_COUNTX(a) cavm_mdc_glb_sbe_countx_t
#define bustype_CAVM_MDC_GLB_SBE_COUNTX(a) CSR_TYPE_RSL
#define basename_CAVM_MDC_GLB_SBE_COUNTX(a) "MDC_GLB_SBE_COUNTX"
#define device_bar_CAVM_MDC_GLB_SBE_COUNTX(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_MDC_GLB_SBE_COUNTX(a) (a)
#define arguments_CAVM_MDC_GLB_SBE_COUNTX(a) (a),-1,-1,-1
...
static inline uint64_t CAVM_MDC_PF_MSIX_PBAX(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_MDC_PF_MSIX_VECX_ADDR(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_MDC_PF_MSIX_VECX_CTL(uint64_t a) __attribute__ ((pure, always_inline));
...
{
    if (cavm_is_model(OCTEONTX_CHEETAH) && (a<=16383))
        return 0x87e010010000ll + 8ll * ((a) & 0x3fff);
    if (cavm_is_model(OCTEONTX_ODINMP) && (a<=32767))
...
union cavm_mdc_win_cmd
{
    ...
    struct cavm_mdc_win_cmd_cheetah
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_36_63        : 28;
        uint64_t chain_id              : 3;  /**< [ 35: 33](R/W) Chain number to send request to.  The transaction will be sent on
                                                                 chain 0 if a [CHAIN_ID] greater than MDC_CONST[MAX_CHAIN_ID] is specified. */
        uint64_t hub_id                : 8;  /**< [ 32: 25](R/W) MDH identifier within MDC_WIN_CMD[CHAIN_ID] to send the request to. */
        uint64_t node_id               : 9;  /**< [ 24: 16](R/W) MDN identifier to send request to, within the hub selected with
    ...
    /* struct cavm_mdc_win_cmd_s cn20; */
    struct cavm_mdc_win_cmd_odinmp
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_36_63        : 28;
        uint64_t chain_id              : 3;  /**< [ 35: 33](R/W) Chain number to send request to.  The transaction will be sent on
 ...
 */
union cavm_mdc_win_tdr
{
    uint64_t u;
    struct cavm_mdc_win_tdr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        ...
        uint64_t node_map              : 32; /**< [ 31:  0](WO) Each bit of this field indicates what nodes are updated. Bit \<a\> is interpreted
                                                                 by nodes whose node_id[4:0] is \<a\> if [NODE_ID_U] matches the node's
                                                                 node_id[8:5]. */
#else /* Word 0 - Little Endian */
        uint64_t node_map              : 32; /**< [ 31:  0](WO) Each bit of this field indicates what nodes are updated. Bit \<a\> is interpreted
                                                                 by nodes whose node_id[4:0] is \<a\> if [NODE_ID_U] matches the node's
    ...
    struct cavm_mdc_win_tdr_cheetah
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_49_63        : 15;
        uint64_t broadcast_disable     : 1;  /**< [ 48: 48](WO) If this bit is 1, MDN_BIST_CONFIG[BROADCAST_DISABLE] of a given node
        ...
        uint64_t chain_id              : 3;  /**< [ 46: 44](WO) Chain number to send request to.
                                                                 Chain 0 is used if a [CHAIN_ID] greater than MDC_CONST[MAX_CHAIN_ID] is specified. */
        uint64_t hub_id                : 8;  /**< [ 43: 36](WO) MDH identifier (Hub id) of the nodes to be updated. */
        uint64_t node_id_u             : 4;  /**< [ 35: 32](WO) Upper 4 bits of MDN identifier (node ID) of the nodes to be updated.
                                                                 There can be up to 32 such nodes (with different lower 5 bits of node ID). */
        uint64_t node_map              : 32; /**< [ 31:  0](WO) Each bit of this field indicates what nodes are updated. Bit \<a\> is interpreted
                                                                 by nodes whose node_id[4:0] is \<a\> if [NODE_ID_U] matches the node's
                                                                 node_id[8:5]. */
#else /* Word 0 - Little Endian */
    ...
    /* struct cavm_mdc_win_tdr_s cn20; */
    struct cavm_mdc_win_tdr_odinmp
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_49_63        : 15;
        uint64_t broadcast_disable     : 1;  /**< [ 48: 48](WO) If this bit is 1, MDN_BIST_CONFIG[BROADCAST_DISABLE] of a given node
        ...
        uint64_t chain_id              : 3;  /**< [ 46: 44](WO) Chain number to send request to.
                                                                 Chain 0 is used if a [CHAIN_ID] greater than MDC_CONST[MAX_CHAIN_ID] is specified. */
        uint64_t hub_id                : 7;  /**< [ 43: 37](WO) MDH identifier (Hub id) of the nodes to be updated. */
        uint64_t node_id_u             : 5;  /**< [ 36: 32](WO) Upper 5 bits of MDN identifier (node ID) of the nodes to be updated.
                                                                 There can be up to 32 such nodes (with different lower 5 bits of node ID). */
        uint64_t node_map              : 32; /**< [ 31:  0](WO) Each bit of this field indicates what nodes are updated. Bit \<a\> is interpreted
                                                                 by nodes whose node_id[4:0] is \<a\> if [NODE_ID_U] matches the node's
                                                                 node_id[9:5]. */
...
typedef union cavm_mdc_win_tdr cavm_mdc_win_tdr_t;

#define CAVM_MDC_WIN_TDR CAVM_MDC_WIN_TDR_FUNC()
...
#define bustype_CAVM_MDC_WIN_TDR CSR_TYPE_RSL
#define basename_CAVM_MDC_WIN_TDR "MDC_WIN_TDR"
#define device_bar_CAVM_MDC_WIN_TDR 0x0 /* PF_BAR0 */
#define busnum_CAVM_MDC_WIN_TDR 0
#define arguments_CAVM_MDC_WIN_TDR -1,-1,-1,-1
