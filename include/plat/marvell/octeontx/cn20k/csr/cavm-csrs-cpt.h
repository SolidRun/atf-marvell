...
#define CAVM_CPT_AF_INT_VEC_E_RAS (5)
#define CAVM_CPT_AF_INT_VEC_E_RVU (4)
...
static inline uint64_t CAVM_CPTX_AF_ACTIVE_CYCLES_PC(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a001c000ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b<=131071)))
        return 0xce00a9100000ll + 0x10000000ll * ((a) & 0x1) + 8ll * ((b) & 0x1ffff);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a9000000ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0046000ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0006000ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0000000ll + 0x10000000ll * ((a) & 0x1);
...
union cavm_cptx_af_constants1
{
    ...
    struct cavm_cptx_af_constants1_s
    {
        ...
        uint64_t ae                    : 16; /**< [ 47: 32](RO/H) Number of AEs. In CNXXXX, for CPT returns 0x40 (64), or less if there are fuse-disables. */
        uint64_t ie                    : 16; /**< [ 31: 16](RO/H) Number of IEs. In CNXXXX, for CPT returns 0x10 (16), or less if there are fuse-disables. */
        uint64_t se                    : 16; /**< [ 15:  0](RO/H) "Number of SEs. In CNXXXX, for CPT returns 0xB0 (176), or less if there are fuse-disables.
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0001000ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0001008ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a002a000ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a002e000ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0049438ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0049430ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0049418ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0049410ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b<=255)))
        return 0xce00a0049800ll + 0x10000000ll * ((a) & 0x1) + 8ll * ((b) & 0xff);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0049600ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0048028ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0049508ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0048010ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0048008ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b<=127)))
        return 0xce00a0049000ll + 0x10000000ll * ((a) & 0x1) + 8ll * ((b) & 0x7f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0049428ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0049420ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0048000ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0049408ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0049400ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0049458ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0049450ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0048018ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0048020ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0049448ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0049440ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0003000ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0004000ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b<=255)))
        return 0xce00a0016000ll + 0x10000000ll * ((a) & 0x1) + 8ll * ((b) & 0xff);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b<=255)))
        return 0xce00a0020000ll + 0x10000000ll * ((a) & 0x1) + 8ll * ((b) & 0xff);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b<=255)))
        return 0xce00a0012000ll + 0x10000000ll * ((a) & 0x1) + 8ll * ((b) & 0xff);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b<=255)))
        return 0xce00a0013000ll + 0x10000000ll * ((a) & 0x1) + 8ll * ((b) & 0xff);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b<=255)))
        return 0xce00a0026000ll + 0x10000000ll * ((a) & 0x1) + 8ll * ((b) & 0xff);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b<=15)))
        return 0xce00a0022000ll + 0x10000000ll * ((a) & 0x1) + 8ll * ((b) & 0xf);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a001d000ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a001e000ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b<=7)))
        return 0xce00a0024000ll + 0x10000000ll * ((a) & 0x1) + 8ll * ((b) & 0x7);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b<=7)))
        return 0xce00a0025000ll + 0x10000000ll * ((a) & 0x1) + 8ll * ((b) & 0x7);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0014000ll + 0x10000000ll * ((a) & 0x1);
...
union cavm_cptx_af_exe_perf_ctl
{
    ...
    struct cavm_cptx_af_exe_perf_ctl_s
    {
        ...
        uint64_t epci_inb_cnt_en       : 8;  /**< [ 55: 48](R/W) Enable EPCI inbound counters. */
        uint64_t reserved_40_47        : 8;
        uint64_t epci_outb_cnt_en      : 8;  /**< [ 39: 32](R/W) Enable EPCI outbound counters. */
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0021000ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0023000ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a001f000ll + 0x10000000ll * ((a) & 0x1);
...
union cavm_cptx_af_fltx_int
{
    ...
    struct cavm_cptx_af_fltx_int_s
    {
        ...
        uint64_t exe                   : 64; /**< [ 63:  0](R/W1C/H) "One interrupt bit per engine. CPT sets the bit when the engine has an
                                                                 ...
                                                                 _ CPT_AF_FLT(2)_INT[EXE] - engine(191..128).
                                                                 _ CPT_AF_FLT(3)_INT[EXE] - engine(255..192).
...
static inline uint64_t CAVM_CPTX_AF_FLTX_INT(uint64_t a, uint64_t b)
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b<=3)))
        return 0xce00a000a000ll + 0x10000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3);
...
union cavm_cptx_af_fltx_int_ena_w1c
{
    ...
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t exe                   : 64; /**< [ 63:  0](R/W1C/H) Reads or clears enable for CPT_AF_FLT(0..3)_INT[EXE]. */
#else /* Word 0 - Little Endian */
        uint64_t exe                   : 64; /**< [ 63:  0](R/W1C/H) Reads or clears enable for CPT_AF_FLT(0..3)_INT[EXE]. */
#endif /* Word 0 - End */
    } s;
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b<=3)))
        return 0xce00a000c000ll + 0x10000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3);
...
union cavm_cptx_af_fltx_int_ena_w1s
{
    ...
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t exe                   : 64; /**< [ 63:  0](R/W1S/H) Reads or sets enable for CPT_AF_FLT(0..3)_INT[EXE]. */
#else /* Word 0 - Little Endian */
        uint64_t exe                   : 64; /**< [ 63:  0](R/W1S/H) Reads or sets enable for CPT_AF_FLT(0..3)_INT[EXE]. */
#endif /* Word 0 - End */
    } s;
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b<=3)))
        return 0xce00a000d000ll + 0x10000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3);
...
union cavm_cptx_af_fltx_int_w1s
{
    ...
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t exe                   : 64; /**< [ 63:  0](R/W1S/H) Reads or sets CPT_AF_FLT(0..3)_INT[EXE]. */
#else /* Word 0 - Little Endian */
        uint64_t exe                   : 64; /**< [ 63:  0](R/W1S/H) Reads or sets CPT_AF_FLT(0..3)_INT[EXE]. */
#endif /* Word 0 - End */
    } s;
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b<=3)))
        return 0xce00a000b000ll + 0x10000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b<=7)))
        return 0xce00a002d000ll + 0x10000000ll * ((a) & 0x1) + 8ll * ((b) & 0x7);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0018000ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0017000ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b<=63)))
        return 0xce00a0027000ll + 0x10000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b<=63)))
        return 0xce00a0029000ll + 0x10000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b<=63)))
        return 0xce00a002c000ll + 0x10000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b<=7)))
        return 0xce00a0050080ll + 0x10000000ll * ((a) & 0x1) + 8ll * ((b) & 0x7);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b<=7)))
        return 0xce00a0050040ll + 0x10000000ll * ((a) & 0x1) + 8ll * ((b) & 0x7);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b<=7)))
        return 0xce00a00500c0ll + 0x10000000ll * ((a) & 0x1) + 8ll * ((b) & 0x7);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b<=7) && (c<=1)))
        return 0xce00a0051000ll + 0x10000000ll * ((a) & 0x1) + 0x10ll * ((b) & 0x7) + 8ll * ((c) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0044000ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0015000ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a002b000ll + 0x10000000ll * ((a) & 0x1);
...
union cavm_cptx_af_psnx_exe
{
    ...
    struct cavm_cptx_af_psnx_exe_s
    {
        ...
        uint64_t exe                   : 64; /**< [ 63:  0](R/W1C/H) "One bit per engine. CPT sets the bit when the
                                                                 ...
                                                                 _ CPT_AF_PSN(2)_EXE[EXE] - engine(191..128).
                                                                 _ CPT_AF_PSN(3)_EXE[EXE] - engine(255..192).
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b<=3)))
        return 0xce00a000e000ll + 0x10000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3);
...
union cavm_cptx_af_psnx_exe_w1s
{
    ...
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t exe                   : 64; /**< [ 63:  0](R/W1S/H) Reads or sets CPT_AF_PSN(0..3)_EXE[EXE]. */
#else /* Word 0 - Little Endian */
        uint64_t exe                   : 64; /**< [ 63:  0](R/W1S/H) Reads or sets CPT_AF_PSN(0..3)_EXE[EXE]. */
#endif /* Word 0 - End */
    } s;
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b<=3)))
        return 0xce00a000f000ll + 0x10000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3);
...
static inline uint64_t CAVM_CPTX_AF_PSNX_LF(uint64_t a, uint64_t b)
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b==0)))
        return 0xce00a0010000ll + 0x10000000ll * ((a) & 0x1) + 8ll * ((b) & 0x0);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b==0)))
        return 0xce00a0011000ll + 0x10000000ll * ((a) & 0x1) + 8ll * ((b) & 0x0);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0047020ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0047038ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0047030ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0047028ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a001a000ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0019000ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a001b000ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0047000ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0047018ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0047010ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0047008ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0045000ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0050000ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0050008ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0050108ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0050100ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0050010ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0050018ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b<=2)))
        return 0xce00a002f000ll + 0x10000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce0000a00010ll + 0x100000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce0000a00500ll + 0x100000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce0000a00550ll + 0x100000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce0000a00560ll + 0x100000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce0000a00530ll + 0x100000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce0000a00540ll + 0x100000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce0000a00520ll + 0x100000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce0000a00510ll + 0x100000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce0000a00050ll + 0x100000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce0000a00060ll + 0x100000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce0000a000a0ll + 0x100000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce0000a00090ll + 0x100000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce0000a00030ll + 0x100000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce0000a00040ll + 0x100000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce0000a000b0ll + 0x100000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce0000a000e0ll + 0x100000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce0000a000d0ll + 0x100000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce0000a000c0ll + 0x100000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b<=15)))
        return 0xce0000a00400ll + 0x100000ll * ((a) & 0x1) + 8ll * ((b) & 0xf);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce0000a000f0ll + 0x100000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce0000a00120ll + 0x100000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce0000a00110ll + 0x100000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce0000a00100ll + 0x100000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && (a<=1))
        return 0xce00a0042000ll + 0x10000000ll * ((a) & 0x1);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b<=63)))
        return 0xce00a0041000ll + 0x10000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=1) && (b<=63)))
        return 0xce00a0043000ll + 0x10000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3f);
