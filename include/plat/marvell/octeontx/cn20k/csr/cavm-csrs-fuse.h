...
#define CAVM_FUSE_NUM_E_AP_DISABLEX(a) (0x400 + (a))
...
#define CAVM_FUSE_NUM_E_BISR_FUSED_ONLY_CHEETAH (0xcc)
#define CAVM_FUSE_NUM_E_BISR_FUSED_ONLY_ODINMP (0x73)
...
#define CAVM_FUSE_NUM_E_CPT_EXE_DISABLEX_CHEETAH(a) (0x1c00 + (a))
#define CAVM_FUSE_NUM_E_CPT_EXE_DISABLEX_ODINMP(a) (0x320 + (a))
...
#define CAVM_FUSE_NUM_E_EMA_ROMX_CHEETAH(a) (0x6d + (a))
#define CAVM_FUSE_NUM_E_EMA_ROMX_ODINMP(a) (0x67 + (a))
#define CAVM_FUSE_NUM_E_EMA_TCAMX_CHEETAH(a) (0x62 + (a))
#define CAVM_FUSE_NUM_E_EMA_TCAMX_ODINMP(a) (0x5c + (a))
...
#define CAVM_FUSE_NUM_E_LLC_WAY_DISABLEX(a) (0x216 + (a))
...
#define CAVM_FUSE_NUM_E_MESH_ESEL_ECOSEL_V1X(a) (0x348 + (a))
#define CAVM_FUSE_NUM_E_MESH_ESEL_ECOSEL_V2X(a) (0x350 + (a))
#define CAVM_FUSE_NUM_E_MESH_ESEL_ECOSEL_V3X(a) (0x358 + (a))
#define CAVM_FUSE_NUM_E_METAL_FIXX_CHEETAH(a) (0x73 + (a))
#define CAVM_FUSE_NUM_E_METAL_FIXX_ODINMP(a) (0x6d + (a))
#define CAVM_FUSE_NUM_E_MFG_INFOX(a) (0x400 + (a))
#define CAVM_FUSE_NUM_E_MFG_INFO16X(a) (0x800 + (a))
#define CAVM_FUSE_NUM_E_MFG_INFO27X(a) (0xdd8 + (a))
#define CAVM_FUSE_NUM_E_MFG_INFO28X(a) (0xe00 + (a))
#define CAVM_FUSE_NUM_E_MFG_INFO3X(a) (0x180 + (a))
#define CAVM_FUSE_NUM_E_MHB_FUSE_CRIPPLEX(a) (0x6a0 + (a))
#define CAVM_FUSE_NUM_E_ML_DISABLE (0x254)
#define CAVM_FUSE_NUM_E_MSW_DISABLEX(a) (0x700 + (a))
...
#define CAVM_FUSE_NUM_E_RSVD12FX(a) (0x12f + (a))
...
#define CAVM_FUSE_NUM_E_RSVD346X(a) (0x346 + (a))
#define CAVM_FUSE_NUM_E_RSVD378X(a) (0x378 + (a))
...
#define CAVM_FUSE_NUM_E_RSVDB4X(a) (0xb4 + (a))
#define CAVM_FUSE_NUM_E_RSVDE00X(a) (0xe00 + (a))
#define CAVM_FUSE_NUM_E_RUN_PLATFORMX_CHEETAH(a) (0xcd + (a))
#define CAVM_FUSE_NUM_E_RUN_PLATFORMX_ODINMP(a) (0x75 + (a))
#define CAVM_FUSE_NUM_E_SCNT_SROSELX(a) (0x340 + (a))
...
#define CAVM_FUSE_NUM_E_TAD_DISABLEX(a) (0x600 + (a))
#define CAVM_FUSE_NUM_E_TAD_F2X(a) (0x2f2 + (a))
#define CAVM_FUSE_NUM_E_TAD_F3X(a) (0x2f0 + (a))
#define CAVM_FUSE_NUM_E_TGGX(a) (0x600 + (a))
#define CAVM_FUSE_NUM_E_TNI_BASE_V1X(a) (0x360 + (a))
#define CAVM_FUSE_NUM_E_TNI_BASE_V2X(a) (0x368 + (a))
#define CAVM_FUSE_NUM_E_TNI_BASE_V3X(a) (0x370 + (a))
#define CAVM_FUSE_NUM_E_TNI_OFFSET_V1X(a) (0xa00 + (a))
#define CAVM_FUSE_NUM_E_TNI_OFFSET_V2X(a) (0xb48 + (a))
#define CAVM_FUSE_NUM_E_TNI_OFFSET_V3X(a) (0xc90 + (a))
