...
#define CAVM_FUSE_NUM_E_BISR_FUSED_ONLY (0xcc)
...
#define CAVM_FUSE_NUM_E_CPT_EXE_DISABLEX(a) (0x1c00 + (a))
...
#define CAVM_FUSE_NUM_E_EMA_ROMX(a) (0x6d + (a))
#define CAVM_FUSE_NUM_E_EMA_TCAMX(a) (0x62 + (a))
...
#define CAVM_FUSE_NUM_E_METAL_FIXX(a) (0x73 + (a))
...
#define CAVM_FUSE_NUM_E_RUN_PLATFORMX(a) (0xcd + (a))
