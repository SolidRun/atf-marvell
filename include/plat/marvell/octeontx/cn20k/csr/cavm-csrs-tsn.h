 ...
 */
#define CAVM_TSN_BAR_E_TSNX_PF_BAR0(a) (0xca0040000000ll + 0x100000000ll * (a))
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=23) || (a==48)))
        return 0xca0040000000ll + 0x100000000ll * ((a) & 0x3f);
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=11) || (a==48) || ((a>=57)&&(a<=63))))
        return 0xca0040000000ll + 0x100000000ll * ((a) & 0x3f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=23) || (a==48)))
        return 0xca0040000018ll + 0x100000000ll * ((a) & 0x3f);
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=11) || (a==48) || ((a>=57)&&(a<=63))))
        return 0xca0040000018ll + 0x100000000ll * ((a) & 0x3f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=23) || (a==48)))
        return 0xca0040000010ll + 0x100000000ll * ((a) & 0x3f);
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=11) || (a==48) || ((a>=57)&&(a<=63))))
        return 0xca0040000010ll + 0x100000000ll * ((a) & 0x3f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=23) || (a==48)))
        return 0xca0040000020ll + 0x100000000ll * ((a) & 0x3f);
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=11) || (a==48) || ((a>=57)&&(a<=63))))
        return 0xca0040000020ll + 0x100000000ll * ((a) & 0x3f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=23) || (a==48)))
        return 0xca0040000028ll + 0x100000000ll * ((a) & 0x3f);
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=11) || (a==48) || ((a>=57)&&(a<=63))))
        return 0xca0040000028ll + 0x100000000ll * ((a) & 0x3f);
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=23) || (a==48)))
        return 0xca0040000008ll + 0x100000000ll * ((a) & 0x3f);
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=11) || (a==48) || ((a>=57)&&(a<=63))))
        return 0xca0040000008ll + 0x100000000ll * ((a) & 0x3f);
