...
{
    if (cavm_is_model(OCTEONTX_CHEETAH) && ((a<=5) && (b<=5)))
...
{
    if (cavm_is_model(OCTEONTX_CHEETAH) && ((a<=5) && (b<=5) && (c<=1) && (d<=1)))
...
{
    if (cavm_is_model(OCTEONTX_CHEETAH) && ((a<=5) && (b<=5) && (c<=2)))
...
{
    if (cavm_is_model(OCTEONTX_CHEETAH) && ((a<=5) && (b<=5) && (c<=1)))
