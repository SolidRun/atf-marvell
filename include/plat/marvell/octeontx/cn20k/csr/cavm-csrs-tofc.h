...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=3) && (b==0) && (c<=3)))
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=3) && (b<=11)))
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=3) && (b<=31) && (c<=7)))
...
{
    if (cavm_is_model(OCTEONTX_CN20KA) && ((a<=3) && (b<=5) && (c<=7)))
