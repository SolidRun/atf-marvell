...
/**
 * Enumeration lenc_bar_e
 */
#define CAVM_LENC_BAR_E_LENCX_PF_BAR2(a) (0xc00840a00000ll + 0x100000000ll * (a))
#define CAVM_LENC_BAR_E_LENCX_PF_BAR2_SIZE 0x40000ull
...
static inline uint64_t CAVM_LENCX_ABX_CONTROL(uint64_t a, uint64_t b)
{
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=2) && (b<=2)))
        return 0xc00840a00000ll + 0x100000000ll * ((a) & 0x3) + 0x10000ll * ((b) & 0x3);
...
#define device_bar_CAVM_LENCX_ABX_CONTROL(a,b) 0x2 /* PF_BAR2 */
...
{
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=2) && (b<=2)))
        return 0xc00840a00040ll + 0x100000000ll * ((a) & 0x3) + 0x10000ll * ((b) & 0x3);
...
#define device_bar_CAVM_LENCX_ABX_ERROR_ENABLE0(a,b) 0x2 /* PF_BAR2 */
...
{
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=2) && (b<=2)))
        return 0xc00840a00030ll + 0x100000000ll * ((a) & 0x3) + 0x10000ll * ((b) & 0x3);
...
#define device_bar_CAVM_LENCX_ABX_ERROR_SOURCE0(a,b) 0x2 /* PF_BAR2 */
...
{
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=2) && (b<=2) && (c<=384)))
        return 0xc00840a02000ll + 0x100000000ll * ((a) & 0x3) + 0x10000ll * ((b) & 0x3) + 8ll * ((c) & 0x1ff);
...
#define device_bar_CAVM_LENCX_ABX_HAB_JCFG0_RAMX_DATA(a,b,c) 0x2 /* PF_BAR2 */
...
{
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=2) && (b<=2) && (c<=384)))
        return 0xc00840a04000ll + 0x100000000ll * ((a) & 0x3) + 0x10000ll * ((b) & 0x3) + 8ll * ((c) & 0x1ff);
...
#define device_bar_CAVM_LENCX_ABX_HAB_JCFG1_RAMX_DATA(a,b,c) 0x2 /* PF_BAR2 */
...
{
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=2) && (b<=2) && (c<=384)))
        return 0xc00840a06000ll + 0x100000000ll * ((a) & 0x3) + 0x10000ll * ((b) & 0x3) + 8ll * ((c) & 0x1ff);
...
#define device_bar_CAVM_LENCX_ABX_HAB_JCFG2_RAMX_DATA(a,b,c) 0x2 /* PF_BAR2 */
...
{
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=2) && (b<=2)))
        return 0xc00840a00018ll + 0x100000000ll * ((a) & 0x3) + 0x10000ll * ((b) & 0x3);
...
#define device_bar_CAVM_LENCX_ABX_STATUS(a,b) 0x2 /* PF_BAR2 */
...
{
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=2) && (b<=2)))
        return 0xc00840a01040ll + 0x100000000ll * ((a) & 0x3) + 0x10000ll * ((b) & 0x3);
...
#define device_bar_CAVM_LENCX_ABX_TC_CONFIG_ERR_FLAGS(a,b) 0x2 /* PF_BAR2 */
...
{
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=2) && (b<=2)))
        return 0xc00840a01010ll + 0x100000000ll * ((a) & 0x3) + 0x10000ll * ((b) & 0x3);
...
#define device_bar_CAVM_LENCX_ABX_TC_CONTROL(a,b) 0x2 /* PF_BAR2 */
...
{
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=2) && (b<=2)))
        return 0xc00840a01038ll + 0x100000000ll * ((a) & 0x3) + 0x10000ll * ((b) & 0x3);
...
#define device_bar_CAVM_LENCX_ABX_TC_ERROR(a,b) 0x2 /* PF_BAR2 */
...
{
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=2) && (b<=2)))
        return 0xc00840a01030ll + 0x100000000ll * ((a) & 0x3) + 0x10000ll * ((b) & 0x3);
...
#define device_bar_CAVM_LENCX_ABX_TC_ERROR_MASK(a,b) 0x2 /* PF_BAR2 */
...
{
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=2) && (b<=2)))
        return 0xc00840a01000ll + 0x100000000ll * ((a) & 0x3) + 0x10000ll * ((b) & 0x3);
...
#define device_bar_CAVM_LENCX_ABX_TC_MAIN_RESET(a,b) 0x2 /* PF_BAR2 */
...
{
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a<=2) && (b<=2)))
        return 0xc00840a01020ll + 0x100000000ll * ((a) & 0x3) + 0x10000ll * ((b) & 0x3);
...
#define device_bar_CAVM_LENCX_ABX_TC_STATUS(a,b) 0x2 /* PF_BAR2 */
