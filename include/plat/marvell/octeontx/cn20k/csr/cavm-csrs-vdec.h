...
/**
 * Enumeration vdec_bar_e
 */
#define CAVM_VDEC_BAR_E_VDECX_PF_BAR2(a) (0x87e042000000ll + 0x80000ll * (a))
#define CAVM_VDEC_BAR_E_VDECX_PF_BAR2_SIZE 0x40000ull
...
#define device_bar_CAVM_VDECX_ABX_CONTROL(a,b) 0x2 /* PF_BAR2 */
...
#define device_bar_CAVM_VDECX_ABX_ERROR_ENABLE0(a,b) 0x2 /* PF_BAR2 */
...
#define device_bar_CAVM_VDECX_ABX_ERROR_SOURCE0(a,b) 0x2 /* PF_BAR2 */
...
{
    if (cavm_is_model(OCTEONTX_CNF20KA) && ((a==0) && (b<=1) && (c<=255)))
...
#define device_bar_CAVM_VDECX_ABX_HAB_JCFG0_RAMX_DATA(a,b,c) 0x2 /* PF_BAR2 */
...
#define device_bar_CAVM_VDECX_ABX_HAB_JCFG1_RAMX_DATA(a,b,c) 0x2 /* PF_BAR2 */
...
#define device_bar_CAVM_VDECX_ABX_HAB_JCFG2_RAMX_DATA(a,b,c) 0x2 /* PF_BAR2 */
...
#define device_bar_CAVM_VDECX_ABX_STATUS(a,b) 0x2 /* PF_BAR2 */
...
#define device_bar_CAVM_VDECX_ABX_TC_CONF_ERR_FLAG_REG(a,b) 0x2 /* PF_BAR2 */
...
#define device_bar_CAVM_VDECX_ABX_TC_CONTROL_REG(a,b) 0x2 /* PF_BAR2 */
 ...
 * VDEC()_AB()_TC_ERROR_REG will generate an error signal only when the
 * corresponding bit is set in VDEC()_AB()_TC_ERROR_MASK_REG[ERR_MASK].
 */
...
#define device_bar_CAVM_VDECX_ABX_TC_ERROR_MASK_REG(a,b) 0x2 /* PF_BAR2 */
...
union cavm_vdecx_abx_tc_error_reg
{
    ...
    struct cavm_vdecx_abx_tc_error_reg_s
    {
        ...
        uint64_t inv_cfg               : 1;  /**< [  8:  8](R/W1C/H) Invalid task configuration -- aborted job.  Further information is
                                                                 captured in VDEC()_AB()_TC_CONF_ERR_FLAG_REG. */
...
#define device_bar_CAVM_VDECX_ABX_TC_ERROR_REG(a,b) 0x2 /* PF_BAR2 */
...
#define device_bar_CAVM_VDECX_ABX_TC_MAIN_RESET_REG(a,b) 0x2 /* PF_BAR2 */
...
#define device_bar_CAVM_VDECX_ABX_TC_STATUS0_REG(a,b) 0x2 /* PF_BAR2 */
