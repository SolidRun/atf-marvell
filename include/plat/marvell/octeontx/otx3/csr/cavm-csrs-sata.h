...
#define CAVM_SATA_BAR_E_SATAX_PF_BAR4(a) (0x810000000000ll + 0x1000000000ll * (a))
#define CAVM_SATA_BAR_E_SATAX_PF_BAR4_SIZE 0x200000ull
...
union cavm_satax_msix_vecx_addr
{
    ...
    /* struct cavm_satax_msix_vecx_addr_s cn; */
};
...
union cavm_satax_uctl_intena_w1c
{
    ...
    /* struct cavm_satax_uctl_intena_w1c_s cn; */
};
...
union cavm_satax_uctl_intena_w1s
{
    ...
    /* struct cavm_satax_uctl_intena_w1s_s cn; */
};
...
union cavm_satax_uctl_intstat_w1s
{
    ...
    /* struct cavm_satax_uctl_intstat_w1s_s cn; */
};
