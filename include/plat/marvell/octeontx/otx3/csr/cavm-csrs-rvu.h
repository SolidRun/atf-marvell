...
union cavm_rvu_af_gen_int
{
    ...
    struct cavm_rvu_af_gen_int_s
    {
        ...
        uint64_t mbox_mem_fault        : 1;  /**< [  2:  2](R/W1C/H) Memory fault on BAR4 mailbox read or write. */
...
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_3_63         : 61;
        uint64_t mbox_mem_fault        : 1;  /**< [  2:  2](R/W1C/H) Reads or clears enable for RVU_AF_GEN_INT[MBOX_MEM_FAULT]. */
...
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_3_63         : 61;
        uint64_t mbox_mem_fault        : 1;  /**< [  2:  2](R/W1S/H) Reads or sets enable for RVU_AF_GEN_INT[MBOX_MEM_FAULT]. */
...
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_3_63         : 61;
        uint64_t mbox_mem_fault        : 1;  /**< [  2:  2](R/W1S/H) Reads or sets RVU_AF_GEN_INT[MBOX_MEM_FAULT]. */
 ...
 */
union cavm_rvu_af_pfx_bar4_addr
{
    uint64_t u;
    struct cavm_rvu_af_pfx_bar4_addr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
typedef union cavm_rvu_af_pfx_bar4_addr cavm_rvu_af_pfx_bar4_addr_t;
...
#define typedef_CAVM_RVU_AF_PFX_BAR4_ADDR(a) cavm_rvu_af_pfx_bar4_addr_t
#define bustype_CAVM_RVU_AF_PFX_BAR4_ADDR(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_RVU_AF_PFX_BAR4_ADDR(a) "RVU_AF_PFX_BAR4_ADDR"
#define device_bar_CAVM_RVU_AF_PFX_BAR4_ADDR(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_RVU_AF_PFX_BAR4_ADDR(a) (a)
#define arguments_CAVM_RVU_AF_PFX_BAR4_ADDR(a) (a),-1,-1,-1
 ...
 */
union cavm_rvu_af_pfx_bar4_cfg
{
    uint64_t u;
    struct cavm_rvu_af_pfx_bar4_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_rvu_af_pfx_bar4_cfg_s cn; */
};
typedef union cavm_rvu_af_pfx_bar4_cfg cavm_rvu_af_pfx_bar4_cfg_t;
...
#define typedef_CAVM_RVU_AF_PFX_BAR4_CFG(a) cavm_rvu_af_pfx_bar4_cfg_t
#define bustype_CAVM_RVU_AF_PFX_BAR4_CFG(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_RVU_AF_PFX_BAR4_CFG(a) "RVU_AF_PFX_BAR4_CFG"
#define device_bar_CAVM_RVU_AF_PFX_BAR4_CFG(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_RVU_AF_PFX_BAR4_CFG(a) (a)
#define arguments_CAVM_RVU_AF_PFX_BAR4_CFG(a) (a),-1,-1,-1
 ...
 */
union cavm_rvu_af_pfx_lmtline_addr
{
    uint64_t u;
    struct cavm_rvu_af_pfx_lmtline_addr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
typedef union cavm_rvu_af_pfx_lmtline_addr cavm_rvu_af_pfx_lmtline_addr_t;
...
#define typedef_CAVM_RVU_AF_PFX_LMTLINE_ADDR(a) cavm_rvu_af_pfx_lmtline_addr_t
#define bustype_CAVM_RVU_AF_PFX_LMTLINE_ADDR(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_RVU_AF_PFX_LMTLINE_ADDR(a) "RVU_AF_PFX_LMTLINE_ADDR"
#define device_bar_CAVM_RVU_AF_PFX_LMTLINE_ADDR(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_RVU_AF_PFX_LMTLINE_ADDR(a) (a)
#define arguments_CAVM_RVU_AF_PFX_LMTLINE_ADDR(a) (a),-1,-1,-1
...
union cavm_rvu_af_pfx_vf_bar4_addr
{
    ...
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t addr                  : 48; /**< [ 63: 16](R/W) Programmable size of VF BAR4 region in DRAM.
                                                                 This region contains all VF_LMTLINEs. */
        uint64_t reserved_0_15         : 16;
#else /* Word 0 - Little Endian */
        uint64_t reserved_0_15         : 16;
        uint64_t addr                  : 48; /**< [ 63: 16](R/W) Programmable size of VF BAR4 region in DRAM.
 ...
 */
union cavm_rvu_af_pfx_vf_bar4_cfg
{
    uint64_t u;
    struct cavm_rvu_af_pfx_vf_bar4_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_6_63         : 58;
    ...
    /* struct cavm_rvu_af_pfx_vf_bar4_cfg_s cn; */
};
typedef union cavm_rvu_af_pfx_vf_bar4_cfg cavm_rvu_af_pfx_vf_bar4_cfg_t;
...
#define typedef_CAVM_RVU_AF_PFX_VF_BAR4_CFG(a) cavm_rvu_af_pfx_vf_bar4_cfg_t
#define bustype_CAVM_RVU_AF_PFX_VF_BAR4_CFG(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_RVU_AF_PFX_VF_BAR4_CFG(a) "RVU_AF_PFX_VF_BAR4_CFG"
#define device_bar_CAVM_RVU_AF_PFX_VF_BAR4_CFG(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_RVU_AF_PFX_VF_BAR4_CFG(a) (a)
#define arguments_CAVM_RVU_AF_PFX_VF_BAR4_CFG(a) (a),-1,-1,-1
...
union cavm_rvu_af_ras
{
    ...
    struct cavm_rvu_af_ras_s
    {
        ...
        uint64_t mbox_mem_poison       : 1;  /**< [  1:  1](R/W1C/H) Received BAR4 read response with poisoned data. */
...
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_2_63         : 62;
        uint64_t mbox_mem_poison       : 1;  /**< [  1:  1](R/W1C/H) Reads or clears enable for RVU_AF_RAS[MBOX_MEM_POISON]. */
...
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_2_63         : 62;
        uint64_t mbox_mem_poison       : 1;  /**< [  1:  1](R/W1S/H) Reads or sets enable for RVU_AF_RAS[MBOX_MEM_POISON]. */
...
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_2_63         : 62;
        uint64_t mbox_mem_poison       : 1;  /**< [  1:  1](R/W1S/H) Reads or sets RVU_AF_RAS[MBOX_MEM_POISON]. */
 ...
 */
union cavm_rvu_af_smmu_addr_req
{
    uint64_t u;
...
#define CAVM_RVU_AF_SMMU_ADDR_REQ CAVM_RVU_AF_SMMU_ADDR_REQ_FUNC()
...
#define bustype_CAVM_RVU_AF_SMMU_ADDR_REQ CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_RVU_AF_SMMU_ADDR_REQ "RVU_AF_SMMU_ADDR_REQ"
#define device_bar_CAVM_RVU_AF_SMMU_ADDR_REQ 0x0 /* RVU_BAR0 */
#define busnum_CAVM_RVU_AF_SMMU_ADDR_REQ 0
#define arguments_CAVM_RVU_AF_SMMU_ADDR_REQ -1,-1,-1,-1
 ...
 */
union cavm_rvu_af_smmu_addr_rsp_sts
{
    uint64_t u;
    struct cavm_rvu_af_smmu_addr_rsp_sts_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_4_63         : 60;
        uint64_t sec                   : 1;  /**< [  3:  3](RO/H) Translation returned secure; hardware will zero the PA. */
    ...
    /* struct cavm_rvu_af_smmu_addr_rsp_sts_s cn; */
};
typedef union cavm_rvu_af_smmu_addr_rsp_sts cavm_rvu_af_smmu_addr_rsp_sts_t;

#define CAVM_RVU_AF_SMMU_ADDR_RSP_STS CAVM_RVU_AF_SMMU_ADDR_RSP_STS_FUNC()
...
#define bustype_CAVM_RVU_AF_SMMU_ADDR_RSP_STS CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_RVU_AF_SMMU_ADDR_RSP_STS "RVU_AF_SMMU_ADDR_RSP_STS"
#define device_bar_CAVM_RVU_AF_SMMU_ADDR_RSP_STS 0x0 /* RVU_BAR0 */
#define busnum_CAVM_RVU_AF_SMMU_ADDR_RSP_STS 0
 ...
 */
union cavm_rvu_af_smmu_tln_flit0_1
{
    uint64_t u;
    struct cavm_rvu_af_smmu_tln_flit0_1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_rvu_af_smmu_tln_flit0_1_s cn; */
};
typedef union cavm_rvu_af_smmu_tln_flit0_1 cavm_rvu_af_smmu_tln_flit0_1_t;

#define CAVM_RVU_AF_SMMU_TLN_FLIT0_1 CAVM_RVU_AF_SMMU_TLN_FLIT0_1_FUNC()
...
#define bustype_CAVM_RVU_AF_SMMU_TLN_FLIT0_1 CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_RVU_AF_SMMU_TLN_FLIT0_1 "RVU_AF_SMMU_TLN_FLIT0_1"
#define device_bar_CAVM_RVU_AF_SMMU_TLN_FLIT0_1 0x0 /* RVU_BAR0 */
#define busnum_CAVM_RVU_AF_SMMU_TLN_FLIT0_1 0
#define arguments_CAVM_RVU_AF_SMMU_TLN_FLIT0_1 -1,-1,-1,-1
 ...
 */
union cavm_rvu_af_smmu_tln_flit1_1
{
    uint64_t u;
    struct cavm_rvu_af_smmu_tln_flit1_1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_15_63        : 49;
    ...
    /* struct cavm_rvu_af_smmu_tln_flit1_1_s cn; */
};
typedef union cavm_rvu_af_smmu_tln_flit1_1 cavm_rvu_af_smmu_tln_flit1_1_t;

#define CAVM_RVU_AF_SMMU_TLN_FLIT1_1 CAVM_RVU_AF_SMMU_TLN_FLIT1_1_FUNC()
...
#define bustype_CAVM_RVU_AF_SMMU_TLN_FLIT1_1 CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_RVU_AF_SMMU_TLN_FLIT1_1 "RVU_AF_SMMU_TLN_FLIT1_1"
#define device_bar_CAVM_RVU_AF_SMMU_TLN_FLIT1_1 0x0 /* RVU_BAR0 */
#define busnum_CAVM_RVU_AF_SMMU_TLN_FLIT1_1 0
#define arguments_CAVM_RVU_AF_SMMU_TLN_FLIT1_1 -1,-1,-1,-1
 ...
 */
union cavm_rvu_af_smmu_txn_req
{
    uint64_t u;
    struct cavm_rvu_af_smmu_txn_req_s
    {
        ...
        uint64_t pf                    : 5;  /**< [ 12:  8](R/W) SMMU request PF number (inside SMMU request's stream ID). */
        uint64_t func                  : 8;  /**< [  7:  0](R/W) SMMU request function number (inside SMMU request's stream ID). */
#else /* Word 0 - Little Endian */
        uint64_t func                  : 8;  /**< [  7:  0](R/W) SMMU request function number (inside SMMU request's stream ID). */
        uint64_t pf                    : 5;  /**< [ 12:  8](R/W) SMMU request PF number (inside SMMU request's stream ID). */
        uint64_t wr_perm               : 1;  /**< [ 13: 13](R/W) SMMU request with write permission */
...
typedef union cavm_rvu_af_smmu_txn_req cavm_rvu_af_smmu_txn_req_t;

#define CAVM_RVU_AF_SMMU_TXN_REQ CAVM_RVU_AF_SMMU_TXN_REQ_FUNC()
...
#define bustype_CAVM_RVU_AF_SMMU_TXN_REQ CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_RVU_AF_SMMU_TXN_REQ "RVU_AF_SMMU_TXN_REQ"
#define device_bar_CAVM_RVU_AF_SMMU_TXN_REQ 0x0 /* RVU_BAR0 */
#define busnum_CAVM_RVU_AF_SMMU_TXN_REQ 0
#define arguments_CAVM_RVU_AF_SMMU_TXN_REQ -1,-1,-1,-1
...
union cavm_rvu_pf_block_addrx_disc
{
    ...
    struct cavm_rvu_pf_block_addrx_disc_s
    {
        ...
        uint64_t imp                   : 1;  /**< [ 11: 11](RO/H) Implemented. When set, a block is present at this BLOCK_ADDR index as
                                                                 ...
                                                                 CN98XX:
                                                                 _ RVUM, LMT, NPA, NIX(0..1), NPC, NDC(0..5), APR = 1.
                                                                 _ SSO, SSOW, TIM = ~sso_cripple.
...
static inline uint64_t CAVM_RVU_PF_BLOCK_ADDRX_DISC(uint64_t a) __attribute__ ((pure, always_inline));
 ...
 */
union cavm_rvu_pf_lmtline_addr
{
    uint64_t u;
    struct cavm_rvu_pf_lmtline_addr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t addr                  : 64; /**< [ 63:  0](RO/H) Reflection of RVU_AF_PF()_LMTLINE_ADDR. */
#else /* Word 0 - Little Endian */
        uint64_t addr                  : 64; /**< [ 63:  0](RO/H) Reflection of RVU_AF_PF()_LMTLINE_ADDR. */
#endif /* Word 0 - End */
    } s;
    /* struct cavm_rvu_pf_lmtline_addr_s cn; */
};
typedef union cavm_rvu_pf_lmtline_addr cavm_rvu_pf_lmtline_addr_t;

#define CAVM_RVU_PF_LMTLINE_ADDR CAVM_RVU_PF_LMTLINE_ADDR_FUNC()
...
#define bustype_CAVM_RVU_PF_LMTLINE_ADDR CSR_TYPE_RVU_PF_BAR2
#define basename_CAVM_RVU_PF_LMTLINE_ADDR "RVU_PF_LMTLINE_ADDR"
#define device_bar_CAVM_RVU_PF_LMTLINE_ADDR 0x2 /* RVU_BAR2 */
#define busnum_CAVM_RVU_PF_LMTLINE_ADDR 0
#define arguments_CAVM_RVU_PF_LMTLINE_ADDR -1,-1,-1,-1
...
static inline uint64_t CAVM_RVU_PF_MSIX_PBAX(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_RVU_PF_MSIX_VECX_ADDR(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_RVU_PF_MSIX_VECX_CTL(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_RVU_PF_PFAF_MBOXX(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_RVU_PF_VFX_PFVF_MBOXX(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
 ...
 */
union cavm_rvu_pf_vf_mbox_addr
{
    uint64_t u;
    struct cavm_rvu_pf_vf_mbox_addr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t addr                  : 48; /**< [ 63: 16](RO/H) Physical base address of the PF/VF mailbox memory -
                                                                 calculated by HW to be RVU_AF_PF()_BAR4_ADDR + 64KB.
    ...
    /* struct cavm_rvu_pf_vf_mbox_addr_s cn; */
};
typedef union cavm_rvu_pf_vf_mbox_addr cavm_rvu_pf_vf_mbox_addr_t;

#define CAVM_RVU_PF_VF_MBOX_ADDR CAVM_RVU_PF_VF_MBOX_ADDR_FUNC()
...
#define bustype_CAVM_RVU_PF_VF_MBOX_ADDR CSR_TYPE_RVU_PF_BAR2
#define basename_CAVM_RVU_PF_VF_MBOX_ADDR "RVU_PF_VF_MBOX_ADDR"
#define device_bar_CAVM_RVU_PF_VF_MBOX_ADDR 0x2 /* RVU_BAR2 */
#define busnum_CAVM_RVU_PF_VF_MBOX_ADDR 0
#define arguments_CAVM_RVU_PF_VF_MBOX_ADDR -1,-1,-1,-1
...
static inline uint64_t CAVM_RVU_PF_VFFLR_INTX(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_RVU_PF_VFFLR_INT_ENA_W1CX(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_RVU_PF_VFFLR_INT_ENA_W1SX(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_RVU_PF_VFFLR_INT_W1SX(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_RVU_PF_VFME_INTX(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_RVU_PF_VFME_INT_ENA_W1CX(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_RVU_PF_VFME_INT_ENA_W1SX(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_RVU_PF_VFME_INT_W1SX(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_RVU_PF_VFME_STATUSX(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_RVU_PF_VFPF_MBOX_INTX(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_RVU_PF_VFPF_MBOX_INT_ENA_W1CX(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_RVU_PF_VFPF_MBOX_INT_ENA_W1SX(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_RVU_PF_VFPF_MBOX_INT_W1SX(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_RVU_PF_VFTRPENDX(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_RVU_PF_VFTRPEND_W1SX(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_RVU_PRIV_BLOCK_TYPEX_REV(uint64_t a) __attribute__ ((pure, always_inline));
...
union cavm_rvu_priv_const
{
    ...
    struct cavm_rvu_priv_const_s
    {
        ...
        uint64_t smmu                  : 1;  /**< [ 49: 49](RO) RVUM has address transaltion I/F with SMMU */
...
static inline uint64_t CAVM_RVU_PRIV_HWVFX_CPTX_CFG(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_RVU_PRIV_HWVFX_INT_CFG(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_RVU_PRIV_HWVFX_NIXX_CFG(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_RVU_PRIV_HWVFX_NPA_CFG(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_RVU_PRIV_HWVFX_REEX_CFG(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_RVU_PRIV_HWVFX_SSO_CFG(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_RVU_PRIV_HWVFX_SSOW_CFG(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_RVU_PRIV_HWVFX_TIM_CFG(uint64_t a) __attribute__ ((pure, always_inline));
...
union cavm_rvu_priv_pfx_cfg
{
    ...
    struct cavm_rvu_priv_pfx_cfg_s
    {
        ...
        uint64_t af_ena                : 1;  /**< [ 21: 21](R/W) Admin function enable. When set, the PF is allowed to access AF (RVU PF
                                                                 ...
                                                                 Internal:
                                                                 BAR0 accesses to all RVU blocks will fault. */
...
static inline uint64_t CAVM_RVU_VF_BLOCK_ADDRX_DISC(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_RVU_VF_MSIX_PBAX(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_RVU_VF_MSIX_VECX_ADDR(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_RVU_VF_MSIX_VECX_CTL(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_RVU_VF_VFPF_MBOXX(uint64_t a) __attribute__ ((pure, always_inline));
