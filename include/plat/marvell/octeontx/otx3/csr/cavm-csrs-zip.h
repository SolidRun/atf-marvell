 ...
 */
#define CAVM_ZIP_PF_INT_VEC_E_MBOXX(a) (0 + (a))
...
union cavm_zip_constants
{
    ...
    /* struct cavm_zip_constants_s cn; */
};
...
union cavm_zip_core_reset
{
    ...
    /* struct cavm_zip_core_reset_s cn; */
};
...
union cavm_zip_dbg_corex_inst
{
    ...
    /* struct cavm_zip_dbg_corex_inst_s cn; */
};
...
union cavm_zip_quex_sbuf_ctl
{
    ...
    /* struct cavm_zip_quex_sbuf_ctl_s cn; */
};
