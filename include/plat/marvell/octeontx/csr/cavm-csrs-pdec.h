...
union cavm_pdec_report_s
{
    ...
    /* struct cavm_pdec_report_s_s cn9; */
    /* struct cavm_pdec_report_s_s cnf95xxp1; */
    struct cavm_pdec_report_s_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_60_63        : 4;
        uint64_t crc_calculated0       : 11; /**< [ 59: 49] Calculated CRC of the reported path (For the first CB) */
    ...
    /* struct cavm_pdec_report_s_cnf95xxp2 f95o; */
    /* struct cavm_pdec_report_s_cnf95xxp2 loki; */
};
...
union cavm_pdec_task_cfg_s
{
    ...
    /* struct cavm_pdec_task_cfg_s_s cn9; */
    /* struct cavm_pdec_task_cfg_s_s cnf95xxp1; */
    struct cavm_pdec_task_cfg_s_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_63           : 1;
        uint64_t npc_wm                : 2;  /**< [ 62: 61] Number of parity check bits with minimum row weight.
    ...
    /* struct cavm_pdec_task_cfg_s_cnf95xxp2 f95o; */
    /* struct cavm_pdec_task_cfg_s_cnf95xxp2 loki; */
};
...
union cavm_pdecx_hab_jcfg0_ramx_data
{
    ...
    /* struct cavm_pdecx_hab_jcfg0_ramx_data_s cn9; */
    /* struct cavm_pdecx_hab_jcfg0_ramx_data_s cnf95xxp1; */
    struct cavm_pdecx_hab_jcfg0_ramx_data_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_pdecx_hab_jcfg0_ramx_data_cnf95xxp2 f95o; */
    /* struct cavm_pdecx_hab_jcfg0_ramx_data_cnf95xxp2 loki; */
};
...
static inline uint64_t CAVM_PDECX_HAB_JCFG0_RAMX_DATA(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=1) && (b<=149)))
        return 0x87e043582000ll + 0x8000ll * ((a) & 0x1) + 8ll * ((b) & 0xff);
...
union cavm_pdecx_hab_jcfg1_ramx_data
{
    ...
    /* struct cavm_pdecx_hab_jcfg1_ramx_data_s cn9; */
    /* struct cavm_pdecx_hab_jcfg1_ramx_data_s cnf95xxp1; */
    struct cavm_pdecx_hab_jcfg1_ramx_data_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_pdecx_hab_jcfg1_ramx_data_cnf95xxp2 f95o; */
    /* struct cavm_pdecx_hab_jcfg1_ramx_data_cnf95xxp2 loki; */
};
...
union cavm_pdecx_hab_jcfg2_ramx_data
{
    ...
    /* struct cavm_pdecx_hab_jcfg2_ramx_data_s cn9; */
    /* struct cavm_pdecx_hab_jcfg2_ramx_data_s cnf95xxp1; */
    struct cavm_pdecx_hab_jcfg2_ramx_data_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_pdecx_hab_jcfg2_ramx_data_cnf95xxp2 f95o; */
    /* struct cavm_pdecx_hab_jcfg2_ramx_data_cnf95xxp2 loki; */
};
...
union cavm_pdecx_tc_config_err_flags_reg
{
    ...
    /* struct cavm_pdecx_tc_config_err_flags_reg_s cn9; */
    struct cavm_pdecx_tc_config_err_flags_reg_cnf95xxp1
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    struct cavm_pdecx_tc_config_err_flags_reg_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_23_63        : 41;
    ...
    /* struct cavm_pdecx_tc_config_err_flags_reg_cnf95xxp2 f95o; */
    /* struct cavm_pdecx_tc_config_err_flags_reg_cnf95xxp2 loki; */
};
...
union cavm_pdecx_tc_config_regx
{
    ...
    /* struct cavm_pdecx_tc_config_regx_s cn9; */
    /* struct cavm_pdecx_tc_config_regx_s cnf95xxp1; */
    struct cavm_pdecx_tc_config_regx_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_pdecx_tc_config_regx_cnf95xxp2 f95o; */
    /* struct cavm_pdecx_tc_config_regx_cnf95xxp2 loki; */
};
...
union cavm_pdecx_tc_control_reg
{
    ...
    /* struct cavm_pdecx_tc_control_reg_s cn9; */
    struct cavm_pdecx_tc_control_reg_cnf95xxp1
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
    ...
    struct cavm_pdecx_tc_control_reg_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
        uint64_t reserved_5_31         : 27;
    ...
    /* struct cavm_pdecx_tc_control_reg_cnf95xxp2 f95o; */
    /* struct cavm_pdecx_tc_control_reg_cnf95xxp2 loki; */
};
...
union cavm_pdecx_tc_error_reg
{
    ...
    /* struct cavm_pdecx_tc_error_reg_s cn9; */
    /* struct cavm_pdecx_tc_error_reg_s cnf95xxp1; */
    struct cavm_pdecx_tc_error_reg_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_9_63         : 55;
    ...
    /* struct cavm_pdecx_tc_error_reg_cnf95xxp2 f95o; */
    /* struct cavm_pdecx_tc_error_reg_cnf95xxp2 loki; */
};
...
union cavm_pdecx_tc_main_reset_reg
{
    ...
    /* struct cavm_pdecx_tc_main_reset_reg_s cn9; */
    /* struct cavm_pdecx_tc_main_reset_reg_s cnf95xxp1; */
    struct cavm_pdecx_tc_main_reset_reg_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_pdecx_tc_main_reset_reg_cnf95xxp2 f95o; */
    /* struct cavm_pdecx_tc_main_reset_reg_cnf95xxp2 loki; */
};
...
union cavm_pdecx_tc_main_start_reg
{
    ...
    /* struct cavm_pdecx_tc_main_start_reg_s cn9; */
    /* struct cavm_pdecx_tc_main_start_reg_s cnf95xxp1; */
    struct cavm_pdecx_tc_main_start_reg_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_pdecx_tc_main_start_reg_cnf95xxp2 f95o; */
    /* struct cavm_pdecx_tc_main_start_reg_cnf95xxp2 loki; */
};
...
union cavm_pdecx_tc_mon_regx
{
    ...
    /* struct cavm_pdecx_tc_mon_regx_s cn9; */
    /* struct cavm_pdecx_tc_mon_regx_s cnf95xxp1; */
    struct cavm_pdecx_tc_mon_regx_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_pdecx_tc_mon_regx_cnf95xxp2 f95o; */
    /* struct cavm_pdecx_tc_mon_regx_cnf95xxp2 loki; */
};
...
static inline uint64_t CAVM_PDECX_TC_MON_REGX(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=1) && (b<=3)))
        return 0x87e043581300ll + 0x8000ll * ((a) & 0x1) + 8ll * ((b) & 0x3);
...
union cavm_pdecx_tc_status_reg
{
    ...
    /* struct cavm_pdecx_tc_status_reg_s cn9; */
    /* struct cavm_pdecx_tc_status_reg_s cnf95xxp1; */
    struct cavm_pdecx_tc_status_reg_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_pdecx_tc_status_reg_cnf95xxp2 f95o; */
    /* struct cavm_pdecx_tc_status_reg_cnf95xxp2 loki; */
};
