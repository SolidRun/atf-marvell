...
static inline uint64_t CAVM_CBPX_INTERFACECONFIGURATION_ADDX_START(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CBPX_INTERFACECONFIGURATION_ADDX_START(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_LOKI) && ((a<=15) && ((b>=1)&&(b<=31))))
        return 0x87e044823520ll + 0x40000ll * ((a) & 0xf) + 0x10ll * ((b) & 0x1f);
