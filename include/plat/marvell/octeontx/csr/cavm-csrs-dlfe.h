...
static inline uint64_t CAVM_DLFE_ANT_EXPX(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DLFE_ANT_EXPX(uint64_t a)
{
...
static inline uint64_t CAVM_DLFE_ANT_GAINX(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DLFE_ANT_GAINX(uint64_t a)
{
...
static inline uint64_t CAVM_DLFE_CONFIG0_DATAX(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DLFE_CONFIG0_DATAX(uint64_t a)
{
...
static inline uint64_t CAVM_DLFE_CONFIG1_DATAX(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DLFE_CONFIG1_DATAX(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
static inline uint64_t CAVM_DLFE_CONFIG2_DATAX(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DLFE_CONFIG2_DATAX(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
static inline uint64_t CAVM_DLFE_RES_MAPX(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DLFE_RES_MAPX(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=11))
...
static inline uint64_t CAVM_DLFE_TSSIX(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DLFE_TSSIX(uint64_t a)
{
