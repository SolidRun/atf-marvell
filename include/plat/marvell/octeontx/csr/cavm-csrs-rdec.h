...
static inline uint64_t CAVM_RDECX_CONFIGURATION(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RDECX_CONFIGURATION(uint64_t a)
{
...
static inline uint64_t CAVM_RDECX_CONTROL(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RDECX_CONTROL(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=2))
...
static inline uint64_t CAVM_RDECX_ECO(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RDECX_ECO(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=2))
...
static inline uint64_t CAVM_RDECX_ERROR_ENABLE0(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RDECX_ERROR_ENABLE0(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=2))
...
static inline uint64_t CAVM_RDECX_ERROR_SOURCE0(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RDECX_ERROR_SOURCE0(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=2))
...
static inline uint64_t CAVM_RDECX_NR_MTBL_AX(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RDECX_NR_MTBL_AX(uint64_t a, uint64_t b)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && ((a<=2) && (b<=127)))
        return 0x87e043103000ll + 0x8000ll * ((a) & 0x3) + 8ll * ((b) & 0x7f);
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=2) && (b<=127)))
        return 0x87e043103000ll + 0x8000ll * ((a) & 0x3) + 8ll * ((b) & 0x7f);
...
static inline uint64_t CAVM_RDECX_NR_MTBL_BX(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RDECX_NR_MTBL_BX(uint64_t a, uint64_t b)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && ((a<=2) && (b<=127)))
...
static inline uint64_t CAVM_RDECX_NR_RTBL_AX(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RDECX_NR_RTBL_AX(uint64_t a, uint64_t b)
{
...
static inline uint64_t CAVM_RDECX_NR_RTBL_BX(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RDECX_NR_RTBL_BX(uint64_t a, uint64_t b)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && ((a<=2) && (b<=31)))
...
static inline uint64_t CAVM_RDECX_NR_STBL_AX(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RDECX_NR_STBL_AX(uint64_t a, uint64_t b)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && ((a<=2) && (b<=31)))
...
static inline uint64_t CAVM_RDECX_NR_STBL_BX(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RDECX_NR_STBL_BX(uint64_t a, uint64_t b)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && ((a<=2) && (b<=31)))
...
static inline uint64_t CAVM_RDECX_SCRATCH(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RDECX_SCRATCH(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=2))
...
static inline uint64_t CAVM_RDECX_STATUS(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RDECX_STATUS(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=2))
