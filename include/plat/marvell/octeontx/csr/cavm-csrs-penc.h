...
union cavm_penc_common_cfg_s
{
    ...
    /* struct cavm_penc_common_cfg_s_s cn9; */
    /* struct cavm_penc_common_cfg_s_s cnf95xxp1; */
    struct cavm_penc_common_cfg_s_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
        uint64_t num_cfg_words_per_task : 8; /**< [ 31: 24] Number of configuration words per task. Must be 0x9 for all PENC jobs. */
...
union cavm_penc_task_cfg_s
{
    ...
    /* struct cavm_penc_task_cfg_s_s cn9; */
    /* struct cavm_penc_task_cfg_s_s cnf95xxp1; */
    struct cavm_penc_task_cfg_s_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_45_63        : 19;
        uint64_t g_size                : 13; /**< [ 44: 32] Size after rate matching (corresponds to G in 3GPP).
...
static inline uint64_t CAVM_PENCX_CONTROL(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_PENCX_CONTROL(uint64_t a)
{
...
static inline uint64_t CAVM_PENCX_ERROR_ENABLE0(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_PENCX_ERROR_ENABLE0(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
static inline uint64_t CAVM_PENCX_ERROR_SOURCE0(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_PENCX_ERROR_SOURCE0(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
union cavm_pencx_hab_jcfg0_ramx_data
{
    ...
    /* struct cavm_pencx_hab_jcfg0_ramx_data_s cn9; */
    /* struct cavm_pencx_hab_jcfg0_ramx_data_s cnf95xxp1; */
    struct cavm_pencx_hab_jcfg0_ramx_data_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
static inline uint64_t CAVM_PENCX_HAB_JCFG0_RAMX_DATA(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_PENCX_HAB_JCFG0_RAMX_DATA(uint64_t a, uint64_t b)
{
...
union cavm_pencx_hab_jcfg1_ramx_data
{
    ...
    /* struct cavm_pencx_hab_jcfg1_ramx_data_s cn9; */
    /* struct cavm_pencx_hab_jcfg1_ramx_data_s cnf95xxp1; */
    struct cavm_pencx_hab_jcfg1_ramx_data_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
static inline uint64_t CAVM_PENCX_HAB_JCFG1_RAMX_DATA(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_PENCX_HAB_JCFG1_RAMX_DATA(uint64_t a, uint64_t b)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && ((a<=1) && (b<=255)))
...
union cavm_pencx_hab_jcfg2_ramx_data
{
    ...
    /* struct cavm_pencx_hab_jcfg2_ramx_data_s cn9; */
    /* struct cavm_pencx_hab_jcfg2_ramx_data_s cnf95xxp1; */
    struct cavm_pencx_hab_jcfg2_ramx_data_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
static inline uint64_t CAVM_PENCX_HAB_JCFG2_RAMX_DATA(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_PENCX_HAB_JCFG2_RAMX_DATA(uint64_t a, uint64_t b)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && ((a<=1) && (b<=255)))
...
static inline uint64_t CAVM_PENCX_STATUS(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_PENCX_STATUS(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
union cavm_pencx_tc_config_err_flags_reg
{
    ...
    /* struct cavm_pencx_tc_config_err_flags_reg_s cn9; */
    struct cavm_pencx_tc_config_err_flags_reg_cnf95xxp1
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    struct cavm_pencx_tc_config_err_flags_reg_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
...
static inline uint64_t CAVM_PENCX_TC_CONFIG_ERR_FLAGS_REG(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_PENCX_TC_CONFIG_ERR_FLAGS_REG(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
union cavm_pencx_tc_control_reg
{
    ...
    /* struct cavm_pencx_tc_control_reg_s cn9; */
    struct cavm_pencx_tc_control_reg_cnf95xxp1
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
    ...
    struct cavm_pencx_tc_control_reg_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
        uint64_t reserved_5_31         : 27;
...
static inline uint64_t CAVM_PENCX_TC_CONTROL_REG(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_PENCX_TC_CONTROL_REG(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
static inline uint64_t CAVM_PENCX_TC_ERROR_MASK_REG(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_PENCX_TC_ERROR_MASK_REG(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
union cavm_pencx_tc_error_reg
{
    ...
    /* struct cavm_pencx_tc_error_reg_s cn9; */
    /* struct cavm_pencx_tc_error_reg_s cnf95xxp1; */
    struct cavm_pencx_tc_error_reg_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_9_63         : 55;
...
static inline uint64_t CAVM_PENCX_TC_ERROR_REG(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_PENCX_TC_ERROR_REG(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
union cavm_pencx_tc_main_reset_reg
{
    ...
    /* struct cavm_pencx_tc_main_reset_reg_s cn9; */
    /* struct cavm_pencx_tc_main_reset_reg_s cnf95xxp1; */
    struct cavm_pencx_tc_main_reset_reg_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
...
static inline uint64_t CAVM_PENCX_TC_MAIN_RESET_REG(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_PENCX_TC_MAIN_RESET_REG(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
union cavm_pencx_tc_status_reg
{
    ...
    /* struct cavm_pencx_tc_status_reg_s cn9; */
    /* struct cavm_pencx_tc_status_reg_s cnf95xxp1; */
    struct cavm_pencx_tc_status_reg_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
static inline uint64_t CAVM_PENCX_TC_STATUS_REG(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_PENCX_TC_STATUS_REG(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
