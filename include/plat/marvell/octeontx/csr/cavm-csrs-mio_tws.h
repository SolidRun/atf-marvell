...
union cavm_mio_twsx_io_ctl
{
    ...
    /* struct cavm_mio_twsx_io_ctl_s cn9; */
    /* struct cavm_mio_twsx_io_ctl_s cn96xxp1; */
    struct cavm_mio_twsx_io_ctl_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_4_63         : 60;
        uint64_t drive                 : 2;  /**< [  3:  2](R/W) TWSI bus pin output drive strength.
                                                                 ...
                                                                 0x3 = 16 mA. */
        uint64_t reserved_1            : 1;
        uint64_t slew                  : 1;  /**< [  0:  0](R/W) TWSI bus pin output slew rate control.
                                                                 0 = High slew rate.
                                                                 1 = Low slew rate. */
#else /* Word 0 - Little Endian */
        uint64_t slew                  : 1;  /**< [  0:  0](R/W) TWSI bus pin output slew rate control.
    ...
    struct cavm_mio_twsx_io_ctl_cn96xxp4
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_4_63         : 60;
        uint64_t drive                 : 2;  /**< [  3:  2](R/W) TWSI bus pin output drive strength.
    ...
    /* struct cavm_mio_twsx_io_ctl_cn96xxp4 cnf95xxp3; */
    /* struct cavm_mio_twsx_io_ctl_cn96xxp3 f95mm; */
    /* struct cavm_mio_twsx_io_ctl_cn96xxp3 f95o_p1; */
    /* struct cavm_mio_twsx_io_ctl_cn96xxp4 f95o_p2; */
    /* struct cavm_mio_twsx_io_ctl_cn96xxp3 loki_p1; */
    /* struct cavm_mio_twsx_io_ctl_cn96xxp4 loki_p2; */
};
