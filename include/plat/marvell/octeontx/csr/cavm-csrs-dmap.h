...
static inline uint64_t CAVM_DMAPX_BP_TEST0(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DMAPX_BP_TEST0(uint64_t a)
{
...
static inline uint64_t CAVM_DMAPX_BP_TEST1(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DMAPX_BP_TEST1(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
static inline uint64_t CAVM_DMAPX_BP_TEST2(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DMAPX_BP_TEST2(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
static inline uint64_t CAVM_DMAPX_CONTROL(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DMAPX_CONTROL(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
static inline uint64_t CAVM_DMAPX_ECO(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DMAPX_ECO(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
static inline uint64_t CAVM_DMAPX_JDX_CFG0(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DMAPX_JDX_CFG0(uint64_t a, uint64_t b)
{
...
static inline uint64_t CAVM_DMAPX_JDX_CFG1(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DMAPX_JDX_CFG1(uint64_t a, uint64_t b)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && ((a<=1) && (b<=2)))
...
static inline uint64_t CAVM_DMAPX_JDX_CFG2(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DMAPX_JDX_CFG2(uint64_t a, uint64_t b)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && ((a<=1) && (b<=2)))
...
static inline uint64_t CAVM_DMAPX_JDX_CFG3(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DMAPX_JDX_CFG3(uint64_t a, uint64_t b)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && ((a<=1) && (b<=2)))
...
static inline uint64_t CAVM_DMAPX_JDX_CFG4(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DMAPX_JDX_CFG4(uint64_t a, uint64_t b)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && ((a<=1) && (b<=2)))
...
static inline uint64_t CAVM_DMAPX_JDX_LTE_NR_CFGX(uint64_t a, uint64_t b, uint64_t c) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DMAPX_JDX_LTE_NR_CFGX(uint64_t a, uint64_t b, uint64_t c)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && ((a<=1) && (b<=2) && (c<=15)))
        return 0x87e043a82028ll + 0x80000ll * ((a) & 0x1) + 0x2000ll * ((b) & 0x3) + 8ll * ((c) & 0xf);
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=1) && (b<=2) && (c<=15)))
        return 0x87e043a82028ll + 0x80000ll * ((a) & 0x1) + 0x2000ll * ((b) & 0x3) + 8ll * ((c) & 0xf);
...
static inline uint64_t CAVM_DMAPX_STATUS(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DMAPX_STATUS(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
