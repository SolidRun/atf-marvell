...
static inline uint64_t CAVM_MDAB_MBPX_DMEM_ARRAYX(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_MDAB_MBPX_DMEM_ARRAYX(uint64_t a, uint64_t b)
{
...
static inline uint64_t CAVM_MDAB_MBPX_IMEM_ARRAYX(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_MDAB_MBPX_IMEM_ARRAYX(uint64_t a, uint64_t b)
{
