...
union cavm_lenc_cb_cfg_s
{
    ...
    struct cavm_lenc_cb_cfg_s_s
    {
        ...
        uint64_t cb_size               : 14; /**< [ 25: 12] The code block size including CB CRC. It corresponds to 'K' in 38.212
                                                                 ...
                                                                 The valid range is [40, 8448], where the minimum size is the minimum
                                                                 LENC_TASK_CFG_S[TB_SIZE] of 24 bits plus the 16-bit TB CRC. */
    ...
    /* struct cavm_lenc_cb_cfg_s_s cn9; */
    struct cavm_lenc_cb_cfg_s_cnf95xxp1
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t rm_e                  : 21; /**< [ 63: 43] Rate matching size. Valid range is [LENC_TASK_CFG_S[MOD_ORDER], 1467648].
                                                                 * Must be \> 0.
    ...
    struct cavm_lenc_cb_cfg_s_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
union cavm_lenc_common_cfg_s
{
    ...
    /* struct cavm_lenc_common_cfg_s_s cn9; */
    /* struct cavm_lenc_common_cfg_s_s cnf95xxp1; */
    struct cavm_lenc_common_cfg_s_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_6_63         : 58;
...
union cavm_lenc_task_cfg_s
{
    ...
    struct cavm_lenc_task_cfg_s_s
    {
        ...
        uint64_t tb_size               : 32; /**< [ 95: 64] Transport Block size. It corresponds to 'A' defined in Section 5.1
                                                                 of [R1]. Valid range is [24,1277992]. */
#else /* Word 1 - Little Endian */
        uint64_t tb_size               : 32; /**< [ 95: 64] Transport Block size. It corresponds to 'A' defined in Section 5.1
                                                                 of [R1]. Valid range is [24,1277992]. */
        uint64_t ncb_size              : 16; /**< [111: 96] soft buffer size for each code block as specified in Section
    ...
    /* struct cavm_lenc_task_cfg_s_s cn9; */
    struct cavm_lenc_task_cfg_s_cnf95xxp1
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t mod_order             : 4;  /**< [ 63: 60] Modulation order:
                                                                 0x1 = {pi}/2 BPSK.
    ...
    struct cavm_lenc_task_cfg_s_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t mod_order             : 4;  /**< [ 63: 60] Modulation order:
                                                                 0x1 = {pi}/2 BPSK.
...
static inline uint64_t CAVM_LENCX_ABX_CONTROL(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_LENCX_ABX_CONTROL(uint64_t a, uint64_t b)
{
...
static inline uint64_t CAVM_LENCX_ABX_ECO(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_LENCX_ABX_ERROR_ENABLE0(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_LENCX_ABX_ERROR_SOURCE0(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_LENCX_ABX_ERROR_SOURCE0(uint64_t a, uint64_t b)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && ((a<=1) && (b<=1)))
...
union cavm_lencx_abx_hab_jcfg0_ramx_data
{
    ...
    /* struct cavm_lencx_abx_hab_jcfg0_ramx_data_s cn9; */
    /* struct cavm_lencx_abx_hab_jcfg0_ramx_data_s cnf95xxp1; */
    struct cavm_lencx_abx_hab_jcfg0_ramx_data_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
static inline uint64_t CAVM_LENCX_ABX_HAB_JCFG0_RAMX_DATA(uint64_t a, uint64_t b, uint64_t c) __attribute__ ((pure, always_inline));
...
union cavm_lencx_abx_hab_jcfg1_ramx_data
{
    ...
    /* struct cavm_lencx_abx_hab_jcfg1_ramx_data_s cn9; */
    /* struct cavm_lencx_abx_hab_jcfg1_ramx_data_s cnf95xxp1; */
    struct cavm_lencx_abx_hab_jcfg1_ramx_data_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
static inline uint64_t CAVM_LENCX_ABX_HAB_JCFG1_RAMX_DATA(uint64_t a, uint64_t b, uint64_t c) __attribute__ ((pure, always_inline));
...
union cavm_lencx_abx_hab_jcfg2_ramx_data
{
    ...
    /* struct cavm_lencx_abx_hab_jcfg2_ramx_data_s cn9; */
    /* struct cavm_lencx_abx_hab_jcfg2_ramx_data_s cnf95xxp1; */
    struct cavm_lencx_abx_hab_jcfg2_ramx_data_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
static inline uint64_t CAVM_LENCX_ABX_HAB_JCFG2_RAMX_DATA(uint64_t a, uint64_t b, uint64_t c) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_LENCX_ABX_SCRATCH(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_LENCX_ABX_STATUS(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_LENCX_ABX_STATUS(uint64_t a, uint64_t b)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && ((a<=1) && (b<=1)))
...
union cavm_lencx_abx_tc_configx
{
    ...
    /* struct cavm_lencx_abx_tc_configx_s cn9; */
    /* struct cavm_lencx_abx_tc_configx_s cnf95xxp1; */
    struct cavm_lencx_abx_tc_configx_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
static inline uint64_t CAVM_LENCX_ABX_TC_CONFIGX(uint64_t a, uint64_t b, uint64_t c) __attribute__ ((pure, always_inline));
...
union cavm_lencx_abx_tc_config_err_flags
{
    ...
    /* struct cavm_lencx_abx_tc_config_err_flags_s cn9; */
    struct cavm_lencx_abx_tc_config_err_flags_cnf95xxp1
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    struct cavm_lencx_abx_tc_config_err_flags_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
...
static inline uint64_t CAVM_LENCX_ABX_TC_CONFIG_ERR_FLAGS(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
...
union cavm_lencx_abx_tc_control
{
    ...
    /* struct cavm_lencx_abx_tc_control_s cn9; */
    /* struct cavm_lencx_abx_tc_control_s cnf95xxp1; */
    struct cavm_lencx_abx_tc_control_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_5_63         : 59;
        uint64_t control_bus           : 5;  /**< [  4:  0](R/W) Internal core static control inputs.
...
static inline uint64_t CAVM_LENCX_ABX_TC_CONTROL(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
...
union cavm_lencx_abx_tc_error
{
    ...
    /* struct cavm_lencx_abx_tc_error_s cn9; */
    /* struct cavm_lencx_abx_tc_error_s cnf95xxp1; */
    struct cavm_lencx_abx_tc_error_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_9_63         : 55;
...
static inline uint64_t CAVM_LENCX_ABX_TC_ERROR(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_LENCX_ABX_TC_ERROR_MASK(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
...
union cavm_lencx_abx_tc_main_reset
{
    ...
    /* struct cavm_lencx_abx_tc_main_reset_s cn9; */
    /* struct cavm_lencx_abx_tc_main_reset_s cnf95xxp1; */
    struct cavm_lencx_abx_tc_main_reset_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
...
static inline uint64_t CAVM_LENCX_ABX_TC_MAIN_RESET(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
...
union cavm_lencx_abx_tc_main_start
{
    ...
    /* struct cavm_lencx_abx_tc_main_start_s cn9; */
    /* struct cavm_lencx_abx_tc_main_start_s cnf95xxp1; */
    struct cavm_lencx_abx_tc_main_start_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
...
static inline uint64_t CAVM_LENCX_ABX_TC_MAIN_START(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
...
union cavm_lencx_abx_tc_mon
{
    ...
    /* struct cavm_lencx_abx_tc_mon_s cn9; */
    /* struct cavm_lencx_abx_tc_mon_s cnf95xxp1; */
    struct cavm_lencx_abx_tc_mon_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
...
static inline uint64_t CAVM_LENCX_ABX_TC_MON(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
...
union cavm_lencx_abx_tc_status
{
    ...
    /* struct cavm_lencx_abx_tc_status_s cn9; */
    /* struct cavm_lencx_abx_tc_status_s cnf95xxp1; */
    struct cavm_lencx_abx_tc_status_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
static inline uint64_t CAVM_LENCX_ABX_TC_STATUS(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
