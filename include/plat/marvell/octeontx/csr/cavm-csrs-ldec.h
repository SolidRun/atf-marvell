...
union cavm_ldec_cb_cfg_s
{
    ...
    /* struct cavm_ldec_cb_cfg_s_s cn9; */
    struct cavm_ldec_cb_cfg_s_cnf95xxp1
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    struct cavm_ldec_cb_cfg_s_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
union cavm_ldec_common_cfg_s
{
    ...
    /* struct cavm_ldec_common_cfg_s_s cn9; */
    /* struct cavm_ldec_common_cfg_s_s cnf95xxp1; */
    struct cavm_ldec_common_cfg_s_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_28_63        : 36;
...
union cavm_ldec_opt_task_cfg_s
{
    ...
    /* struct cavm_ldec_opt_task_cfg_s_s cn9; */
    /* struct cavm_ldec_opt_task_cfg_s_s cnf95xxp1; */
    struct cavm_ldec_opt_task_cfg_s_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
union cavm_ldec_task_cfg_s
{
    ...
    /* struct cavm_ldec_task_cfg_s_s cn9; */
    struct cavm_ldec_task_cfg_s_cnf95xxp1
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t negstop_th            : 16; /**< [ 63: 48] Negative stopping threshold. */
        uint64_t stop_it               : 2;  /**< [ 47: 46] Activates the early iteration stopping mechanism upon parity check pass.
    ...
    struct cavm_ldec_task_cfg_s_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t negstop_th            : 16; /**< [ 63: 48] Negative stopping threshold. */
        uint64_t stop_it               : 2;  /**< [ 47: 46] Activates the early iteration stopping mechanism upon parity check pass.
...
union cavm_ldecx_abx_hab_jcfg0_ramx_data
{
    ...
    /* struct cavm_ldecx_abx_hab_jcfg0_ramx_data_s cn9; */
    /* struct cavm_ldecx_abx_hab_jcfg0_ramx_data_s cnf95xxp1; */
    struct cavm_ldecx_abx_hab_jcfg0_ramx_data_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
static inline uint64_t CAVM_LDECX_ABX_HAB_JCFG0_RAMX_DATA(uint64_t a, uint64_t b, uint64_t c)
{
    ...
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=1) && (b<=1) && (c<=511)))
        return 0x87e043682000ll + 0x500000ll * ((a) & 0x1) + 0x8000ll * ((b) & 0x1) + 8ll * ((c) & 0x1ff);
...
union cavm_ldecx_abx_hab_jcfg1_ramx_data
{
    ...
    /* struct cavm_ldecx_abx_hab_jcfg1_ramx_data_s cn9; */
    /* struct cavm_ldecx_abx_hab_jcfg1_ramx_data_s cnf95xxp1; */
    struct cavm_ldecx_abx_hab_jcfg1_ramx_data_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
union cavm_ldecx_abx_hab_jcfg2_ramx_data
{
    ...
    /* struct cavm_ldecx_abx_hab_jcfg2_ramx_data_s cn9; */
    /* struct cavm_ldecx_abx_hab_jcfg2_ramx_data_s cnf95xxp1; */
    struct cavm_ldecx_abx_hab_jcfg2_ramx_data_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
union cavm_ldecx_abx_tc_control
{
    ...
    /* struct cavm_ldecx_abx_tc_control_s cn9; */
    /* struct cavm_ldecx_abx_tc_control_s cnf95xxp1; */
    struct cavm_ldecx_abx_tc_control_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_5_63         : 59;
...
union cavm_ldecx_abx_tc_error
{
    ...
    /* struct cavm_ldecx_abx_tc_error_s cn9; */
    /* struct cavm_ldecx_abx_tc_error_s cnf95xxp1; */
    struct cavm_ldecx_abx_tc_error_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_9_63         : 55;
...
union cavm_ldecx_abx_tc_main_reset
{
    ...
    /* struct cavm_ldecx_abx_tc_main_reset_s cn9; */
    /* struct cavm_ldecx_abx_tc_main_reset_s cnf95xxp1; */
    struct cavm_ldecx_abx_tc_main_reset_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
...
union cavm_ldecx_abx_tc_status
{
    ...
    /* struct cavm_ldecx_abx_tc_status_s cn9; */
    /* struct cavm_ldecx_abx_tc_status_s cnf95xxp1; */
    struct cavm_ldecx_abx_tc_status_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
