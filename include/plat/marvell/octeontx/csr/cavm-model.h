...
#define OCTEONTX_CN98XX_PASS1_1   __OM_BUILD(0xb1, 1, 1)
#define OCTEONTX_CN98XX_PASS2_0   __OM_BUILD(0xb1, 2, 0)
...
#define OCTEONTX_CN98XX_PASS2_X   (OCTEONTX_CN98XX_PASS2_0 | __OM_IGNORE_MINOR_REVISION)
...
#define OCTEONTX_CN96XX_PASS4_0   __OM_BUILD(0xb2, 4, 0) /* Called D0 */
...
#define OCTEONTX_CN96XX_PASS4_X   (OCTEONTX_CN96XX_PASS4_0 | __OM_IGNORE_MINOR_REVISION)
...
#define OCTEONTX_CNF95XX_PASS3_0  __OM_BUILD(0xb3, 3, 0) /* Called C0 */
...
#define OCTEONTX_CNF95XX_PASS3_X  (OCTEONTX_CNF95XX_PASS3_0 | __OM_IGNORE_MINOR_REVISION)

#define OCTEONTX_LOKI_PASS1_0     __OM_BUILD(0xb4, 1, 0) /* Called A0 */
#define OCTEONTX_LOKI_PASS1_1     __OM_BUILD(0xb4, 1, 1) /* Called A0 */
#define OCTEONTX_LOKI_PASS2_0     __OM_BUILD(0xb4, 2, 0) /* Called B0 */
...
#define OCTEONTX_LOKI_PASS2_X     (OCTEONTX_LOKI_PASS2_0 | __OM_IGNORE_MINOR_REVISION)

#define OCTEONTX_F95MM_PASS1_0     __OM_BUILD(0xb5, 1, 0) /* Called A0 */
#define OCTEONTX_F95MM_PASS2_0     __OM_BUILD(0xb5, 2, 0) /* Called B0 */
...
#define OCTEONTX_F95MM_PASS2_X     (OCTEONTX_F95MM_PASS2_0 | __OM_IGNORE_MINOR_REVISION)
