...
static inline uint64_t CAVM_CIMX_ICC_AP0R0_EL1(uint64_t a)
{
    ...
    if (cavm_is_model(OCTEONTX_CN96XX_PASS1_X) && (a<=23))
        return 0x87b000063220ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CN96XX_PASS3_X) && (a<=23))
        return 0x87b000063220ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CN96XX_PASS4_X) && (a<=47))
...
union cavm_cimx_icc_hppir0_el1
{
    ...
    /* struct cavm_cimx_icc_hppir0_el1_s cn96xxp4; */
    /* struct cavm_cimx_icc_hppir0_el1_s cn98xx; */
    /* struct cavm_cimx_icc_hppir0_el1_s cnf95xx; */
    /* struct cavm_cimx_icc_hppir0_el1_s f95mm; */
    /* struct cavm_cimx_icc_hppir0_el1_s f95o; */
...
union cavm_cimx_icc_hppir1_el1
{
    ...
    /* struct cavm_cimx_icc_hppir1_el1_s cn96xxp4; */
    /* struct cavm_cimx_icc_hppir1_el1_s cn98xx; */
    /* struct cavm_cimx_icc_hppir1_el1_s cnf95xx; */
    /* struct cavm_cimx_icc_hppir1_el1_s f95mm; */
    /* struct cavm_cimx_icc_hppir1_el1_s f95o; */
...
union cavm_cimx_icc_rpr_el1
{
    ...
    /* struct cavm_cimx_icc_rpr_el1_s cn96xxp4; */
    /* struct cavm_cimx_icc_rpr_el1_s cn98xx; */
    /* struct cavm_cimx_icc_rpr_el1_s cnf95xx; */
    /* struct cavm_cimx_icc_rpr_el1_s f95mm; */
    /* struct cavm_cimx_icc_rpr_el1_s f95o; */
...
static inline uint64_t CAVM_CIMX_ICH_LRX_EL2(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_CN96XX_PASS1_X) && ((a<=23) && (b<=15)))
        return 0x87b000073300ll + 0x80000ll * ((a) & 0x1f) + 8ll * ((b) & 0xf);
    if (cavm_is_model(OCTEONTX_CN96XX_PASS3_X) && ((a<=23) && (b<=15)))
        return 0x87b000073300ll + 0x80000ll * ((a) & 0x1f) + 8ll * ((b) & 0xf);
    if (cavm_is_model(OCTEONTX_CN96XX_PASS4_X) && ((a<=47) && (b<=15)))
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && ((a<=5) && (b<=15)))
        return 0x87b000073300ll + 0x80000ll * ((a) & 0x7) + 8ll * ((b) & 0xf);
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=47) && (b<=15)))
        return 0x87b000073300ll + 0x80000ll * ((a) & 0x3f) + 8ll * ((b) & 0xf);
