...
union cavm_mdbw_jd_dma_cfg_word_2_s
{
    ...
    /* struct cavm_mdbw_jd_dma_cfg_word_2_s_s cn9; */
    /* struct cavm_mdbw_jd_dma_cfg_word_2_s_s cnf95xxp1; */
    struct cavm_mdbw_jd_dma_cfg_word_2_s_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t stride                : 32; /**< [ 63: 32] Signed distance in bytes between the start of consecutive blocks of 2D
                                                                 DMA. Must be two's complement value in the range ABS([STRIDE]) \< 128
...
static inline uint64_t CAVM_MDBWX_AB_PORT_HP(uint64_t a)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && (a<=14))
        return 0x87e044002350ll + 0x4000ll * ((a) & 0xf);
...
static inline uint64_t CAVM_MDBWX_AB_SLTX_CDERR_OFLOW_JTAG(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && ((a<=14) && (b<=1)))
        return 0x87e044000f40ll + 0x4000ll * ((a) & 0xf) + 8ll * ((b) & 0x1);
...
static inline uint64_t CAVM_MDBWX_AB_SLTX_CDERR_UFLOW_JTAG(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && ((a<=14) && (b<=1)))
        return 0x87e044000f50ll + 0x4000ll * ((a) & 0xf) + 8ll * ((b) & 0x1);
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=42) && (b<=1)))
        return 0x87e044000f50ll + 0x4000ll * ((a) & 0x3f) + 8ll * ((b) & 0x1);
...
static inline uint64_t CAVM_MDBWX_AB_SLTX_CFG_FAT_JTAG(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && ((a<=14) && (b<=1)))
        return 0x87e044001900ll + 0x4000ll * ((a) & 0xf) + 0x10ll * ((b) & 0x1);
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=42) && (b<=1)))
        return 0x87e044001900ll + 0x4000ll * ((a) & 0x3f) + 0x10ll * ((b) & 0x1);
...
static inline uint64_t CAVM_MDBWX_AB_SLTX_CFG_NFAT_JTAG(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && ((a<=14) && (b<=1)))
        return 0x87e044002100ll + 0x4000ll * ((a) & 0xf) + 0x10ll * ((b) & 0x1);
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=42) && (b<=1)))
        return 0x87e044002100ll + 0x4000ll * ((a) & 0x3f) + 0x10ll * ((b) & 0x1);
...
static inline uint64_t CAVM_MDBWX_AB_SLTX_CP_FAT_JTAG(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && ((a<=14) && (b<=1)))
        return 0x87e044001a00ll + 0x4000ll * ((a) & 0xf) + 0x10ll * ((b) & 0x1);
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=42) && (b<=1)))
        return 0x87e044001a00ll + 0x4000ll * ((a) & 0x3f) + 0x10ll * ((b) & 0x1);
...
static inline uint64_t CAVM_MDBWX_AB_SLTX_CP_NFAT_JTAG(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && ((a<=14) && (b<=1)))
        return 0x87e044002200ll + 0x4000ll * ((a) & 0xf) + 0x10ll * ((b) & 0x1);
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=42) && (b<=1)))
        return 0x87e044002200ll + 0x4000ll * ((a) & 0x3f) + 0x10ll * ((b) & 0x1);
...
union cavm_mdbwx_ab_sltx_derr_ena_w1c
{
    ...
    /* struct cavm_mdbwx_ab_sltx_derr_ena_w1c_s cn9; */
    /* struct cavm_mdbwx_ab_sltx_derr_ena_w1c_s cnf95xx; */
    struct cavm_mdbwx_ab_sltx_derr_ena_w1c_f95mm
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_27_63        : 37;
        uint64_t cfg_dma_uflow         : 1;  /**< [ 26: 26](R/W1C/H) Reads or clears enable for MDBW(0..14)_AB_SLT(0..1)_DERR_INT[CFG_DMA_UFLOW]. */
        uint64_t cfg_dma_oflow         : 1;  /**< [ 25: 25](R/W1C/H) Reads or clears enable for MDBW(0..14)_AB_SLT(0..1)_DERR_INT[CFG_DMA_OFLOW]. */
        uint64_t reserved_13_24        : 12;
        uint64_t wr_dma_uflow_port0    : 1;  /**< [ 12: 12](R/W1C/H) Reads or clears enable for MDBW(0..14)_AB_SLT(0..1)_DERR_INT[WR_DMA_UFLOW_PORT0]. */
        uint64_t reserved_9_11         : 3;
        uint64_t wr_dma_oflow_port0    : 1;  /**< [  8:  8](R/W1C/H) Reads or clears enable for MDBW(0..14)_AB_SLT(0..1)_DERR_INT[WR_DMA_OFLOW_PORT0]. */
        uint64_t reserved_5_7          : 3;
        uint64_t rd_dma_uflow_port0    : 1;  /**< [  4:  4](R/W1C/H) Reads or clears enable for MDBW(0..14)_AB_SLT(0..1)_DERR_INT[RD_DMA_UFLOW_PORT0]. */
        uint64_t reserved_1_3          : 3;
        uint64_t rd_dma_oflow_port0    : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for MDBW(0..14)_AB_SLT(0..1)_DERR_INT[RD_DMA_OFLOW_PORT0]. */
#else /* Word 0 - Little Endian */
        uint64_t rd_dma_oflow_port0    : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for MDBW(0..14)_AB_SLT(0..1)_DERR_INT[RD_DMA_OFLOW_PORT0]. */
        uint64_t reserved_1_3          : 3;
        uint64_t rd_dma_uflow_port0    : 1;  /**< [  4:  4](R/W1C/H) Reads or clears enable for MDBW(0..14)_AB_SLT(0..1)_DERR_INT[RD_DMA_UFLOW_PORT0]. */
    ...
    struct cavm_mdbwx_ab_sltx_derr_ena_w1c_f95o
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_27_63        : 37;
        uint64_t cfg_dma_uflow         : 1;  /**< [ 26: 26](R/W1C/H) Reads or clears enable for MDBW(0..42)_AB_SLT(0..1)_DERR_INT[CFG_DMA_UFLOW]. */
        uint64_t cfg_dma_oflow         : 1;  /**< [ 25: 25](R/W1C/H) Reads or clears enable for MDBW(0..42)_AB_SLT(0..1)_DERR_INT[CFG_DMA_OFLOW]. */
        uint64_t reserved_13_24        : 12;
        uint64_t wr_dma_uflow_port0    : 1;  /**< [ 12: 12](R/W1C/H) Reads or clears enable for MDBW(0..42)_AB_SLT(0..1)_DERR_INT[WR_DMA_UFLOW_PORT0]. */
        uint64_t reserved_9_11         : 3;
        uint64_t wr_dma_oflow_port0    : 1;  /**< [  8:  8](R/W1C/H) Reads or clears enable for MDBW(0..42)_AB_SLT(0..1)_DERR_INT[WR_DMA_OFLOW_PORT0]. */
        uint64_t reserved_5_7          : 3;
        uint64_t rd_dma_uflow_port0    : 1;  /**< [  4:  4](R/W1C/H) Reads or clears enable for MDBW(0..42)_AB_SLT(0..1)_DERR_INT[RD_DMA_UFLOW_PORT0]. */
        uint64_t reserved_1_3          : 3;
        uint64_t rd_dma_oflow_port0    : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for MDBW(0..42)_AB_SLT(0..1)_DERR_INT[RD_DMA_OFLOW_PORT0]. */
#else /* Word 0 - Little Endian */
        uint64_t rd_dma_oflow_port0    : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for MDBW(0..42)_AB_SLT(0..1)_DERR_INT[RD_DMA_OFLOW_PORT0]. */
        uint64_t reserved_1_3          : 3;
        uint64_t rd_dma_uflow_port0    : 1;  /**< [  4:  4](R/W1C/H) Reads or clears enable for MDBW(0..42)_AB_SLT(0..1)_DERR_INT[RD_DMA_UFLOW_PORT0]. */
...
static inline uint64_t CAVM_MDBWX_AB_SLTX_DERR_ENA_W1C(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && ((a<=14) && (b<=1)))
        return 0x87e044001100ll + 0x4000ll * ((a) & 0xf) + 0x10ll * ((b) & 0x1);
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=42) && (b<=1)))
        return 0x87e044001100ll + 0x4000ll * ((a) & 0x3f) + 0x10ll * ((b) & 0x1);
...
union cavm_mdbwx_ab_sltx_derr_ena_w1s
{
    ...
    /* struct cavm_mdbwx_ab_sltx_derr_ena_w1s_s cn9; */
    /* struct cavm_mdbwx_ab_sltx_derr_ena_w1s_s cnf95xx; */
    struct cavm_mdbwx_ab_sltx_derr_ena_w1s_f95mm
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_27_63        : 37;
        uint64_t cfg_dma_uflow         : 1;  /**< [ 26: 26](R/W1S/H) Reads or sets enable for MDBW(0..14)_AB_SLT(0..1)_DERR_INT[CFG_DMA_UFLOW]. */
        uint64_t cfg_dma_oflow         : 1;  /**< [ 25: 25](R/W1S/H) Reads or sets enable for MDBW(0..14)_AB_SLT(0..1)_DERR_INT[CFG_DMA_OFLOW]. */
        uint64_t reserved_13_24        : 12;
        uint64_t wr_dma_uflow_port0    : 1;  /**< [ 12: 12](R/W1S/H) Reads or sets enable for MDBW(0..14)_AB_SLT(0..1)_DERR_INT[WR_DMA_UFLOW_PORT0]. */
        uint64_t reserved_9_11         : 3;
        uint64_t wr_dma_oflow_port0    : 1;  /**< [  8:  8](R/W1S/H) Reads or sets enable for MDBW(0..14)_AB_SLT(0..1)_DERR_INT[WR_DMA_OFLOW_PORT0]. */
        uint64_t reserved_5_7          : 3;
        uint64_t rd_dma_uflow_port0    : 1;  /**< [  4:  4](R/W1S/H) Reads or sets enable for MDBW(0..14)_AB_SLT(0..1)_DERR_INT[RD_DMA_UFLOW_PORT0]. */
        uint64_t reserved_1_3          : 3;
        uint64_t rd_dma_oflow_port0    : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for MDBW(0..14)_AB_SLT(0..1)_DERR_INT[RD_DMA_OFLOW_PORT0]. */
#else /* Word 0 - Little Endian */
        uint64_t rd_dma_oflow_port0    : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for MDBW(0..14)_AB_SLT(0..1)_DERR_INT[RD_DMA_OFLOW_PORT0]. */
        uint64_t reserved_1_3          : 3;
        uint64_t rd_dma_uflow_port0    : 1;  /**< [  4:  4](R/W1S/H) Reads or sets enable for MDBW(0..14)_AB_SLT(0..1)_DERR_INT[RD_DMA_UFLOW_PORT0]. */
    ...
    struct cavm_mdbwx_ab_sltx_derr_ena_w1s_f95o
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_27_63        : 37;
        uint64_t cfg_dma_uflow         : 1;  /**< [ 26: 26](R/W1S/H) Reads or sets enable for MDBW(0..42)_AB_SLT(0..1)_DERR_INT[CFG_DMA_UFLOW]. */
        uint64_t cfg_dma_oflow         : 1;  /**< [ 25: 25](R/W1S/H) Reads or sets enable for MDBW(0..42)_AB_SLT(0..1)_DERR_INT[CFG_DMA_OFLOW]. */
        uint64_t reserved_13_24        : 12;
        uint64_t wr_dma_uflow_port0    : 1;  /**< [ 12: 12](R/W1S/H) Reads or sets enable for MDBW(0..42)_AB_SLT(0..1)_DERR_INT[WR_DMA_UFLOW_PORT0]. */
        uint64_t reserved_9_11         : 3;
        uint64_t wr_dma_oflow_port0    : 1;  /**< [  8:  8](R/W1S/H) Reads or sets enable for MDBW(0..42)_AB_SLT(0..1)_DERR_INT[WR_DMA_OFLOW_PORT0]. */
        uint64_t reserved_5_7          : 3;
        uint64_t rd_dma_uflow_port0    : 1;  /**< [  4:  4](R/W1S/H) Reads or sets enable for MDBW(0..42)_AB_SLT(0..1)_DERR_INT[RD_DMA_UFLOW_PORT0]. */
        uint64_t reserved_1_3          : 3;
        uint64_t rd_dma_oflow_port0    : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for MDBW(0..42)_AB_SLT(0..1)_DERR_INT[RD_DMA_OFLOW_PORT0]. */
#else /* Word 0 - Little Endian */
        uint64_t rd_dma_oflow_port0    : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for MDBW(0..42)_AB_SLT(0..1)_DERR_INT[RD_DMA_OFLOW_PORT0]. */
        uint64_t reserved_1_3          : 3;
        uint64_t rd_dma_uflow_port0    : 1;  /**< [  4:  4](R/W1S/H) Reads or sets enable for MDBW(0..42)_AB_SLT(0..1)_DERR_INT[RD_DMA_UFLOW_PORT0]. */
...
static inline uint64_t CAVM_MDBWX_AB_SLTX_DERR_ENA_W1S(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && ((a<=14) && (b<=1)))
        return 0x87e044001000ll + 0x4000ll * ((a) & 0xf) + 0x10ll * ((b) & 0x1);
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=42) && (b<=1)))
        return 0x87e044001000ll + 0x4000ll * ((a) & 0x3f) + 0x10ll * ((b) & 0x1);
...
static inline uint64_t CAVM_MDBWX_AB_SLTX_DERR_INT(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && ((a<=14) && (b<=1)))
        return 0x87e044000e00ll + 0x4000ll * ((a) & 0xf) + 0x10ll * ((b) & 0x1);
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=42) && (b<=1)))
        return 0x87e044000e00ll + 0x4000ll * ((a) & 0x3f) + 0x10ll * ((b) & 0x1);
...
union cavm_mdbwx_ab_sltx_derr_int_w1s
{
    ...
    /* struct cavm_mdbwx_ab_sltx_derr_int_w1s_s cn9; */
    /* struct cavm_mdbwx_ab_sltx_derr_int_w1s_s cnf95xx; */
    struct cavm_mdbwx_ab_sltx_derr_int_w1s_f95mm
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_27_63        : 37;
        uint64_t cfg_dma_uflow         : 1;  /**< [ 26: 26](R/W1S/H) Reads or sets MDBW(0..14)_AB_SLT(0..1)_DERR_INT[CFG_DMA_UFLOW]. */
        uint64_t cfg_dma_oflow         : 1;  /**< [ 25: 25](R/W1S/H) Reads or sets MDBW(0..14)_AB_SLT(0..1)_DERR_INT[CFG_DMA_OFLOW]. */
        uint64_t reserved_13_24        : 12;
        uint64_t wr_dma_uflow_port0    : 1;  /**< [ 12: 12](R/W1S/H) Reads or sets MDBW(0..14)_AB_SLT(0..1)_DERR_INT[WR_DMA_UFLOW_PORT0]. */
        uint64_t reserved_9_11         : 3;
        uint64_t wr_dma_oflow_port0    : 1;  /**< [  8:  8](R/W1S/H) Reads or sets MDBW(0..14)_AB_SLT(0..1)_DERR_INT[WR_DMA_OFLOW_PORT0]. */
        uint64_t reserved_5_7          : 3;
        uint64_t rd_dma_uflow_port0    : 1;  /**< [  4:  4](R/W1S/H) Reads or sets MDBW(0..14)_AB_SLT(0..1)_DERR_INT[RD_DMA_UFLOW_PORT0]. */
        uint64_t reserved_1_3          : 3;
        uint64_t rd_dma_oflow_port0    : 1;  /**< [  0:  0](R/W1S/H) Reads or sets MDBW(0..14)_AB_SLT(0..1)_DERR_INT[RD_DMA_OFLOW_PORT0]. */
#else /* Word 0 - Little Endian */
        uint64_t rd_dma_oflow_port0    : 1;  /**< [  0:  0](R/W1S/H) Reads or sets MDBW(0..14)_AB_SLT(0..1)_DERR_INT[RD_DMA_OFLOW_PORT0]. */
        uint64_t reserved_1_3          : 3;
        uint64_t rd_dma_uflow_port0    : 1;  /**< [  4:  4](R/W1S/H) Reads or sets MDBW(0..14)_AB_SLT(0..1)_DERR_INT[RD_DMA_UFLOW_PORT0]. */
    ...
    struct cavm_mdbwx_ab_sltx_derr_int_w1s_f95o
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_27_63        : 37;
        uint64_t cfg_dma_uflow         : 1;  /**< [ 26: 26](R/W1S/H) Reads or sets MDBW(0..42)_AB_SLT(0..1)_DERR_INT[CFG_DMA_UFLOW]. */
        uint64_t cfg_dma_oflow         : 1;  /**< [ 25: 25](R/W1S/H) Reads or sets MDBW(0..42)_AB_SLT(0..1)_DERR_INT[CFG_DMA_OFLOW]. */
        uint64_t reserved_13_24        : 12;
        uint64_t wr_dma_uflow_port0    : 1;  /**< [ 12: 12](R/W1S/H) Reads or sets MDBW(0..42)_AB_SLT(0..1)_DERR_INT[WR_DMA_UFLOW_PORT0]. */
        uint64_t reserved_9_11         : 3;
        uint64_t wr_dma_oflow_port0    : 1;  /**< [  8:  8](R/W1S/H) Reads or sets MDBW(0..42)_AB_SLT(0..1)_DERR_INT[WR_DMA_OFLOW_PORT0]. */
        uint64_t reserved_5_7          : 3;
        uint64_t rd_dma_uflow_port0    : 1;  /**< [  4:  4](R/W1S/H) Reads or sets MDBW(0..42)_AB_SLT(0..1)_DERR_INT[RD_DMA_UFLOW_PORT0]. */
        uint64_t reserved_1_3          : 3;
        uint64_t rd_dma_oflow_port0    : 1;  /**< [  0:  0](R/W1S/H) Reads or sets MDBW(0..42)_AB_SLT(0..1)_DERR_INT[RD_DMA_OFLOW_PORT0]. */
#else /* Word 0 - Little Endian */
        uint64_t rd_dma_oflow_port0    : 1;  /**< [  0:  0](R/W1S/H) Reads or sets MDBW(0..42)_AB_SLT(0..1)_DERR_INT[RD_DMA_OFLOW_PORT0]. */
        uint64_t reserved_1_3          : 3;
        uint64_t rd_dma_uflow_port0    : 1;  /**< [  4:  4](R/W1S/H) Reads or sets MDBW(0..42)_AB_SLT(0..1)_DERR_INT[RD_DMA_UFLOW_PORT0]. */
...
static inline uint64_t CAVM_MDBWX_AB_SLTX_DERR_INT_W1S(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && ((a<=14) && (b<=1)))
        return 0x87e044001200ll + 0x4000ll * ((a) & 0xf) + 0x10ll * ((b) & 0x1);
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=42) && (b<=1)))
        return 0x87e044001200ll + 0x4000ll * ((a) & 0x3f) + 0x10ll * ((b) & 0x1);
...
union cavm_mdbwx_ab_sltx_fat_err_ena_w1c
{
    ...
    /* struct cavm_mdbwx_ab_sltx_fat_err_ena_w1c_s cn9; */
    /* struct cavm_mdbwx_ab_sltx_fat_err_ena_w1c_s cnf95xx; */
    struct cavm_mdbwx_ab_sltx_fat_err_ena_w1c_f95mm
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
        ...
        uint64_t reserved_9_11         : 3;
        uint64_t wr_dma_port0          : 1;  /**< [  8:  8](R/W1C/H) Reads or clears enable for MDBW(0..14)_AB_SLT(0..1)_FAT_ERR_INT[WR_DMA_PORT0]. */
        uint64_t reserved_1_7          : 7;
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for MDBW(0..14)_AB_SLT(0..1)_FAT_ERR_INT[RD_DMA_PORT0]. */
#else /* Word 0 - Little Endian */
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for MDBW(0..14)_AB_SLT(0..1)_FAT_ERR_INT[RD_DMA_PORT0]. */
        uint64_t reserved_1_7          : 7;
        uint64_t wr_dma_port0          : 1;  /**< [  8:  8](R/W1C/H) Reads or clears enable for MDBW(0..14)_AB_SLT(0..1)_FAT_ERR_INT[WR_DMA_PORT0]. */
    ...
    struct cavm_mdbwx_ab_sltx_fat_err_ena_w1c_f95o
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
        ...
        uint64_t reserved_9_11         : 3;
        uint64_t wr_dma_port0          : 1;  /**< [  8:  8](R/W1C/H) Reads or clears enable for MDBW(0..42)_AB_SLT(0..1)_FAT_ERR_INT[WR_DMA_PORT0]. */
        uint64_t reserved_1_7          : 7;
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for MDBW(0..42)_AB_SLT(0..1)_FAT_ERR_INT[RD_DMA_PORT0]. */
#else /* Word 0 - Little Endian */
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for MDBW(0..42)_AB_SLT(0..1)_FAT_ERR_INT[RD_DMA_PORT0]. */
        uint64_t reserved_1_7          : 7;
        uint64_t wr_dma_port0          : 1;  /**< [  8:  8](R/W1C/H) Reads or clears enable for MDBW(0..42)_AB_SLT(0..1)_FAT_ERR_INT[WR_DMA_PORT0]. */
...
static inline uint64_t CAVM_MDBWX_AB_SLTX_FAT_ERR_ENA_W1C(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && ((a<=14) && (b<=1)))
        return 0x87e044001500ll + 0x4000ll * ((a) & 0xf) + 0x10ll * ((b) & 0x1);
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=42) && (b<=1)))
        return 0x87e044001500ll + 0x4000ll * ((a) & 0x3f) + 0x10ll * ((b) & 0x1);
...
union cavm_mdbwx_ab_sltx_fat_err_ena_w1s
{
    ...
    /* struct cavm_mdbwx_ab_sltx_fat_err_ena_w1s_s cn9; */
    /* struct cavm_mdbwx_ab_sltx_fat_err_ena_w1s_s cnf95xx; */
    struct cavm_mdbwx_ab_sltx_fat_err_ena_w1s_f95mm
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
        ...
        uint64_t reserved_9_11         : 3;
        uint64_t wr_dma_port0          : 1;  /**< [  8:  8](R/W1S/H) Reads or sets enable for MDBW(0..14)_AB_SLT(0..1)_FAT_ERR_INT[WR_DMA_PORT0]. */
        uint64_t reserved_1_7          : 7;
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for MDBW(0..14)_AB_SLT(0..1)_FAT_ERR_INT[RD_DMA_PORT0]. */
#else /* Word 0 - Little Endian */
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for MDBW(0..14)_AB_SLT(0..1)_FAT_ERR_INT[RD_DMA_PORT0]. */
        uint64_t reserved_1_7          : 7;
        uint64_t wr_dma_port0          : 1;  /**< [  8:  8](R/W1S/H) Reads or sets enable for MDBW(0..14)_AB_SLT(0..1)_FAT_ERR_INT[WR_DMA_PORT0]. */
    ...
    struct cavm_mdbwx_ab_sltx_fat_err_ena_w1s_f95o
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
        ...
        uint64_t reserved_9_11         : 3;
        uint64_t wr_dma_port0          : 1;  /**< [  8:  8](R/W1S/H) Reads or sets enable for MDBW(0..42)_AB_SLT(0..1)_FAT_ERR_INT[WR_DMA_PORT0]. */
        uint64_t reserved_1_7          : 7;
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for MDBW(0..42)_AB_SLT(0..1)_FAT_ERR_INT[RD_DMA_PORT0]. */
#else /* Word 0 - Little Endian */
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for MDBW(0..42)_AB_SLT(0..1)_FAT_ERR_INT[RD_DMA_PORT0]. */
        uint64_t reserved_1_7          : 7;
        uint64_t wr_dma_port0          : 1;  /**< [  8:  8](R/W1S/H) Reads or sets enable for MDBW(0..42)_AB_SLT(0..1)_FAT_ERR_INT[WR_DMA_PORT0]. */
...
static inline uint64_t CAVM_MDBWX_AB_SLTX_FAT_ERR_ENA_W1S(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && ((a<=14) && (b<=1)))
        return 0x87e044001400ll + 0x4000ll * ((a) & 0xf) + 0x10ll * ((b) & 0x1);
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=42) && (b<=1)))
        return 0x87e044001400ll + 0x4000ll * ((a) & 0x3f) + 0x10ll * ((b) & 0x1);
...
static inline uint64_t CAVM_MDBWX_AB_SLTX_FAT_ERR_INT(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && ((a<=14) && (b<=1)))
        return 0x87e044001300ll + 0x4000ll * ((a) & 0xf) + 0x10ll * ((b) & 0x1);
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=42) && (b<=1)))
        return 0x87e044001300ll + 0x4000ll * ((a) & 0x3f) + 0x10ll * ((b) & 0x1);
...
union cavm_mdbwx_ab_sltx_fat_err_int_w1s
{
    ...
    /* struct cavm_mdbwx_ab_sltx_fat_err_int_w1s_s cn9; */
    /* struct cavm_mdbwx_ab_sltx_fat_err_int_w1s_s cnf95xx; */
    struct cavm_mdbwx_ab_sltx_fat_err_int_w1s_f95mm
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
        ...
        uint64_t reserved_9_11         : 3;
        uint64_t wr_dma_port0          : 1;  /**< [  8:  8](R/W1S/H) Reads or sets MDBW(0..14)_AB_SLT(0..1)_FAT_ERR_INT[WR_DMA_PORT0]. */
        uint64_t reserved_1_7          : 7;
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1S/H) Reads or sets MDBW(0..14)_AB_SLT(0..1)_FAT_ERR_INT[RD_DMA_PORT0]. */
#else /* Word 0 - Little Endian */
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1S/H) Reads or sets MDBW(0..14)_AB_SLT(0..1)_FAT_ERR_INT[RD_DMA_PORT0]. */
        uint64_t reserved_1_7          : 7;
        uint64_t wr_dma_port0          : 1;  /**< [  8:  8](R/W1S/H) Reads or sets MDBW(0..14)_AB_SLT(0..1)_FAT_ERR_INT[WR_DMA_PORT0]. */
    ...
    struct cavm_mdbwx_ab_sltx_fat_err_int_w1s_f95o
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
        ...
        uint64_t reserved_9_11         : 3;
        uint64_t wr_dma_port0          : 1;  /**< [  8:  8](R/W1S/H) Reads or sets MDBW(0..42)_AB_SLT(0..1)_FAT_ERR_INT[WR_DMA_PORT0]. */
        uint64_t reserved_1_7          : 7;
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1S/H) Reads or sets MDBW(0..42)_AB_SLT(0..1)_FAT_ERR_INT[RD_DMA_PORT0]. */
#else /* Word 0 - Little Endian */
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1S/H) Reads or sets MDBW(0..42)_AB_SLT(0..1)_FAT_ERR_INT[RD_DMA_PORT0]. */
        uint64_t reserved_1_7          : 7;
        uint64_t wr_dma_port0          : 1;  /**< [  8:  8](R/W1S/H) Reads or sets MDBW(0..42)_AB_SLT(0..1)_FAT_ERR_INT[WR_DMA_PORT0]. */
...
static inline uint64_t CAVM_MDBWX_AB_SLTX_FAT_ERR_INT_W1S(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && ((a<=14) && (b<=1)))
        return 0x87e044001600ll + 0x4000ll * ((a) & 0xf) + 0x10ll * ((b) & 0x1);
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=42) && (b<=1)))
        return 0x87e044001600ll + 0x4000ll * ((a) & 0x3f) + 0x10ll * ((b) & 0x1);
...
union cavm_mdbwx_ab_sltx_nfat_err_ena_w1c
{
    ...
    /* struct cavm_mdbwx_ab_sltx_nfat_err_ena_w1c_s cn9; */
    /* struct cavm_mdbwx_ab_sltx_nfat_err_ena_w1c_s cnf95xx; */
    struct cavm_mdbwx_ab_sltx_nfat_err_ena_w1c_f95mm
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
        ...
        uint64_t reserved_9_11         : 3;
        uint64_t wr_dma_port0          : 1;  /**< [  8:  8](R/W1C/H) Reads or clears enable for MDBW(0..14)_AB_SLT(0..1)_NFAT_ERR_INT[WR_DMA_PORT0]. */
        uint64_t reserved_1_7          : 7;
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for MDBW(0..14)_AB_SLT(0..1)_NFAT_ERR_INT[RD_DMA_PORT0]. */
#else /* Word 0 - Little Endian */
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for MDBW(0..14)_AB_SLT(0..1)_NFAT_ERR_INT[RD_DMA_PORT0]. */
        uint64_t reserved_1_7          : 7;
        uint64_t wr_dma_port0          : 1;  /**< [  8:  8](R/W1C/H) Reads or clears enable for MDBW(0..14)_AB_SLT(0..1)_NFAT_ERR_INT[WR_DMA_PORT0]. */
    ...
    struct cavm_mdbwx_ab_sltx_nfat_err_ena_w1c_f95o
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
        ...
        uint64_t reserved_9_11         : 3;
        uint64_t wr_dma_port0          : 1;  /**< [  8:  8](R/W1C/H) Reads or clears enable for MDBW(0..42)_AB_SLT(0..1)_NFAT_ERR_INT[WR_DMA_PORT0]. */
        uint64_t reserved_1_7          : 7;
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for MDBW(0..42)_AB_SLT(0..1)_NFAT_ERR_INT[RD_DMA_PORT0]. */
#else /* Word 0 - Little Endian */
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for MDBW(0..42)_AB_SLT(0..1)_NFAT_ERR_INT[RD_DMA_PORT0]. */
        uint64_t reserved_1_7          : 7;
        uint64_t wr_dma_port0          : 1;  /**< [  8:  8](R/W1C/H) Reads or clears enable for MDBW(0..42)_AB_SLT(0..1)_NFAT_ERR_INT[WR_DMA_PORT0]. */
...
static inline uint64_t CAVM_MDBWX_AB_SLTX_NFAT_ERR_ENA_W1C(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && ((a<=14) && (b<=1)))
        return 0x87e044001d00ll + 0x4000ll * ((a) & 0xf) + 0x10ll * ((b) & 0x1);
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=42) && (b<=1)))
        return 0x87e044001d00ll + 0x4000ll * ((a) & 0x3f) + 0x10ll * ((b) & 0x1);
...
union cavm_mdbwx_ab_sltx_nfat_err_ena_w1s
{
    ...
    /* struct cavm_mdbwx_ab_sltx_nfat_err_ena_w1s_s cn9; */
    /* struct cavm_mdbwx_ab_sltx_nfat_err_ena_w1s_s cnf95xx; */
    struct cavm_mdbwx_ab_sltx_nfat_err_ena_w1s_f95mm
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
        ...
        uint64_t reserved_9_11         : 3;
        uint64_t wr_dma_port0          : 1;  /**< [  8:  8](R/W1S/H) Reads or sets enable for MDBW(0..14)_AB_SLT(0..1)_NFAT_ERR_INT[WR_DMA_PORT0]. */
        uint64_t reserved_1_7          : 7;
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for MDBW(0..14)_AB_SLT(0..1)_NFAT_ERR_INT[RD_DMA_PORT0]. */
#else /* Word 0 - Little Endian */
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for MDBW(0..14)_AB_SLT(0..1)_NFAT_ERR_INT[RD_DMA_PORT0]. */
        uint64_t reserved_1_7          : 7;
        uint64_t wr_dma_port0          : 1;  /**< [  8:  8](R/W1S/H) Reads or sets enable for MDBW(0..14)_AB_SLT(0..1)_NFAT_ERR_INT[WR_DMA_PORT0]. */
    ...
    struct cavm_mdbwx_ab_sltx_nfat_err_ena_w1s_f95o
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
        ...
        uint64_t reserved_9_11         : 3;
        uint64_t wr_dma_port0          : 1;  /**< [  8:  8](R/W1S/H) Reads or sets enable for MDBW(0..42)_AB_SLT(0..1)_NFAT_ERR_INT[WR_DMA_PORT0]. */
        uint64_t reserved_1_7          : 7;
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for MDBW(0..42)_AB_SLT(0..1)_NFAT_ERR_INT[RD_DMA_PORT0]. */
#else /* Word 0 - Little Endian */
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for MDBW(0..42)_AB_SLT(0..1)_NFAT_ERR_INT[RD_DMA_PORT0]. */
        uint64_t reserved_1_7          : 7;
        uint64_t wr_dma_port0          : 1;  /**< [  8:  8](R/W1S/H) Reads or sets enable for MDBW(0..42)_AB_SLT(0..1)_NFAT_ERR_INT[WR_DMA_PORT0]. */
...
static inline uint64_t CAVM_MDBWX_AB_SLTX_NFAT_ERR_ENA_W1S(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && ((a<=14) && (b<=1)))
        return 0x87e044001c00ll + 0x4000ll * ((a) & 0xf) + 0x10ll * ((b) & 0x1);
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=42) && (b<=1)))
        return 0x87e044001c00ll + 0x4000ll * ((a) & 0x3f) + 0x10ll * ((b) & 0x1);
...
static inline uint64_t CAVM_MDBWX_AB_SLTX_NFAT_ERR_INT(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && ((a<=14) && (b<=1)))
        return 0x87e044001b00ll + 0x4000ll * ((a) & 0xf) + 0x10ll * ((b) & 0x1);
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=42) && (b<=1)))
        return 0x87e044001b00ll + 0x4000ll * ((a) & 0x3f) + 0x10ll * ((b) & 0x1);
...
union cavm_mdbwx_ab_sltx_nfat_err_int_w1s
{
    ...
    /* struct cavm_mdbwx_ab_sltx_nfat_err_int_w1s_s cn9; */
    /* struct cavm_mdbwx_ab_sltx_nfat_err_int_w1s_s cnf95xx; */
    struct cavm_mdbwx_ab_sltx_nfat_err_int_w1s_f95mm
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
        ...
        uint64_t reserved_9_11         : 3;
        uint64_t wr_dma_port0          : 1;  /**< [  8:  8](R/W1S/H) Reads or sets MDBW(0..14)_AB_SLT(0..1)_NFAT_ERR_INT[WR_DMA_PORT0]. */
        uint64_t reserved_1_7          : 7;
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1S/H) Reads or sets MDBW(0..14)_AB_SLT(0..1)_NFAT_ERR_INT[RD_DMA_PORT0]. */
#else /* Word 0 - Little Endian */
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1S/H) Reads or sets MDBW(0..14)_AB_SLT(0..1)_NFAT_ERR_INT[RD_DMA_PORT0]. */
        uint64_t reserved_1_7          : 7;
        uint64_t wr_dma_port0          : 1;  /**< [  8:  8](R/W1S/H) Reads or sets MDBW(0..14)_AB_SLT(0..1)_NFAT_ERR_INT[WR_DMA_PORT0]. */
    ...
    struct cavm_mdbwx_ab_sltx_nfat_err_int_w1s_f95o
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
        ...
        uint64_t reserved_9_11         : 3;
        uint64_t wr_dma_port0          : 1;  /**< [  8:  8](R/W1S/H) Reads or sets MDBW(0..42)_AB_SLT(0..1)_NFAT_ERR_INT[WR_DMA_PORT0]. */
        uint64_t reserved_1_7          : 7;
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1S/H) Reads or sets MDBW(0..42)_AB_SLT(0..1)_NFAT_ERR_INT[RD_DMA_PORT0]. */
#else /* Word 0 - Little Endian */
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1S/H) Reads or sets MDBW(0..42)_AB_SLT(0..1)_NFAT_ERR_INT[RD_DMA_PORT0]. */
        uint64_t reserved_1_7          : 7;
        uint64_t wr_dma_port0          : 1;  /**< [  8:  8](R/W1S/H) Reads or sets MDBW(0..42)_AB_SLT(0..1)_NFAT_ERR_INT[WR_DMA_PORT0]. */
...
static inline uint64_t CAVM_MDBWX_AB_SLTX_NFAT_ERR_INT_W1S(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && ((a<=14) && (b<=1)))
        return 0x87e044001e00ll + 0x4000ll * ((a) & 0xf) + 0x10ll * ((b) & 0x1);
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=42) && (b<=1)))
        return 0x87e044001e00ll + 0x4000ll * ((a) & 0x3f) + 0x10ll * ((b) & 0x1);
...
static inline uint64_t CAVM_MDBWX_AB_SLTX_RD_FAT_JTAG(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && ((a<=14) && (b<=1)))
        return 0x87e044001700ll + 0x4000ll * ((a) & 0xf) + 0x10ll * ((b) & 0x1);
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=42) && (b<=1)))
        return 0x87e044001700ll + 0x4000ll * ((a) & 0x3f) + 0x10ll * ((b) & 0x1);
...
static inline uint64_t CAVM_MDBWX_AB_SLTX_RD_NFAT_JTAG(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && ((a<=14) && (b<=1)))
        return 0x87e044001f00ll + 0x4000ll * ((a) & 0xf) + 0x10ll * ((b) & 0x1);
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=42) && (b<=1)))
        return 0x87e044001f00ll + 0x4000ll * ((a) & 0x3f) + 0x10ll * ((b) & 0x1);
...
static inline uint64_t CAVM_MDBWX_AB_SLTX_RDERR_OFLOW_JTAG(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && ((a<=14) && (b<=1)))
        return 0x87e044000f00ll + 0x4000ll * ((a) & 0xf) + 8ll * ((b) & 0x1);
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=42) && (b<=1)))
        return 0x87e044000f00ll + 0x4000ll * ((a) & 0x3f) + 8ll * ((b) & 0x1);
...
static inline uint64_t CAVM_MDBWX_AB_SLTX_RDERR_UFLOW_JTAG(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && ((a<=14) && (b<=1)))
        return 0x87e044000f10ll + 0x4000ll * ((a) & 0xf) + 8ll * ((b) & 0x1);
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=42) && (b<=1)))
        return 0x87e044000f10ll + 0x4000ll * ((a) & 0x3f) + 8ll * ((b) & 0x1);
...
static inline uint64_t CAVM_MDBWX_AB_SLTX_WDERR_OFLOW_JTAG(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && ((a<=14) && (b<=1)))
        return 0x87e044000f20ll + 0x4000ll * ((a) & 0xf) + 8ll * ((b) & 0x1);
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=42) && (b<=1)))
        return 0x87e044000f20ll + 0x4000ll * ((a) & 0x3f) + 8ll * ((b) & 0x1);
...
static inline uint64_t CAVM_MDBWX_AB_SLTX_WDERR_UFLOW_JTAG(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && ((a<=14) && (b<=1)))
        return 0x87e044000f30ll + 0x4000ll * ((a) & 0xf) + 8ll * ((b) & 0x1);
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=42) && (b<=1)))
        return 0x87e044000f30ll + 0x4000ll * ((a) & 0x3f) + 8ll * ((b) & 0x1);
...
static inline uint64_t CAVM_MDBWX_AB_SLTX_WR_FAT_JTAG(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && ((a<=14) && (b<=1)))
        return 0x87e044001800ll + 0x4000ll * ((a) & 0xf) + 0x10ll * ((b) & 0x1);
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=42) && (b<=1)))
        return 0x87e044001800ll + 0x4000ll * ((a) & 0x3f) + 0x10ll * ((b) & 0x1);
...
static inline uint64_t CAVM_MDBWX_AB_SLTX_WR_NFAT_JTAG(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && ((a<=14) && (b<=1)))
        return 0x87e044002000ll + 0x4000ll * ((a) & 0xf) + 0x10ll * ((b) & 0x1);
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=42) && (b<=1)))
        return 0x87e044002000ll + 0x4000ll * ((a) & 0x3f) + 0x10ll * ((b) & 0x1);
...
union cavm_mdbwx_adr_err_ena_w1c
{
    ...
    /* struct cavm_mdbwx_adr_err_ena_w1c_s cn9; */
    /* struct cavm_mdbwx_adr_err_ena_w1c_s cnf95xx; */
    struct cavm_mdbwx_adr_err_ena_w1c_f95mm
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_4_63         : 60;
        uint64_t gaa_wr_nxm_err        : 1;  /**< [  3:  3](R/W1C/H) Reads or clears enable for MDBW(0..14)_ADR_ERR_INT[GAA_WR_NXM_ERR]. */
        uint64_t gaa_rd_nxm_err        : 1;  /**< [  2:  2](R/W1C/H) Reads or clears enable for MDBW(0..14)_ADR_ERR_INT[GAA_RD_NXM_ERR]. */
        uint64_t ddr_range_err         : 1;  /**< [  1:  1](R/W1C/H) Reads or clears enable for MDBW(0..14)_ADR_ERR_INT[DDR_RANGE_ERR]. */
        uint64_t smem_range_err        : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for MDBW(0..14)_ADR_ERR_INT[SMEM_RANGE_ERR]. */
#else /* Word 0 - Little Endian */
        uint64_t smem_range_err        : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for MDBW(0..14)_ADR_ERR_INT[SMEM_RANGE_ERR]. */
        uint64_t ddr_range_err         : 1;  /**< [  1:  1](R/W1C/H) Reads or clears enable for MDBW(0..14)_ADR_ERR_INT[DDR_RANGE_ERR]. */
        uint64_t gaa_rd_nxm_err        : 1;  /**< [  2:  2](R/W1C/H) Reads or clears enable for MDBW(0..14)_ADR_ERR_INT[GAA_RD_NXM_ERR]. */
    ...
    struct cavm_mdbwx_adr_err_ena_w1c_f95o
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_4_63         : 60;
        uint64_t gaa_wr_nxm_err        : 1;  /**< [  3:  3](R/W1C/H) Reads or clears enable for MDBW(0..42)_ADR_ERR_INT[GAA_WR_NXM_ERR]. */
        uint64_t gaa_rd_nxm_err        : 1;  /**< [  2:  2](R/W1C/H) Reads or clears enable for MDBW(0..42)_ADR_ERR_INT[GAA_RD_NXM_ERR]. */
        uint64_t ddr_range_err         : 1;  /**< [  1:  1](R/W1C/H) Reads or clears enable for MDBW(0..42)_ADR_ERR_INT[DDR_RANGE_ERR]. */
        uint64_t smem_range_err        : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for MDBW(0..42)_ADR_ERR_INT[SMEM_RANGE_ERR]. */
#else /* Word 0 - Little Endian */
        uint64_t smem_range_err        : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for MDBW(0..42)_ADR_ERR_INT[SMEM_RANGE_ERR]. */
        uint64_t ddr_range_err         : 1;  /**< [  1:  1](R/W1C/H) Reads or clears enable for MDBW(0..42)_ADR_ERR_INT[DDR_RANGE_ERR]. */
        uint64_t gaa_rd_nxm_err        : 1;  /**< [  2:  2](R/W1C/H) Reads or clears enable for MDBW(0..42)_ADR_ERR_INT[GAA_RD_NXM_ERR]. */
...
static inline uint64_t CAVM_MDBWX_ADR_ERR_ENA_W1C(uint64_t a)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && (a<=14))
        return 0x87e044000d10ll + 0x4000ll * ((a) & 0xf);
    if (cavm_is_model(OCTEONTX_F95O) && (a<=42))
        return 0x87e044000d10ll + 0x4000ll * ((a) & 0x3f);
...
union cavm_mdbwx_adr_err_ena_w1s
{
    ...
    /* struct cavm_mdbwx_adr_err_ena_w1s_s cn9; */
    /* struct cavm_mdbwx_adr_err_ena_w1s_s cnf95xx; */
    struct cavm_mdbwx_adr_err_ena_w1s_f95mm
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_4_63         : 60;
        uint64_t gaa_wr_nxm_err        : 1;  /**< [  3:  3](R/W1S/H) Reads or sets enable for MDBW(0..14)_ADR_ERR_INT[GAA_WR_NXM_ERR]. */
        uint64_t gaa_rd_nxm_err        : 1;  /**< [  2:  2](R/W1S/H) Reads or sets enable for MDBW(0..14)_ADR_ERR_INT[GAA_RD_NXM_ERR]. */
        uint64_t ddr_range_err         : 1;  /**< [  1:  1](R/W1S/H) Reads or sets enable for MDBW(0..14)_ADR_ERR_INT[DDR_RANGE_ERR]. */
        uint64_t smem_range_err        : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for MDBW(0..14)_ADR_ERR_INT[SMEM_RANGE_ERR]. */
#else /* Word 0 - Little Endian */
        uint64_t smem_range_err        : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for MDBW(0..14)_ADR_ERR_INT[SMEM_RANGE_ERR]. */
        uint64_t ddr_range_err         : 1;  /**< [  1:  1](R/W1S/H) Reads or sets enable for MDBW(0..14)_ADR_ERR_INT[DDR_RANGE_ERR]. */
        uint64_t gaa_rd_nxm_err        : 1;  /**< [  2:  2](R/W1S/H) Reads or sets enable for MDBW(0..14)_ADR_ERR_INT[GAA_RD_NXM_ERR]. */
    ...
    struct cavm_mdbwx_adr_err_ena_w1s_f95o
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_4_63         : 60;
        uint64_t gaa_wr_nxm_err        : 1;  /**< [  3:  3](R/W1S/H) Reads or sets enable for MDBW(0..42)_ADR_ERR_INT[GAA_WR_NXM_ERR]. */
        uint64_t gaa_rd_nxm_err        : 1;  /**< [  2:  2](R/W1S/H) Reads or sets enable for MDBW(0..42)_ADR_ERR_INT[GAA_RD_NXM_ERR]. */
        uint64_t ddr_range_err         : 1;  /**< [  1:  1](R/W1S/H) Reads or sets enable for MDBW(0..42)_ADR_ERR_INT[DDR_RANGE_ERR]. */
        uint64_t smem_range_err        : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for MDBW(0..42)_ADR_ERR_INT[SMEM_RANGE_ERR]. */
#else /* Word 0 - Little Endian */
        uint64_t smem_range_err        : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for MDBW(0..42)_ADR_ERR_INT[SMEM_RANGE_ERR]. */
        uint64_t ddr_range_err         : 1;  /**< [  1:  1](R/W1S/H) Reads or sets enable for MDBW(0..42)_ADR_ERR_INT[DDR_RANGE_ERR]. */
        uint64_t gaa_rd_nxm_err        : 1;  /**< [  2:  2](R/W1S/H) Reads or sets enable for MDBW(0..42)_ADR_ERR_INT[GAA_RD_NXM_ERR]. */
...
static inline uint64_t CAVM_MDBWX_ADR_ERR_ENA_W1S(uint64_t a)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && (a<=14))
        return 0x87e044000d08ll + 0x4000ll * ((a) & 0xf);
    if (cavm_is_model(OCTEONTX_F95O) && (a<=42))
        return 0x87e044000d08ll + 0x4000ll * ((a) & 0x3f);
...
union cavm_mdbwx_adr_err_int
{
    ...
    /* struct cavm_mdbwx_adr_err_int_s cn9; */
    /* struct cavm_mdbwx_adr_err_int_s cnf95xxp1; */
    struct cavm_mdbwx_adr_err_int_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_4_63         : 60;
...
static inline uint64_t CAVM_MDBWX_ADR_ERR_INT(uint64_t a)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && (a<=14))
        return 0x87e044000d00ll + 0x4000ll * ((a) & 0xf);
    if (cavm_is_model(OCTEONTX_F95O) && (a<=42))
        return 0x87e044000d00ll + 0x4000ll * ((a) & 0x3f);
...
union cavm_mdbwx_adr_err_int_w1s
{
    ...
    /* struct cavm_mdbwx_adr_err_int_w1s_s cn9; */
    /* struct cavm_mdbwx_adr_err_int_w1s_s cnf95xx; */
    struct cavm_mdbwx_adr_err_int_w1s_f95mm
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_4_63         : 60;
        uint64_t gaa_wr_nxm_err        : 1;  /**< [  3:  3](R/W1S/H) Reads or sets MDBW(0..14)_ADR_ERR_INT[GAA_WR_NXM_ERR]. */
        uint64_t gaa_rd_nxm_err        : 1;  /**< [  2:  2](R/W1S/H) Reads or sets MDBW(0..14)_ADR_ERR_INT[GAA_RD_NXM_ERR]. */
        uint64_t ddr_range_err         : 1;  /**< [  1:  1](R/W1S/H) Reads or sets MDBW(0..14)_ADR_ERR_INT[DDR_RANGE_ERR]. */
        uint64_t smem_range_err        : 1;  /**< [  0:  0](R/W1S/H) Reads or sets MDBW(0..14)_ADR_ERR_INT[SMEM_RANGE_ERR]. */
#else /* Word 0 - Little Endian */
        uint64_t smem_range_err        : 1;  /**< [  0:  0](R/W1S/H) Reads or sets MDBW(0..14)_ADR_ERR_INT[SMEM_RANGE_ERR]. */
        uint64_t ddr_range_err         : 1;  /**< [  1:  1](R/W1S/H) Reads or sets MDBW(0..14)_ADR_ERR_INT[DDR_RANGE_ERR]. */
        uint64_t gaa_rd_nxm_err        : 1;  /**< [  2:  2](R/W1S/H) Reads or sets MDBW(0..14)_ADR_ERR_INT[GAA_RD_NXM_ERR]. */
    ...
    struct cavm_mdbwx_adr_err_int_w1s_f95o
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_4_63         : 60;
        uint64_t gaa_wr_nxm_err        : 1;  /**< [  3:  3](R/W1S/H) Reads or sets MDBW(0..42)_ADR_ERR_INT[GAA_WR_NXM_ERR]. */
        uint64_t gaa_rd_nxm_err        : 1;  /**< [  2:  2](R/W1S/H) Reads or sets MDBW(0..42)_ADR_ERR_INT[GAA_RD_NXM_ERR]. */
        uint64_t ddr_range_err         : 1;  /**< [  1:  1](R/W1S/H) Reads or sets MDBW(0..42)_ADR_ERR_INT[DDR_RANGE_ERR]. */
        uint64_t smem_range_err        : 1;  /**< [  0:  0](R/W1S/H) Reads or sets MDBW(0..42)_ADR_ERR_INT[SMEM_RANGE_ERR]. */
#else /* Word 0 - Little Endian */
        uint64_t smem_range_err        : 1;  /**< [  0:  0](R/W1S/H) Reads or sets MDBW(0..42)_ADR_ERR_INT[SMEM_RANGE_ERR]. */
        uint64_t ddr_range_err         : 1;  /**< [  1:  1](R/W1S/H) Reads or sets MDBW(0..42)_ADR_ERR_INT[DDR_RANGE_ERR]. */
        uint64_t gaa_rd_nxm_err        : 1;  /**< [  2:  2](R/W1S/H) Reads or sets MDBW(0..42)_ADR_ERR_INT[GAA_RD_NXM_ERR]. */
...
static inline uint64_t CAVM_MDBWX_ADR_ERR_INT_W1S(uint64_t a)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && (a<=14))
        return 0x87e044000d18ll + 0x4000ll * ((a) & 0xf);
    if (cavm_is_model(OCTEONTX_F95O) && (a<=42))
        return 0x87e044000d18ll + 0x4000ll * ((a) & 0x3f);
...
static inline uint64_t CAVM_MDBWX_ADR_ERR_JTAG(uint64_t a)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && (a<=14))
        return 0x87e044000d20ll + 0x4000ll * ((a) & 0xf);
    if (cavm_is_model(OCTEONTX_F95O) && (a<=42))
        return 0x87e044000d20ll + 0x4000ll * ((a) & 0x3f);
...
static inline uint64_t CAVM_MDBWX_ADR_ERROR_JCE_W0(uint64_t a)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && (a<=14))
        return 0x87e044000060ll + 0x4000ll * ((a) & 0xf);
    if (cavm_is_model(OCTEONTX_F95O) && (a<=42))
        return 0x87e044000060ll + 0x4000ll * ((a) & 0x3f);
...
static inline uint64_t CAVM_MDBWX_ADR_ERROR_JCE_W1(uint64_t a)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && (a<=14))
        return 0x87e044000068ll + 0x4000ll * ((a) & 0xf);
    if (cavm_is_model(OCTEONTX_F95O) && (a<=42))
        return 0x87e044000068ll + 0x4000ll * ((a) & 0x3f);
...
union cavm_mdbwx_cfg
{
    ...
    /* struct cavm_mdbwx_cfg_s cn9; */
    /* struct cavm_mdbwx_cfg_s cnf95xxp1; */
    struct cavm_mdbwx_cfg_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_51_63        : 13;
        uint64_t mdbw_done             : 1;  /**< [ 50: 50](RO/H) This bit is set, after this register's [ENA] bit = 0, and indicates the MDBW has completed
...
static inline uint64_t CAVM_MDBWX_CFG(uint64_t a)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && (a<=14))
        return 0x87e044000000ll + 0x4000ll * ((a) & 0xf);
    if (cavm_is_model(OCTEONTX_F95O) && (a<=42))
        return 0x87e044000000ll + 0x4000ll * ((a) & 0x3f);
...
static inline uint64_t CAVM_MDBWX_DMA_ERROR_JCE_W0(uint64_t a)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && (a<=14))
        return 0x87e044000020ll + 0x4000ll * ((a) & 0xf);
    if (cavm_is_model(OCTEONTX_F95O) && (a<=42))
        return 0x87e044000020ll + 0x4000ll * ((a) & 0x3f);
...
static inline uint64_t CAVM_MDBWX_DMA_ERROR_JCE_W1(uint64_t a)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && (a<=14))
        return 0x87e044000028ll + 0x4000ll * ((a) & 0xf);
    if (cavm_is_model(OCTEONTX_F95O) && (a<=42))
        return 0x87e044000028ll + 0x4000ll * ((a) & 0x3f);
...
static inline uint64_t CAVM_MDBWX_ERR_STAT0(uint64_t a)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && (a<=14))
        return 0x87e044002318ll + 0x4000ll * ((a) & 0xf);
    if (cavm_is_model(OCTEONTX_F95O) && (a<=42))
        return 0x87e044002318ll + 0x4000ll * ((a) & 0x3f);
...
union cavm_mdbwx_err_stat1
{
    ...
    /* struct cavm_mdbwx_err_stat1_s cnf95xxp1; */
...
static inline uint64_t CAVM_MDBWX_ERR_STAT1(uint64_t a)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && (a<=14))
        return 0x87e044002320ll + 0x4000ll * ((a) & 0xf);
    if (cavm_is_model(OCTEONTX_F95O) && (a<=42))
        return 0x87e044002320ll + 0x4000ll * ((a) & 0x3f);
...
static inline uint64_t CAVM_MDBWX_FATAL_ERROR_JCE_W0(uint64_t a)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && (a<=14))
        return 0x87e044000030ll + 0x4000ll * ((a) & 0xf);
    if (cavm_is_model(OCTEONTX_F95O) && (a<=42))
        return 0x87e044000030ll + 0x4000ll * ((a) & 0x3f);
...
static inline uint64_t CAVM_MDBWX_FATAL_ERROR_JCE_W1(uint64_t a)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && (a<=14))
        return 0x87e044000038ll + 0x4000ll * ((a) & 0xf);
    if (cavm_is_model(OCTEONTX_F95O) && (a<=42))
        return 0x87e044000038ll + 0x4000ll * ((a) & 0x3f);
...
static inline uint64_t CAVM_MDBWX_FYI(uint64_t a)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && (a<=14))
        return 0x87e044000100ll + 0x4000ll * ((a) & 0xf);
    if (cavm_is_model(OCTEONTX_F95O) && (a<=42))
        return 0x87e044000100ll + 0x4000ll * ((a) & 0x3f);
...
union cavm_mdbwx_jd_cfg
{
    ...
    /* struct cavm_mdbwx_jd_cfg_s cn9; */
    /* struct cavm_mdbwx_jd_cfg_s cnf95xxp1; */
    struct cavm_mdbwx_jd_cfg_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t addr_range_chk_ena    : 1;  /**< [ 63: 63](R/W) LLC/DRAM and SMEM address range check enable. */
        uint64_t ghb_throttle_dis      : 1;  /**< [ 62: 62](R/W) GHAB interface throttle disable. */
...
static inline uint64_t CAVM_MDBWX_JD_CFG(uint64_t a)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && (a<=14))
        return 0x87e044000008ll + 0x4000ll * ((a) & 0xf);
    if (cavm_is_model(OCTEONTX_F95O) && (a<=42))
        return 0x87e044000008ll + 0x4000ll * ((a) & 0x3f);
...
static inline uint64_t CAVM_MDBWX_JOB_COMPL_STAT(uint64_t a)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && (a<=14))
        return 0x87e044002308ll + 0x4000ll * ((a) & 0xf);
    if (cavm_is_model(OCTEONTX_F95O) && (a<=42))
        return 0x87e044002308ll + 0x4000ll * ((a) & 0x3f);
...
static inline uint64_t CAVM_MDBWX_JOB_DROP_STAT(uint64_t a)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && (a<=14))
        return 0x87e044002310ll + 0x4000ll * ((a) & 0xf);
    if (cavm_is_model(OCTEONTX_F95O) && (a<=42))
        return 0x87e044002310ll + 0x4000ll * ((a) & 0x3f);
...
static inline uint64_t CAVM_MDBWX_JOB_ENQUEUE_STAT(uint64_t a)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && (a<=14))
        return 0x87e044002300ll + 0x4000ll * ((a) & 0xf);
    if (cavm_is_model(OCTEONTX_F95O) && (a<=42))
        return 0x87e044002300ll + 0x4000ll * ((a) & 0x3f);
...
static inline uint64_t CAVM_MDBWX_JOBQX_CFG(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && ((a<=14) && (b<=1)))
        return 0x87e044000010ll + 0x4000ll * ((a) & 0xf) + 8ll * ((b) & 0x1);
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=42) && (b<=1)))
        return 0x87e044000010ll + 0x4000ll * ((a) & 0x3f) + 8ll * ((b) & 0x1);
...
static inline uint64_t CAVM_MDBWX_NON_FATAL_ERROR_JCE_W0(uint64_t a)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && (a<=14))
        return 0x87e044000040ll + 0x4000ll * ((a) & 0xf);
    if (cavm_is_model(OCTEONTX_F95O) && (a<=42))
        return 0x87e044000040ll + 0x4000ll * ((a) & 0x3f);
...
static inline uint64_t CAVM_MDBWX_NON_FATAL_ERROR_JCE_W1(uint64_t a)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && (a<=14))
        return 0x87e044000048ll + 0x4000ll * ((a) & 0xf);
    if (cavm_is_model(OCTEONTX_F95O) && (a<=42))
        return 0x87e044000048ll + 0x4000ll * ((a) & 0x3f);
...
union cavm_mdbwx_phymem_range
{
    ...
    /* struct cavm_mdbwx_phymem_range_s cn9; */
    /* struct cavm_mdbwx_phymem_range_s cnf95xxp1; */
    struct cavm_mdbwx_phymem_range_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_57_63        : 7;
...
static inline uint64_t CAVM_MDBWX_PHYMEM_RANGE(uint64_t a)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && (a<=14))
        return 0x87e044002410ll + 0x4000ll * ((a) & 0xf);
    if (cavm_is_model(OCTEONTX_F95O) && (a<=42))
        return 0x87e044002410ll + 0x4000ll * ((a) & 0x3f);
...
union cavm_mdbwx_sysmem_range_max
{
    ...
    /* struct cavm_mdbwx_sysmem_range_max_s cn9; */
    /* struct cavm_mdbwx_sysmem_range_max_s cnf95xxp1; */
    struct cavm_mdbwx_sysmem_range_max_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_53_63        : 11;
...
static inline uint64_t CAVM_MDBWX_SYSMEM_RANGE_MAX(uint64_t a)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && (a<=14))
        return 0x87e044002408ll + 0x4000ll * ((a) & 0xf);
    if (cavm_is_model(OCTEONTX_F95O) && (a<=42))
        return 0x87e044002408ll + 0x4000ll * ((a) & 0x3f);
...
union cavm_mdbwx_sysmem_range_min
{
    ...
    /* struct cavm_mdbwx_sysmem_range_min_s cn9; */
    /* struct cavm_mdbwx_sysmem_range_min_s cnf95xxp1; */
    struct cavm_mdbwx_sysmem_range_min_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_53_63        : 11;
...
static inline uint64_t CAVM_MDBWX_SYSMEM_RANGE_MIN(uint64_t a)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && (a<=14))
        return 0x87e044002400ll + 0x4000ll * ((a) & 0xf);
    if (cavm_is_model(OCTEONTX_F95O) && (a<=42))
        return 0x87e044002400ll + 0x4000ll * ((a) & 0x3f);
...
static inline uint64_t CAVM_MDBWX_TIMEOUT_JCE_W0(uint64_t a)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && (a<=14))
        return 0x87e044000050ll + 0x4000ll * ((a) & 0xf);
    if (cavm_is_model(OCTEONTX_F95O) && (a<=42))
        return 0x87e044000050ll + 0x4000ll * ((a) & 0x3f);
...
static inline uint64_t CAVM_MDBWX_TIMEOUT_JCE_W1(uint64_t a)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && (a<=14))
        return 0x87e044000058ll + 0x4000ll * ((a) & 0xf);
    if (cavm_is_model(OCTEONTX_F95O) && (a<=42))
        return 0x87e044000058ll + 0x4000ll * ((a) & 0x3f);
