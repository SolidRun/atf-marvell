...
union cavm_tdec_common_cfg_s
{
    ...
    /* struct cavm_tdec_common_cfg_s_s cn9; */
    /* struct cavm_tdec_common_cfg_s_s cnf95xxp1; */
    struct cavm_tdec_common_cfg_s_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
        uint64_t cfg_wrds_per_task     : 8;  /**< [ 31: 24] The number of job configuration words for each task. This field must
...
union cavm_tdec_harq_hdr_s
{
    ...
    /* struct cavm_tdec_harq_hdr_s_s cn9; */
    /* struct cavm_tdec_harq_hdr_s_s cnf95xxp1; */
    struct cavm_tdec_harq_hdr_s_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_52_63        : 12;
        uint64_t hc_e                  : 20; /**< [ 51: 32] Number of HARQ LLRs in the input/output. */
...
union cavm_tdec_lte_task_cfg_s
{
    ...
    struct cavm_tdec_lte_task_cfg_s_s
    {
        ...
        uint64_t byps_llr_negate       : 1;  /**< [104:104] When set to 1, bypasse LLR negation. */
        ...
        uint64_t k0_p                  : 16; /**< [159:144] The bit offset in the pruned virtual circular buffer for the first
                                                                 CB. This value must be in the range [0,3x[FIRST_CB_SIZE] + 12 -
                                                                 2x[FILLER] - 1]. */
        ...
        uint64_t byps_bs_so            : 1;  /**< [224:224] When set to 1, bypass bit selection and NULL bit
                                                                 ...
                                                                 Note this valid only in per-CB mode (when [BYPS_TB_PROC] = 1). */
    ...
    /* struct cavm_tdec_lte_task_cfg_s_s cn9; */
    /* struct cavm_tdec_lte_task_cfg_s_s cnf95xxp1; */
    struct cavm_tdec_lte_task_cfg_s_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t payload               : 20; /**< [ 63: 44] The number of bits in the decoded transport block payload, not including the
        ...
        uint64_t reserved_238_239      : 2;
        uint64_t half_it_so            : 6;  /**< [237:232] The number of half iterations performed prior to producing the
                                                                 soft-bit output. When [SO_SEL] = 1, this value must be an even number greater than zero
                                                                 and must be less than or equal to [HALF_IT].

                                                                 Do not set [HALF_IT_SO] = 0. This value causes the TC core to return a fatal error
                                                                 with the error bit INVALID_HALF_IT_SO = 1 even if SO is not enabled. */
        uint64_t half_it               : 6;  /**< [231:226] The number of half iterations for CTC decoding.  This value must
                                                                 be even. */
        uint64_t reserved_225          : 1;
        uint64_t byps_bs_so            : 1;  /**< [224:224] When set to 1, bypass bit selection and NULL bit
    ...
    /* struct cavm_tdec_lte_task_cfg_s_cnf95xxp2 loki; */
};
...
static inline uint64_t CAVM_TDECX_HAB_JCFG0_RAMX_DATA(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=2) && (b<=255)))
        return 0x87e043602000ll + 0x8000ll * ((a) & 0x3) + 8ll * ((b) & 0xff);
...
union cavm_tdecx_tc_config_err_flags_reg
{
    ...
    /* struct cavm_tdecx_tc_config_err_flags_reg_s cn9; */
    /* struct cavm_tdecx_tc_config_err_flags_reg_s cnf95xxp1; */
    struct cavm_tdecx_tc_config_err_flags_reg_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_53_63        : 11;
        uint64_t invalid_bypass_scrambling : 1;/**< [ 52: 52](RO/H) Reserved.
...
union cavm_tdecx_tc_error_reg
{
    ...
    struct cavm_tdecx_tc_error_reg_s
    {
        ...
        uint64_t hcout_int_err         : 1;  /**< [ 19: 19](R/W1/H) HARQ output internal error due to insufficient data.  Write 1 to toggle. */
        uint64_t hcin_input_err        : 1;  /**< [ 18: 18](R/W1/H) HARQ input error due to one or more missing CB.  Write 1 to toggle. */
        uint64_t hcin_size_err         : 1;  /**< [ 17: 17](R/W1/H) HARQ input size error.  Write 1 to toggle. */
        uint64_t reserved_9_16         : 8;
        uint64_t inv_cfg               : 1;  /**< [  8:  8](R/W1/H) Invalid task configuration -- aborted job.  Further information is
                                                                 captured in TDEC(0..1)_TC_CONFIG_ERR_FLAGS_REG.  Write 1 to toggle. */
        uint64_t reg_mask_err          : 4;  /**< [  7:  4](RAZ) Reserved. */
        uint64_t ign_read              : 1;  /**< [  3:  3](R/W1/H) Ignored read access error -- one already in progress.  Write 1 to toggle. */
        uint64_t inv_read              : 1;  /**< [  2:  2](R/W1/H) Invalid read access error.  Write 1 to toggle. */
        uint64_t inv_write             : 1;  /**< [  1:  1](R/W1/H) Invalid write access error.  Write 1 to toggle. */
        uint64_t inv_start             : 1;  /**< [  0:  0](R/W1/H) Invalid start task error.  Write 1 to toggle. */
#else /* Word 0 - Little Endian */
        uint64_t inv_start             : 1;  /**< [  0:  0](R/W1/H) Invalid start task error.  Write 1 to toggle. */
        uint64_t inv_write             : 1;  /**< [  1:  1](R/W1/H) Invalid write access error.  Write 1 to toggle. */
        uint64_t inv_read              : 1;  /**< [  2:  2](R/W1/H) Invalid read access error.  Write 1 to toggle. */
    ...
    /* struct cavm_tdecx_tc_error_reg_s cn9; */
    /* struct cavm_tdecx_tc_error_reg_s cnf95xxp1; */
    struct cavm_tdecx_tc_error_reg_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_20_63        : 44;
...
union cavm_tdecx_tc_main_reset_reg
{
    ...
    struct cavm_tdecx_tc_main_reset_reg_s
    {
        ...
        uint64_t soft_reset            : 1;  /**< [  0:  0](R/W) Reset bit.  Write any value to reset the TDEC decoder core. */
#else /* Word 0 - Little Endian */
        uint64_t soft_reset            : 1;  /**< [  0:  0](R/W) Reset bit.  Write any value to reset the TDEC decoder core. */
        uint64_t reserved_1_63         : 63;
#endif /* Word 0 - End */
    } s;
    /* struct cavm_tdecx_tc_main_reset_reg_s cn9; */
    /* struct cavm_tdecx_tc_main_reset_reg_s cnf95xxp1; */
    struct cavm_tdecx_tc_main_reset_reg_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
...
union cavm_tdecx_tc_status0_reg
{
    ...
    /* struct cavm_tdecx_tc_status0_reg_s cnf95xxp1; */
