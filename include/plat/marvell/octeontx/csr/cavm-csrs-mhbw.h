...
union cavm_mhbw_jd_dma_cfg_word_2_s
{
    ...
    /* struct cavm_mhbw_jd_dma_cfg_word_2_s_s cn9; */
    /* struct cavm_mhbw_jd_dma_cfg_word_2_s_s cnf95xxp1; */
    struct cavm_mhbw_jd_dma_cfg_word_2_s_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t stride                : 32; /**< [ 63: 32] Signed distance in bytes between the start of consecutive blocks of 2D
                                                                 DMA. Must be two's complement value in the range ABS([STRIDE]) \< 128
...
union cavm_mhbw_jd_dma_cfg_word_3_s
{
    ...
    /* struct cavm_mhbw_jd_dma_cfg_word_3_s_s cn9; */
    /* struct cavm_mhbw_jd_dma_cfg_word_3_s_s cnf95xxp1; */
    struct cavm_mhbw_jd_dma_cfg_word_3_s_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
union cavm_mhbw_jd_hdr_word_0_s
{
    ...
    /* struct cavm_mhbw_jd_hdr_word_0_s_s cn9; */
    /* struct cavm_mhbw_jd_hdr_word_0_s_s cnf95xxp1; */
    struct cavm_mhbw_jd_hdr_word_0_s_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_61_63        : 3;
        uint64_t toth                  : 4;  /**< [ 60: 57] Job timeout threshold. The timeout timer starts counting when the job
...
static inline uint64_t CAVM_MHBWX_ABX_PORT_HP(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=28) && (b<=2)))
        return 0x87e043023000ll + 0x80000ll * ((a) & 0x1f) + 0x40ll * ((b) & 0x3);
    if (cavm_is_model(OCTEONTX_LOKI) && ((a<=28) && (b<=2)))
        return 0x87e043023000ll + 0x80000ll * ((a) & 0x1f) + 0x40ll * ((b) & 0x3);
...
static inline uint64_t CAVM_MHBWX_ABX_SLTX_CP_FAT_JTAG(uint64_t a, uint64_t b, uint64_t c)
{
    ...
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=28) && (b<=2) && (c<=2)))
        return 0x87e043022000ll + 0x80000ll * ((a) & 0x1f) + 0x40ll * ((b) & 0x3) + 0x10ll * ((c) & 0x3);
    if (cavm_is_model(OCTEONTX_LOKI) && ((a<=28) && (b<=2) && (c<=2)))
        return 0x87e043022000ll + 0x80000ll * ((a) & 0x1f) + 0x40ll * ((b) & 0x3) + 0x10ll * ((c) & 0x3);
...
union cavm_mhbwx_abx_sltx_derr_ena_w1c
{
    ...
    /* struct cavm_mhbwx_abx_sltx_derr_ena_w1c_s cn9; */
    /* struct cavm_mhbwx_abx_sltx_derr_ena_w1c_s cnf95xx; */
    struct cavm_mhbwx_abx_sltx_derr_ena_w1c_f95mm
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
    ...
    struct cavm_mhbwx_abx_sltx_derr_ena_w1c_f95o
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
        uint64_t wr_dma_uflow_port3    : 1;  /**< [ 15: 15](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[WR_DMA_UFLOW_PORT3]. */
        uint64_t wr_dma_uflow_port2    : 1;  /**< [ 14: 14](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[WR_DMA_UFLOW_PORT2]. */
        uint64_t wr_dma_uflow_port1    : 1;  /**< [ 13: 13](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[WR_DMA_UFLOW_PORT1]. */
        uint64_t wr_dma_uflow_port0    : 1;  /**< [ 12: 12](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[WR_DMA_UFLOW_PORT0]. */
        uint64_t wr_dma_oflow_port3    : 1;  /**< [ 11: 11](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[WR_DMA_OFLOW_PORT3]. */
        uint64_t wr_dma_oflow_port2    : 1;  /**< [ 10: 10](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[WR_DMA_OFLOW_PORT2]. */
        uint64_t wr_dma_oflow_port1    : 1;  /**< [  9:  9](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[WR_DMA_OFLOW_PORT1]. */
        uint64_t wr_dma_oflow_port0    : 1;  /**< [  8:  8](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[WR_DMA_OFLOW_PORT0]. */
        uint64_t rd_dma_uflow_port3    : 1;  /**< [  7:  7](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_UFLOW_PORT3]. */
        uint64_t rd_dma_uflow_port2    : 1;  /**< [  6:  6](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_UFLOW_PORT2]. */
        uint64_t rd_dma_uflow_port1    : 1;  /**< [  5:  5](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_UFLOW_PORT1]. */
        uint64_t rd_dma_uflow_port0    : 1;  /**< [  4:  4](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_UFLOW_PORT0]. */
        uint64_t rd_dma_oflow_port3    : 1;  /**< [  3:  3](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_OFLOW_PORT3]. */
        uint64_t rd_dma_oflow_port2    : 1;  /**< [  2:  2](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_OFLOW_PORT2]. */
        uint64_t rd_dma_oflow_port1    : 1;  /**< [  1:  1](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_OFLOW_PORT1]. */
        uint64_t rd_dma_oflow_port0    : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_OFLOW_PORT0]. */
#else /* Word 0 - Little Endian */
        uint64_t rd_dma_oflow_port0    : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_OFLOW_PORT0]. */
        uint64_t rd_dma_oflow_port1    : 1;  /**< [  1:  1](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_OFLOW_PORT1]. */
        uint64_t rd_dma_oflow_port2    : 1;  /**< [  2:  2](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_OFLOW_PORT2]. */
    ...
    /* struct cavm_mhbwx_abx_sltx_derr_ena_w1c_f95o loki; */
};
...
union cavm_mhbwx_abx_sltx_derr_ena_w1s
{
    ...
    /* struct cavm_mhbwx_abx_sltx_derr_ena_w1s_s cn9; */
    /* struct cavm_mhbwx_abx_sltx_derr_ena_w1s_s cnf95xx; */
    struct cavm_mhbwx_abx_sltx_derr_ena_w1s_f95mm
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
    ...
    struct cavm_mhbwx_abx_sltx_derr_ena_w1s_f95o
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
        uint64_t wr_dma_uflow_port3    : 1;  /**< [ 15: 15](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[WR_DMA_UFLOW_PORT3]. */
        uint64_t wr_dma_uflow_port2    : 1;  /**< [ 14: 14](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[WR_DMA_UFLOW_PORT2]. */
        uint64_t wr_dma_uflow_port1    : 1;  /**< [ 13: 13](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[WR_DMA_UFLOW_PORT1]. */
        uint64_t wr_dma_uflow_port0    : 1;  /**< [ 12: 12](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[WR_DMA_UFLOW_PORT0]. */
        uint64_t wr_dma_oflow_port3    : 1;  /**< [ 11: 11](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[WR_DMA_OFLOW_PORT3]. */
        uint64_t wr_dma_oflow_port2    : 1;  /**< [ 10: 10](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[WR_DMA_OFLOW_PORT2]. */
        uint64_t wr_dma_oflow_port1    : 1;  /**< [  9:  9](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[WR_DMA_OFLOW_PORT1]. */
        uint64_t wr_dma_oflow_port0    : 1;  /**< [  8:  8](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[WR_DMA_OFLOW_PORT0]. */
        uint64_t rd_dma_uflow_port3    : 1;  /**< [  7:  7](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_UFLOW_PORT3]. */
        uint64_t rd_dma_uflow_port2    : 1;  /**< [  6:  6](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_UFLOW_PORT2]. */
        uint64_t rd_dma_uflow_port1    : 1;  /**< [  5:  5](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_UFLOW_PORT1]. */
        uint64_t rd_dma_uflow_port0    : 1;  /**< [  4:  4](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_UFLOW_PORT0]. */
        uint64_t rd_dma_oflow_port3    : 1;  /**< [  3:  3](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_OFLOW_PORT3]. */
        uint64_t rd_dma_oflow_port2    : 1;  /**< [  2:  2](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_OFLOW_PORT2]. */
        uint64_t rd_dma_oflow_port1    : 1;  /**< [  1:  1](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_OFLOW_PORT1]. */
        uint64_t rd_dma_oflow_port0    : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_OFLOW_PORT0]. */
#else /* Word 0 - Little Endian */
        uint64_t rd_dma_oflow_port0    : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_OFLOW_PORT0]. */
        uint64_t rd_dma_oflow_port1    : 1;  /**< [  1:  1](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_OFLOW_PORT1]. */
        uint64_t rd_dma_oflow_port2    : 1;  /**< [  2:  2](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_OFLOW_PORT2]. */
    ...
    /* struct cavm_mhbwx_abx_sltx_derr_ena_w1s_f95o loki; */
};
 ...
 * (MHBW(0..28)). Note that registers only exist for the number of HABs and
...
union cavm_mhbwx_abx_sltx_derr_int_w1s
{
    ...
    /* struct cavm_mhbwx_abx_sltx_derr_int_w1s_s cn9; */
    /* struct cavm_mhbwx_abx_sltx_derr_int_w1s_s cnf95xx; */
    struct cavm_mhbwx_abx_sltx_derr_int_w1s_f95mm
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
    ...
    struct cavm_mhbwx_abx_sltx_derr_int_w1s_f95o
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
        uint64_t wr_dma_uflow_port3    : 1;  /**< [ 15: 15](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[WR_DMA_UFLOW_PORT3]. */
        uint64_t wr_dma_uflow_port2    : 1;  /**< [ 14: 14](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[WR_DMA_UFLOW_PORT2]. */
        uint64_t wr_dma_uflow_port1    : 1;  /**< [ 13: 13](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[WR_DMA_UFLOW_PORT1]. */
        uint64_t wr_dma_uflow_port0    : 1;  /**< [ 12: 12](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[WR_DMA_UFLOW_PORT0]. */
        uint64_t wr_dma_oflow_port3    : 1;  /**< [ 11: 11](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[WR_DMA_OFLOW_PORT3]. */
        uint64_t wr_dma_oflow_port2    : 1;  /**< [ 10: 10](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[WR_DMA_OFLOW_PORT2]. */
        uint64_t wr_dma_oflow_port1    : 1;  /**< [  9:  9](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[WR_DMA_OFLOW_PORT1]. */
        uint64_t wr_dma_oflow_port0    : 1;  /**< [  8:  8](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[WR_DMA_OFLOW_PORT0]. */
        uint64_t rd_dma_uflow_port3    : 1;  /**< [  7:  7](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_UFLOW_PORT3]. */
        uint64_t rd_dma_uflow_port2    : 1;  /**< [  6:  6](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_UFLOW_PORT2]. */
        uint64_t rd_dma_uflow_port1    : 1;  /**< [  5:  5](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_UFLOW_PORT1]. */
        uint64_t rd_dma_uflow_port0    : 1;  /**< [  4:  4](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_UFLOW_PORT0]. */
        uint64_t rd_dma_oflow_port3    : 1;  /**< [  3:  3](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_OFLOW_PORT3]. */
        uint64_t rd_dma_oflow_port2    : 1;  /**< [  2:  2](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_OFLOW_PORT2]. */
        uint64_t rd_dma_oflow_port1    : 1;  /**< [  1:  1](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_OFLOW_PORT1]. */
        uint64_t rd_dma_oflow_port0    : 1;  /**< [  0:  0](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_OFLOW_PORT0]. */
#else /* Word 0 - Little Endian */
        uint64_t rd_dma_oflow_port0    : 1;  /**< [  0:  0](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_OFLOW_PORT0]. */
        uint64_t rd_dma_oflow_port1    : 1;  /**< [  1:  1](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_OFLOW_PORT1]. */
        uint64_t rd_dma_oflow_port2    : 1;  /**< [  2:  2](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_DERR_INT[RD_DMA_OFLOW_PORT2]. */
    ...
    /* struct cavm_mhbwx_abx_sltx_derr_int_w1s_f95o loki; */
};
...
union cavm_mhbwx_abx_sltx_fat_err_ena_w1c
{
    ...
    /* struct cavm_mhbwx_abx_sltx_fat_err_ena_w1c_s cn9; */
    struct cavm_mhbwx_abx_sltx_fat_err_ena_w1c_cnf95xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
        uint64_t ab                    : 1;  /**< [ 18: 18](R/W1C/H) Reads or clears enable for MHBW(0..27)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[AB]. */
    ...
    struct cavm_mhbwx_abx_sltx_fat_err_ena_w1c_f95mm
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
    ...
    struct cavm_mhbwx_abx_sltx_fat_err_ena_w1c_f95o
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
        uint64_t ab                    : 1;  /**< [ 18: 18](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[AB]. */
        uint64_t jd_fetch              : 1;  /**< [ 17: 17](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[JD_FETCH]. */
        uint64_t job_sd_fetch          : 1;  /**< [ 16: 16](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[JOB_SD_FETCH]. */
        uint64_t reserved_13_15        : 3;
        uint64_t reserved_12           : 1;
        uint64_t wr_dma_port3          : 1;  /**< [ 11: 11](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[WR_DMA_PORT3]. */
        uint64_t wr_dma_port2          : 1;  /**< [ 10: 10](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[WR_DMA_PORT2]. */
        uint64_t wr_dma_port1          : 1;  /**< [  9:  9](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[WR_DMA_PORT1]. */
        uint64_t wr_dma_port0          : 1;  /**< [  8:  8](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[WR_DMA_PORT0]. */
        uint64_t reserved_4_7          : 4;
        uint64_t rd_dma_port3          : 1;  /**< [  3:  3](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[RD_DMA_PORT3]. */
        uint64_t rd_dma_port2          : 1;  /**< [  2:  2](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[RD_DMA_PORT2]. */
        uint64_t rd_dma_port1          : 1;  /**< [  1:  1](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[RD_DMA_PORT1]. */
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[RD_DMA_PORT0]. */
#else /* Word 0 - Little Endian */
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[RD_DMA_PORT0]. */
        uint64_t rd_dma_port1          : 1;  /**< [  1:  1](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[RD_DMA_PORT1]. */
        uint64_t rd_dma_port2          : 1;  /**< [  2:  2](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[RD_DMA_PORT2]. */
    ...
    /* struct cavm_mhbwx_abx_sltx_fat_err_ena_w1c_f95o loki; */
};
...
union cavm_mhbwx_abx_sltx_fat_err_ena_w1s
{
    ...
    /* struct cavm_mhbwx_abx_sltx_fat_err_ena_w1s_s cn9; */
    struct cavm_mhbwx_abx_sltx_fat_err_ena_w1s_cnf95xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
        uint64_t ab                    : 1;  /**< [ 18: 18](R/W1S/H) Reads or sets enable for MHBW(0..27)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[AB]. */
    ...
    struct cavm_mhbwx_abx_sltx_fat_err_ena_w1s_f95mm
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
    ...
    struct cavm_mhbwx_abx_sltx_fat_err_ena_w1s_f95o
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
        uint64_t ab                    : 1;  /**< [ 18: 18](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[AB]. */
        uint64_t jd_fetch              : 1;  /**< [ 17: 17](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[JD_FETCH]. */
        uint64_t job_sd_fetch          : 1;  /**< [ 16: 16](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[JOB_SD_FETCH]. */
        uint64_t reserved_13_15        : 3;
        uint64_t reserved_12           : 1;
        uint64_t wr_dma_port3          : 1;  /**< [ 11: 11](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[WR_DMA_PORT3]. */
        uint64_t wr_dma_port2          : 1;  /**< [ 10: 10](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[WR_DMA_PORT2]. */
        uint64_t wr_dma_port1          : 1;  /**< [  9:  9](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[WR_DMA_PORT1]. */
        uint64_t wr_dma_port0          : 1;  /**< [  8:  8](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[WR_DMA_PORT0]. */
        uint64_t reserved_4_7          : 4;
        uint64_t rd_dma_port3          : 1;  /**< [  3:  3](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[RD_DMA_PORT3]. */
        uint64_t rd_dma_port2          : 1;  /**< [  2:  2](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[RD_DMA_PORT2]. */
        uint64_t rd_dma_port1          : 1;  /**< [  1:  1](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[RD_DMA_PORT1]. */
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[RD_DMA_PORT0]. */
#else /* Word 0 - Little Endian */
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[RD_DMA_PORT0]. */
        uint64_t rd_dma_port1          : 1;  /**< [  1:  1](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[RD_DMA_PORT1]. */
        uint64_t rd_dma_port2          : 1;  /**< [  2:  2](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[RD_DMA_PORT2]. */
    ...
    /* struct cavm_mhbwx_abx_sltx_fat_err_ena_w1s_f95o loki; */
};
...
union cavm_mhbwx_abx_sltx_fat_err_int_w1s
{
    ...
    /* struct cavm_mhbwx_abx_sltx_fat_err_int_w1s_s cn9; */
    struct cavm_mhbwx_abx_sltx_fat_err_int_w1s_cnf95xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
        uint64_t ab                    : 1;  /**< [ 18: 18](R/W1S/H) Reads or sets MHBW(0..27)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[AB]. */
    ...
    struct cavm_mhbwx_abx_sltx_fat_err_int_w1s_f95mm
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
    ...
    struct cavm_mhbwx_abx_sltx_fat_err_int_w1s_f95o
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
        uint64_t ab                    : 1;  /**< [ 18: 18](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[AB]. */
        uint64_t jd_fetch              : 1;  /**< [ 17: 17](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[JD_FETCH]. */
        uint64_t job_sd_fetch          : 1;  /**< [ 16: 16](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[JOB_SD_FETCH]. */
        uint64_t reserved_13_15        : 3;
        uint64_t reserved_12           : 1;
        uint64_t wr_dma_port3          : 1;  /**< [ 11: 11](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[WR_DMA_PORT3]. */
        uint64_t wr_dma_port2          : 1;  /**< [ 10: 10](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[WR_DMA_PORT2]. */
        uint64_t wr_dma_port1          : 1;  /**< [  9:  9](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[WR_DMA_PORT1]. */
        uint64_t wr_dma_port0          : 1;  /**< [  8:  8](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[WR_DMA_PORT0]. */
        uint64_t reserved_4_7          : 4;
        uint64_t rd_dma_port3          : 1;  /**< [  3:  3](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[RD_DMA_PORT3]. */
        uint64_t rd_dma_port2          : 1;  /**< [  2:  2](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[RD_DMA_PORT2]. */
        uint64_t rd_dma_port1          : 1;  /**< [  1:  1](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[RD_DMA_PORT1]. */
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[RD_DMA_PORT0]. */
#else /* Word 0 - Little Endian */
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[RD_DMA_PORT0]. */
        uint64_t rd_dma_port1          : 1;  /**< [  1:  1](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[RD_DMA_PORT1]. */
        uint64_t rd_dma_port2          : 1;  /**< [  2:  2](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_FAT_ERR_INT[RD_DMA_PORT2]. */
    ...
    /* struct cavm_mhbwx_abx_sltx_fat_err_int_w1s_f95o loki; */
};
...
union cavm_mhbwx_abx_sltx_nfat_err_ena_w1c
{
    ...
    /* struct cavm_mhbwx_abx_sltx_nfat_err_ena_w1c_s cn9; */
    struct cavm_mhbwx_abx_sltx_nfat_err_ena_w1c_cnf95xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
        uint64_t ab                    : 1;  /**< [ 18: 18](R/W1C/H) Reads or clears enable for MHBW(0..27)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[AB]. */
    ...
    struct cavm_mhbwx_abx_sltx_nfat_err_ena_w1c_f95mm
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
    ...
    struct cavm_mhbwx_abx_sltx_nfat_err_ena_w1c_f95o
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
        uint64_t ab                    : 1;  /**< [ 18: 18](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[AB]. */
        uint64_t jd_fetch              : 1;  /**< [ 17: 17](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[JD_FETCH]. */
        uint64_t job_sd_fetch          : 1;  /**< [ 16: 16](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[JOB_SD_FETCH]. */
        uint64_t reserved_13_15        : 3;
        uint64_t reserved_12           : 1;
        uint64_t wr_dma_port3          : 1;  /**< [ 11: 11](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[WR_DMA_PORT3]. */
        uint64_t wr_dma_port2          : 1;  /**< [ 10: 10](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[WR_DMA_PORT2]. */
        uint64_t wr_dma_port1          : 1;  /**< [  9:  9](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[WR_DMA_PORT1]. */
        uint64_t wr_dma_port0          : 1;  /**< [  8:  8](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[WR_DMA_PORT0]. */
        uint64_t reserved_4_7          : 4;
        uint64_t rd_dma_port3          : 1;  /**< [  3:  3](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[RD_DMA_PORT3]. */
        uint64_t rd_dma_port2          : 1;  /**< [  2:  2](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[RD_DMA_PORT2]. */
        uint64_t rd_dma_port1          : 1;  /**< [  1:  1](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[RD_DMA_PORT1]. */
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[RD_DMA_PORT0]. */
#else /* Word 0 - Little Endian */
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[RD_DMA_PORT0]. */
        uint64_t rd_dma_port1          : 1;  /**< [  1:  1](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[RD_DMA_PORT1]. */
        uint64_t rd_dma_port2          : 1;  /**< [  2:  2](R/W1C/H) Reads or clears enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[RD_DMA_PORT2]. */
    ...
    /* struct cavm_mhbwx_abx_sltx_nfat_err_ena_w1c_f95o loki; */
};
...
union cavm_mhbwx_abx_sltx_nfat_err_ena_w1s
{
    ...
    /* struct cavm_mhbwx_abx_sltx_nfat_err_ena_w1s_s cn9; */
    struct cavm_mhbwx_abx_sltx_nfat_err_ena_w1s_cnf95xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
        uint64_t ab                    : 1;  /**< [ 18: 18](R/W1S/H) Reads or sets enable for MHBW(0..27)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[AB]. */
    ...
    struct cavm_mhbwx_abx_sltx_nfat_err_ena_w1s_f95mm
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
    ...
    struct cavm_mhbwx_abx_sltx_nfat_err_ena_w1s_f95o
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
        uint64_t ab                    : 1;  /**< [ 18: 18](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[AB]. */
        uint64_t jd_fetch              : 1;  /**< [ 17: 17](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[JD_FETCH]. */
        uint64_t job_sd_fetch          : 1;  /**< [ 16: 16](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[JOB_SD_FETCH]. */
        uint64_t reserved_13_15        : 3;
        uint64_t reserved_12           : 1;
        uint64_t wr_dma_port3          : 1;  /**< [ 11: 11](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[WR_DMA_PORT3]. */
        uint64_t wr_dma_port2          : 1;  /**< [ 10: 10](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[WR_DMA_PORT2]. */
        uint64_t wr_dma_port1          : 1;  /**< [  9:  9](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[WR_DMA_PORT1]. */
        uint64_t wr_dma_port0          : 1;  /**< [  8:  8](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[WR_DMA_PORT0]. */
        uint64_t reserved_4_7          : 4;
        uint64_t rd_dma_port3          : 1;  /**< [  3:  3](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[RD_DMA_PORT3]. */
        uint64_t rd_dma_port2          : 1;  /**< [  2:  2](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[RD_DMA_PORT2]. */
        uint64_t rd_dma_port1          : 1;  /**< [  1:  1](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[RD_DMA_PORT1]. */
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[RD_DMA_PORT0]. */
#else /* Word 0 - Little Endian */
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[RD_DMA_PORT0]. */
        uint64_t rd_dma_port1          : 1;  /**< [  1:  1](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[RD_DMA_PORT1]. */
        uint64_t rd_dma_port2          : 1;  /**< [  2:  2](R/W1S/H) Reads or sets enable for MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[RD_DMA_PORT2]. */
    ...
    /* struct cavm_mhbwx_abx_sltx_nfat_err_ena_w1s_f95o loki; */
};
...
union cavm_mhbwx_abx_sltx_nfat_err_int_w1s
{
    ...
    /* struct cavm_mhbwx_abx_sltx_nfat_err_int_w1s_s cn9; */
    struct cavm_mhbwx_abx_sltx_nfat_err_int_w1s_cnf95xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
        uint64_t ab                    : 1;  /**< [ 18: 18](R/W1S/H) Reads or sets MHBW(0..27)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[AB]. */
    ...
    struct cavm_mhbwx_abx_sltx_nfat_err_int_w1s_f95mm
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
    ...
    struct cavm_mhbwx_abx_sltx_nfat_err_int_w1s_f95o
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
        uint64_t ab                    : 1;  /**< [ 18: 18](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[AB]. */
        uint64_t jd_fetch              : 1;  /**< [ 17: 17](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[JD_FETCH]. */
        uint64_t job_sd_fetch          : 1;  /**< [ 16: 16](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[JOB_SD_FETCH]. */
        uint64_t reserved_13_15        : 3;
        uint64_t reserved_12           : 1;
        uint64_t wr_dma_port3          : 1;  /**< [ 11: 11](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[WR_DMA_PORT3]. */
        uint64_t wr_dma_port2          : 1;  /**< [ 10: 10](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[WR_DMA_PORT2]. */
        uint64_t wr_dma_port1          : 1;  /**< [  9:  9](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[WR_DMA_PORT1]. */
        uint64_t wr_dma_port0          : 1;  /**< [  8:  8](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[WR_DMA_PORT0]. */
        uint64_t reserved_4_7          : 4;
        uint64_t rd_dma_port3          : 1;  /**< [  3:  3](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[RD_DMA_PORT3]. */
        uint64_t rd_dma_port2          : 1;  /**< [  2:  2](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[RD_DMA_PORT2]. */
        uint64_t rd_dma_port1          : 1;  /**< [  1:  1](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[RD_DMA_PORT1]. */
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[RD_DMA_PORT0]. */
#else /* Word 0 - Little Endian */
        uint64_t rd_dma_port0          : 1;  /**< [  0:  0](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[RD_DMA_PORT0]. */
        uint64_t rd_dma_port1          : 1;  /**< [  1:  1](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[RD_DMA_PORT1]. */
        uint64_t rd_dma_port2          : 1;  /**< [  2:  2](R/W1S/H) Reads or sets MHBW(0..28)_AB(0..2)_SLT(0..2)_NFAT_ERR_INT[RD_DMA_PORT2]. */
    ...
    /* struct cavm_mhbwx_abx_sltx_nfat_err_int_w1s_f95o loki; */
};
...
union cavm_mhbwx_adr_err_ena_w1c
{
    ...
    /* struct cavm_mhbwx_adr_err_ena_w1c_s cn9; */
    /* struct cavm_mhbwx_adr_err_ena_w1c_s cnf95xx; */
    struct cavm_mhbwx_adr_err_ena_w1c_f95mm
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_4_63         : 60;
    ...
    struct cavm_mhbwx_adr_err_ena_w1c_f95o
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_4_63         : 60;
        uint64_t gaa_wr_nxm_err        : 1;  /**< [  3:  3](R/W1C/H) Reads or clears enable for MHBW(0..28)_ADR_ERR_INT[GAA_WR_NXM_ERR]. */
        uint64_t gaa_rd_nxm_err        : 1;  /**< [  2:  2](R/W1C/H) Reads or clears enable for MHBW(0..28)_ADR_ERR_INT[GAA_RD_NXM_ERR]. */
        uint64_t ddr_range_err         : 1;  /**< [  1:  1](R/W1C/H) Reads or clears enable for MHBW(0..28)_ADR_ERR_INT[DDR_RANGE_ERR]. */
        uint64_t smem_range_err        : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for MHBW(0..28)_ADR_ERR_INT[SMEM_RANGE_ERR]. */
#else /* Word 0 - Little Endian */
        uint64_t smem_range_err        : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for MHBW(0..28)_ADR_ERR_INT[SMEM_RANGE_ERR]. */
        uint64_t ddr_range_err         : 1;  /**< [  1:  1](R/W1C/H) Reads or clears enable for MHBW(0..28)_ADR_ERR_INT[DDR_RANGE_ERR]. */
        uint64_t gaa_rd_nxm_err        : 1;  /**< [  2:  2](R/W1C/H) Reads or clears enable for MHBW(0..28)_ADR_ERR_INT[GAA_RD_NXM_ERR]. */
    ...
    /* struct cavm_mhbwx_adr_err_ena_w1c_f95o loki; */
};
...
static inline uint64_t CAVM_MHBWX_ADR_ERR_ENA_W1C(uint64_t a)
{
    ...
    if (cavm_is_model(OCTEONTX_F95O) && (a<=28))
        return 0x87e043020d10ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=28))
        return 0x87e043020d10ll + 0x80000ll * ((a) & 0x1f);
...
union cavm_mhbwx_adr_err_ena_w1s
{
    ...
    /* struct cavm_mhbwx_adr_err_ena_w1s_s cn9; */
    /* struct cavm_mhbwx_adr_err_ena_w1s_s cnf95xx; */
    struct cavm_mhbwx_adr_err_ena_w1s_f95mm
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_4_63         : 60;
    ...
    struct cavm_mhbwx_adr_err_ena_w1s_f95o
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_4_63         : 60;
        uint64_t gaa_wr_nxm_err        : 1;  /**< [  3:  3](R/W1S/H) Reads or sets enable for MHBW(0..28)_ADR_ERR_INT[GAA_WR_NXM_ERR]. */
        uint64_t gaa_rd_nxm_err        : 1;  /**< [  2:  2](R/W1S/H) Reads or sets enable for MHBW(0..28)_ADR_ERR_INT[GAA_RD_NXM_ERR]. */
        uint64_t ddr_range_err         : 1;  /**< [  1:  1](R/W1S/H) Reads or sets enable for MHBW(0..28)_ADR_ERR_INT[DDR_RANGE_ERR]. */
        uint64_t smem_range_err        : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for MHBW(0..28)_ADR_ERR_INT[SMEM_RANGE_ERR]. */
#else /* Word 0 - Little Endian */
        uint64_t smem_range_err        : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for MHBW(0..28)_ADR_ERR_INT[SMEM_RANGE_ERR]. */
        uint64_t ddr_range_err         : 1;  /**< [  1:  1](R/W1S/H) Reads or sets enable for MHBW(0..28)_ADR_ERR_INT[DDR_RANGE_ERR]. */
        uint64_t gaa_rd_nxm_err        : 1;  /**< [  2:  2](R/W1S/H) Reads or sets enable for MHBW(0..28)_ADR_ERR_INT[GAA_RD_NXM_ERR]. */
    ...
    /* struct cavm_mhbwx_adr_err_ena_w1s_f95o loki; */
};
...
union cavm_mhbwx_adr_err_int
{
    ...
    /* struct cavm_mhbwx_adr_err_int_s cn9; */
    /* struct cavm_mhbwx_adr_err_int_s cnf95xxp1; */
    struct cavm_mhbwx_adr_err_int_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_4_63         : 60;
...
union cavm_mhbwx_adr_err_int_w1s
{
    ...
    /* struct cavm_mhbwx_adr_err_int_w1s_s cn9; */
    /* struct cavm_mhbwx_adr_err_int_w1s_s cnf95xx; */
    struct cavm_mhbwx_adr_err_int_w1s_f95mm
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_4_63         : 60;
    ...
    struct cavm_mhbwx_adr_err_int_w1s_f95o
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_4_63         : 60;
        uint64_t gaa_wr_nxm_err        : 1;  /**< [  3:  3](R/W1S/H) Reads or sets MHBW(0..28)_ADR_ERR_INT[GAA_WR_NXM_ERR]. */
        uint64_t gaa_rd_nxm_err        : 1;  /**< [  2:  2](R/W1S/H) Reads or sets MHBW(0..28)_ADR_ERR_INT[GAA_RD_NXM_ERR]. */
        uint64_t ddr_range_err         : 1;  /**< [  1:  1](R/W1S/H) Reads or sets MHBW(0..28)_ADR_ERR_INT[DDR_RANGE_ERR]. */
        uint64_t smem_range_err        : 1;  /**< [  0:  0](R/W1S/H) Reads or sets MHBW(0..28)_ADR_ERR_INT[SMEM_RANGE_ERR]. */
#else /* Word 0 - Little Endian */
        uint64_t smem_range_err        : 1;  /**< [  0:  0](R/W1S/H) Reads or sets MHBW(0..28)_ADR_ERR_INT[SMEM_RANGE_ERR]. */
        uint64_t ddr_range_err         : 1;  /**< [  1:  1](R/W1S/H) Reads or sets MHBW(0..28)_ADR_ERR_INT[DDR_RANGE_ERR]. */
        uint64_t gaa_rd_nxm_err        : 1;  /**< [  2:  2](R/W1S/H) Reads or sets MHBW(0..28)_ADR_ERR_INT[GAA_RD_NXM_ERR]. */
    ...
    /* struct cavm_mhbwx_adr_err_int_w1s_f95o loki; */
};
...
union cavm_mhbwx_adr_error_jce_w0
{
    ...
    /* struct cavm_mhbwx_adr_error_jce_w0_s cn9; */
    /* struct cavm_mhbwx_adr_error_jce_w0_s cnf95xxp1; */
    struct cavm_mhbwx_adr_error_jce_w0_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
union cavm_mhbwx_adr_error_jce_w1
{
    ...
    /* struct cavm_mhbwx_adr_error_jce_w1_s cn9; */
    /* struct cavm_mhbwx_adr_error_jce_w1_s cnf95xxp1; */
    struct cavm_mhbwx_adr_error_jce_w1_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
/**
 * Register (RSL) mhbw#_cbclk_active_pc
 *
...
{
    if (cavm_is_model(OCTEONTX_F95O) && (a<=28))
        return 0x87e04302f028ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=28))
        return 0x87e04302f028ll + 0x80000ll * ((a) & 0x1f);
...
#define bustype_CAVM_MHBWX_CBCLK_ACTIVE_PC(a) CSR_TYPE_RSL
...
union cavm_mhbwx_cfg
{
    ...
    /* struct cavm_mhbwx_cfg_s cn9; */
    /* struct cavm_mhbwx_cfg_s cnf95xxp1; */
    struct cavm_mhbwx_cfg_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_51_63        : 13;
        uint64_t mhbw_done             : 1;  /**< [ 50: 50](RO/H) Indicates the MHBW has been disabled and has finished clearing all
...
{
    if (cavm_is_model(OCTEONTX_F95O) && (a<=28))
        return 0x87e04302f010ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=28))
        return 0x87e04302f010ll + 0x80000ll * ((a) & 0x1f);
...
#define bustype_CAVM_MHBWX_DV_SCRATCH(a) CSR_TYPE_RSL
...
union cavm_mhbwx_err_stat1
{
    ...
    /* struct cavm_mhbwx_err_stat1_s cn9; */
    /* struct cavm_mhbwx_err_stat1_s cnf95xxp1; */
    struct cavm_mhbwx_err_stat1_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t adr_err_stat          : 32; /**< [ 63: 32](R/W/H) Count of address range errors.
                                                                 Internal:
...
static inline uint64_t CAVM_MHBWX_EXTX_SFUNC(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95MM) && (((a<=16) || ((a>=18)&&(a<=21)) || (a==26)) && (b<=3)))
        return 0x87e04302d100ll + 0x80000ll * ((a) & 0x1f) + 0x10ll * ((b) & 0x3);
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=28) && (b<=3)))
        return 0x87e04302d100ll + 0x80000ll * ((a) & 0x1f) + 0x10ll * ((b) & 0x3);
    if (cavm_is_model(OCTEONTX_LOKI) && ((a<=28) && (b<=3)))
        return 0x87e04302d100ll + 0x80000ll * ((a) & 0x1f) + 0x10ll * ((b) & 0x3);
...
union cavm_mhbwx_fyi
{
    ...
    struct cavm_mhbwx_fyi_s
    {
        ...
        uint64_t ghb_port              : 3;  /**< [ 50: 48](RO/H) The GHAB port number the MHAB attached to. */
    ...
    /* struct cavm_mhbwx_fyi_s cn9; */
    struct cavm_mhbwx_fyi_cnf95xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t psm_did               : 6;  /**< [ 63: 58](RO/H) The PSM ID used to schedule jobs on this MHAB (i.e., the bit to set in
                                                                 PSM_RSRC_TBL()[MAB_MAP] to map a job type to this MHAB). */
...
static inline uint64_t CAVM_MHBWX_JOBQX_CFG(uint64_t a, uint64_t b)
{
    ...
    if (cavm_is_model(OCTEONTX_F95O) && ((a<=28) && (b<=1)))
        return 0x87e043020010ll + 0x80000ll * ((a) & 0x1f) + 8ll * ((b) & 0x1);
    if (cavm_is_model(OCTEONTX_LOKI) && ((a<=28) && (b<=1)))
        return 0x87e043020010ll + 0x80000ll * ((a) & 0x1f) + 8ll * ((b) & 0x1);
...
union cavm_mhbwx_phymem_range
{
    ...
    /* struct cavm_mhbwx_phymem_range_s cn9; */
    /* struct cavm_mhbwx_phymem_range_s cnf95xxp1; */
    struct cavm_mhbwx_phymem_range_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_57_63        : 7;
...
union cavm_mhbwx_sysmem_range_max
{
    ...
    /* struct cavm_mhbwx_sysmem_range_max_s cn9; */
    /* struct cavm_mhbwx_sysmem_range_max_s cnf95xxp1; */
    struct cavm_mhbwx_sysmem_range_max_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_53_63        : 11;
...
union cavm_mhbwx_sysmem_range_min
{
    ...
    /* struct cavm_mhbwx_sysmem_range_min_s cn9; */
    /* struct cavm_mhbwx_sysmem_range_min_s cnf95xxp1; */
    struct cavm_mhbwx_sysmem_range_min_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_53_63        : 11;
...
/**
 * Register (RSL) mhbw#_ubclk_cycles_pc
 *
...
{
    if (cavm_is_model(OCTEONTX_F95O) && (a<=28))
        return 0x87e04302f020ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=28))
        return 0x87e04302f020ll + 0x80000ll * ((a) & 0x1f);
...
#define bustype_CAVM_MHBWX_UBCLK_CYCLES_PC(a) CSR_TYPE_RSL
