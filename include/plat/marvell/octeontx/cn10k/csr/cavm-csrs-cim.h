...
static inline uint64_t CAVM_CIMX_ICC_AP0R0_EL1(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICC_AP0R0_EL1(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
        return 0x87b000063220ll + 0x80000ll * ((a) & 0x3f);
    if (cavm_is_model(OCTEONTX_CN10KB) && (a<=47))
        return 0x87b000063220ll + 0x80000ll * ((a) & 0x3f);
    if (cavm_is_model(OCTEONTX_CNF10KA) && (a<=47))
        return 0x87b000063220ll + 0x80000ll * ((a) & 0x3f);
...
static inline uint64_t CAVM_CIMX_ICC_AP1R0_EL1_NS(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICC_AP1R0_EL1_NS(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
...
static inline uint64_t CAVM_CIMX_ICC_AP1R0_EL1_S(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICC_AP1R0_EL1_S(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
...
union cavm_cimx_icc_asgi1r_el1
{
    ...
    struct cavm_cimx_icc_asgi1r_el1_s
    {
        ...
        uint64_t aff3                  : 8;  /**< [ 55: 48](WO) Affinity 3. The affinity 3 value of the affinity path of the cluster for which SGI
                                                                 interrupts will be generated. */
        uint64_t rs                    : 4;  /**< [ 47: 44](R/W) Range Selector.  Controls which group of 16 values is represented by the TARGETLIST field. */
        ...
        uint64_t irm                   : 1;  /**< [ 40: 40](WO) Interrupt routing mode.
                                                                 ...
                                                                 are reserved. */
        uint64_t aff2                  : 8;  /**< [ 39: 32](WO) Affinity 2. The affinity 2 value of the affinity path of the cluster for which SGI
                                                                 interrupts will be generated. */
        uint64_t reserved_28_31        : 4;
        uint64_t intid                 : 4;  /**< [ 27: 24](WO) SGI Interrupt ID. */
        uint64_t aff1                  : 8;  /**< [ 23: 16](WO) Affinity 1. The affinity 1 value of the affinity path of the cluster for which SGI
                                                                 interrupts will be generated. */
...
static inline uint64_t CAVM_CIMX_ICC_ASGI1R_EL1(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICC_ASGI1R_EL1(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
...
union cavm_cimx_icc_bpr0_el1
{
    ...
    struct cavm_cimx_icc_bpr0_el1_cn
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
static inline uint64_t CAVM_CIMX_ICC_BPR0_EL1(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICC_BPR0_EL1(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
...
union cavm_cimx_icc_bpr1_el1_ns
{
    ...
    struct cavm_cimx_icc_bpr1_el1_ns_cn
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_5_63         : 59;
        uint64_t reserved_3_4          : 2;
...
static inline uint64_t CAVM_CIMX_ICC_BPR1_EL1_NS(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICC_BPR1_EL1_NS(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
...
static inline uint64_t CAVM_CIMX_ICC_BPR1_EL1_S(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICC_BPR1_EL1_S(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
...
/**
 * Register (NCB) cim#_icc_ctlr_el1
 *
 * Interrupt Controller Register
 * This register controls aspects of the behavior of the GIC CPU interface and
 * provides information about the features implemented.
 */
union cavm_cimx_icc_ctlr_el1
{
    uint64_t u;
    struct cavm_cimx_icc_ctlr_el1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_20_63        : 44;
        uint64_t extrange              : 1;  /**< [ 19: 19](RO/H) Extended Interrupt ID range.
                                                                 0 - CPU interface does not support interrupt IDs in the range 1024 to 8192.
                                                                 1 - CPU interface supports interrupt IDs in the range 1024 to 8192.
                                                                 This is an alias of CIM()_ICC_CTLR_EL3[EXTRANGE]. */
        uint64_t rss                   : 1;  /**< [ 18: 18](RO/H) Range selector support.
                                                                 0 - Targeted SGIs with affinity level zero values of 0-15 are supported.
                                                                 1 - Targeted SGIs with affinity level zero values of 0-255 are supported.
                                                                 This is an alias of CIM()_ICC_CTLR_EL3[RSS]. */
    ...
    /* struct cavm_cimx_icc_ctlr_el1_s cn; */
};
typedef union cavm_cimx_icc_ctlr_el1 cavm_cimx_icc_ctlr_el1_t;

static inline uint64_t CAVM_CIMX_ICC_CTLR_EL1(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICC_CTLR_EL1(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
    ...
    if (cavm_is_model(OCTEONTX_CNF10KB) && (a<=47))
        return 0x87b000063320ll + 0x80000ll * ((a) & 0x3f);
    __cavm_csr_fatal("CIMX_ICC_CTLR_EL1", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_CIMX_ICC_CTLR_EL1(a) cavm_cimx_icc_ctlr_el1_t
#define bustype_CAVM_CIMX_ICC_CTLR_EL1(a) CSR_TYPE_NCB
#define basename_CAVM_CIMX_ICC_CTLR_EL1(a) "CIMX_ICC_CTLR_EL1"
#define busnum_CAVM_CIMX_ICC_CTLR_EL1(a) (a)
...
union cavm_cimx_icc_ctlr_el3
{
    ...
    struct cavm_cimx_icc_ctlr_el3_s
    {
        ...
        uint64_t rss                   : 1;  /**< [ 18: 18](RO/H) Range selector support.
                                                                 0 - Targeted SGIs with affinity level zero values of 0-15 are supported.
                                                                 1 - Targeted SGIs with affinity level zero values of 0-255 are supported. */
        uint64_t nds                   : 1;  /**< [ 17: 17](RO/H) Disable Security not supported.
                                                                 0 - The Cpu interface logic supports disabling security.
                                                                 1 - The Cpu interface logic does not support disabling security and
...
static inline uint64_t CAVM_CIMX_ICC_CTLR_EL3(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICC_CTLR_EL3(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
...
static inline uint64_t CAVM_CIMX_ICC_DIR_EL1(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICC_DIR_EL1(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
 ...
 * A processor writes to this register to inform the CPU interface that it has completed the
 * processing of the specified group 0 interrupt.
 */
...
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_24_63        : 40;
        uint64_t eoiintid              : 24; /**< [ 23:  0](WO) The INTID from the corresponding ICC_IAR0_EL1 access.

                                                                 This field has either 16 or 24 bits implemented. The number of implemented bits can be found in
                                                                 ICC_CTLR_EL1.IDbits and ICC_CTLR_EL3.IDbits. If only 16 bits are implemented, bits [23:16]
                                                                 of this register are RES0.

                                                                 If the EOImode bit for the current Exception level and Security state is 0, a
                                                                 write to this register
                                                                 drops the priority for the interrupt, and also deactivates the interrupt.

                                                                 If the EOImode bit for the current Exception level and Security state is 1, a
                                                                 write to this register only
                                                                 drops the priority for the interrupt. Software must write to ICC_DIR_EL1 to
                                                                 ...
                                                                 * If EL3 is implemented and the software is executing at EL3, the appropriate
                                                                 bit is ICC_CTLR_EL3.EOImode_EL3.
                                                                 * If EL3 is implemented and the software is not executing at EL3, the bit
                                                                 depends on the current Security state:
...
static inline uint64_t CAVM_CIMX_ICC_EOIR0_EL1(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICC_EOIR0_EL1(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
...
static inline uint64_t CAVM_CIMX_ICC_EOIR1_EL1(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICC_EOIR1_EL1(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
 ...
 * Indicates the interrupt ID of the highest priority pending group 0 interrupt on the CPU interface.
 */
...
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_24_63        : 40;
        uint64_t pendintid             : 24; /**< [ 23:  0](RO/H) The Interrupt identifier of the highest priority pending interrupt, if that interrupt is
                                                                 observable at the current security state and exception level.

                                                                 If the highest priority pending interrupt is not observable, this field contains a special INTID to
                                                                 indicate the reason. These special INTIDs can be one of: 1020, 1021, or 1023. See Special INTIDs
...
static inline uint64_t CAVM_CIMX_ICC_HPPIR0_EL1(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICC_HPPIR0_EL1(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
...
static inline uint64_t CAVM_CIMX_ICC_HPPIR1_EL1(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICC_HPPIR1_EL1(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
 ...
 * The processor reads this register
...
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_24_63        : 40;
        uint64_t intid                 : 24; /**< [ 23:  0](RO/H) Interrupt ID of the signaled interrupt.

                                                                 This is the INTID of the highest priority pending interrupt, if that interrupt is
                                                                 of sufficient priority for it to be signaled to the processor, and if it can be
                                                                 acknowledged at the current security state and exception level

                                                                 If the highest priority pending interrupt is not observable, this field contains
                                                                 a special interrupt ID to indicate the reason.   These special interrupt IDs can
                                                                 be one of 1020, 1021 or 1023.     1020 will be signaled if a secure group one
                                                                 interrupt is the highest priority pending interrupt and the current security state
                                                                 is non-secure.   1021 will be signaled if a non-secure group one interrupt is the
                                                                 highest priority pending interrupt and the current security state is secure.
                                                                 1023 indicates that no interrupt is currently pending.

                                                                 To allow software to ensure appropriate observability of actions initiated by
                                                                 GIC register accesses,
                                                                 the processor and CPU interface logic must ensure that reads of this register
                                                                 are self-synchronising when
                                                                 ...
                                                                 register is architecturally executed so that no spurious interrupt exception
                                                                 occurs if interrupts are
                                                                 unmasked by an instruction immediately following the read. See Observability of the effects of
                                                                 accesses to the GIC registers in IHI0069E, for more information.
...
static inline uint64_t CAVM_CIMX_ICC_IAR0_EL1(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICC_IAR0_EL1(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
...
static inline uint64_t CAVM_CIMX_ICC_IAR1_EL1(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICC_IAR1_EL1(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
...
static inline uint64_t CAVM_CIMX_ICC_IGRPEN0_EL1(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICC_IGRPEN0_EL1(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
...
static inline uint64_t CAVM_CIMX_ICC_IGRPEN1_EL1_NS(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICC_IGRPEN1_EL1_NS(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
...
static inline uint64_t CAVM_CIMX_ICC_IGRPEN1_EL1_S(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICC_IGRPEN1_EL1_S(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
...
static inline uint64_t CAVM_CIMX_ICC_IGRPEN1_EL3(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICC_IGRPEN1_EL3(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
 ...
 * in this register are signalled to the PE.
 *
 * Writes to this register must be high performance and must ensure that no interrupt of lower
 * priority than the written value occurs after the write, without requiring an ISB or an exception
 * boundary.
 *
...
static inline uint64_t CAVM_CIMX_ICC_PMR_EL1(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICC_PMR_EL1(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
...
static inline uint64_t CAVM_CIMX_ICC_RPR_EL1(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICC_RPR_EL1(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
...
static inline uint64_t CAVM_CIMX_ICC_SGI0R_EL1(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICC_SGI0R_EL1(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
...
static inline uint64_t CAVM_CIMX_ICC_SGI1R_EL1(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICC_SGI1R_EL1(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
...
static inline uint64_t CAVM_CIMX_ICC_SRE_EL1_NS(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICC_SRE_EL1_NS(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
...
static inline uint64_t CAVM_CIMX_ICC_SRE_EL1_S(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICC_SRE_EL1_S(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
...
static inline uint64_t CAVM_CIMX_ICC_SRE_EL2(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICC_SRE_EL2(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
...
static inline uint64_t CAVM_CIMX_ICC_SRE_EL3(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICC_SRE_EL3(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
...
static inline uint64_t CAVM_CIMX_ICH_AP0R0_EL2(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICH_AP0R0_EL2(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
...
static inline uint64_t CAVM_CIMX_ICH_AP1R0_EL2(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICH_AP1R0_EL2(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
...
static inline uint64_t CAVM_CIMX_ICH_EISR_EL2(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICH_EISR_EL2(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
...
static inline uint64_t CAVM_CIMX_ICH_ELSR_EL2(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICH_ELSR_EL2(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
...
static inline uint64_t CAVM_CIMX_ICH_HCR_EL2(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICH_HCR_EL2(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
...
static inline uint64_t CAVM_CIMX_ICH_LRX_EL2(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICH_LRX_EL2(uint64_t a, uint64_t b)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && ((a<=32) && (b<=15)))
        return 0x87b000073300ll + 0x80000ll * ((a) & 0x3f) + 8ll * ((b) & 0xf);
    if (cavm_is_model(OCTEONTX_CN10KB) && ((a<=47) && (b<=15)))
        return 0x87b000073300ll + 0x80000ll * ((a) & 0x3f) + 8ll * ((b) & 0xf);
    if (cavm_is_model(OCTEONTX_CNF10KA) && ((a<=47) && (b<=15)))
        return 0x87b000073300ll + 0x80000ll * ((a) & 0x3f) + 8ll * ((b) & 0xf);
    if (cavm_is_model(OCTEONTX_CNF10KB) && ((a<=47) && (b<=15)))
        return 0x87b000073300ll + 0x80000ll * ((a) & 0x3f) + 8ll * ((b) & 0xf);
...
static inline uint64_t CAVM_CIMX_ICH_MISR_EL2(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICH_MISR_EL2(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
...
static inline uint64_t CAVM_CIMX_ICH_VMCR_EL2(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICH_VMCR_EL2(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
...
static inline uint64_t CAVM_CIMX_ICH_VTR_EL2(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CIMX_ICH_VTR_EL2(uint64_t a)
{
    if (cavm_is_model(OCTEONTX_CN10KA) && (a<=32))
