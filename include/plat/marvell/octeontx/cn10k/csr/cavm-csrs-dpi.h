 ...
 */
#define CAVM_DPI_BAR_E_DPIX_PF_BAR0(a) (0x86e000000000ll + 0x1000000000ll * (a))
#define CAVM_DPI_BAR_E_DPIX_PF_BAR0_SIZE 0x100000000ull
#define CAVM_DPI_BAR_E_DPIX_PF_BAR4(a) (0x86e100000000ll + 0x1000000000ll * (a))
#define CAVM_DPI_BAR_E_DPIX_PF_BAR4_SIZE 0x100000ull
#define CAVM_DPI_BAR_E_DPIX_VFX_BAR0(a,b) (0x86e200000000ll + 0x1000000000ll * (a) + 0x100000ll * (b))
#define CAVM_DPI_BAR_E_DPIX_VFX_BAR0_SIZE 0x100000ull
#define CAVM_DPI_BAR_E_DPIX_VFX_BAR4(a,b) (0x86e210000000ll + 0x1000000000ll * (a) + 0x100000ll * (b))
...
#define CAVM_DPI_PF_INT_VEC_E_DPI_EPFX_DMA_VF_LINT(a) (0x6c + (a))
...
#define CAVM_DPI_PF_INT_VEC_E_SDP_IRE_LINTX(a) (0x62 + (a))
#define CAVM_DPI_PF_INT_VEC_E_SDP_ORD_LINTX(a) (0x66 + (a))
#define CAVM_DPI_PF_INT_VEC_E_SDP_ORE_LINTX(a) (0x64 + (a))
 ...
 * Enumerates the MSI-X interrupt vectors.
 */
#define CAVM_DPI_VF_INT_VEC_E_DPI_MBOX_PF_VF_INT (1)
...
union cavm_sdp_func_sel_s
{
    ...
    struct cavm_sdp_func_sel_s_s
    {
        ...
        uint32_t epf                   : 2;  /**< [  8:  7] Selects the PCIe physical function within the referenced MAC.
...
{
    if (a==0)
        return 0x86e0000100b0ll + 0x1000000000ll * ((a) & 0x0);
...
static inline uint64_t CAVM_DPIX_CSCLK_ACTIVE_PC(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_CSCLK_ACTIVE_PC(uint64_t a)
{
    if (a==0)
        return 0x86e000010000ll + 0x1000000000ll * ((a) & 0x0);
...
static inline uint64_t CAVM_DPIX_CTL(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_CTL(uint64_t a)
{
    if (a==0)
        return 0x86e000010010ll + 0x1000000000ll * ((a) & 0x0);
...
static inline uint64_t CAVM_DPIX_DMAX_ERR_RSP_STATUS(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_DMAX_ERR_RSP_STATUS(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=31))
        return 0x86e000000038ll + 0x1000000000ll * ((a) & 0x0) + 0x800ll * ((b) & 0x1f);
...
static inline uint64_t CAVM_DPIX_DMAX_IBUFF_CSIZE(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_DMAX_IBUFF_CSIZE(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=31))
        return 0x86e000000000ll + 0x1000000000ll * ((a) & 0x0) + 0x800ll * ((b) & 0x1f);
...
union cavm_dpix_dmax_ids
{
    ...
    struct cavm_dpix_dmax_ids_s
    {
        ...
        uint64_t dma_sec_strm          : 8;  /**< [ 55: 48](R/W) Second Stream ID. Stream identifier bits \<7:0\> for DMA reads and writes. Stream
                                                                 ID \<15:8\> is from the DPI's
...
static inline uint64_t CAVM_DPIX_DMAX_IDS(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_DMAX_IDS(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=31))
        return 0x86e000000018ll + 0x1000000000ll * ((a) & 0x0) + 0x800ll * ((b) & 0x1f);
...
static inline uint64_t CAVM_DPIX_DMAX_IDS2(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_DMAX_IDS2(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=31))
        return 0x86e000000020ll + 0x1000000000ll * ((a) & 0x0) + 0x800ll * ((b) & 0x1f);
...
/**
 * Register (NCB) dpi#_dma#_pri
 *
 * DPI DMA Instruction Queue Priority Register
 */
union cavm_dpix_dmax_pri
{
    uint64_t u;
...
typedef union cavm_dpix_dmax_pri cavm_dpix_dmax_pri_t;

static inline uint64_t CAVM_DPIX_DMAX_PRI(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_DMAX_PRI(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=31))
        return 0x86e000000040ll + 0x1000000000ll * ((a) & 0x0) + 0x800ll * ((b) & 0x1f);
    __cavm_csr_fatal("DPIX_DMAX_PRI", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_DPIX_DMAX_PRI(a,b) cavm_dpix_dmax_pri_t
#define bustype_CAVM_DPIX_DMAX_PRI(a,b) CSR_TYPE_NCB
#define basename_CAVM_DPIX_DMAX_PRI(a,b) "DPIX_DMAX_PRI"
#define device_bar_CAVM_DPIX_DMAX_PRI(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DPIX_DMAX_PRI(a,b) (a)
#define arguments_CAVM_DPIX_DMAX_PRI(a,b) (a),(b),-1,-1
...
static inline uint64_t CAVM_DPIX_DMAX_QRST(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_DMAX_QRST(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=31))
        return 0x86e000000030ll + 0x1000000000ll * ((a) & 0x0) + 0x800ll * ((b) & 0x1f);
...
static inline uint64_t CAVM_DPIX_DMAX_REQBNK0(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_DMAX_REQBNK0(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=31))
        return 0x86e000000008ll + 0x1000000000ll * ((a) & 0x0) + 0x800ll * ((b) & 0x1f);
...
static inline uint64_t CAVM_DPIX_DMAX_REQBNK1(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_DMAX_REQBNK1(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=31))
        return 0x86e000000010ll + 0x1000000000ll * ((a) & 0x0) + 0x800ll * ((b) & 0x1f);
...
static inline uint64_t CAVM_DPIX_DMA_ARB_CONTROL(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_DMA_ARB_CONTROL(uint64_t a)
{
    if (a==0)
        return 0x86e000010020ll + 0x1000000000ll * ((a) & 0x0);
    __cavm_csr_fatal("DPIX_DMA_ARB_CONTROL", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_DPIX_DMA_ARB_CONTROL(a) cavm_dpix_dma_arb_control_t
#define bustype_CAVM_DPIX_DMA_ARB_CONTROL(a) CSR_TYPE_NCB
#define basename_CAVM_DPIX_DMA_ARB_CONTROL(a) "DPIX_DMA_ARB_CONTROL"
#define device_bar_CAVM_DPIX_DMA_ARB_CONTROL(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DPIX_DMA_ARB_CONTROL(a) (a)
#define arguments_CAVM_DPIX_DMA_ARB_CONTROL(a) (a),-1,-1,-1
...
static inline uint64_t CAVM_DPIX_DMA_CCX_CNT(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_DMA_CCX_CNT(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=63))
        return 0x86e000012000ll + 0x1000000000ll * ((a) & 0x0) + 8ll * ((b) & 0x3f);
...
static inline uint64_t CAVM_DPIX_DMA_CCX_INT(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_DMA_CCX_INT(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=63))
        return 0x86e000011000ll + 0x1000000000ll * ((a) & 0x0) + 8ll * ((b) & 0x3f);
...
static inline uint64_t CAVM_DPIX_DMA_CCX_INT_ENA_W1C(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_DMA_CCX_INT_ENA_W1C(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=63))
        return 0x86e000011800ll + 0x1000000000ll * ((a) & 0x0) + 8ll * ((b) & 0x3f);
...
static inline uint64_t CAVM_DPIX_DMA_CCX_INT_ENA_W1S(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_DMA_CCX_INT_ENA_W1S(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=63))
        return 0x86e000011c00ll + 0x1000000000ll * ((a) & 0x0) + 8ll * ((b) & 0x3f);
...
static inline uint64_t CAVM_DPIX_DMA_CCX_INT_W1S(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_DMA_CCX_INT_W1S(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=63))
        return 0x86e000011400ll + 0x1000000000ll * ((a) & 0x0) + 8ll * ((b) & 0x3f);
...
static inline uint64_t CAVM_DPIX_DMA_CONTROL(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_DMA_CONTROL(uint64_t a)
{
    if (a==0)
        return 0x86e000010018ll + 0x1000000000ll * ((a) & 0x0);
...
static inline uint64_t CAVM_DPIX_DMA_ENGX_EN(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_DMA_ENGX_EN(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=5))
        return 0x86e000010040ll + 0x1000000000ll * ((a) & 0x0) + 8ll * ((b) & 0x7);
...
union cavm_dpix_dma_intl_sel
{
    ...
    /* struct cavm_dpix_dma_intl_sel_s cn; */
};
typedef union cavm_dpix_dma_intl_sel cavm_dpix_dma_intl_sel_t;

static inline uint64_t CAVM_DPIX_DMA_INTL_SEL(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_DMA_INTL_SEL(uint64_t a)
{
    if (a==0)
        return 0x86e000010028ll + 0x1000000000ll * ((a) & 0x0);
    __cavm_csr_fatal("DPIX_DMA_INTL_SEL", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_DPIX_DMA_INTL_SEL(a) cavm_dpix_dma_intl_sel_t
#define bustype_CAVM_DPIX_DMA_INTL_SEL(a) CSR_TYPE_NCB
#define basename_CAVM_DPIX_DMA_INTL_SEL(a) "DPIX_DMA_INTL_SEL"
...
static inline uint64_t CAVM_DPIX_EBUS_PORTX_CFG(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_EBUS_PORTX_CFG(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=1))
        return 0x86e000010100ll + 0x1000000000ll * ((a) & 0x0) + 8ll * ((b) & 0x1);
...
static inline uint64_t CAVM_DPIX_EBUS_PORTX_ERR(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_EBUS_PORTX_ERR(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=1))
        return 0x86e000010280ll + 0x1000000000ll * ((a) & 0x0) + 8ll * ((b) & 0x1);
...
static inline uint64_t CAVM_DPIX_EBUS_PORTX_ERR_INFO(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_EBUS_PORTX_ERR_INFO(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=1))
        return 0x86e000010200ll + 0x1000000000ll * ((a) & 0x0) + 8ll * ((b) & 0x1);
...
static inline uint64_t CAVM_DPIX_EBUS_PORTX_SCFG(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_EBUS_PORTX_SCFG(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=1))
        return 0x86e000010180ll + 0x1000000000ll * ((a) & 0x0) + 8ll * ((b) & 0x1);
...
static inline uint64_t CAVM_DPIX_EBUS_RECAL(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_EBUS_RECAL(uint64_t a)
{
    if (a==0)
        return 0x86e0000100f0ll + 0x1000000000ll * ((a) & 0x0);
...
static inline uint64_t CAVM_DPIX_ENGX_BUF(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_ENGX_BUF(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=5))
        return 0x86e0000100c0ll + 0x1000000000ll * ((a) & 0x0) + 8ll * ((b) & 0x7);
 ...
 */
union cavm_dpix_epfx_dma_vf_lint
{
    uint64_t u;
    struct cavm_dpix_epfx_dma_vf_lint_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_dpix_epfx_dma_vf_lint_s cn; */
};
typedef union cavm_dpix_epfx_dma_vf_lint cavm_dpix_epfx_dma_vf_lint_t;

static inline uint64_t CAVM_DPIX_EPFX_DMA_VF_LINT(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_EPFX_DMA_VF_LINT(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=3))
        return 0x86e000014000ll + 0x1000000000ll * ((a) & 0x0) + 0x20ll * ((b) & 0x3);
    __cavm_csr_fatal("DPIX_EPFX_DMA_VF_LINT", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_DPIX_EPFX_DMA_VF_LINT(a,b) cavm_dpix_epfx_dma_vf_lint_t
#define bustype_CAVM_DPIX_EPFX_DMA_VF_LINT(a,b) CSR_TYPE_NCB
#define basename_CAVM_DPIX_EPFX_DMA_VF_LINT(a,b) "DPIX_EPFX_DMA_VF_LINT"
#define device_bar_CAVM_DPIX_EPFX_DMA_VF_LINT(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DPIX_EPFX_DMA_VF_LINT(a,b) (a)
#define arguments_CAVM_DPIX_EPFX_DMA_VF_LINT(a,b) (a),(b),-1,-1

/**
 * Register (NCB) dpi#_epf#_dma_vf_lint_ena_w1c
 *
 * DPI DMA Error Response VF Bit Array Local Enable Clear Registers
 * This register clears interrupt enable bits.
 */
union cavm_dpix_epfx_dma_vf_lint_ena_w1c
{
    uint64_t u;
    struct cavm_dpix_epfx_dma_vf_lint_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t vf_int                : 64; /**< [ 63:  0](R/W1C/H) Reads or clears enable for DPI(0)_EPF(0..3)_DMA_VF_LINT[VF_INT]. */
#else /* Word 0 - Little Endian */
        uint64_t vf_int                : 64; /**< [ 63:  0](R/W1C/H) Reads or clears enable for DPI(0)_EPF(0..3)_DMA_VF_LINT[VF_INT]. */
#endif /* Word 0 - End */
    } s;
    /* struct cavm_dpix_epfx_dma_vf_lint_ena_w1c_s cn; */
};
typedef union cavm_dpix_epfx_dma_vf_lint_ena_w1c cavm_dpix_epfx_dma_vf_lint_ena_w1c_t;

static inline uint64_t CAVM_DPIX_EPFX_DMA_VF_LINT_ENA_W1C(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_EPFX_DMA_VF_LINT_ENA_W1C(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=3))
        return 0x86e000014400ll + 0x1000000000ll * ((a) & 0x0) + 0x20ll * ((b) & 0x3);
    __cavm_csr_fatal("DPIX_EPFX_DMA_VF_LINT_ENA_W1C", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_DPIX_EPFX_DMA_VF_LINT_ENA_W1C(a,b) cavm_dpix_epfx_dma_vf_lint_ena_w1c_t
#define bustype_CAVM_DPIX_EPFX_DMA_VF_LINT_ENA_W1C(a,b) CSR_TYPE_NCB
#define basename_CAVM_DPIX_EPFX_DMA_VF_LINT_ENA_W1C(a,b) "DPIX_EPFX_DMA_VF_LINT_ENA_W1C"
#define device_bar_CAVM_DPIX_EPFX_DMA_VF_LINT_ENA_W1C(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DPIX_EPFX_DMA_VF_LINT_ENA_W1C(a,b) (a)
#define arguments_CAVM_DPIX_EPFX_DMA_VF_LINT_ENA_W1C(a,b) (a),(b),-1,-1

/**
 * Register (NCB) dpi#_epf#_dma_vf_lint_ena_w1s
 *
 * DPI DMA Error Response VF Bit Array Local Enable Set Registers
 * This register sets interrupt enable bits.
 */
union cavm_dpix_epfx_dma_vf_lint_ena_w1s
{
    uint64_t u;
    struct cavm_dpix_epfx_dma_vf_lint_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t vf_int                : 64; /**< [ 63:  0](R/W1S/H) Reads or sets enable for DPI(0)_EPF(0..3)_DMA_VF_LINT[VF_INT]. */
#else /* Word 0 - Little Endian */
        uint64_t vf_int                : 64; /**< [ 63:  0](R/W1S/H) Reads or sets enable for DPI(0)_EPF(0..3)_DMA_VF_LINT[VF_INT]. */
#endif /* Word 0 - End */
    } s;
    /* struct cavm_dpix_epfx_dma_vf_lint_ena_w1s_s cn; */
};
typedef union cavm_dpix_epfx_dma_vf_lint_ena_w1s cavm_dpix_epfx_dma_vf_lint_ena_w1s_t;

static inline uint64_t CAVM_DPIX_EPFX_DMA_VF_LINT_ENA_W1S(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_EPFX_DMA_VF_LINT_ENA_W1S(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=3))
        return 0x86e000014600ll + 0x1000000000ll * ((a) & 0x0) + 0x20ll * ((b) & 0x3);
    __cavm_csr_fatal("DPIX_EPFX_DMA_VF_LINT_ENA_W1S", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_DPIX_EPFX_DMA_VF_LINT_ENA_W1S(a,b) cavm_dpix_epfx_dma_vf_lint_ena_w1s_t
#define bustype_CAVM_DPIX_EPFX_DMA_VF_LINT_ENA_W1S(a,b) CSR_TYPE_NCB
#define basename_CAVM_DPIX_EPFX_DMA_VF_LINT_ENA_W1S(a,b) "DPIX_EPFX_DMA_VF_LINT_ENA_W1S"
#define device_bar_CAVM_DPIX_EPFX_DMA_VF_LINT_ENA_W1S(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DPIX_EPFX_DMA_VF_LINT_ENA_W1S(a,b) (a)
#define arguments_CAVM_DPIX_EPFX_DMA_VF_LINT_ENA_W1S(a,b) (a),(b),-1,-1

/**
 * Register (NCB) dpi#_epf#_dma_vf_lint_w1s
 *
 * DPI DMA Error Response VF Bit Array Set Registers
 * This register sets interrupt bits.
 */
union cavm_dpix_epfx_dma_vf_lint_w1s
{
    uint64_t u;
    struct cavm_dpix_epfx_dma_vf_lint_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t vf_int                : 64; /**< [ 63:  0](R/W1S/H) Reads or sets DPI(0)_EPF(0..3)_DMA_VF_LINT[VF_INT]. */
#else /* Word 0 - Little Endian */
        uint64_t vf_int                : 64; /**< [ 63:  0](R/W1S/H) Reads or sets DPI(0)_EPF(0..3)_DMA_VF_LINT[VF_INT]. */
#endif /* Word 0 - End */
    } s;
    /* struct cavm_dpix_epfx_dma_vf_lint_w1s_s cn; */
};
typedef union cavm_dpix_epfx_dma_vf_lint_w1s cavm_dpix_epfx_dma_vf_lint_w1s_t;

static inline uint64_t CAVM_DPIX_EPFX_DMA_VF_LINT_W1S(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_EPFX_DMA_VF_LINT_W1S(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=3))
        return 0x86e000014200ll + 0x1000000000ll * ((a) & 0x0) + 0x20ll * ((b) & 0x3);
    __cavm_csr_fatal("DPIX_EPFX_DMA_VF_LINT_W1S", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_DPIX_EPFX_DMA_VF_LINT_W1S(a,b) cavm_dpix_epfx_dma_vf_lint_w1s_t
#define bustype_CAVM_DPIX_EPFX_DMA_VF_LINT_W1S(a,b) CSR_TYPE_NCB
#define basename_CAVM_DPIX_EPFX_DMA_VF_LINT_W1S(a,b) "DPIX_EPFX_DMA_VF_LINT_W1S"
#define device_bar_CAVM_DPIX_EPFX_DMA_VF_LINT_W1S(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DPIX_EPFX_DMA_VF_LINT_W1S(a,b) (a)
#define arguments_CAVM_DPIX_EPFX_DMA_VF_LINT_W1S(a,b) (a),(b),-1,-1
...
static inline uint64_t CAVM_DPIX_EPFX_MISC_LINT(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_EPFX_MISC_LINT(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=3))
        return 0x86e000014a00ll + 0x1000000000ll * ((a) & 0x0) + 0x20ll * ((b) & 0x3);
...
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_7_63         : 57;
        uint64_t flr                   : 1;  /**< [  6:  6](R/W1C/H) Reads or clears enable for DPI(0)_EPF(0..3)_MISC_LINT[FLR]. */
        uint64_t dmapf_err             : 1;  /**< [  5:  5](R/W1C/H) Reads or clears enable for DPI(0)_EPF(0..3)_MISC_LINT[DMAPF_ERR]. */
        uint64_t pppf_err              : 1;  /**< [  4:  4](R/W1C/H) Reads or clears enable for DPI(0)_EPF(0..3)_MISC_LINT[PPPF_ERR]. */
        uint64_t un_wi                 : 1;  /**< [  3:  3](R/W1C/H) Reads or clears enable for DPI(0)_EPF(0..3)_MISC_LINT[UN_WI]. */
        uint64_t un_b0                 : 1;  /**< [  2:  2](R/W1C/H) Reads or clears enable for DPI(0)_EPF(0..3)_MISC_LINT[UN_B0]. */
        uint64_t up_wi                 : 1;  /**< [  1:  1](R/W1C/H) Reads or clears enable for DPI(0)_EPF(0..3)_MISC_LINT[UP_WI]. */
        uint64_t up_b0                 : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for DPI(0)_EPF(0..3)_MISC_LINT[UP_B0]. */
#else /* Word 0 - Little Endian */
        uint64_t up_b0                 : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for DPI(0)_EPF(0..3)_MISC_LINT[UP_B0]. */
        uint64_t up_wi                 : 1;  /**< [  1:  1](R/W1C/H) Reads or clears enable for DPI(0)_EPF(0..3)_MISC_LINT[UP_WI]. */
        uint64_t un_b0                 : 1;  /**< [  2:  2](R/W1C/H) Reads or clears enable for DPI(0)_EPF(0..3)_MISC_LINT[UN_B0]. */
...
static inline uint64_t CAVM_DPIX_EPFX_MISC_LINT_ENA_W1C(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_EPFX_MISC_LINT_ENA_W1C(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=3))
        return 0x86e000014a10ll + 0x1000000000ll * ((a) & 0x0) + 0x20ll * ((b) & 0x3);
...
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_7_63         : 57;
        uint64_t flr                   : 1;  /**< [  6:  6](R/W1S/H) Reads or sets enable for DPI(0)_EPF(0..3)_MISC_LINT[FLR]. */
        uint64_t dmapf_err             : 1;  /**< [  5:  5](R/W1S/H) Reads or sets enable for DPI(0)_EPF(0..3)_MISC_LINT[DMAPF_ERR]. */
        uint64_t pppf_err              : 1;  /**< [  4:  4](R/W1S/H) Reads or sets enable for DPI(0)_EPF(0..3)_MISC_LINT[PPPF_ERR]. */
        uint64_t un_wi                 : 1;  /**< [  3:  3](R/W1S/H) Reads or sets enable for DPI(0)_EPF(0..3)_MISC_LINT[UN_WI]. */
        uint64_t un_b0                 : 1;  /**< [  2:  2](R/W1S/H) Reads or sets enable for DPI(0)_EPF(0..3)_MISC_LINT[UN_B0]. */
        uint64_t up_wi                 : 1;  /**< [  1:  1](R/W1S/H) Reads or sets enable for DPI(0)_EPF(0..3)_MISC_LINT[UP_WI]. */
        uint64_t up_b0                 : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for DPI(0)_EPF(0..3)_MISC_LINT[UP_B0]. */
#else /* Word 0 - Little Endian */
        uint64_t up_b0                 : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for DPI(0)_EPF(0..3)_MISC_LINT[UP_B0]. */
        uint64_t up_wi                 : 1;  /**< [  1:  1](R/W1S/H) Reads or sets enable for DPI(0)_EPF(0..3)_MISC_LINT[UP_WI]. */
        uint64_t un_b0                 : 1;  /**< [  2:  2](R/W1S/H) Reads or sets enable for DPI(0)_EPF(0..3)_MISC_LINT[UN_B0]. */
...
static inline uint64_t CAVM_DPIX_EPFX_MISC_LINT_ENA_W1S(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_EPFX_MISC_LINT_ENA_W1S(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=3))
        return 0x86e000014a18ll + 0x1000000000ll * ((a) & 0x0) + 0x20ll * ((b) & 0x3);
...
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_7_63         : 57;
        uint64_t flr                   : 1;  /**< [  6:  6](R/W1S/H) Reads or sets DPI(0)_EPF(0..3)_MISC_LINT[FLR]. */
        uint64_t dmapf_err             : 1;  /**< [  5:  5](R/W1S/H) Reads or sets DPI(0)_EPF(0..3)_MISC_LINT[DMAPF_ERR]. */
        uint64_t pppf_err              : 1;  /**< [  4:  4](R/W1S/H) Reads or sets DPI(0)_EPF(0..3)_MISC_LINT[PPPF_ERR]. */
        uint64_t un_wi                 : 1;  /**< [  3:  3](R/W1S/H) Reads or sets DPI(0)_EPF(0..3)_MISC_LINT[UN_WI]. */
        uint64_t un_b0                 : 1;  /**< [  2:  2](R/W1S/H) Reads or sets DPI(0)_EPF(0..3)_MISC_LINT[UN_B0]. */
        uint64_t up_wi                 : 1;  /**< [  1:  1](R/W1S/H) Reads or sets DPI(0)_EPF(0..3)_MISC_LINT[UP_WI]. */
        uint64_t up_b0                 : 1;  /**< [  0:  0](R/W1S/H) Reads or sets DPI(0)_EPF(0..3)_MISC_LINT[UP_B0]. */
#else /* Word 0 - Little Endian */
        uint64_t up_b0                 : 1;  /**< [  0:  0](R/W1S/H) Reads or sets DPI(0)_EPF(0..3)_MISC_LINT[UP_B0]. */
        uint64_t up_wi                 : 1;  /**< [  1:  1](R/W1S/H) Reads or sets DPI(0)_EPF(0..3)_MISC_LINT[UP_WI]. */
        uint64_t un_b0                 : 1;  /**< [  2:  2](R/W1S/H) Reads or sets DPI(0)_EPF(0..3)_MISC_LINT[UN_B0]. */
...
static inline uint64_t CAVM_DPIX_EPFX_MISC_LINT_W1S(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_EPFX_MISC_LINT_W1S(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=3))
        return 0x86e000014a08ll + 0x1000000000ll * ((a) & 0x0) + 0x20ll * ((b) & 0x3);
 ...
 */
union cavm_dpix_epfx_pp_vf_lint
{
    uint64_t u;
    struct cavm_dpix_epfx_pp_vf_lint_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_dpix_epfx_pp_vf_lint_s cn; */
};
typedef union cavm_dpix_epfx_pp_vf_lint cavm_dpix_epfx_pp_vf_lint_t;

static inline uint64_t CAVM_DPIX_EPFX_PP_VF_LINT(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_EPFX_PP_VF_LINT(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=3))
        return 0x86e000014c00ll + 0x1000000000ll * ((a) & 0x0) + 0x20ll * ((b) & 0x3);
    __cavm_csr_fatal("DPIX_EPFX_PP_VF_LINT", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_DPIX_EPFX_PP_VF_LINT(a,b) cavm_dpix_epfx_pp_vf_lint_t
#define bustype_CAVM_DPIX_EPFX_PP_VF_LINT(a,b) CSR_TYPE_NCB
#define basename_CAVM_DPIX_EPFX_PP_VF_LINT(a,b) "DPIX_EPFX_PP_VF_LINT"
#define device_bar_CAVM_DPIX_EPFX_PP_VF_LINT(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DPIX_EPFX_PP_VF_LINT(a,b) (a)
#define arguments_CAVM_DPIX_EPFX_PP_VF_LINT(a,b) (a),(b),-1,-1

/**
 * Register (NCB) dpi#_epf#_pp_vf_lint_ena_w1c
 *
 * DPI DMA Error Response VF Bit Array Local Enable Clear Registers
 * This register clears interrupt enable bits.
 */
union cavm_dpix_epfx_pp_vf_lint_ena_w1c
{
    uint64_t u;
    struct cavm_dpix_epfx_pp_vf_lint_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t vf_int                : 64; /**< [ 63:  0](R/W1C/H) Reads or clears enable for DPI(0)_EPF(0..3)_PP_VF_LINT[VF_INT]. */
#else /* Word 0 - Little Endian */
        uint64_t vf_int                : 64; /**< [ 63:  0](R/W1C/H) Reads or clears enable for DPI(0)_EPF(0..3)_PP_VF_LINT[VF_INT]. */
#endif /* Word 0 - End */
    } s;
    /* struct cavm_dpix_epfx_pp_vf_lint_ena_w1c_s cn; */
};
typedef union cavm_dpix_epfx_pp_vf_lint_ena_w1c cavm_dpix_epfx_pp_vf_lint_ena_w1c_t;

static inline uint64_t CAVM_DPIX_EPFX_PP_VF_LINT_ENA_W1C(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_EPFX_PP_VF_LINT_ENA_W1C(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=3))
        return 0x86e000015000ll + 0x1000000000ll * ((a) & 0x0) + 0x20ll * ((b) & 0x3);
    __cavm_csr_fatal("DPIX_EPFX_PP_VF_LINT_ENA_W1C", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_DPIX_EPFX_PP_VF_LINT_ENA_W1C(a,b) cavm_dpix_epfx_pp_vf_lint_ena_w1c_t
#define bustype_CAVM_DPIX_EPFX_PP_VF_LINT_ENA_W1C(a,b) CSR_TYPE_NCB
#define basename_CAVM_DPIX_EPFX_PP_VF_LINT_ENA_W1C(a,b) "DPIX_EPFX_PP_VF_LINT_ENA_W1C"
#define device_bar_CAVM_DPIX_EPFX_PP_VF_LINT_ENA_W1C(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DPIX_EPFX_PP_VF_LINT_ENA_W1C(a,b) (a)
#define arguments_CAVM_DPIX_EPFX_PP_VF_LINT_ENA_W1C(a,b) (a),(b),-1,-1

/**
 * Register (NCB) dpi#_epf#_pp_vf_lint_ena_w1s
 *
 * DPI DMA Error Response VF Bit Array Local Enable Set Registers
 * This register sets interrupt enable bits.
 */
union cavm_dpix_epfx_pp_vf_lint_ena_w1s
{
    uint64_t u;
    struct cavm_dpix_epfx_pp_vf_lint_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t vf_int                : 64; /**< [ 63:  0](R/W1S/H) Reads or sets enable for DPI(0)_EPF(0..3)_PP_VF_LINT[VF_INT]. */
#else /* Word 0 - Little Endian */
        uint64_t vf_int                : 64; /**< [ 63:  0](R/W1S/H) Reads or sets enable for DPI(0)_EPF(0..3)_PP_VF_LINT[VF_INT]. */
#endif /* Word 0 - End */
    } s;
    /* struct cavm_dpix_epfx_pp_vf_lint_ena_w1s_s cn; */
};
typedef union cavm_dpix_epfx_pp_vf_lint_ena_w1s cavm_dpix_epfx_pp_vf_lint_ena_w1s_t;

static inline uint64_t CAVM_DPIX_EPFX_PP_VF_LINT_ENA_W1S(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_EPFX_PP_VF_LINT_ENA_W1S(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=3))
        return 0x86e000015200ll + 0x1000000000ll * ((a) & 0x0) + 0x20ll * ((b) & 0x3);
    __cavm_csr_fatal("DPIX_EPFX_PP_VF_LINT_ENA_W1S", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_DPIX_EPFX_PP_VF_LINT_ENA_W1S(a,b) cavm_dpix_epfx_pp_vf_lint_ena_w1s_t
#define bustype_CAVM_DPIX_EPFX_PP_VF_LINT_ENA_W1S(a,b) CSR_TYPE_NCB
#define basename_CAVM_DPIX_EPFX_PP_VF_LINT_ENA_W1S(a,b) "DPIX_EPFX_PP_VF_LINT_ENA_W1S"
#define device_bar_CAVM_DPIX_EPFX_PP_VF_LINT_ENA_W1S(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DPIX_EPFX_PP_VF_LINT_ENA_W1S(a,b) (a)
#define arguments_CAVM_DPIX_EPFX_PP_VF_LINT_ENA_W1S(a,b) (a),(b),-1,-1

/**
 * Register (NCB) dpi#_epf#_pp_vf_lint_w1s
 *
 * DPI DMA Error Response VF Bit Array Set Registers
 * This register sets interrupt bits.
 */
union cavm_dpix_epfx_pp_vf_lint_w1s
{
    uint64_t u;
    struct cavm_dpix_epfx_pp_vf_lint_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t vf_int                : 64; /**< [ 63:  0](R/W1S/H) Reads or sets DPI(0)_EPF(0..3)_PP_VF_LINT[VF_INT]. */
#else /* Word 0 - Little Endian */
        uint64_t vf_int                : 64; /**< [ 63:  0](R/W1S/H) Reads or sets DPI(0)_EPF(0..3)_PP_VF_LINT[VF_INT]. */
#endif /* Word 0 - End */
    } s;
    /* struct cavm_dpix_epfx_pp_vf_lint_w1s_s cn; */
};
typedef union cavm_dpix_epfx_pp_vf_lint_w1s cavm_dpix_epfx_pp_vf_lint_w1s_t;

static inline uint64_t CAVM_DPIX_EPFX_PP_VF_LINT_W1S(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_EPFX_PP_VF_LINT_W1S(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=3))
        return 0x86e000014e00ll + 0x1000000000ll * ((a) & 0x0) + 0x20ll * ((b) & 0x3);
    __cavm_csr_fatal("DPIX_EPFX_PP_VF_LINT_W1S", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_DPIX_EPFX_PP_VF_LINT_W1S(a,b) cavm_dpix_epfx_pp_vf_lint_w1s_t
#define bustype_CAVM_DPIX_EPFX_PP_VF_LINT_W1S(a,b) CSR_TYPE_NCB
#define basename_CAVM_DPIX_EPFX_PP_VF_LINT_W1S(a,b) "DPIX_EPFX_PP_VF_LINT_W1S"
#define device_bar_CAVM_DPIX_EPFX_PP_VF_LINT_W1S(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DPIX_EPFX_PP_VF_LINT_W1S(a,b) (a)
#define arguments_CAVM_DPIX_EPFX_PP_VF_LINT_W1S(a,b) (a),(b),-1,-1
...
static inline uint64_t CAVM_DPIX_INFO_REG(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_INFO_REG(uint64_t a)
{
    if (a==0)
        return 0x86e000010300ll + 0x1000000000ll * ((a) & 0x0);
...
/**
 * Register (NCB) dpi#_mbox_pf_vf#_data#
 *
 * DPI PF/VF Mailbox Register
 */
union cavm_dpix_mbox_pf_vfx_datax
{
    uint64_t u;
    struct cavm_dpix_mbox_pf_vfx_datax_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t data                  : 64; /**< [ 63:  0](R/W/H) Mailbox data. These PF registers access the VF/PF mailbox
                                                                 RAM. Each corresponding VF may access the same storage using
                                                                 DPI()_MBOX_VF()_PF_DATA(). DATA(0) is typically used for PF to VF signaling, DATA(1)
                                                                 for VF to PF. Writing DPI()_MBOX_PF_VF()_DATA(0) (but not
                                                                 DPI(0)_MBOX_VF()_PF_DATA(0)) will set the corresponding
                                                                 DPI(0)_PF_MBOX_PF_VF()_INT which if appropriately enabled will send an interrupt
                                                                 to the VF. */
#else /* Word 0 - Little Endian */
        uint64_t data                  : 64; /**< [ 63:  0](R/W/H) Mailbox data. These PF registers access the VF/PF mailbox
                                                                 RAM. Each corresponding VF may access the same storage using
    ...
    /* struct cavm_dpix_mbox_pf_vfx_datax_s cn; */
};
typedef union cavm_dpix_mbox_pf_vfx_datax cavm_dpix_mbox_pf_vfx_datax_t;

static inline uint64_t CAVM_DPIX_MBOX_PF_VFX_DATAX(uint64_t a, uint64_t b, uint64_t c) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_MBOX_PF_VFX_DATAX(uint64_t a, uint64_t b, uint64_t c)
{
    if ((a==0) && (b<=31) && (c<=1))
        return 0x86e000016000ll + 0x1000000000ll * ((a) & 0x0) + 0x10ll * ((b) & 0x1f) + 8ll * ((c) & 0x1);
    __cavm_csr_fatal("DPIX_MBOX_PF_VFX_DATAX", 3, a, b, c, 0, 0, 0);
}

#define typedef_CAVM_DPIX_MBOX_PF_VFX_DATAX(a,b,c) cavm_dpix_mbox_pf_vfx_datax_t
#define bustype_CAVM_DPIX_MBOX_PF_VFX_DATAX(a,b,c) CSR_TYPE_NCB
#define basename_CAVM_DPIX_MBOX_PF_VFX_DATAX(a,b,c) "DPIX_MBOX_PF_VFX_DATAX"
#define device_bar_CAVM_DPIX_MBOX_PF_VFX_DATAX(a,b,c) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DPIX_MBOX_PF_VFX_DATAX(a,b,c) (a)
...
static inline uint64_t CAVM_DPIX_NCBX_CFG(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_NCBX_CFG(uint64_t a, uint64_t b)
{
    if ((a==0) && (b==0))
        return 0x86e0000100a0ll + 0x1000000000ll * ((a) & 0x0) + 8ll * ((b) & 0x0);
...
static inline uint64_t CAVM_DPIX_PF_MSIX_PBAX(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_PF_MSIX_PBAX(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=1))
        return 0x86e1000f0000ll + 0x1000000000ll * ((a) & 0x0) + 8ll * ((b) & 0x1);
...
static inline uint64_t CAVM_DPIX_PF_RAS(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_PF_RAS(uint64_t a)
{
    if (a==0)
        return 0x86e000010308ll + 0x1000000000ll * ((a) & 0x0);
...
static inline uint64_t CAVM_DPIX_PF_RAS_ENA_W1C(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_PF_RAS_ENA_W1C(uint64_t a)
{
    if (a==0)
        return 0x86e000010318ll + 0x1000000000ll * ((a) & 0x0);
...
static inline uint64_t CAVM_DPIX_PF_RAS_ENA_W1S(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_PF_RAS_ENA_W1S(uint64_t a)
{
    if (a==0)
        return 0x86e000010320ll + 0x1000000000ll * ((a) & 0x0);
...
static inline uint64_t CAVM_DPIX_PF_RAS_W1S(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_PF_RAS_W1S(uint64_t a)
{
    if (a==0)
        return 0x86e000010310ll + 0x1000000000ll * ((a) & 0x0);
...
static inline uint64_t CAVM_DPIX_PKT_ERR_RSP(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_DPIX_REQ_ERR_RSP(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_DPIX_REQ_ERR_RSP_EN(uint64_t a) __attribute__ ((pure, always_inline));
...
static inline uint64_t CAVM_DPIX_REQQX_INT(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_REQQX_INT(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=31))
        return 0x86e000012c00ll + 0x1000000000ll * ((a) & 0x0) + 0x20ll * ((b) & 0x1f);
...
union cavm_dpix_reqqx_int_ena_w1c
{
    ...
    struct cavm_dpix_reqqx_int_ena_w1c_s
    {
        ...
        uint64_t inst_dbo              : 1;  /**< [  4:  4](R/W1C/H) Reads or clears enable for DPI(0)_REQQ(0..31)_INT[INST_DBO]. */
        uint64_t csflt                 : 1;  /**< [  3:  3](R/W1C/H) Reads or clears enable for DPI(0)_REQQ(0..31)_INT[CSFLT]. */
        uint64_t wrflt                 : 1;  /**< [  2:  2](R/W1C/H) Reads or clears enable for DPI(0)_REQQ(0..31)_INT[WRFLT]. */
        uint64_t rdflt                 : 1;  /**< [  1:  1](R/W1C/H) Reads or clears enable for DPI(0)_REQQ(0..31)_INT[RDFLT]. */
        uint64_t instrflt              : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for DPI(0)_REQQ(0..31)_INT[INSTRFLT]. */
#else /* Word 0 - Little Endian */
        uint64_t instrflt              : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for DPI(0)_REQQ(0..31)_INT[INSTRFLT]. */
        uint64_t rdflt                 : 1;  /**< [  1:  1](R/W1C/H) Reads or clears enable for DPI(0)_REQQ(0..31)_INT[RDFLT]. */
        uint64_t wrflt                 : 1;  /**< [  2:  2](R/W1C/H) Reads or clears enable for DPI(0)_REQQ(0..31)_INT[WRFLT]. */
...
static inline uint64_t CAVM_DPIX_REQQX_INT_ENA_W1C(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_REQQX_INT_ENA_W1C(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=31))
        return 0x86e000013800ll + 0x1000000000ll * ((a) & 0x0) + 0x20ll * ((b) & 0x1f);
...
union cavm_dpix_reqqx_int_ena_w1s
{
    ...
    struct cavm_dpix_reqqx_int_ena_w1s_s
    {
        ...
        uint64_t inst_dbo              : 1;  /**< [  4:  4](R/W1S/H) Reads or sets enable for DPI(0)_REQQ(0..31)_INT[INST_DBO]. */
        uint64_t csflt                 : 1;  /**< [  3:  3](R/W1S/H) Reads or sets enable for DPI(0)_REQQ(0..31)_INT[CSFLT]. */
        uint64_t wrflt                 : 1;  /**< [  2:  2](R/W1S/H) Reads or sets enable for DPI(0)_REQQ(0..31)_INT[WRFLT]. */
        uint64_t rdflt                 : 1;  /**< [  1:  1](R/W1S/H) Reads or sets enable for DPI(0)_REQQ(0..31)_INT[RDFLT]. */
        uint64_t instrflt              : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for DPI(0)_REQQ(0..31)_INT[INSTRFLT]. */
#else /* Word 0 - Little Endian */
        uint64_t instrflt              : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for DPI(0)_REQQ(0..31)_INT[INSTRFLT]. */
        uint64_t rdflt                 : 1;  /**< [  1:  1](R/W1S/H) Reads or sets enable for DPI(0)_REQQ(0..31)_INT[RDFLT]. */
        uint64_t wrflt                 : 1;  /**< [  2:  2](R/W1S/H) Reads or sets enable for DPI(0)_REQQ(0..31)_INT[WRFLT]. */
...
static inline uint64_t CAVM_DPIX_REQQX_INT_ENA_W1S(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_REQQX_INT_ENA_W1S(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=31))
        return 0x86e000013c00ll + 0x1000000000ll * ((a) & 0x0) + 0x20ll * ((b) & 0x1f);
...
union cavm_dpix_reqqx_int_w1s
{
    ...
    struct cavm_dpix_reqqx_int_w1s_s
    {
        ...
        uint64_t inst_dbo              : 1;  /**< [  4:  4](R/W1S/H) Reads or sets DPI(0)_REQQ(0..31)_INT[INST_DBO]. */
        uint64_t csflt                 : 1;  /**< [  3:  3](R/W1S/H) Reads or sets DPI(0)_REQQ(0..31)_INT[CSFLT]. */
        uint64_t wrflt                 : 1;  /**< [  2:  2](R/W1S/H) Reads or sets DPI(0)_REQQ(0..31)_INT[WRFLT]. */
        uint64_t rdflt                 : 1;  /**< [  1:  1](R/W1S/H) Reads or sets DPI(0)_REQQ(0..31)_INT[RDFLT]. */
        uint64_t instrflt              : 1;  /**< [  0:  0](R/W1S/H) Reads or sets DPI(0)_REQQ(0..31)_INT[INSTRFLT]. */
#else /* Word 0 - Little Endian */
        uint64_t instrflt              : 1;  /**< [  0:  0](R/W1S/H) Reads or sets DPI(0)_REQQ(0..31)_INT[INSTRFLT]. */
        uint64_t rdflt                 : 1;  /**< [  1:  1](R/W1S/H) Reads or sets DPI(0)_REQQ(0..31)_INT[RDFLT]. */
        uint64_t wrflt                 : 1;  /**< [  2:  2](R/W1S/H) Reads or sets DPI(0)_REQQ(0..31)_INT[WRFLT]. */
...
static inline uint64_t CAVM_DPIX_REQQX_INT_W1S(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_REQQX_INT_W1S(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=31))
        return 0x86e000013000ll + 0x1000000000ll * ((a) & 0x0) + 0x20ll * ((b) & 0x1f);
...
/**
 * Register (NCB) dpi#_reqq_genbuff_th_limit
 *
 * DPI REQQ General Buffer High Threshold Configuration Register
 * The register throttles the general buffer limit based on the comparsion of the used buffer with
...
{
    uint64_t u;
    struct cavm_dpix_reqq_genbuff_th_limit_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_62_63        : 2;
    ...
    /* struct cavm_dpix_reqq_genbuff_th_limit_s cn; */
};
typedef union cavm_dpix_reqq_genbuff_th_limit cavm_dpix_reqq_genbuff_th_limit_t;

static inline uint64_t CAVM_DPIX_REQQ_GENBUFF_TH_LIMIT(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_REQQ_GENBUFF_TH_LIMIT(uint64_t a)
{
    if (a==0)
        return 0x86e000017000ll + 0x1000000000ll * ((a) & 0x0);
    __cavm_csr_fatal("DPIX_REQQ_GENBUFF_TH_LIMIT", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_DPIX_REQQ_GENBUFF_TH_LIMIT(a) cavm_dpix_reqq_genbuff_th_limit_t
#define bustype_CAVM_DPIX_REQQ_GENBUFF_TH_LIMIT(a) CSR_TYPE_NCB
#define basename_CAVM_DPIX_REQQ_GENBUFF_TH_LIMIT(a) "DPIX_REQQ_GENBUFF_TH_LIMIT"
...
static inline uint64_t CAVM_DPIX_VDMAX_CNT(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_VDMAX_CNT(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=31))
        return 0x86e200000038ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x1f);
...
static inline uint64_t CAVM_DPIX_VDMAX_COUNTS(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_VDMAX_COUNTS(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=31))
        return 0x86e200000020ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x1f);
...
static inline uint64_t CAVM_DPIX_VDMAX_DBELL(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_VDMAX_DBELL(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=31))
        return 0x86e200000010ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x1f);
...
static inline uint64_t CAVM_DPIX_VDMAX_EN(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_VDMAX_EN(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=31))
        return 0x86e200000000ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x1f);
...
static inline uint64_t CAVM_DPIX_VDMAX_IWBUSY(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_VDMAX_IWBUSY(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=31))
        return 0x86e200000030ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x1f);
...
static inline uint64_t CAVM_DPIX_VDMAX_NADDR(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_VDMAX_NADDR(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=31))
        return 0x86e200000028ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x1f);
...
static inline uint64_t CAVM_DPIX_VDMAX_REQQ_CTL(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_VDMAX_REQQ_CTL(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=31))
        return 0x86e200000008ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x1f);
...
static inline uint64_t CAVM_DPIX_VDMAX_SADDR(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_VDMAX_SADDR(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=31))
        return 0x86e200000018ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x1f);
...
static inline uint64_t CAVM_DPIX_VFX_INT(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_VFX_INT(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=31))
        return 0x86e200000100ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x1f);
...
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
        uint64_t complete              : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for DPI(0)_VF_INT[COMPLETE]. */
#else /* Word 0 - Little Endian */
        uint64_t complete              : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for DPI(0)_VF_INT[COMPLETE]. */
        uint64_t reserved_1_63         : 63;
#endif /* Word 0 - End */
...
static inline uint64_t CAVM_DPIX_VFX_INT_ENA_W1C(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_VFX_INT_ENA_W1C(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=31))
        return 0x86e200000110ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x1f);
...
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
        uint64_t complete              : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for DPI(0)_VF_INT[COMPLETE]. */
#else /* Word 0 - Little Endian */
        uint64_t complete              : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for DPI(0)_VF_INT[COMPLETE]. */
        uint64_t reserved_1_63         : 63;
#endif /* Word 0 - End */
...
static inline uint64_t CAVM_DPIX_VFX_INT_ENA_W1S(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_VFX_INT_ENA_W1S(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=31))
        return 0x86e200000118ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x1f);
...
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
        uint64_t complete              : 1;  /**< [  0:  0](R/W1S/H) Reads or sets DPI(0)_VF_INT[COMPLETE]. */
#else /* Word 0 - Little Endian */
        uint64_t complete              : 1;  /**< [  0:  0](R/W1S/H) Reads or sets DPI(0)_VF_INT[COMPLETE]. */
        uint64_t reserved_1_63         : 63;
#endif /* Word 0 - End */
...
static inline uint64_t CAVM_DPIX_VFX_INT_W1S(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_VFX_INT_W1S(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=31))
        return 0x86e200000108ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x1f);
...
static inline uint64_t CAVM_DPIX_VFX_MSIX_PBAX(uint64_t a, uint64_t b, uint64_t c) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_VFX_MSIX_PBAX(uint64_t a, uint64_t b, uint64_t c)
{
    if ((a==0) && (b<=31) && (c==0))
        return 0x86e2100f0000ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x1f) + 8ll * ((c) & 0x0);
...
static inline uint64_t CAVM_DPIX_VFX_MSIX_VECX_ADDR(uint64_t a, uint64_t b, uint64_t c) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_VFX_MSIX_VECX_ADDR(uint64_t a, uint64_t b, uint64_t c)
{
    if ((a==0) && (b<=31) && (c<=1))
        return 0x86e210000000ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x1f) + 0x10ll * ((c) & 0x1);
...
static inline uint64_t CAVM_DPIX_VFX_MSIX_VECX_CTL(uint64_t a, uint64_t b, uint64_t c) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DPIX_VFX_MSIX_VECX_CTL(uint64_t a, uint64_t b, uint64_t c)
{
    if ((a==0) && (b<=31) && (c<=1))
        return 0x86e210000008ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x1f) + 0x10ll * ((c) & 0x1);
...
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_6_63         : 58;
        uint64_t dtime                 : 2;  /**< [  5:  4](R/W1C/H) Reads or clears enable for SDP(0)_EPF(0..3)_DMA_RINT[DTIME]. */
        uint64_t dcnt                  : 2;  /**< [  3:  2](R/W1C/H) Reads or clears enable for SDP(0)_EPF(0..3)_DMA_RINT[DCNT]. */
        uint64_t dmafi                 : 2;  /**< [  1:  0](R/W1C/H) Reads or clears enable for SDP(0)_EPF(0..3)_DMA_RINT[DMAFI]. */
#else /* Word 0 - Little Endian */
        uint64_t dmafi                 : 2;  /**< [  1:  0](R/W1C/H) Reads or clears enable for SDP(0)_EPF(0..3)_DMA_RINT[DMAFI]. */
        uint64_t dcnt                  : 2;  /**< [  3:  2](R/W1C/H) Reads or clears enable for SDP(0)_EPF(0..3)_DMA_RINT[DCNT]. */
        uint64_t dtime                 : 2;  /**< [  5:  4](R/W1C/H) Reads or clears enable for SDP(0)_EPF(0..3)_DMA_RINT[DTIME]. */
...
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_6_63         : 58;
        uint64_t dtime                 : 2;  /**< [  5:  4](R/W1S/H) Reads or sets enable for SDP(0)_EPF(0..3)_DMA_RINT[DTIME]. */
        uint64_t dcnt                  : 2;  /**< [  3:  2](R/W1S/H) Reads or sets enable for SDP(0)_EPF(0..3)_DMA_RINT[DCNT]. */
        uint64_t dmafi                 : 2;  /**< [  1:  0](R/W1S/H) Reads or sets enable for SDP(0)_EPF(0..3)_DMA_RINT[DMAFI]. */
#else /* Word 0 - Little Endian */
        uint64_t dmafi                 : 2;  /**< [  1:  0](R/W1S/H) Reads or sets enable for SDP(0)_EPF(0..3)_DMA_RINT[DMAFI]. */
        uint64_t dcnt                  : 2;  /**< [  3:  2](R/W1S/H) Reads or sets enable for SDP(0)_EPF(0..3)_DMA_RINT[DCNT]. */
        uint64_t dtime                 : 2;  /**< [  5:  4](R/W1S/H) Reads or sets enable for SDP(0)_EPF(0..3)_DMA_RINT[DTIME]. */
...
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_6_63         : 58;
        uint64_t dtime                 : 2;  /**< [  5:  4](R/W1S/H) Reads or sets SDP(0)_EPF(0..3)_DMA_RINT[DTIME]. */
        uint64_t dcnt                  : 2;  /**< [  3:  2](R/W1S/H) Reads or sets SDP(0)_EPF(0..3)_DMA_RINT[DCNT]. */
        uint64_t dmafi                 : 2;  /**< [  1:  0](R/W1S/H) Reads or sets SDP(0)_EPF(0..3)_DMA_RINT[DMAFI]. */
#else /* Word 0 - Little Endian */
        uint64_t dmafi                 : 2;  /**< [  1:  0](R/W1S/H) Reads or sets SDP(0)_EPF(0..3)_DMA_RINT[DMAFI]. */
        uint64_t dcnt                  : 2;  /**< [  3:  2](R/W1S/H) Reads or sets SDP(0)_EPF(0..3)_DMA_RINT[DCNT]. */
        uint64_t dtime                 : 2;  /**< [  5:  4](R/W1S/H) Reads or sets SDP(0)_EPF(0..3)_DMA_RINT[DTIME]. */
...
{
    if ((a==0) && (b<=3))
        return 0x86e080020200ll + 0x1000000000ll * ((a) & 0x0) + 0x2000000ll * ((b) & 0x3);
...
union cavm_sdpx_epfx_ire_rint_ena_w1c
{
    ...
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t ring_err              : 64; /**< [ 63:  0](R/W1C/H) Reads or clears enable for SDP(0)_EPF(0..3)_IRE_RINT[RING_ERR]. */
#else /* Word 0 - Little Endian */
        uint64_t ring_err              : 64; /**< [ 63:  0](R/W1C/H) Reads or clears enable for SDP(0)_EPF(0..3)_IRE_RINT[RING_ERR]. */
#endif /* Word 0 - End */
    } s;
...
{
    if ((a==0) && (b<=3))
        return 0x86e080020220ll + 0x1000000000ll * ((a) & 0x0) + 0x2000000ll * ((b) & 0x3);
...
union cavm_sdpx_epfx_ire_rint_ena_w1s
{
    ...
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t ring_err              : 64; /**< [ 63:  0](R/W1S/H) Reads or sets enable for SDP(0)_EPF(0..3)_IRE_RINT[RING_ERR]. */
#else /* Word 0 - Little Endian */
        uint64_t ring_err              : 64; /**< [ 63:  0](R/W1S/H) Reads or sets enable for SDP(0)_EPF(0..3)_IRE_RINT[RING_ERR]. */
#endif /* Word 0 - End */
    } s;
...
{
    if ((a==0) && (b<=3))
        return 0x86e080020230ll + 0x1000000000ll * ((a) & 0x0) + 0x2000000ll * ((b) & 0x3);
...
union cavm_sdpx_epfx_ire_rint_w1s
{
    ...
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t ring_err              : 64; /**< [ 63:  0](R/W1S/H) Reads or sets SDP(0)_EPF(0..3)_IRE_RINT[RING_ERR]. */
#else /* Word 0 - Little Endian */
        uint64_t ring_err              : 64; /**< [ 63:  0](R/W1S/H) Reads or sets SDP(0)_EPF(0..3)_IRE_RINT[RING_ERR]. */
#endif /* Word 0 - End */
    } s;
...
{
    if ((a==0) && (b<=3))
        return 0x86e080020210ll + 0x1000000000ll * ((a) & 0x0) + 0x2000000ll * ((b) & 0x3);
...
{
    if ((a==0) && (b<=3))
        return 0x86e080020100ll + 0x1000000000ll * ((a) & 0x0) + 0x2000000ll * ((b) & 0x3);
...
union cavm_sdpx_epfx_mbox_rint_ena_w1c
{
    ...
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t ring_num              : 64; /**< [ 63:  0](R/W1C/H) Reads or clears enable for SDP(0)_EPF(0..3)_MBOX_RINT[RING_NUM]. */
#else /* Word 0 - Little Endian */
        uint64_t ring_num              : 64; /**< [ 63:  0](R/W1C/H) Reads or clears enable for SDP(0)_EPF(0..3)_MBOX_RINT[RING_NUM]. */
#endif /* Word 0 - End */
    } s;
...
{
    if ((a==0) && (b<=3))
        return 0x86e080020140ll + 0x1000000000ll * ((a) & 0x0) + 0x2000000ll * ((b) & 0x3);
...
union cavm_sdpx_epfx_mbox_rint_ena_w1s
{
    ...
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t ring_num              : 64; /**< [ 63:  0](R/W1S/H) Reads or sets enable for SDP(0)_EPF(0..3)_MBOX_RINT[RING_NUM]. */
#else /* Word 0 - Little Endian */
        uint64_t ring_num              : 64; /**< [ 63:  0](R/W1S/H) Reads or sets enable for SDP(0)_EPF(0..3)_MBOX_RINT[RING_NUM]. */
#endif /* Word 0 - End */
    } s;
...
{
    if ((a==0) && (b<=3))
        return 0x86e080020160ll + 0x1000000000ll * ((a) & 0x0) + 0x2000000ll * ((b) & 0x3);
...
union cavm_sdpx_epfx_mbox_rint_w1s
{
    ...
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t ring_num              : 64; /**< [ 63:  0](R/W1S/H) Reads or sets SDP(0)_EPF(0..3)_MBOX_RINT[RING_NUM]. */
#else /* Word 0 - Little Endian */
        uint64_t ring_num              : 64; /**< [ 63:  0](R/W1S/H) Reads or sets SDP(0)_EPF(0..3)_MBOX_RINT[RING_NUM]. */
#endif /* Word 0 - End */
    } s;
...
{
    if ((a==0) && (b<=3))
        return 0x86e080020120ll + 0x1000000000ll * ((a) & 0x0) + 0x2000000ll * ((b) & 0x3);
...
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_6_63         : 58;
        uint64_t dmapf_err             : 1;  /**< [  5:  5](R/W1C/H) Reads or clears enable for SDP(0)_EPF(0..3)_MISC_RINT[DMAPF_ERR]. */
        uint64_t pppf_err              : 1;  /**< [  4:  4](R/W1C/H) Reads or clears enable for SDP(0)_EPF(0..3)_MISC_RINT[PPPF_ERR]. */
        uint64_t un_wi                 : 1;  /**< [  3:  3](R/W1C/H) Reads or clears enable for SDP(0)_EPF(0..3)_MISC_RINT[UN_WI]. */
        uint64_t un_b0                 : 1;  /**< [  2:  2](R/W1C/H) Reads or clears enable for SDP(0)_EPF(0..3)_MISC_RINT[UN_B0]. */
        uint64_t up_wi                 : 1;  /**< [  1:  1](R/W1C/H) Reads or clears enable for SDP(0)_EPF(0..3)_MISC_RINT[UP_WI]. */
        uint64_t up_b0                 : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for SDP(0)_EPF(0..3)_MISC_RINT[UP_B0]. */
#else /* Word 0 - Little Endian */
        uint64_t up_b0                 : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for SDP(0)_EPF(0..3)_MISC_RINT[UP_B0]. */
        uint64_t up_wi                 : 1;  /**< [  1:  1](R/W1C/H) Reads or clears enable for SDP(0)_EPF(0..3)_MISC_RINT[UP_WI]. */
        uint64_t un_b0                 : 1;  /**< [  2:  2](R/W1C/H) Reads or clears enable for SDP(0)_EPF(0..3)_MISC_RINT[UN_B0]. */
...
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_6_63         : 58;
        uint64_t dmapf_err             : 1;  /**< [  5:  5](R/W1S/H) Reads or sets enable for SDP(0)_EPF(0..3)_MISC_RINT[DMAPF_ERR]. */
        uint64_t pppf_err              : 1;  /**< [  4:  4](R/W1S/H) Reads or sets enable for SDP(0)_EPF(0..3)_MISC_RINT[PPPF_ERR]. */
        uint64_t un_wi                 : 1;  /**< [  3:  3](R/W1S/H) Reads or sets enable for SDP(0)_EPF(0..3)_MISC_RINT[UN_WI]. */
        uint64_t un_b0                 : 1;  /**< [  2:  2](R/W1S/H) Reads or sets enable for SDP(0)_EPF(0..3)_MISC_RINT[UN_B0]. */
        uint64_t up_wi                 : 1;  /**< [  1:  1](R/W1S/H) Reads or sets enable for SDP(0)_EPF(0..3)_MISC_RINT[UP_WI]. */
        uint64_t up_b0                 : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for SDP(0)_EPF(0..3)_MISC_RINT[UP_B0]. */
#else /* Word 0 - Little Endian */
        uint64_t up_b0                 : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for SDP(0)_EPF(0..3)_MISC_RINT[UP_B0]. */
        uint64_t up_wi                 : 1;  /**< [  1:  1](R/W1S/H) Reads or sets enable for SDP(0)_EPF(0..3)_MISC_RINT[UP_WI]. */
        uint64_t un_b0                 : 1;  /**< [  2:  2](R/W1S/H) Reads or sets enable for SDP(0)_EPF(0..3)_MISC_RINT[UN_B0]. */
...
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_6_63         : 58;
        uint64_t dmapf_err             : 1;  /**< [  5:  5](R/W1S/H) Reads or sets SDP(0)_EPF(0..3)_MISC_RINT[DMAPF_ERR]. */
        uint64_t pppf_err              : 1;  /**< [  4:  4](R/W1S/H) Reads or sets SDP(0)_EPF(0..3)_MISC_RINT[PPPF_ERR]. */
        uint64_t un_wi                 : 1;  /**< [  3:  3](R/W1S/H) Reads or sets SDP(0)_EPF(0..3)_MISC_RINT[UN_WI]. */
        uint64_t un_b0                 : 1;  /**< [  2:  2](R/W1S/H) Reads or sets SDP(0)_EPF(0..3)_MISC_RINT[UN_B0]. */
        uint64_t up_wi                 : 1;  /**< [  1:  1](R/W1S/H) Reads or sets SDP(0)_EPF(0..3)_MISC_RINT[UP_WI]. */
        uint64_t up_b0                 : 1;  /**< [  0:  0](R/W1S/H) Reads or sets SDP(0)_EPF(0..3)_MISC_RINT[UP_B0]. */
#else /* Word 0 - Little Endian */
        uint64_t up_b0                 : 1;  /**< [  0:  0](R/W1S/H) Reads or sets SDP(0)_EPF(0..3)_MISC_RINT[UP_B0]. */
        uint64_t up_wi                 : 1;  /**< [  1:  1](R/W1S/H) Reads or sets SDP(0)_EPF(0..3)_MISC_RINT[UP_WI]. */
        uint64_t un_b0                 : 1;  /**< [  2:  2](R/W1S/H) Reads or sets SDP(0)_EPF(0..3)_MISC_RINT[UN_B0]. */
...
{
    if ((a==0) && (b<=3))
        return 0x86e080020320ll + 0x1000000000ll * ((a) & 0x0) + 0x2000000ll * ((b) & 0x3);
...
union cavm_sdpx_epfx_ore_rint_ena_w1c
{
    ...
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t ring_err              : 64; /**< [ 63:  0](R/W1C/H) Reads or clears enable for SDP(0)_EPF(0..3)_ORE_RINT[RING_ERR]. */
#else /* Word 0 - Little Endian */
        uint64_t ring_err              : 64; /**< [ 63:  0](R/W1C/H) Reads or clears enable for SDP(0)_EPF(0..3)_ORE_RINT[RING_ERR]. */
#endif /* Word 0 - End */
    } s;
...
{
    if ((a==0) && (b<=3))
        return 0x86e080020340ll + 0x1000000000ll * ((a) & 0x0) + 0x2000000ll * ((b) & 0x3);
...
union cavm_sdpx_epfx_ore_rint_ena_w1s
{
    ...
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t ring_err              : 64; /**< [ 63:  0](R/W1S/H) Reads or sets enable for SDP(0)_EPF(0..3)_ORE_RINT[RING_ERR]. */
#else /* Word 0 - Little Endian */
        uint64_t ring_err              : 64; /**< [ 63:  0](R/W1S/H) Reads or sets enable for SDP(0)_EPF(0..3)_ORE_RINT[RING_ERR]. */
#endif /* Word 0 - End */
    } s;
...
{
    if ((a==0) && (b<=3))
        return 0x86e080020350ll + 0x1000000000ll * ((a) & 0x0) + 0x2000000ll * ((b) & 0x3);
...
union cavm_sdpx_epfx_ore_rint_w1s
{
    ...
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t ring_err              : 64; /**< [ 63:  0](R/W1S/H) Reads or sets SDP(0)_EPF(0..3)_ORE_RINT[RING_ERR]. */
#else /* Word 0 - Little Endian */
        uint64_t ring_err              : 64; /**< [ 63:  0](R/W1S/H) Reads or sets SDP(0)_EPF(0..3)_ORE_RINT[RING_ERR]. */
#endif /* Word 0 - End */
    } s;
...
{
    if ((a==0) && (b<=3))
        return 0x86e080020330ll + 0x1000000000ll * ((a) & 0x0) + 0x2000000ll * ((b) & 0x3);
 ...
 * These registers are not affected by VF FLR.
 *
 * Note: EPF(0..1) are mapped to MAC0, EPF1(2..3) are mapped to MAC2.
 */
...
{
    if ((a==0) && (b<=3) && (c<=1))
        return 0x86e080004000ll + 0x1000000000ll * ((a) & 0x0) + 0x2000000ll * ((b) & 0x3) + 8ll * ((c) & 0x1);
...
union cavm_sdpx_epvf_ringx
{
    ...
    struct cavm_sdpx_epvf_ringx_s
    {
        ...
        uint64_t epvf                  : 9;  /**< [  8:  0](R/W) The function that a ring belongs to.
...
static inline uint64_t CAVM_SDPX_IRE_LINTX(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_SDPX_IRE_LINTX(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=1))
        return 0x86e0c0080400ll + 0x1000000000ll * ((a) & 0x0) + 0x10ll * ((b) & 0x1);
...
union cavm_sdpx_ire_lint_ena_w1cx
{
    ...
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t ring_err              : 64; /**< [ 63:  0](R/W1C/H) Reads or clears enable for SDP(0)_IRE_LINT(0..1)[RING_ERR]. */
#else /* Word 0 - Little Endian */
        uint64_t ring_err              : 64; /**< [ 63:  0](R/W1C/H) Reads or clears enable for SDP(0)_IRE_LINT(0..1)[RING_ERR]. */
#endif /* Word 0 - End */
    } s;
...
static inline uint64_t CAVM_SDPX_IRE_LINT_ENA_W1CX(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_SDPX_IRE_LINT_ENA_W1CX(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=1))
        return 0x86e0c0080600ll + 0x1000000000ll * ((a) & 0x0) + 0x10ll * ((b) & 0x1);
...
union cavm_sdpx_ire_lint_ena_w1sx
{
    ...
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t ring_err              : 64; /**< [ 63:  0](R/W1S/H) Reads or sets enable for SDP(0)_IRE_LINT(0..1)[RING_ERR]. */
#else /* Word 0 - Little Endian */
        uint64_t ring_err              : 64; /**< [ 63:  0](R/W1S/H) Reads or sets enable for SDP(0)_IRE_LINT(0..1)[RING_ERR]. */
#endif /* Word 0 - End */
    } s;
...
static inline uint64_t CAVM_SDPX_IRE_LINT_ENA_W1SX(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_SDPX_IRE_LINT_ENA_W1SX(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=1))
        return 0x86e0c0080700ll + 0x1000000000ll * ((a) & 0x0) + 0x10ll * ((b) & 0x1);
...
union cavm_sdpx_ire_lint_w1sx
{
    ...
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t ring_err              : 64; /**< [ 63:  0](R/W1S/H) Reads or sets SDP(0)_IRE_LINT(0..1)[RING_ERR]. */
#else /* Word 0 - Little Endian */
        uint64_t ring_err              : 64; /**< [ 63:  0](R/W1S/H) Reads or sets SDP(0)_IRE_LINT(0..1)[RING_ERR]. */
#endif /* Word 0 - End */
    } s;
...
static inline uint64_t CAVM_SDPX_IRE_LINT_W1SX(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_SDPX_IRE_LINT_W1SX(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=1))
        return 0x86e0c0080500ll + 0x1000000000ll * ((a) & 0x0) + 0x10ll * ((b) & 0x1);
 ...
 *
 * Internal:
 * "* SDP(0)_LMAC_CONST0/1(0) [ V=1 EP=1 IFTY=0 IFN=0 MAC=0 PF=2 EPF=0 VFS=64
 * VRINGS=128 PRINGS=32 TRINGS=128].
 * * SDP(0)_LMAC_CONST0/1(1) [ V=1 EP=0 IFTY=0 IFN=1 MAC=1 PF=2 EPF=0 VFS=0   VRINGS=0
 * PRINGS=0  TRINGS=0  ].
 * * SDP(0)_LMAC_CONST0/1(2) [ V=1 EP=0 IFTY=0 IFN=2 MAC=2 PF=2 EPF=0 VFS=0
 * VRINGS=0 PRINGS=0 TRINGS=0].
 * * SDP(0)_LMAC_CONST0/1(3) [ V=1 EP=0 IFTY=0 IFN=3 MAC=3 PF=2 EPF=0 VFS=0   VRINGS=0
 * PRINGS=0  TRINGS=0  ].
...
union cavm_sdpx_macx_pf_ring_ctl
{
    ...
    struct cavm_sdpx_macx_pf_ring_ctl_s
    {
        ...
        uint64_t reserved_2_7          : 6;
        uint64_t npfs                  : 2;  /**< [  1:  0](R/W) Number of PFs for this MAC. */
#else /* Word 0 - Little Endian */
        uint64_t npfs                  : 2;  /**< [  1:  0](R/W) Number of PFs for this MAC. */
        uint64_t reserved_2_7          : 6;
        uint64_t srn                   : 7;  /**< [ 14:  8](R/W) Starting ring number of PF rings. */
...
static inline uint64_t CAVM_SDPX_ORE_LINTX(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_SDPX_ORE_LINTX(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=1))
        return 0x86e0c0080800ll + 0x1000000000ll * ((a) & 0x0) + 0x10ll * ((b) & 0x1);
...
union cavm_sdpx_ore_lint_ena_w1cx
{
    ...
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t ring_err              : 64; /**< [ 63:  0](R/W1C/H) Reads or clears enable for SDP(0)_ORE_LINT(0..1)[RING_ERR]. */
#else /* Word 0 - Little Endian */
        uint64_t ring_err              : 64; /**< [ 63:  0](R/W1C/H) Reads or clears enable for SDP(0)_ORE_LINT(0..1)[RING_ERR]. */
#endif /* Word 0 - End */
    } s;
...
static inline uint64_t CAVM_SDPX_ORE_LINT_ENA_W1CX(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_SDPX_ORE_LINT_ENA_W1CX(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=1))
        return 0x86e0c0080a00ll + 0x1000000000ll * ((a) & 0x0) + 0x10ll * ((b) & 0x1);
...
union cavm_sdpx_ore_lint_ena_w1sx
{
    ...
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t ring_err              : 64; /**< [ 63:  0](R/W1S/H) Reads or sets enable for SDP(0)_ORE_LINT(0..1)[RING_ERR]. */
#else /* Word 0 - Little Endian */
        uint64_t ring_err              : 64; /**< [ 63:  0](R/W1S/H) Reads or sets enable for SDP(0)_ORE_LINT(0..1)[RING_ERR]. */
#endif /* Word 0 - End */
    } s;
...
static inline uint64_t CAVM_SDPX_ORE_LINT_ENA_W1SX(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_SDPX_ORE_LINT_ENA_W1SX(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=1))
        return 0x86e0c0080b00ll + 0x1000000000ll * ((a) & 0x0) + 0x10ll * ((b) & 0x1);
...
union cavm_sdpx_ore_lint_w1sx
{
    ...
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t ring_err              : 64; /**< [ 63:  0](R/W1S/H) Reads or sets SDP(0)_ORE_LINT(0..1)[RING_ERR]. */
#else /* Word 0 - Little Endian */
        uint64_t ring_err              : 64; /**< [ 63:  0](R/W1S/H) Reads or sets SDP(0)_ORE_LINT(0..1)[RING_ERR]. */
#endif /* Word 0 - End */
    } s;
...
static inline uint64_t CAVM_SDPX_ORE_LINT_W1SX(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_SDPX_ORE_LINT_W1SX(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=1))
        return 0x86e0c0080900ll + 0x1000000000ll * ((a) & 0x0) + 0x10ll * ((b) & 0x1);
...
static inline uint64_t CAVM_SDPX_WIN_RD_ADDR(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_SDPX_WIN_RD_ADDR(uint64_t a)
{
    if (a==0)
...
static inline uint64_t CAVM_SDPX_WIN_RD_DATA(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_SDPX_WIN_RD_DATA(uint64_t a)
{
    if (a==0)
...
static inline uint64_t CAVM_SDPX_WIN_WR_ADDR(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_SDPX_WIN_WR_ADDR(uint64_t a)
{
    if (a==0)
...
static inline uint64_t CAVM_SDPX_WIN_WR_DATA(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_SDPX_WIN_WR_DATA(uint64_t a)
{
    if (a==0)
...
static inline uint64_t CAVM_SDPX_WIN_WR_MASK(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_SDPX_WIN_WR_MASK(uint64_t a)
{
    if (a==0)
