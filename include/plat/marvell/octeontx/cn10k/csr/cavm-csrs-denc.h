...
/**
 * Register (RSL) denc#_ab#_control
 *
 * DENC Control Register
 */
union cavm_dencx_abx_control
{
    uint64_t u;
    struct cavm_dencx_abx_control_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_dencx_abx_control_s cn; */
};
typedef union cavm_dencx_abx_control cavm_dencx_abx_control_t;
...
#define typedef_CAVM_DENCX_ABX_CONTROL(a,b) cavm_dencx_abx_control_t
#define bustype_CAVM_DENCX_ABX_CONTROL(a,b) CSR_TYPE_RSL
#define basename_CAVM_DENCX_ABX_CONTROL(a,b) "DENCX_ABX_CONTROL"
#define busnum_CAVM_DENCX_ABX_CONTROL(a,b) (a)
#define arguments_CAVM_DENCX_ABX_CONTROL(a,b) (a),(b),-1,-1

/**
 * Register (RSL) denc#_ab#_eco
 *
 * INTERNAL: DENC ECO Register
 */
union cavm_dencx_abx_eco
{
    uint64_t u;
    struct cavm_dencx_abx_eco_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_dencx_abx_eco_s cn; */
};
typedef union cavm_dencx_abx_eco cavm_dencx_abx_eco_t;

static inline uint64_t CAVM_DENCX_ABX_ECO(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DENCX_ABX_ECO(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=2))
        return 0x87e042080008ll + 0ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x3);
    __cavm_csr_fatal("DENCX_ABX_ECO", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_DENCX_ABX_ECO(a,b) cavm_dencx_abx_eco_t
#define bustype_CAVM_DENCX_ABX_ECO(a,b) CSR_TYPE_RSL
#define basename_CAVM_DENCX_ABX_ECO(a,b) "DENCX_ABX_ECO"
#define busnum_CAVM_DENCX_ABX_ECO(a,b) (a)
#define arguments_CAVM_DENCX_ABX_ECO(a,b) (a),(b),-1,-1

/**
 * Register (RSL) denc#_ab#_error_enable0
 *
 * Error Enable 0 Register
 * This register enables error reporting for read overflow/underflow errors.
 */
union cavm_dencx_abx_error_enable0
{
    uint64_t u;
    struct cavm_dencx_abx_error_enable0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_dencx_abx_error_enable0_s cn; */
};
typedef union cavm_dencx_abx_error_enable0 cavm_dencx_abx_error_enable0_t;
...
#define typedef_CAVM_DENCX_ABX_ERROR_ENABLE0(a,b) cavm_dencx_abx_error_enable0_t
#define bustype_CAVM_DENCX_ABX_ERROR_ENABLE0(a,b) CSR_TYPE_RSL
#define basename_CAVM_DENCX_ABX_ERROR_ENABLE0(a,b) "DENCX_ABX_ERROR_ENABLE0"
#define busnum_CAVM_DENCX_ABX_ERROR_ENABLE0(a,b) (a)
#define arguments_CAVM_DENCX_ABX_ERROR_ENABLE0(a,b) (a),(b),-1,-1

/**
 * Register (RSL) denc#_ab#_error_source0
 *
 * DENC Error Source 0 Register
 * This register indicates the source of overflow/underflow errors.
 */
union cavm_dencx_abx_error_source0
{
    uint64_t u;
    struct cavm_dencx_abx_error_source0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_dencx_abx_error_source0_s cn; */
};
typedef union cavm_dencx_abx_error_source0 cavm_dencx_abx_error_source0_t;
...
#define typedef_CAVM_DENCX_ABX_ERROR_SOURCE0(a,b) cavm_dencx_abx_error_source0_t
#define bustype_CAVM_DENCX_ABX_ERROR_SOURCE0(a,b) CSR_TYPE_RSL
#define basename_CAVM_DENCX_ABX_ERROR_SOURCE0(a,b) "DENCX_ABX_ERROR_SOURCE0"
#define busnum_CAVM_DENCX_ABX_ERROR_SOURCE0(a,b) (a)
#define arguments_CAVM_DENCX_ABX_ERROR_SOURCE0(a,b) (a),(b),-1,-1

/**
 * Register (RSL) denc#_ab#_hab_jcfg0_ram#_data
 *
...
{
    uint64_t u;
    struct cavm_dencx_abx_hab_jcfg0_ramx_data_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_dencx_abx_hab_jcfg0_ramx_data_s cn; */
};
typedef union cavm_dencx_abx_hab_jcfg0_ramx_data cavm_dencx_abx_hab_jcfg0_ramx_data_t;
...
#define typedef_CAVM_DENCX_ABX_HAB_JCFG0_RAMX_DATA(a,b,c) cavm_dencx_abx_hab_jcfg0_ramx_data_t
#define bustype_CAVM_DENCX_ABX_HAB_JCFG0_RAMX_DATA(a,b,c) CSR_TYPE_RSL
#define basename_CAVM_DENCX_ABX_HAB_JCFG0_RAMX_DATA(a,b,c) "DENCX_ABX_HAB_JCFG0_RAMX_DATA"
#define busnum_CAVM_DENCX_ABX_HAB_JCFG0_RAMX_DATA(a,b,c) (a)
#define arguments_CAVM_DENCX_ABX_HAB_JCFG0_RAMX_DATA(a,b,c) (a),(b),(c),-1

/**
 * Register (RSL) denc#_ab#_hab_jcfg1_ram#_data
 *
...
{
    uint64_t u;
    struct cavm_dencx_abx_hab_jcfg1_ramx_data_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t entry                 : 64; /**< [ 63:  0](R/W/H) Job configuration RAM entry. */
#else /* Word 0 - Little Endian */
    ...
    /* struct cavm_dencx_abx_hab_jcfg1_ramx_data_s cn; */
};
typedef union cavm_dencx_abx_hab_jcfg1_ramx_data cavm_dencx_abx_hab_jcfg1_ramx_data_t;
...
#define typedef_CAVM_DENCX_ABX_HAB_JCFG1_RAMX_DATA(a,b,c) cavm_dencx_abx_hab_jcfg1_ramx_data_t
#define bustype_CAVM_DENCX_ABX_HAB_JCFG1_RAMX_DATA(a,b,c) CSR_TYPE_RSL
#define basename_CAVM_DENCX_ABX_HAB_JCFG1_RAMX_DATA(a,b,c) "DENCX_ABX_HAB_JCFG1_RAMX_DATA"
#define busnum_CAVM_DENCX_ABX_HAB_JCFG1_RAMX_DATA(a,b,c) (a)
#define arguments_CAVM_DENCX_ABX_HAB_JCFG1_RAMX_DATA(a,b,c) (a),(b),(c),-1

/**
 * Register (RSL) denc#_ab#_hab_jcfg2_ram#_data
 *
...
{
    uint64_t u;
    struct cavm_dencx_abx_hab_jcfg2_ramx_data_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t entry                 : 64; /**< [ 63:  0](R/W/H) Job configuration RAM entry. */
#else /* Word 0 - Little Endian */
    ...
    /* struct cavm_dencx_abx_hab_jcfg2_ramx_data_s cn; */
};
typedef union cavm_dencx_abx_hab_jcfg2_ramx_data cavm_dencx_abx_hab_jcfg2_ramx_data_t;
...
#define typedef_CAVM_DENCX_ABX_HAB_JCFG2_RAMX_DATA(a,b,c) cavm_dencx_abx_hab_jcfg2_ramx_data_t
#define bustype_CAVM_DENCX_ABX_HAB_JCFG2_RAMX_DATA(a,b,c) CSR_TYPE_RSL
#define basename_CAVM_DENCX_ABX_HAB_JCFG2_RAMX_DATA(a,b,c) "DENCX_ABX_HAB_JCFG2_RAMX_DATA"
#define busnum_CAVM_DENCX_ABX_HAB_JCFG2_RAMX_DATA(a,b,c) (a)
#define arguments_CAVM_DENCX_ABX_HAB_JCFG2_RAMX_DATA(a,b,c) (a),(b),(c),-1

/**
 * Register (RSL) denc#_ab#_scratch
 *
 * INTERNAL: Scratch Register
 *
 * Scratch register.
 */
union cavm_dencx_abx_scratch
{
    uint64_t u;
    struct cavm_dencx_abx_scratch_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_dencx_abx_scratch_s cn; */
};
typedef union cavm_dencx_abx_scratch cavm_dencx_abx_scratch_t;

static inline uint64_t CAVM_DENCX_ABX_SCRATCH(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DENCX_ABX_SCRATCH(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=2))
        return 0x87e042080080ll + 0ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x3);
    __cavm_csr_fatal("DENCX_ABX_SCRATCH", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_DENCX_ABX_SCRATCH(a,b) cavm_dencx_abx_scratch_t
#define bustype_CAVM_DENCX_ABX_SCRATCH(a,b) CSR_TYPE_RSL
#define basename_CAVM_DENCX_ABX_SCRATCH(a,b) "DENCX_ABX_SCRATCH"
#define busnum_CAVM_DENCX_ABX_SCRATCH(a,b) (a)
#define arguments_CAVM_DENCX_ABX_SCRATCH(a,b) (a),(b),-1,-1

/**
 * Register (RSL) denc#_ab#_status
 *
 * DENC Status Register
 */
union cavm_dencx_abx_status
{
    uint64_t u;
    struct cavm_dencx_abx_status_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_5_63         : 59;
    ...
    /* struct cavm_dencx_abx_status_s cn; */
};
typedef union cavm_dencx_abx_status cavm_dencx_abx_status_t;
...
#define typedef_CAVM_DENCX_ABX_STATUS(a,b) cavm_dencx_abx_status_t
#define bustype_CAVM_DENCX_ABX_STATUS(a,b) CSR_TYPE_RSL
#define basename_CAVM_DENCX_ABX_STATUS(a,b) "DENCX_ABX_STATUS"
#define busnum_CAVM_DENCX_ABX_STATUS(a,b) (a)
#define arguments_CAVM_DENCX_ABX_STATUS(a,b) (a),(b),-1,-1

/**
 * Register (RSL) denc#_ab#_tc_cfg_err_flags_reg
 *
 ...
 */
union cavm_dencx_abx_tc_cfg_err_flags_reg
{
    uint64_t u;
    struct cavm_dencx_abx_tc_cfg_err_flags_reg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_dencx_abx_tc_cfg_err_flags_reg_s cn; */
};
typedef union cavm_dencx_abx_tc_cfg_err_flags_reg cavm_dencx_abx_tc_cfg_err_flags_reg_t;
...
#define typedef_CAVM_DENCX_ABX_TC_CFG_ERR_FLAGS_REG(a,b) cavm_dencx_abx_tc_cfg_err_flags_reg_t
#define bustype_CAVM_DENCX_ABX_TC_CFG_ERR_FLAGS_REG(a,b) CSR_TYPE_RSL
#define basename_CAVM_DENCX_ABX_TC_CFG_ERR_FLAGS_REG(a,b) "DENCX_ABX_TC_CFG_ERR_FLAGS_REG"
#define busnum_CAVM_DENCX_ABX_TC_CFG_ERR_FLAGS_REG(a,b) (a)
#define arguments_CAVM_DENCX_ABX_TC_CFG_ERR_FLAGS_REG(a,b) (a),(b),-1,-1

/**
 * Register (RSL) denc#_ab#_tc_config_reg#
 *
 * INTERNAL: TC Task Config Registers
 *
 * TC task config registers.
 */
union cavm_dencx_abx_tc_config_regx
{
    uint64_t u;
    struct cavm_dencx_abx_tc_config_regx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_dencx_abx_tc_config_regx_s cn; */
};
typedef union cavm_dencx_abx_tc_config_regx cavm_dencx_abx_tc_config_regx_t;

static inline uint64_t CAVM_DENCX_ABX_TC_CONFIG_REGX(uint64_t a, uint64_t b, uint64_t c) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DENCX_ABX_TC_CONFIG_REGX(uint64_t a, uint64_t b, uint64_t c)
{
    if ((a==0) && (b<=2) && (c<=44))
        return 0x87e042081400ll + 0ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x3) + 8ll * ((c) & 0x3f);
    __cavm_csr_fatal("DENCX_ABX_TC_CONFIG_REGX", 3, a, b, c, 0, 0, 0);
}

#define typedef_CAVM_DENCX_ABX_TC_CONFIG_REGX(a,b,c) cavm_dencx_abx_tc_config_regx_t
#define bustype_CAVM_DENCX_ABX_TC_CONFIG_REGX(a,b,c) CSR_TYPE_RSL
#define basename_CAVM_DENCX_ABX_TC_CONFIG_REGX(a,b,c) "DENCX_ABX_TC_CONFIG_REGX"
#define busnum_CAVM_DENCX_ABX_TC_CONFIG_REGX(a,b,c) (a)
#define arguments_CAVM_DENCX_ABX_TC_CONFIG_REGX(a,b,c) (a),(b),(c),-1

/**
 * Register (RSL) denc#_ab#_tc_control_reg
 *
 * DENC Encoder Control Register
 * This register configures the internal DENC encoder core.
 */
union cavm_dencx_abx_tc_control_reg
{
    uint64_t u;
    struct cavm_dencx_abx_tc_control_reg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_5_63         : 59;
    ...
    /* struct cavm_dencx_abx_tc_control_reg_s cn; */
};
typedef union cavm_dencx_abx_tc_control_reg cavm_dencx_abx_tc_control_reg_t;
...
#define typedef_CAVM_DENCX_ABX_TC_CONTROL_REG(a,b) cavm_dencx_abx_tc_control_reg_t
#define bustype_CAVM_DENCX_ABX_TC_CONTROL_REG(a,b) CSR_TYPE_RSL
#define basename_CAVM_DENCX_ABX_TC_CONTROL_REG(a,b) "DENCX_ABX_TC_CONTROL_REG"
#define busnum_CAVM_DENCX_ABX_TC_CONTROL_REG(a,b) (a)
#define arguments_CAVM_DENCX_ABX_TC_CONTROL_REG(a,b) (a),(b),-1,-1

/**
 * Register (RSL) denc#_ab#_tc_error_mask_reg
 *
 ...
 */
union cavm_dencx_abx_tc_error_mask_reg
{
    uint64_t u;
    struct cavm_dencx_abx_tc_error_mask_reg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
    ...
    /* struct cavm_dencx_abx_tc_error_mask_reg_s cn; */
};
typedef union cavm_dencx_abx_tc_error_mask_reg cavm_dencx_abx_tc_error_mask_reg_t;
...
#define typedef_CAVM_DENCX_ABX_TC_ERROR_MASK_REG(a,b) cavm_dencx_abx_tc_error_mask_reg_t
#define bustype_CAVM_DENCX_ABX_TC_ERROR_MASK_REG(a,b) CSR_TYPE_RSL
#define basename_CAVM_DENCX_ABX_TC_ERROR_MASK_REG(a,b) "DENCX_ABX_TC_ERROR_MASK_REG"
#define busnum_CAVM_DENCX_ABX_TC_ERROR_MASK_REG(a,b) (a)
#define arguments_CAVM_DENCX_ABX_TC_ERROR_MASK_REG(a,b) (a),(b),-1,-1

/**
 * Register (RSL) denc#_ab#_tc_error_reg
 *
 ...
 * the error(s).
 */
union cavm_dencx_abx_tc_error_reg
{
    uint64_t u;
    struct cavm_dencx_abx_tc_error_reg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_dencx_abx_tc_error_reg_s cn; */
};
typedef union cavm_dencx_abx_tc_error_reg cavm_dencx_abx_tc_error_reg_t;
...
#define typedef_CAVM_DENCX_ABX_TC_ERROR_REG(a,b) cavm_dencx_abx_tc_error_reg_t
#define bustype_CAVM_DENCX_ABX_TC_ERROR_REG(a,b) CSR_TYPE_RSL
#define basename_CAVM_DENCX_ABX_TC_ERROR_REG(a,b) "DENCX_ABX_TC_ERROR_REG"
#define busnum_CAVM_DENCX_ABX_TC_ERROR_REG(a,b) (a)
#define arguments_CAVM_DENCX_ABX_TC_ERROR_REG(a,b) (a),(b),-1,-1

/**
 * Register (RSL) denc#_ab#_tc_main_reset_reg
 *
 * DENC Encoder Reset Register
 * This register provides a reset for the internal encoder core.
 */
union cavm_dencx_abx_tc_main_reset_reg
{
    uint64_t u;
    struct cavm_dencx_abx_tc_main_reset_reg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_dencx_abx_tc_main_reset_reg_s cn; */
};
typedef union cavm_dencx_abx_tc_main_reset_reg cavm_dencx_abx_tc_main_reset_reg_t;
...
#define typedef_CAVM_DENCX_ABX_TC_MAIN_RESET_REG(a,b) cavm_dencx_abx_tc_main_reset_reg_t
#define bustype_CAVM_DENCX_ABX_TC_MAIN_RESET_REG(a,b) CSR_TYPE_RSL
#define basename_CAVM_DENCX_ABX_TC_MAIN_RESET_REG(a,b) "DENCX_ABX_TC_MAIN_RESET_REG"
#define busnum_CAVM_DENCX_ABX_TC_MAIN_RESET_REG(a,b) (a)
#define arguments_CAVM_DENCX_ABX_TC_MAIN_RESET_REG(a,b) (a),(b),-1,-1

/**
 * Register (RSL) denc#_ab#_tc_main_start_reg
 *
 * INTERNAL: TC Start Register
 *
 * TC start register.
 */
union cavm_dencx_abx_tc_main_start_reg
{
    uint64_t u;
    struct cavm_dencx_abx_tc_main_start_reg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_dencx_abx_tc_main_start_reg_s cn; */
};
typedef union cavm_dencx_abx_tc_main_start_reg cavm_dencx_abx_tc_main_start_reg_t;

static inline uint64_t CAVM_DENCX_ABX_TC_MAIN_START_REG(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DENCX_ABX_TC_MAIN_START_REG(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=2))
        return 0x87e042081008ll + 0ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x3);
    __cavm_csr_fatal("DENCX_ABX_TC_MAIN_START_REG", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_DENCX_ABX_TC_MAIN_START_REG(a,b) cavm_dencx_abx_tc_main_start_reg_t
#define bustype_CAVM_DENCX_ABX_TC_MAIN_START_REG(a,b) CSR_TYPE_RSL
#define basename_CAVM_DENCX_ABX_TC_MAIN_START_REG(a,b) "DENCX_ABX_TC_MAIN_START_REG"
#define busnum_CAVM_DENCX_ABX_TC_MAIN_START_REG(a,b) (a)
#define arguments_CAVM_DENCX_ABX_TC_MAIN_START_REG(a,b) (a),(b),-1,-1

/**
 * Register (RSL) denc#_ab#_tc_mon_reg
 *
 * INTERNAL: TC Monitoring Registers
 *
 * TC mon registers.
 */
union cavm_dencx_abx_tc_mon_reg
{
    uint64_t u;
    struct cavm_dencx_abx_tc_mon_reg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_dencx_abx_tc_mon_reg_s cn; */
};
typedef union cavm_dencx_abx_tc_mon_reg cavm_dencx_abx_tc_mon_reg_t;

static inline uint64_t CAVM_DENCX_ABX_TC_MON_REG(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DENCX_ABX_TC_MON_REG(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=2))
        return 0x87e042081300ll + 0ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x3);
    __cavm_csr_fatal("DENCX_ABX_TC_MON_REG", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_DENCX_ABX_TC_MON_REG(a,b) cavm_dencx_abx_tc_mon_reg_t
#define bustype_CAVM_DENCX_ABX_TC_MON_REG(a,b) CSR_TYPE_RSL
#define basename_CAVM_DENCX_ABX_TC_MON_REG(a,b) "DENCX_ABX_TC_MON_REG"
#define busnum_CAVM_DENCX_ABX_TC_MON_REG(a,b) (a)
#define arguments_CAVM_DENCX_ABX_TC_MON_REG(a,b) (a),(b),-1,-1

/**
 * Register (RSL) denc#_ab#_tc_static_epdcch_reg#
 *
 ...
 */
union cavm_dencx_abx_tc_static_epdcch_regx
{
    uint64_t u;
    struct cavm_dencx_abx_tc_static_epdcch_regx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_dencx_abx_tc_static_epdcch_regx_s cn; */
};
typedef union cavm_dencx_abx_tc_static_epdcch_regx cavm_dencx_abx_tc_static_epdcch_regx_t;
...
#define typedef_CAVM_DENCX_ABX_TC_STATIC_EPDCCH_REGX(a,b,c) cavm_dencx_abx_tc_static_epdcch_regx_t
#define bustype_CAVM_DENCX_ABX_TC_STATIC_EPDCCH_REGX(a,b,c) CSR_TYPE_RSL
#define basename_CAVM_DENCX_ABX_TC_STATIC_EPDCCH_REGX(a,b,c) "DENCX_ABX_TC_STATIC_EPDCCH_REGX"
#define busnum_CAVM_DENCX_ABX_TC_STATIC_EPDCCH_REGX(a,b,c) (a)
#define arguments_CAVM_DENCX_ABX_TC_STATIC_EPDCCH_REGX(a,b,c) (a),(b),(c),-1

/**
 * Register (RSL) denc#_ab#_tc_static_pdcch_reg#
 *
 ...
 * write these registers, either at start-up or at any other time.
 */
union cavm_dencx_abx_tc_static_pdcch_regx
{
    uint64_t u;
    struct cavm_dencx_abx_tc_static_pdcch_regx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_dencx_abx_tc_static_pdcch_regx_s cn; */
};
typedef union cavm_dencx_abx_tc_static_pdcch_regx cavm_dencx_abx_tc_static_pdcch_regx_t;
...
#define typedef_CAVM_DENCX_ABX_TC_STATIC_PDCCH_REGX(a,b,c) cavm_dencx_abx_tc_static_pdcch_regx_t
#define bustype_CAVM_DENCX_ABX_TC_STATIC_PDCCH_REGX(a,b,c) CSR_TYPE_RSL
#define basename_CAVM_DENCX_ABX_TC_STATIC_PDCCH_REGX(a,b,c) "DENCX_ABX_TC_STATIC_PDCCH_REGX"
#define busnum_CAVM_DENCX_ABX_TC_STATIC_PDCCH_REGX(a,b,c) (a)
#define arguments_CAVM_DENCX_ABX_TC_STATIC_PDCCH_REGX(a,b,c) (a),(b),(c),-1

/**
 * Register (RSL) denc#_ab#_tc_status0_reg
 *
 * DENC Encoder Status Register
 * This register reports status from the internal encoder core.
 */
union cavm_dencx_abx_tc_status0_reg
{
    uint64_t u;
    struct cavm_dencx_abx_tc_status0_reg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_dencx_abx_tc_status0_reg_s cn; */
};
typedef union cavm_dencx_abx_tc_status0_reg cavm_dencx_abx_tc_status0_reg_t;
...
#define typedef_CAVM_DENCX_ABX_TC_STATUS0_REG(a,b) cavm_dencx_abx_tc_status0_reg_t
#define bustype_CAVM_DENCX_ABX_TC_STATUS0_REG(a,b) CSR_TYPE_RSL
#define basename_CAVM_DENCX_ABX_TC_STATUS0_REG(a,b) "DENCX_ABX_TC_STATUS0_REG"
#define busnum_CAVM_DENCX_ABX_TC_STATUS0_REG(a,b) (a)
#define arguments_CAVM_DENCX_ABX_TC_STATUS0_REG(a,b) (a),(b),-1,-1

/**
 * Register (RSL) denc#_ab#_tc_status1_reg
 *
 * INTERNAL: TC Status 1 Register
 *
 * TC status 1 register.
 */
union cavm_dencx_abx_tc_status1_reg
{
    uint64_t u;
    struct cavm_dencx_abx_tc_status1_reg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_dencx_abx_tc_status1_reg_s cn; */
};
typedef union cavm_dencx_abx_tc_status1_reg cavm_dencx_abx_tc_status1_reg_t;

static inline uint64_t CAVM_DENCX_ABX_TC_STATUS1_REG(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DENCX_ABX_TC_STATUS1_REG(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=2))
        return 0x87e042081028ll + 0ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x3);
    __cavm_csr_fatal("DENCX_ABX_TC_STATUS1_REG", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_DENCX_ABX_TC_STATUS1_REG(a,b) cavm_dencx_abx_tc_status1_reg_t
#define bustype_CAVM_DENCX_ABX_TC_STATUS1_REG(a,b) CSR_TYPE_RSL
#define basename_CAVM_DENCX_ABX_TC_STATUS1_REG(a,b) "DENCX_ABX_TC_STATUS1_REG"
#define busnum_CAVM_DENCX_ABX_TC_STATUS1_REG(a,b) (a)
#define arguments_CAVM_DENCX_ABX_TC_STATUS1_REG(a,b) (a),(b),-1,-1
