...
{
    if ((a<=1) && (b<=2))
        return 0x87e040c00000ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=2))
        return 0x87e040c00008ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=2))
        return 0x87e040c00040ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=2))
        return 0x87e040c00048ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=2))
        return 0x87e040c00030ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=2))
        return 0x87e040c00038ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=2) && (c<=511))
        return 0x87e040c02000ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3) + 8ll * ((c) & 0x1ff);
...
{
    if ((a<=1) && (b<=2) && (c<=511))
        return 0x87e040c04000ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3) + 8ll * ((c) & 0x1ff);
...
{
    if ((a<=1) && (b<=2) && (c<=511))
        return 0x87e040c06000ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3) + 8ll * ((c) & 0x1ff);
...
{
    if ((a<=1) && (b<=2))
        return 0x87e040c00080ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=2))
        return 0x87e040c00018ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=2) && (c<=7))
        return 0x87e040c01400ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3) + 8ll * ((c) & 0x7);
...
{
    if ((a<=1) && (b<=2))
        return 0x87e040c01040ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=2))
        return 0x87e040c01010ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=2))
        return 0x87e040c01038ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=2))
        return 0x87e040c01030ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=2))
        return 0x87e040c01000ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=2))
        return 0x87e040c01008ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=2) && (c<=3))
        return 0x87e040c01300ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3) + 8ll * ((c) & 0x3);
...
{
    if ((a<=1) && (b<=2))
        return 0x87e040c01020ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
