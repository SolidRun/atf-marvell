...
/**
 * Enumeration rfoe_rx_pswt_new_e
 *
 * RFOE RX Packet Status Word Type Enumeration
 * Enumerates the PROTOCOL_STS_WRD and RFOE_TIMESTAMP fields in RX packet status word
 */
#define CAVM_RFOE_RX_PSWT_NEW_E_ECPRI_BCN_TYPE (3)
#define CAVM_RFOE_RX_PSWT_NEW_E_ECPRI_BFN_TYPE (2)
#define CAVM_RFOE_RX_PSWT_NEW_E_ROE_BCN_TYPE (1)
#define CAVM_RFOE_RX_PSWT_NEW_E_ROE_BFN_TYPE (0)
    ...
    struct cavm_rfoe_psw_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t pswt                  : 2;  /**< [ 63: 62] PSW Type.  Enumerated by RFOE_RX_PSWT_E. */
        uint64_t lmac_id               : 2;  /**< [ 61: 60] LMAC ID on which the Packet was received */
        uint64_t rfoe_id               : 4;  /**< [ 59: 56] RFOE Instance ID on which the Packet was received */
        uint64_t reserved_54_55        : 2;
        uint64_t jd_ptr_tmem           : 1;  /**< [ 53: 53] Target memory selection for job descriptor used by this packet/symbol.
                                                                 0 = SMEM.
                                                                 1 = LLC/DRAM.
        ...
        uint64_t mac_err_sts           : 6;  /**< [117:112] Packet error status, 0 = no errors detected.  For non-zero:
                                                                 ...
                                                                 * Bit(5) is the eCPRI Sequence ID (ECPRI_HDR_S[SEQ_ID]) error status. Set
                                                                 ...
                                                                 Packet Error Status from x2p err field.  0 = no error detected. Values enumerated in
                                                                 x2p2_p2x2_defs::x2p2_pkt_err_t */
        uint64_t mcs_err_sts           : 8;  /**< [111:104] MCS error status
                                                                 Internal:
                                                                 MCS Packet Error Status from exception code err field.  0 = no error detected. Values enumerated in
                                                                 mcs_intf_defs::mcs_out_sb_if_t */
        ...
        uint64_t rfoe_timestamp        : 64; /**< [255:192] The Timestamp field is defined by RFOE_PSW_W3_BCN_S or RFOE_PSW_W3_BFN_S based on the
                                                                 RFOE_RX_CTR[TSTAMP_FORMAT] configuration */
...
union cavm_rfoe_psw_w2_roe_s
{
    ...
    struct cavm_rfoe_psw_w2_roe_s_s
    {
        ...
        uint64_t rfoe_id               : 4;  /**< [ 37: 34] RFOE Instance ID on which the Packet was received */
        uint64_t lmac_id               : 2;  /**< [ 33: 32] LMAC ID on which the Packet was received */
        uint64_t flowid                : 8;  /**< [ 31: 24] Flowid field extracted from RoE packet header. Undefined for CHI and ALT
                                                                 packets.
...
/**
 * Structure rfoe_psw_w3_bfn_s
 *
 * RFOE Timestamp BFN Structure
 * RFOE Timestamp field described in BFN format
 */
union cavm_rfoe_psw_w3_bfn_s
{
    uint64_t u;
    struct cavm_rfoe_psw_w3_bfn_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
        uint64_t bfn_frame             : 12; /**< [ 31: 20] BFN Frame value */
        uint64_t subframe              : 4;  /**< [ 19: 16] Subframe value. */
        uint64_t tick                  : 16; /**< [ 15:  0] Timer Tick value. */
#else /* Word 0 - Little Endian */
        uint64_t tick                  : 16; /**< [ 15:  0] Timer Tick value. */
        uint64_t subframe              : 4;  /**< [ 19: 16] Subframe value. */
        uint64_t bfn_frame             : 12; /**< [ 31: 20] BFN Frame value */
    ...
    /* struct cavm_rfoe_psw_w3_bfn_s_s cn; */
};
...
union cavm_rfoe_tx_pkt_log_s
{
    ...
    struct cavm_rfoe_tx_pkt_log_s_s
    {
        ...
        uint64_t tx_err                : 1;  /**< [ 87: 87] When set to 1, indicates the packet was sent to CGX with the error bit set. */
...
{
    if (a<=1)
        return 0x861000001068ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000000900ll + 0x1000000ll * ((a) & 0x1);
...
{
    if ((a<=1) && (b<=3) && (c<=3))
        return 0x861000001920ll + 0x1000000ll * ((a) & 0x1) + 0x40ll * ((b) & 0x3) + 8ll * ((c) & 0x3);
...
union cavm_rfoex_linkx_tx_ptp_ring_ctl
{
    ...
    struct cavm_rfoex_linkx_tx_ptp_ring_ctl_s
    {
        ...
        uint64_t gmid3                 : 2;  /**< [ 31: 30](R/W) Guest Machine ID to select stream ID for writes to the ring when [TARGE_MEM]==1 */
        uint64_t gmid2                 : 2;  /**< [ 29: 28](R/W) Guest Machine ID to select stream ID for writes to the ring when [TARGE_MEM]==1 */
        uint64_t gmid1                 : 2;  /**< [ 27: 26](R/W) Guest Machine ID to select stream ID for writes to the ring when [TARGE_MEM]==1 */
        uint64_t gmid0                 : 2;  /**< [ 25: 24](R/W) Guest Machine ID to select stream ID for writes to the ring when [TARGE_MEM]==1 */
...
{
    if ((a<=1) && (b<=3))
        return 0x861000001900ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3);
...
{
    if (a<=1)
        return 0x861000001838ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000001858ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000001830ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000001850ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000001828ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000001848ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000001820ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000001840ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000001008ll + 0x1000000ll * ((a) & 0x1);
...
{
    if ((a<=1) && (b<=3))
        return 0x861000001de0ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=3))
        return 0x861000001dc0ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3);
...
{
    if (a<=1)
        return 0x861000001f00ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000001018ll + 0x1000000ll * ((a) & 0x1);
...
{
    if ((a<=1) && (b<=7))
        return 0x861000001780ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x7);
...
{
    if ((a<=1) && (b<=3))
        return 0x861000001da0ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3);
...
{
    if (a<=1)
        return 0x861000001f08ll + 0x1000000ll * ((a) & 0x1);
...
{
    if ((a<=1) && (b<=3))
        return 0x861000001d80ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=3))
        return 0x861000001d60ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=3))
        return 0x8610000018c0ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=3))
        return 0x861000001e60ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=3))
        return 0x861000001e00ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=3))
        return 0x861000001860ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3);
...
union cavm_rfoex_rx_error_ena_w1c
{
    ...
    struct cavm_rfoex_rx_error_ena_w1c_s
    {
        ...
        uint64_t full_drop             : 1;  /**< [ 16: 16](R/W1C/H) Reads or clears enable for RFOE(0..1)_RX_ERROR_INT[FULL_DROP]. */
        uint64_t vlan_tpid             : 1;  /**< [ 15: 15](R/W1C/H) Reads or clears enable for RFOE(0..1)_RX_ERROR_INT[VLAN_TPID]. */
        uint64_t ecpri_hdr             : 1;  /**< [ 14: 14](R/W1C/H) Reads or clears enable for RFOE(0..1)_RX_ERROR_INT[ECPRI_HDR]. */
        uint64_t pkt_len_range         : 1;  /**< [ 13: 13](R/W1C/H) Reads or clears enable for RFOE(0..1)_RX_ERROR_INT[PKT_LEN_RANGE]. */
        ...
        uint64_t idx_range             : 1;  /**< [  8:  8](R/W1C/H) Reads or clears enable for RFOE(0..1)_RX_ERROR_INT[IDX_RANGE]. */
...
{
    if (a<=1)
        return 0x861000001ea0ll + 0x1000000ll * ((a) & 0x1);
...
union cavm_rfoex_rx_error_ena_w1s
{
    ...
    struct cavm_rfoex_rx_error_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_17_63        : 47;
        uint64_t full_drop             : 1;  /**< [ 16: 16](R/W1S/H) Reads or sets enable for RFOE(0..1)_RX_ERROR_INT[FULL_DROP]. */
        uint64_t vlan_tpid             : 1;  /**< [ 15: 15](R/W1S/H) Reads or sets enable for RFOE(0..1)_RX_ERROR_INT[VLAN_TPID]. */
        uint64_t ecpri_hdr             : 1;  /**< [ 14: 14](R/W1S/H) Reads or sets enable for RFOE(0..1)_RX_ERROR_INT[ECPRI_HDR]. */
        uint64_t pkt_len_range         : 1;  /**< [ 13: 13](R/W1S/H) Reads or sets enable for RFOE(0..1)_RX_ERROR_INT[PKT_LEN_RANGE]. */
        ...
        uint64_t idx_range             : 1;  /**< [  8:  8](R/W1S/H) Reads or sets enable for RFOE(0..1)_RX_ERROR_INT[IDX_RANGE]. */
...
{
    if (a<=1)
        return 0x861000001e98ll + 0x1000000ll * ((a) & 0x1);
...
{
    if ((a<=1) && (b<=16))
        return 0x861000001f70ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x1f);
...
{
    if (a<=1)
        return 0x861000001e90ll + 0x1000000ll * ((a) & 0x1);
...
union cavm_rfoex_rx_error_int_w1s
{
    ...
    struct cavm_rfoex_rx_error_int_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_17_63        : 47;
        uint64_t full_drop             : 1;  /**< [ 16: 16](R/W1S/H) Reads or sets RFOE(0..1)_RX_ERROR_INT[FULL_DROP]. */
        uint64_t vlan_tpid             : 1;  /**< [ 15: 15](R/W1S/H) Reads or sets RFOE(0..1)_RX_ERROR_INT[VLAN_TPID]. */
        uint64_t ecpri_hdr             : 1;  /**< [ 14: 14](R/W1S/H) Reads or sets RFOE(0..1)_RX_ERROR_INT[ECPRI_HDR]. */
        uint64_t pkt_len_range         : 1;  /**< [ 13: 13](R/W1S/H) Reads or sets RFOE(0..1)_RX_ERROR_INT[PKT_LEN_RANGE]. */
        ...
        uint64_t idx_range             : 1;  /**< [  8:  8](R/W1S/H) Reads or sets RFOE(0..1)_RX_ERROR_INT[IDX_RANGE]. */
...
{
    if (a<=1)
        return 0x861000001ea8ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000001eb0ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000001eb8ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x8610000018a0ll + 0x1000000ll * ((a) & 0x1);
...
{
    if ((a<=1) && (b<=15))
        return 0x861000001300ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0xf);
...
{
    if (a<=1)
        return 0x861000001d30ll + 0x1000000ll * ((a) & 0x1);
...
{
    if ((a<=1) && (b<=31))
        return 0x861000001200ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x1f);
...
/**
 * Register (NCB) rfoe#_rx_flow_id_offset
 *
 * RFOE RX Flow ID Offset Register
 * Offset flowID value used as input to the Flow Table hash. Unique value per RFOE.
 */
union cavm_rfoex_rx_flow_id_offset
{
    uint64_t u;
    struct cavm_rfoex_rx_flow_id_offset_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_4_63         : 60;
        uint64_t offset                : 4;  /**< [  3:  0](R/W) Flow ID Offset used as input to flow table hash. */
#else /* Word 0 - Little Endian */
        uint64_t offset                : 4;  /**< [  3:  0](R/W) Flow ID Offset used as input to flow table hash. */
        uint64_t reserved_4_63         : 60;
#endif /* Word 0 - End */
    } s;
    /* struct cavm_rfoex_rx_flow_id_offset_s cn; */
};
typedef union cavm_rfoex_rx_flow_id_offset cavm_rfoex_rx_flow_id_offset_t;

static inline uint64_t CAVM_RFOEX_RX_FLOW_ID_OFFSET(uint64_t a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RFOEX_RX_FLOW_ID_OFFSET(uint64_t a)
{
    if (a<=1)
        return 0x861000001cf0ll + 0x1000000ll * ((a) & 0x1);
    __cavm_csr_fatal("RFOEX_RX_FLOW_ID_OFFSET", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_RFOEX_RX_FLOW_ID_OFFSET(a) cavm_rfoex_rx_flow_id_offset_t
#define bustype_CAVM_RFOEX_RX_FLOW_ID_OFFSET(a) CSR_TYPE_NCB
#define basename_CAVM_RFOEX_RX_FLOW_ID_OFFSET(a) "RFOEX_RX_FLOW_ID_OFFSET"
#define busnum_CAVM_RFOEX_RX_FLOW_ID_OFFSET(a) (a)
#define arguments_CAVM_RFOEX_RX_FLOW_ID_OFFSET(a) (a),-1,-1,-1
...
{
    if (a<=1)
        return 0x861000001d28ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000001cc0ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000001ce0ll + 0x1000000ll * ((a) & 0x1);
...
{
    if ((a<=1) && (b<=3))
        return 0x861000001c00ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3);
...
union cavm_rfoex_rx_ind_jdt_cfg0
{
    ...
    struct cavm_rfoex_rx_ind_jdt_cfg0_s
    {
        ...
        uint64_t pkt_offset            : 5;  /**< [ 56: 52](R/W) Packet offset in units of 128-bits. DMA operation starts at an offset of
                                                                 ...
                                                                 Must be \<= 24. If [PKT_STATUS_WRITE]=1, must be \> 2 or the packet
...
{
    if (a<=1)
        return 0x861000001c40ll + 0x1000000ll * ((a) & 0x1);
...
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_49_63        : 15;
        uint64_t seq_id_check_en       : 1;  /**< [ 48: 48](R/W) Enables ECPRI Seq_ID Check. */
...
{
    if (a<=1)
        return 0x861000001c48ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000001c58ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000001c60ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000001c50ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000001c68ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000001c70ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000001c80ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000001c78ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000001c30ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000001c20ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000001c28ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000001c38ll + 0x1000000ll * ((a) & 0x1);
...
{
    if ((a<=1) && (b<=1))
        return 0x861000001cd0ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x1);
...
{
    if (a<=1)
        return 0x861000001bf8ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000001060ll + 0x1000000ll * ((a) & 0x1);
...
{
    if ((a<=1) && (b<=1055))
        return 0x861000010000ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x7ff);
...
{
    if (a<=1)
        return 0x861000001d40ll + 0x1000000ll * ((a) & 0x1);
...
{
    if ((a<=1) && (b<=15))
        return 0x861000001500ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0xf);
...
{
    if ((a<=1) && (b<=15))
        return 0x861000001480ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0xf);
...
{
    if ((a<=1) && (b<=15))
        return 0x861000001400ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0xf);
...
{
    if ((a<=1) && (b<=15))
        return 0x861000001580ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0xf);
...
{
    if (a<=1)
        return 0x861000001600ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000001608ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000001d38ll + 0x1000000ll * ((a) & 0x1);
...
{
    if ((a<=1) && (b<=3))
        return 0x861000001880ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=1))
        return 0x861000001020ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x1);
...
{
    if ((a<=1) && (b<=1))
        return 0x861000001030ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x1);
...
{
    if (a<=1)
        return 0x861000001000ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000001010ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000001d20ll + 0x1000000ll * ((a) & 0x1);
...
{
    if ((a<=1) && (b<=15))
        return 0x861000001100ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0xf);
...
{
    if ((a<=1) && (b<=15))
        return 0x861000001180ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0xf);
...
{
    if ((a<=1) && (b<=1))
        return 0x861000001070ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x1);
...
{
    if ((a<=1) && (b<=3))
        return 0x8610000010a0ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=3))
        return 0x8610000010c0ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3);
...
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_4_63         : 60;
        uint64_t tstamp_format         : 1;  /**< [  3:  3](R/W) Selects between BFN or BCN Format. Set 0 for BFN Format, 1 for BCN Format
                                                                 This is used for packet logging. */
...
{
    if (a<=1)
        return 0x861000000f08ll + 0x1000000ll * ((a) & 0x1);
...
{
    if ((a<=1) && (b<=7))
        return 0x861000000800ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x7);
...
{
    if ((a<=1) && (b<=7))
        return 0x861000000880ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x7);
...
{
    if ((a<=1) && (b<=7))
        return 0x861000000840ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x7);
...
{
    if ((a<=1) && (b<=7))
        return 0x8610000008c0ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x7);
...
{
    if (a<=1)
        return 0x861000000c00ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000000c10ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000000c08ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000000c18ll + 0x1000000ll * ((a) & 0x1);
...
{
    if (a<=1)
        return 0x861000000bf8ll + 0x1000000ll * ((a) & 0x1);
 ...
 *
 * INTERNAL: RFOE Instance ID Register
 */
...
{
    if (a<=1)
        return 0x861000000908ll + 0x1000000ll * ((a) & 0x1);
...
{
    if ((a<=1) && (b<=3))
        return 0x861000000f80ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=3))
        return 0x861000000f40ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=3))
        return 0x861000000f60ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=3))
        return 0x861000000f20ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=3))
        return 0x861000000fa0ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3);
...
union cavm_rfoex_tx_ptp_tstmp_w1x
{
    ...
    struct cavm_rfoex_tx_ptp_tstmp_w1x_s
    {
        ...
        uint64_t tx_err                : 1;  /**< [ 23: 23](RO/H) When set to 1, indicates the packet was sent to CGX witht error bit set. */
...
{
    if ((a<=1) && (b<=3))
        return 0x861000000fc0ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3);
...
{
    if (a<=1)
        return 0x861000000f00ll + 0x1000000ll * ((a) & 0x1);
