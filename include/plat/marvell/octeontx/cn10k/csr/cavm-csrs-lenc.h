...
{
    if ((a<=1) && (b<=2))
        return 0x87e040a00000ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=2))
        return 0x87e040a00008ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=2))
        return 0x87e040a00040ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=2))
        return 0x87e040a00030ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=2) && (c<=384))
        return 0x87e040a02000ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3) + 8ll * ((c) & 0x1ff);
...
{
    if ((a<=1) && (b<=2) && (c<=384))
        return 0x87e040a04000ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3) + 8ll * ((c) & 0x1ff);
...
{
    if ((a<=1) && (b<=2) && (c<=384))
        return 0x87e040a06000ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3) + 8ll * ((c) & 0x1ff);
...
{
    if ((a<=1) && (b<=2))
        return 0x87e040a00080ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=2))
        return 0x87e040a00018ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=2) && (c<=7))
        return 0x87e040a01400ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3) + 8ll * ((c) & 0x7);
...
{
    if ((a<=1) && (b<=2))
        return 0x87e040a01040ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=2))
        return 0x87e040a01010ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=2))
        return 0x87e040a01038ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=2))
        return 0x87e040a01030ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=2))
        return 0x87e040a01000ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=2))
        return 0x87e040a01008ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=2))
        return 0x87e040a01300ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
...
{
    if ((a<=1) && (b<=2))
        return 0x87e040a01020ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
