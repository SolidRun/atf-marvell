...
#define CAVM_CPC_DVFS_MODE_E_POWER_BUDGET (1)
...
union cavm_cpc_bp_test2_bp_cfg_s
{
    ...
    struct cavm_cpc_bp_test2_bp_cfg_s_s
    {
        ...
        uint32_t cpc_ram_rowx_arb      : 16; /**< [ 15:  0] Config for cpc_ram_rowx_arb. */
#else /* Word 0 - Little Endian */
        uint32_t cpc_ram_rowx_arb      : 16; /**< [ 15:  0] Config for cpc_ram_rowx_arb. */
        uint32_t reserved_16_31        : 16;
#endif /* Word 0 - End */
...
union cavm_cpc_bp_test2_enable_s
{
    ...
    struct cavm_cpc_bp_test2_enable_s_s
    {
        ...
        uint32_t cpc_ram_rowx_arb      : 8;  /**< [  7:  0] ENABLE for cpc_ram_rowx_arb. */
#else /* Word 0 - Little Endian */
        uint32_t cpc_ram_rowx_arb      : 8;  /**< [  7:  0] ENABLE for cpc_ram_rowx_arb. */
        uint32_t reserved_8_31         : 24;
#endif /* Word 0 - End */
...
union cavm_cpc_dvfs_config_s
{
    ...
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t coreclk3_freq_max     : 16; /**< [ 63: 48] Frequency in MHz */
        uint64_t coreclk2_freq_max     : 16; /**< [ 47: 32] Frequency in MHz */
        uint64_t coreclk1_freq_max     : 16; /**< [ 31: 16] Frequency in MHz */
        uint64_t coreclk0_freq_max     : 16; /**< [ 15:  0] Frequency in MHz. In DVFS mode, this is the
                                                                 CORECLK\<n\> frequency.  In THERMAL_BUDGET mode, this is the CORECLK\<n\> frequency
                                                                 when APs are active; CORECLK\<n\> frequency may be reduced if die temp exceeds
                                                                 THROTTLE_TEMP.  In POWER_BUDGET mode, this is the CORECLK\<n\> frequency when
                                                                 APs are active; CORECLK\<n\> frequency may be reduced if die temp exceeds THROTTLE_TEMP
        ...
        uint64_t coreclk7_freq_max     : 16; /**< [127:112] Frequency in MHz */
        uint64_t coreclk6_freq_max     : 16; /**< [111: 96] Frequency in MHz */
        uint64_t coreclk5_freq_max     : 16; /**< [ 95: 80] Frequency in MHz */
        uint64_t coreclk4_freq_max     : 16; /**< [ 79: 64] Frequency in MHz */
        ...
        uint64_t coreclk11_freq_max    : 16; /**< [191:176] Frequency in MHz */
        uint64_t coreclk10_freq_max    : 16; /**< [175:160] Frequency in MHz */
        uint64_t coreclk9_freq_max     : 16; /**< [159:144] Frequency in MHz */
        uint64_t coreclk8_freq_max     : 16; /**< [143:128] Frequency in MHz */
        ...
        uint64_t coreclk15_freq_max    : 16; /**< [255:240] Frequency in MHz */
        uint64_t coreclk14_freq_max    : 16; /**< [239:224] Frequency in MHz */
        uint64_t coreclk13_freq_max    : 16; /**< [223:208] Frequency in MHz */
        uint64_t coreclk12_freq_max    : 16; /**< [207:192] Frequency in MHz */
        ...
        uint64_t coreclk19_freq_max    : 16; /**< [319:304] Frequency in MHz */
        uint64_t coreclk18_freq_max    : 16; /**< [303:288] Frequency in MHz */
        uint64_t coreclk17_freq_max    : 16; /**< [287:272] Frequency in MHz */
        uint64_t coreclk16_freq_max    : 16; /**< [271:256] Frequency in MHz */
        ...
        uint64_t coreclk23_freq_max    : 16; /**< [383:368] Frequency in MHz */
        uint64_t coreclk22_freq_max    : 16; /**< [367:352] Frequency in MHz */
        uint64_t coreclk21_freq_max    : 16; /**< [351:336] Frequency in MHz */
        uint64_t coreclk20_freq_max    : 16; /**< [335:320] Frequency in MHz */
        ...
        uint64_t coreclk27_freq_max    : 16; /**< [447:432] Frequency in MHz */
        uint64_t coreclk26_freq_max    : 16; /**< [431:416] Frequency in MHz */
        uint64_t coreclk25_freq_max    : 16; /**< [415:400] Frequency in MHz */
        uint64_t coreclk24_freq_max    : 16; /**< [399:384] Frequency in MHz */
        ...
        uint64_t coreclk31_freq_max    : 16; /**< [511:496] Frequency in MHz */
        uint64_t coreclk30_freq_max    : 16; /**< [495:480] Frequency in MHz */
        uint64_t coreclk29_freq_max    : 16; /**< [479:464] Frequency in MHz */
        uint64_t coreclk28_freq_max    : 16; /**< [463:448] Frequency in MHz */
        ...
        uint64_t coreclk35_freq_max    : 16; /**< [575:560] Frequency in MHz */
        uint64_t coreclk34_freq_max    : 16; /**< [559:544] Frequency in MHz */
        uint64_t coreclk33_freq_max    : 16; /**< [543:528] Frequency in MHz */
        uint64_t coreclk32_freq_max    : 16; /**< [527:512] Frequency in MHz */
        ...
        uint64_t dvfs_config_version   : 16; /**< [639:624] Version field for this data structure.  Default value 0x9300. */
        uint64_t coreclk_freq_min      : 16; /**< [623:608] Frequency in MHz.  In THERMAL_BUDGET and POWER_BUDGET modes, this is
                                                                 the CORECLK\<n\> frequency used when all APs are idle.  Ignored in DVFS
                                                                 and MANUAL_CONTROL modes.  Range 500 MHz to [CORECLK_FREQ_MAX]. */
        uint64_t meshclk_freq          : 16; /**< [607:592] Frequency in MHz. */
        uint64_t throttle_temp         : 16; /**< [591:576] The die temperature at which the reported THERMAL_MARGIN is 0.
                                                                 In THERMAL_BUDGET and POWER_BUDGET modes, it is also the die
        ...
        uint64_t thermal_trip_temp     : 16; /**< [703:688] Temperature in degrees C where THERMAL_TRIP_N is asserted. Hardware
                                                                 will assert the THERMAL_TRIP_N pin when this die temp is exceeded,
                                                                 signaling the board to emergency power off. Default is 130
                                                                 Celsius. */
        uint64_t vdd_sys_tolerance     : 16; /**< [687:672] The +/- control tolerance of the VDD_SYS supply as measured at the
                                                                 chip in mV.   Default is +/-29 mV.  Doesn't apply to CN8XXX chips. */
        uint64_t vdd_core_tolerance    : 16; /**< [671:656] The +/- control tolerance of the VDDC supply as measured at the
                                                                 chip in mV.   Default is +/-29 mV.  Doesn't apply to CN8XXX chips. */
        uint64_t sclk_freq_min         : 16; /**< [655:640] Frequency in MHz.  Ignored in DVFS mode. In THERMAL_BUDGET and POWER_BUDGET
                                                                 modes, the SCLK frequency when the coprocessors are idle. */
        ...
        uint64_t sclk_freq_max         : 16; /**< [767:752] Frequency in MHz.  In DVFS mode, the coprocessor clock SCLK
                                                                 frequency.  In THERMAL_BUDGET and POWER_BUDGET modes, the SCLK frequency
                                                                 when the coprocessors are active. */
        uint64_t thermal_hot_temp      : 16; /**< [751:736] SCP firmware will assert the THERMAL_HOT_L pin when the highest
        ...
        uint64_t dvfs_power_control_mode : 16;/**< [735:720] The operating mode of the DVFS (Dynamic Frequency Voltage Scaling)
                                                                 power control code.  Enumerated by CPC_DVFS_MODE_E. */
        uint64_t dvfs_power_budget     : 16; /**< [719:704] The total chip power budget in Watts.  In POWER_BUDGET mode,
                                                                 DVFS control modulates CORECLK\<n\> frequency to keep power at or
        ...
        uint64_t active_threshold      : 16; /**< [831:816] The percentage of maximum IPC at which a core is considered active.
                                                                 Encoded as percent * 1000.  Range 0.001% to 32.7%.  Default 1%.
                                                                 Only used in THERMAL_BUDGET and POWER_BUDGET modes. */
        uint64_t dvfs_thermal_hot_backoff : 16;/**< [815:800] The percentage that the DVFS control should attempt to reduce the chip
                                                                 ...
                                                                 POWER_BUDGET modes. */
        uint64_t avs_safemode_enable   : 1;  /**< [799:799] When avs_safemode is enabled, all CORECLK\<n\> go to min speed when AVS failures are detected. */
        uint64_t ecp_disable           : 1;  /**< [798:798] Instructs SCP firmware to not start the ECP. */
        uint64_t scp_uart_redirect_num : 4;  /**< [797:794] Selects which AP UART to connect to the SCP UART. 0x0 selects no
                                                                 ...
                                                                 UART [SCP_UART_NUM]. */
        uint64_t twsi_slave_addr       : 7;  /**< [793:787] The I2C address of the TWSI slave controller. */
        uint64_t twsi_slave_bus        : 3;  /**< [786:784] The TWSI controller number that processes TWSI slave transactions from chip side. */
        uint64_t wakeup_mode           : 2;  /**< [783:782] Enumerated by CPC_WAKEUP_MODE_E. Default CPC_WAKEUP_MODE_E::FAST_WAKE_SLOW_SLEEP. */
        uint64_t force_secondary_boot  : 1;  /**< [781:781] Force the next reboot to use the secondary boot device. */
        uint64_t mcp_disable           : 1;  /**< [780:780] Instructs SCP firmware to not start the MCP. */
        uint64_t scp_uart_num          : 4;  /**< [779:776] Selects which UART SCP will use for the SCP CLI and logging.  0xF selects no logging. */
        uint64_t failsafe_timeout      : 8;  /**< [775:768] This timeout detects boot failures in when booting from the
        ...
        uint64_t dspclk_freq_min       : 16; /**< [895:880] Minimum DSP clock (DSPCLK) frequency in MHz.  SCP firmware will vary
                                                                 the actual DSPCLK frequency between min and max based on SCMI messages
                                                                 from the AP. CNF10XXX chips only. */
        uint64_t dspclk_freq_max       : 16; /**< [879:864] Maximum DSP clock (DSPCLK) frequency in MHz.  SCP firmware will vary
                                                                 the actual DSPCLK frequency between min and max based on SCMI messages
                                                                 from the AP. CNF10XXX chips only. */
        uint64_t bclk_freq_min         : 16; /**< [863:848] Minimum BPHY clock (BCLK) frequency in MHz.  SCP firmware will vary
                                                                 the actual BCLK frequency between min and max based on SCMI messages
                                                                 from the AP. CNF10XXX chips only. */
        uint64_t bclk_freq_max         : 16; /**< [847:832] Maximum BPHY clock (BCLK) frequency in MHz.  SCP firmware will vary
                                                                 the actual BCLK frequency between min and max based on SCMI messages
                                                                 from the AP. CNF10XXX chips only. */
        ...
        uint64_t vdd_sys_compensation  : 16; /**< [959:944] A multiplication factor that is applied to the requested VDD_SYS voltage.  Default 1.000.
                                                                 Encoded as factor * 1000. */
        uint64_t vdd_core_compensation : 16; /**< [943:928] A multiplication factor that is applied to the requested VDDC voltage.  Default 1.000.
                                                                 Encoded as factor * 1000. */
        uint64_t reserved_912_927      : 16;
        uint64_t nclk_freq             : 16; /**< [911:896] Frequency in MHz. Nokia IP clock.  CNF105NXXX chips only. */
...
union cavm_cpc_bp_test2
{
    ...
    struct cavm_cpc_bp_test2_s
    {
        ...
        uint64_t bp_cfg                : 16; /**< [ 39: 24](R/W) Backpressure weight. For diagnostic use only.
                                                                 Internal:
                                                                 There are 2 backpressure configuration bits per enable, with the two bits
                                                                 defined as 0x0=100% of the time, 0x1=75% of the time, 0x2=50% of the time,
                                                                 0x3=25% of the time.
