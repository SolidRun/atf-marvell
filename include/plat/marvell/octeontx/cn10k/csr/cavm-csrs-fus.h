...
#define CAVM_FUS_FUSE_NUM_E_BISR_FUSED_ONLY (0x53)
...
#define CAVM_FUS_FUSE_NUM_E_CORE_INIT_MULX(a) (0x43 + (a))
#define CAVM_FUS_FUSE_NUM_E_CORE_INIT_PLL (0x4a)
#define CAVM_FUS_FUSE_NUM_E_CORE_MAX_MULX(a) (0x4b + (a))
#define CAVM_FUS_FUSE_NUM_E_CPT0_NOCRYPTOX(a) (0x255 + (a))
#define CAVM_FUS_FUSE_NUM_E_CPT1_NOCRYPTOX(a) (0x257 + (a))
#define CAVM_FUS_FUSE_NUM_E_CPT_EXE_DISABLEX(a) (0x320 + (a))
...
#define CAVM_FUS_FUSE_NUM_E_DLL_LOCK_FREEZE (0x54)
#define CAVM_FUS_FUSE_NUM_E_DLL_REFRESH_RATEX(a) (0x55 + (a))
#define CAVM_FUS_FUSE_NUM_E_DRO_CRIPPLE (0x73)
#define CAVM_FUS_FUSE_NUM_E_DSS_CRIPPLEX(a) (0x300 + (a))
...
#define CAVM_FUS_FUSE_NUM_E_GSERP_PROCESSX(a) (0x150 + (a))
#define CAVM_FUS_FUSE_NUM_E_GSER_ERCX(a) (0xf00 + (a))
#define CAVM_FUS_FUSE_NUM_E_INIT_MULX(a) (0x16a + (a))
...
#define CAVM_FUS_FUSE_NUM_E_MCS_FULL_CRIPPLEX(a) (0x172 + (a))
#define CAVM_FUS_FUSE_NUM_E_MCS_ROUTABLE_CRIPPLEX(a) (0x179 + (a))
#define CAVM_FUS_FUSE_NUM_E_METAL_FIXX(a) (0x2c + (a))
#define CAVM_FUS_FUSE_NUM_E_MFG_INFOX(a) (0x400 + (a))
#define CAVM_FUS_FUSE_NUM_E_MLC_CRIPPLEX(a) (0x219 + (a))
#define CAVM_FUS_FUSE_NUM_E_ML_DISABLE (0x254)
#define CAVM_FUS_FUSE_NUM_E_NODE1TRAPENA (0x250)
#define CAVM_FUS_FUSE_NUM_E_NPC_5NM_TCAM_RMX(a) (0x140 + (a))
#define CAVM_FUS_FUSE_NUM_E_NPC_5NM_TCAM_RME (0x146)
#define CAVM_FUS_FUSE_NUM_E_NPC_5NM_TCAM_WMX(a) (0x144 + (a))
#define CAVM_FUS_FUSE_NUM_E_PCC_SSIDX(a) (0x310 + (a))
#define CAVM_FUS_FUSE_NUM_E_PDFX(a) (0x640 + (a))
#define CAVM_FUS_FUSE_NUM_E_PEM_CRIPPLEX(a) (0x230 + (a))
#define CAVM_FUS_FUSE_NUM_E_PNR_INIT_MULX(a) (0x34 + (a))
#define CAVM_FUS_FUSE_NUM_E_PNR_INIT_PLL (0x3b)
#define CAVM_FUS_FUSE_NUM_E_PNR_MAX_MULX(a) (0x3c + (a))
...
#define CAVM_FUS_FUSE_NUM_E_REFCLK_CHECK (0x52)
#define CAVM_FUS_FUSE_NUM_E_REPAIRX(a) (0x1000 + (a))
#define CAVM_FUS_FUSE_NUM_E_ROM_INFOX(a) (0x3f0 + (a))
#define CAVM_FUS_FUSE_NUM_E_RPM_CRIPPLEX(a) (0x2a8 + (a))
#define CAVM_FUS_FUSE_NUM_E_RSVD147X(a) (0x147 + (a))
#define CAVM_FUS_FUSE_NUM_E_RSVD160X(a) (0x160 + (a))
#define CAVM_FUS_FUSE_NUM_E_RSVD171 (0x171)
...
#define CAVM_FUS_FUSE_NUM_E_RSVD2F5X(a) (0x2f5 + (a))
#define CAVM_FUS_FUSE_NUM_E_RSVD31X(a) (0x31 + (a))
#define CAVM_FUS_FUSE_NUM_E_RSVD318X(a) (0x318 + (a))
#define CAVM_FUS_FUSE_NUM_E_RSVD3B0X(a) (0x3b0 + (a))
...
#define CAVM_FUS_FUSE_NUM_E_TAD_CRIPPLEX(a) (0x2b0 + (a))
#define CAVM_FUS_FUSE_NUM_E_TAD_F2X(a) (0x2f2 + (a))
#define CAVM_FUS_FUSE_NUM_E_TAD_F3X(a) (0x2f0 + (a))
