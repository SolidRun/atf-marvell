...
#endif /* Word 4 - End */
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 5 - Big Endian */
        uint64_t gthr_size             : 4;  /**< [383:380] Gather-list size. Number of SGE enties that comprise a gather-list pointed to by the DPTR. */
...
#endif /* Word 5 - End */
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 6 - Big Endian */
        uint64_t sctr_size             : 4;  /**< [447:444] Scatter-list size.  When not doing inplace processing, this is the number of SGE
                                                                 enties that comprise a scatter-list pointed to by the RPTR. */
...
union cavm_cptx_af_ctl
{
    ...
    struct cavm_cptx_af_ctl_s
    {
        ...
        uint64_t t106_mode             : 1;  /**< [ 18: 18](R/W) When T106_MODE is set to zero, HW exposes changes to CPT_INST to support scatter/gather.
                                                                 When T106_MODE is set to one, the CPT_INST is compatible with T106 SW and microcode. */
...
union cavm_cptx_af_rxc_cfg2
{
    ...
    struct cavm_cptx_af_rxc_cfg2_cn10ka
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_8_63         : 56;
        uint64_t l3p_ext_hdr           : 8;  /**< [  7:  0](R/W) IPv6 programmable extension header type to use when parsing the IPv6 header
