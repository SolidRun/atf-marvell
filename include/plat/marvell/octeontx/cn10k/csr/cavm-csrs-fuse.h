...
#define CAVM_FUSE_NUM_E_PNR_INIT_MULX(a) (0xa0 + (a))
#define CAVM_FUSE_NUM_E_PNR_INIT_PLL (0xa7)
#define CAVM_FUSE_NUM_E_PNR_MAX_MULX(a) (0xa8 + (a))
...
#define CAVM_FUSE_NUM_E_RSVD28B (0x28b)
...
#define CAVM_FUSE_NUM_E_RSVD8FX(a) (0x8f + (a))
#define CAVM_FUSE_NUM_E_RSVDBEX(a) (0xbe + (a))
