...
#define CAVM_FUSE_NUM_E_CORE_INIT_MULX(a) (0xaf + (a))
#define CAVM_FUSE_NUM_E_CORE_INIT_PLL (0xb6)
#define CAVM_FUSE_NUM_E_CORE_MAX_MULX(a) (0xb7 + (a))
...
#define CAVM_FUSE_NUM_E_NPC_5NM_TCAM_RMX(a) (0x160 + (a))
#define CAVM_FUSE_NUM_E_NPC_5NM_TCAM_RME (0x166)
#define CAVM_FUSE_NUM_E_NPC_5NM_TCAM_WMX(a) (0x164 + (a))
...
#define CAVM_FUSE_NUM_E_PNR_INIT_MULX(a) (0xbe + (a))
#define CAVM_FUSE_NUM_E_PNR_INIT_PLL (0xc5)
#define CAVM_FUSE_NUM_E_PNR_MAX_MULX(a) (0xc6 + (a))
...
#define CAVM_FUSE_NUM_E_RSVD202X(a) (0x202 + (a))
...
#define CAVM_FUSE_NUM_E_RSVDAE (0xae)
#define CAVM_FUSE_NUM_E_RSVDCDX(a) (0xcd + (a))
