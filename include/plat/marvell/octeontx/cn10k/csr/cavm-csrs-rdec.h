...
/**
 * Register (RSL) rdec#_ab#_configuration
 *
 ...
 */
union cavm_rdecx_abx_configuration
{
    uint64_t u;
    struct cavm_rdecx_abx_configuration_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_54_63        : 10;
    ...
    /* struct cavm_rdecx_abx_configuration_s cn; */
};
typedef union cavm_rdecx_abx_configuration cavm_rdecx_abx_configuration_t;

static inline uint64_t CAVM_RDECX_ABX_CONFIGURATION(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RDECX_ABX_CONFIGURATION(uint64_t a, uint64_t b)
{
    if ((a<=1) && (b<=2))
        return 0x87e040e02000ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
    __cavm_csr_fatal("RDECX_ABX_CONFIGURATION", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_RDECX_ABX_CONFIGURATION(a,b) cavm_rdecx_abx_configuration_t
#define bustype_CAVM_RDECX_ABX_CONFIGURATION(a,b) CSR_TYPE_RSL
#define basename_CAVM_RDECX_ABX_CONFIGURATION(a,b) "RDECX_ABX_CONFIGURATION"
#define busnum_CAVM_RDECX_ABX_CONFIGURATION(a,b) (a)
#define arguments_CAVM_RDECX_ABX_CONFIGURATION(a,b) (a),(b),-1,-1

/**
 * Register (RSL) rdec#_ab#_control
 *
 * RDEC_CONTROL Register
 * This register is used to start RDEC HAB processing.
 */
union cavm_rdecx_abx_control
{
    uint64_t u;
    struct cavm_rdecx_abx_control_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_rdecx_abx_control_s cn; */
};
typedef union cavm_rdecx_abx_control cavm_rdecx_abx_control_t;

static inline uint64_t CAVM_RDECX_ABX_CONTROL(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RDECX_ABX_CONTROL(uint64_t a, uint64_t b)
{
    if ((a<=1) && (b<=2))
        return 0x87e040e00000ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
    __cavm_csr_fatal("RDECX_ABX_CONTROL", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_RDECX_ABX_CONTROL(a,b) cavm_rdecx_abx_control_t
#define bustype_CAVM_RDECX_ABX_CONTROL(a,b) CSR_TYPE_RSL
#define basename_CAVM_RDECX_ABX_CONTROL(a,b) "RDECX_ABX_CONTROL"
#define busnum_CAVM_RDECX_ABX_CONTROL(a,b) (a)
#define arguments_CAVM_RDECX_ABX_CONTROL(a,b) (a),(b),-1,-1

/**
 * Register (RSL) rdec#_ab#_eco
 *
 * INTERNAL: RDEC ECO Register
 */
union cavm_rdecx_abx_eco
{
    uint64_t u;
    struct cavm_rdecx_abx_eco_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
    ...
    /* struct cavm_rdecx_abx_eco_s cn; */
};
typedef union cavm_rdecx_abx_eco cavm_rdecx_abx_eco_t;

static inline uint64_t CAVM_RDECX_ABX_ECO(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RDECX_ABX_ECO(uint64_t a, uint64_t b)
{
    if ((a<=1) && (b<=2))
        return 0x87e040e00008ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
    __cavm_csr_fatal("RDECX_ABX_ECO", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_RDECX_ABX_ECO(a,b) cavm_rdecx_abx_eco_t
#define bustype_CAVM_RDECX_ABX_ECO(a,b) CSR_TYPE_RSL
#define basename_CAVM_RDECX_ABX_ECO(a,b) "RDECX_ABX_ECO"
#define busnum_CAVM_RDECX_ABX_ECO(a,b) (a)
#define arguments_CAVM_RDECX_ABX_ECO(a,b) (a),(b),-1,-1

/**
 * Register (RSL) rdec#_ab#_error_enable0
 *
 * RDEC Error Enable 0 Register
 * This register enables error reporting for RDEC_ERROR_SOURCE0 register.
 */
union cavm_rdecx_abx_error_enable0
{
    uint64_t u;
    struct cavm_rdecx_abx_error_enable0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_rdecx_abx_error_enable0_s cn; */
};
typedef union cavm_rdecx_abx_error_enable0 cavm_rdecx_abx_error_enable0_t;

static inline uint64_t CAVM_RDECX_ABX_ERROR_ENABLE0(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RDECX_ABX_ERROR_ENABLE0(uint64_t a, uint64_t b)
{
    if ((a<=1) && (b<=2))
        return 0x87e040e00040ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
    __cavm_csr_fatal("RDECX_ABX_ERROR_ENABLE0", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_RDECX_ABX_ERROR_ENABLE0(a,b) cavm_rdecx_abx_error_enable0_t
#define bustype_CAVM_RDECX_ABX_ERROR_ENABLE0(a,b) CSR_TYPE_RSL
#define basename_CAVM_RDECX_ABX_ERROR_ENABLE0(a,b) "RDECX_ABX_ERROR_ENABLE0"
#define busnum_CAVM_RDECX_ABX_ERROR_ENABLE0(a,b) (a)
#define arguments_CAVM_RDECX_ABX_ERROR_ENABLE0(a,b) (a),(b),-1,-1

/**
 * Register (RSL) rdec#_ab#_error_source0
 *
 * RDEC Error Source Register 0
 * This register reports the source of read DMA overflow/underflow errors.
 */
union cavm_rdecx_abx_error_source0
{
    uint64_t u;
    struct cavm_rdecx_abx_error_source0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
    ...
    /* struct cavm_rdecx_abx_error_source0_s cn; */
};
typedef union cavm_rdecx_abx_error_source0 cavm_rdecx_abx_error_source0_t;

static inline uint64_t CAVM_RDECX_ABX_ERROR_SOURCE0(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RDECX_ABX_ERROR_SOURCE0(uint64_t a, uint64_t b)
{
    if ((a<=1) && (b<=2))
        return 0x87e040e00030ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
    __cavm_csr_fatal("RDECX_ABX_ERROR_SOURCE0", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_RDECX_ABX_ERROR_SOURCE0(a,b) cavm_rdecx_abx_error_source0_t
#define bustype_CAVM_RDECX_ABX_ERROR_SOURCE0(a,b) CSR_TYPE_RSL
#define basename_CAVM_RDECX_ABX_ERROR_SOURCE0(a,b) "RDECX_ABX_ERROR_SOURCE0"
#define busnum_CAVM_RDECX_ABX_ERROR_SOURCE0(a,b) (a)
#define arguments_CAVM_RDECX_ABX_ERROR_SOURCE0(a,b) (a),(b),-1,-1

/**
 * Register (RSL) rdec#_ab#_nr_mtbl_a#
 *
 ...
 */
union cavm_rdecx_abx_nr_mtbl_ax
{
    uint64_t u;
    struct cavm_rdecx_abx_nr_mtbl_ax_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
    ...
    /* struct cavm_rdecx_abx_nr_mtbl_ax_s cn; */
};
typedef union cavm_rdecx_abx_nr_mtbl_ax cavm_rdecx_abx_nr_mtbl_ax_t;

static inline uint64_t CAVM_RDECX_ABX_NR_MTBL_AX(uint64_t a, uint64_t b, uint64_t c) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RDECX_ABX_NR_MTBL_AX(uint64_t a, uint64_t b, uint64_t c)
{
    if ((a<=1) && (b<=2) && (c<=127))
        return 0x87e040e03000ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3) + 8ll * ((c) & 0x7f);
    __cavm_csr_fatal("RDECX_ABX_NR_MTBL_AX", 3, a, b, c, 0, 0, 0);
}

#define typedef_CAVM_RDECX_ABX_NR_MTBL_AX(a,b,c) cavm_rdecx_abx_nr_mtbl_ax_t
#define bustype_CAVM_RDECX_ABX_NR_MTBL_AX(a,b,c) CSR_TYPE_RSL
#define basename_CAVM_RDECX_ABX_NR_MTBL_AX(a,b,c) "RDECX_ABX_NR_MTBL_AX"
#define busnum_CAVM_RDECX_ABX_NR_MTBL_AX(a,b,c) (a)
#define arguments_CAVM_RDECX_ABX_NR_MTBL_AX(a,b,c) (a),(b),(c),-1

/**
 * Register (RSL) rdec#_ab#_nr_mtbl_b#
 *
 ...
 * Software should write this register directly.
 */
union cavm_rdecx_abx_nr_mtbl_bx
{
    uint64_t u;
    struct cavm_rdecx_abx_nr_mtbl_bx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
        uint64_t mask_table_entry      : 32; /**< [ 31:  0](R/W) Mask table entry corresponding to the register index. */
    ...
    /* struct cavm_rdecx_abx_nr_mtbl_bx_s cn; */
};
typedef union cavm_rdecx_abx_nr_mtbl_bx cavm_rdecx_abx_nr_mtbl_bx_t;

static inline uint64_t CAVM_RDECX_ABX_NR_MTBL_BX(uint64_t a, uint64_t b, uint64_t c) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RDECX_ABX_NR_MTBL_BX(uint64_t a, uint64_t b, uint64_t c)
{
    if ((a<=1) && (b<=2) && (c<=127))
        return 0x87e040e03400ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3) + 8ll * ((c) & 0x7f);
    __cavm_csr_fatal("RDECX_ABX_NR_MTBL_BX", 3, a, b, c, 0, 0, 0);
}

#define typedef_CAVM_RDECX_ABX_NR_MTBL_BX(a,b,c) cavm_rdecx_abx_nr_mtbl_bx_t
#define bustype_CAVM_RDECX_ABX_NR_MTBL_BX(a,b,c) CSR_TYPE_RSL
#define basename_CAVM_RDECX_ABX_NR_MTBL_BX(a,b,c) "RDECX_ABX_NR_MTBL_BX"
#define busnum_CAVM_RDECX_ABX_NR_MTBL_BX(a,b,c) (a)
#define arguments_CAVM_RDECX_ABX_NR_MTBL_BX(a,b,c) (a),(b),(c),-1

/**
 * Register (RSL) rdec#_ab#_nr_rtbl_a#
 *
 ...
 * Software should write this register directly.
 */
union cavm_rdecx_abx_nr_rtbl_ax
{
    uint64_t u;
    struct cavm_rdecx_abx_nr_rtbl_ax_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_rdecx_abx_nr_rtbl_ax_s cn; */
};
typedef union cavm_rdecx_abx_nr_rtbl_ax cavm_rdecx_abx_nr_rtbl_ax_t;

static inline uint64_t CAVM_RDECX_ABX_NR_RTBL_AX(uint64_t a, uint64_t b, uint64_t c) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RDECX_ABX_NR_RTBL_AX(uint64_t a, uint64_t b, uint64_t c)
{
    if ((a<=1) && (b<=2) && (c<=31))
        return 0x87e040e04000ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3) + 8ll * ((c) & 0x1f);
    __cavm_csr_fatal("RDECX_ABX_NR_RTBL_AX", 3, a, b, c, 0, 0, 0);
}

#define typedef_CAVM_RDECX_ABX_NR_RTBL_AX(a,b,c) cavm_rdecx_abx_nr_rtbl_ax_t
#define bustype_CAVM_RDECX_ABX_NR_RTBL_AX(a,b,c) CSR_TYPE_RSL
#define basename_CAVM_RDECX_ABX_NR_RTBL_AX(a,b,c) "RDECX_ABX_NR_RTBL_AX"
#define busnum_CAVM_RDECX_ABX_NR_RTBL_AX(a,b,c) (a)
#define arguments_CAVM_RDECX_ABX_NR_RTBL_AX(a,b,c) (a),(b),(c),-1

/**
 * Register (RSL) rdec#_ab#_nr_rtbl_b#
 *
 ...
 * Software should write this register directly.
 */
union cavm_rdecx_abx_nr_rtbl_bx
{
    uint64_t u;
    struct cavm_rdecx_abx_nr_rtbl_bx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_13_63        : 51;
        uint64_t table_entry           : 13; /**< [ 12:  0](R/W) Re-encoding table entry corresponding to the register index. */
    ...
    /* struct cavm_rdecx_abx_nr_rtbl_bx_s cn; */
};
typedef union cavm_rdecx_abx_nr_rtbl_bx cavm_rdecx_abx_nr_rtbl_bx_t;

static inline uint64_t CAVM_RDECX_ABX_NR_RTBL_BX(uint64_t a, uint64_t b, uint64_t c) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RDECX_ABX_NR_RTBL_BX(uint64_t a, uint64_t b, uint64_t c)
{
    if ((a<=1) && (b<=2) && (c<=31))
        return 0x87e040e04400ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3) + 8ll * ((c) & 0x1f);
    __cavm_csr_fatal("RDECX_ABX_NR_RTBL_BX", 3, a, b, c, 0, 0, 0);
}

#define typedef_CAVM_RDECX_ABX_NR_RTBL_BX(a,b,c) cavm_rdecx_abx_nr_rtbl_bx_t
#define bustype_CAVM_RDECX_ABX_NR_RTBL_BX(a,b,c) CSR_TYPE_RSL
#define basename_CAVM_RDECX_ABX_NR_RTBL_BX(a,b,c) "RDECX_ABX_NR_RTBL_BX"
#define busnum_CAVM_RDECX_ABX_NR_RTBL_BX(a,b,c) (a)
#define arguments_CAVM_RDECX_ABX_NR_RTBL_BX(a,b,c) (a),(b),(c),-1

/**
 * Register (RSL) rdec#_ab#_nr_stbl_a#
 *
 ...
 * Software should write this register directly.
 */
union cavm_rdecx_abx_nr_stbl_ax
{
    uint64_t u;
    struct cavm_rdecx_abx_nr_stbl_ax_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_rdecx_abx_nr_stbl_ax_s cn; */
};
typedef union cavm_rdecx_abx_nr_stbl_ax cavm_rdecx_abx_nr_stbl_ax_t;

static inline uint64_t CAVM_RDECX_ABX_NR_STBL_AX(uint64_t a, uint64_t b, uint64_t c) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RDECX_ABX_NR_STBL_AX(uint64_t a, uint64_t b, uint64_t c)
{
    if ((a<=1) && (b<=2) && (c<=31))
        return 0x87e040e03800ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3) + 8ll * ((c) & 0x1f);
    __cavm_csr_fatal("RDECX_ABX_NR_STBL_AX", 3, a, b, c, 0, 0, 0);
}

#define typedef_CAVM_RDECX_ABX_NR_STBL_AX(a,b,c) cavm_rdecx_abx_nr_stbl_ax_t
#define bustype_CAVM_RDECX_ABX_NR_STBL_AX(a,b,c) CSR_TYPE_RSL
#define basename_CAVM_RDECX_ABX_NR_STBL_AX(a,b,c) "RDECX_ABX_NR_STBL_AX"
#define busnum_CAVM_RDECX_ABX_NR_STBL_AX(a,b,c) (a)
#define arguments_CAVM_RDECX_ABX_NR_STBL_AX(a,b,c) (a),(b),(c),-1

/**
 * Register (RSL) rdec#_ab#_nr_stbl_b#
 *
 ...
 * Software should write this register directly.
 */
union cavm_rdecx_abx_nr_stbl_bx
{
    uint64_t u;
    struct cavm_rdecx_abx_nr_stbl_bx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_5_63         : 59;
        uint64_t shift_table_entry     : 5;  /**< [  4:  0](R/W) Shift table entry corresponding to the register index. */
    ...
    /* struct cavm_rdecx_abx_nr_stbl_bx_s cn; */
};
typedef union cavm_rdecx_abx_nr_stbl_bx cavm_rdecx_abx_nr_stbl_bx_t;

static inline uint64_t CAVM_RDECX_ABX_NR_STBL_BX(uint64_t a, uint64_t b, uint64_t c) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RDECX_ABX_NR_STBL_BX(uint64_t a, uint64_t b, uint64_t c)
{
    if ((a<=1) && (b<=2) && (c<=31))
        return 0x87e040e03c00ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3) + 8ll * ((c) & 0x1f);
    __cavm_csr_fatal("RDECX_ABX_NR_STBL_BX", 3, a, b, c, 0, 0, 0);
}

#define typedef_CAVM_RDECX_ABX_NR_STBL_BX(a,b,c) cavm_rdecx_abx_nr_stbl_bx_t
#define bustype_CAVM_RDECX_ABX_NR_STBL_BX(a,b,c) CSR_TYPE_RSL
#define basename_CAVM_RDECX_ABX_NR_STBL_BX(a,b,c) "RDECX_ABX_NR_STBL_BX"
#define busnum_CAVM_RDECX_ABX_NR_STBL_BX(a,b,c) (a)
#define arguments_CAVM_RDECX_ABX_NR_STBL_BX(a,b,c) (a),(b),(c),-1

/**
 * Register (RSL) rdec#_ab#_scratch
 *
 * INTERNAL: Scratch Registers
 *
 * Scratch register.
 */
union cavm_rdecx_abx_scratch
{
    uint64_t u;
    struct cavm_rdecx_abx_scratch_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_rdecx_abx_scratch_s cn; */
};
typedef union cavm_rdecx_abx_scratch cavm_rdecx_abx_scratch_t;

static inline uint64_t CAVM_RDECX_ABX_SCRATCH(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RDECX_ABX_SCRATCH(uint64_t a, uint64_t b)
{
    if ((a<=1) && (b<=2))
        return 0x87e040e00080ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
    __cavm_csr_fatal("RDECX_ABX_SCRATCH", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_RDECX_ABX_SCRATCH(a,b) cavm_rdecx_abx_scratch_t
#define bustype_CAVM_RDECX_ABX_SCRATCH(a,b) CSR_TYPE_RSL
#define basename_CAVM_RDECX_ABX_SCRATCH(a,b) "RDECX_ABX_SCRATCH"
#define busnum_CAVM_RDECX_ABX_SCRATCH(a,b) (a)
#define arguments_CAVM_RDECX_ABX_SCRATCH(a,b) (a),(b),-1,-1

/**
 * Register (RSL) rdec#_ab#_status
 *
 * RDEC Status Register
 * RDEC Status Register.
 */
union cavm_rdecx_abx_status
{
    uint64_t u;
    struct cavm_rdecx_abx_status_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_5_63         : 59;
    ...
    /* struct cavm_rdecx_abx_status_s cn; */
};
typedef union cavm_rdecx_abx_status cavm_rdecx_abx_status_t;

static inline uint64_t CAVM_RDECX_ABX_STATUS(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RDECX_ABX_STATUS(uint64_t a, uint64_t b)
{
    if ((a<=1) && (b<=2))
        return 0x87e040e00018ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x3);
    __cavm_csr_fatal("RDECX_ABX_STATUS", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_RDECX_ABX_STATUS(a,b) cavm_rdecx_abx_status_t
#define bustype_CAVM_RDECX_ABX_STATUS(a,b) CSR_TYPE_RSL
#define basename_CAVM_RDECX_ABX_STATUS(a,b) "RDECX_ABX_STATUS"
#define busnum_CAVM_RDECX_ABX_STATUS(a,b) (a)
#define arguments_CAVM_RDECX_ABX_STATUS(a,b) (a),(b),-1,-1
