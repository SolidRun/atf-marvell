...
{
    if ((a<=1) && (b<=1))
        return 0x87e042c00000ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a<=1) && (b<=1))
        return 0x87e042c00080ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a<=1) && (b<=1) && (c<=2))
        return 0x87e042c02000ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x1) + 0x2000ll * ((c) & 0x3);
...
{
    if ((a<=1) && (b<=1) && (c<=2))
        return 0x87e042c02008ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x1) + 0x2000ll * ((c) & 0x3);
...
union cavm_rfoex_abx_slotx_configuration2
{
    ...
    struct cavm_rfoex_abx_slotx_configuration2_s
    {
        ...
        uint64_t ptp_ring_id           : 2;  /**< [ 58: 57](R/W) TX PTP timestamp buffer ring in memory to use when writting the log message.
...
{
    if ((a<=1) && (b<=1) && (c<=2))
        return 0x87e042c02010ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x1) + 0x2000ll * ((c) & 0x3);
...
union cavm_rfoex_abx_slotx_configuration3
{
    ...
    struct cavm_rfoex_abx_slotx_configuration3_s
    {
        ...
        uint64_t tx_err                : 1;  /**< [ 18: 18](R/W) TX Error
                                                                 When set to 1, indicates the packet is errored and drop the packet. */
        uint64_t lmacid                : 2;  /**< [ 17: 16](R/W) LMAC destination ID. Must select an enabled LMAC on which to send the
                                                                 packet. */
...
{
    if ((a<=1) && (b<=1) && (c<=2))
        return 0x87e042c02018ll + 0x80000ll * ((a) & 0x1) + 0x10000ll * ((b) & 0x1) + 0x2000ll * ((c) & 0x3);
