...
union cavm_rmap_lte_mode_s
{
    ...
    struct cavm_rmap_lte_mode_s_s
    {
        ...
        uint64_t ri_symb_flg           : 1;  /**< [ 53: 53] Indicate location for ri_symbs:
                                                                 0: the original F95 RI locations.
                                                                 1: new F105 RI locations. */
        ...
        uint64_t err_var_in_data       : 8;  /**< [114:107] Error Variance for Data. The value range is [0, 127]. SW constraints that
        ...
        uint64_t pic_enable            : 1;  /**< [143:143] 0: pic feature is not enabled;
                                                                 1: pic feature is enabled; */
        ...
        uint64_t num_encoded_cqi_bits  : 18; /**< [233:216] The number of encoded cqi bits. When it is RM coded,=32.
                                                                 ...
                                                                 =num_rm_cqi_bit= NL?QCQI.
                                                                 Range: [0, 248832].
                                                                 [0]:                                    if num_rm_cqi_bit = 0
                                                                 [1,,248832]:                            if num_rm_cqi_bit \<= 5760
                                                                 [1,, 5760] or [num_rm_cqi_bit,, 248832] if num_rm_cqi_bit \> 5760
                                                                 [invalid]:                              if num_rm_cqi_bit \> 5760 &
                                                                 num_encoded_cqi_bit \< num_rm_cqi_bit,
                                                                                                         where num_rm_cqi_bit=num_cqi_re*mod_order*num_layers
                                                                                                         Shall be [0,num_cqi_re*mod_order*num_layers]
        ...
        uint64_t reserved_313_319      : 7;
        uint64_t bypass_phaserotation  : 1;  /**< [312:312] 0: phase rotation is enabled.
                                                                 1: phase rotation is bypassed. */
        uint64_t phase_slope           : 12; /**< [311:300] The slope a of the linear function to compute the phase.
                                                                 Range is [0,4095]. */
        uint64_t phase_intercept1      : 12; /**< [299:288] The first intercept b1 of the piece-wise linear function.
                                                                 Range is [0,4095]. */
        uint64_t phase_intercept2      : 12; /**< [287:276] The first intercept b2 of the piece-wise linear function.
                                                                 Range is [0,4095]. */
        uint64_t phase_break_point     : 12; /**< [275:264] The scalar used to scale the qvar_report for the UCI bits.
                                                                 Range is [1,128].
        ...
        uint64_t reserved_328_383      : 56;
        uint64_t q_threshold_low       : 8;  /**< [327:320] The threshold used for protection of small qvar_report(k) values. */
...
union cavm_rmap_nr_mode_s
{
    ...
    struct cavm_rmap_nr_mode_s_s
    {
        ...
        uint64_t reserved_637_639      : 3;
        uint64_t bypass_phaserotation  : 1;  /**< [636:636] 0: phase rotation is enabled.
                                                                 1: phase rotation is bypassed. */
        uint64_t c_re_m2               : 12; /**< [635:624] C_im [-2] */
        uint64_t c_im_m2               : 12; /**< [623:612] C_im [-2] */
        uint64_t c_re_m1               : 12; /**< [611:600] C_re [-1] */
        uint64_t c_im_m1               : 12; /**< [599:588] C_im [-1] */
        uint64_t c_re_m0               : 12; /**< [587:576] C_re [0] */
        ...
        uint64_t c_im_m0               : 12; /**< [703:692] C_im [0] */
        uint64_t c_re_p1               : 12; /**< [691:680] C_re [1] */
        uint64_t c_im_p1               : 12; /**< [679:668] C_im [1] */
        uint64_t c_re_p2               : 12; /**< [667:656] C_re [2] */
        uint64_t c_im_p2               : 12; /**< [655:644] C_im [2] */
        uint64_t rshft_bits_pr         : 4;  /**< [643:640] The number of bits at right shift of the phase rotation filter. Range is [0,12]. */
        ...
        uint64_t reserved_736_767      : 32;
        uint64_t phase_slope           : 12; /**< [735:724] The slope a of the linear function to compute the phase.
                                                                 Range: [0,4095]. */
        uint64_t phase_intercept1      : 12; /**< [723:712] The first intercept b1 of the piece-wise linear function.
                                                                 Range is [0,4095]. */
        uint64_t q_threshold_low       : 8;  /**< [711:704] The threshold used for protection of small qvar_report(k) values. */
 ...
 * When RMAP(0)_AB(0..1)_TC_ERROR[CORE_ERR] is set, this field indicates which
...
union cavm_rmapx_abx_control0
{
    ...
    struct cavm_rmapx_abx_control0_s
    {
        ...
        uint64_t start3                : 1;  /**< [  3:  3](R/W/H) Write 1 to start processing the job in configuration slot 3. This bit auto-clears.
                                                                 Writes are ignored when the configuration slot is busy (RMAP(0)_AB(0..1)_STATUS[STATUS3] = 1). */
        uint64_t start2                : 1;  /**< [  2:  2](R/W/H) Write 1 to start processing the job in configuration slot 2. This bit auto-clears.
                                                                 Writes are ignored when the configuration slot is busy (RMAP(0)_AB(0..1)_STATUS[STATUS2] = 1). */
        uint64_t start1                : 1;  /**< [  1:  1](R/W/H) Write 1 to start processing the job in configuration slot 1. This bit auto-clears.
                                                                 Writes are ignored when the configuration slot is busy (RMAP(0)_AB(0..1)_STATUS[STATUS1] = 1). */
        uint64_t start0                : 1;  /**< [  0:  0](R/W/H) Write 1 to start processing the job in configuration slot 0. This bit auto-clears.
                                                                 Writes are ignored when the configuration slot is busy (RMAP(0)_AB(0..1)_STATUS[STATUS0] = 1). */
#else /* Word 0 - Little Endian */
        uint64_t start0                : 1;  /**< [  0:  0](R/W/H) Write 1 to start processing the job in configuration slot 0. This bit auto-clears.
                                                                 Writes are ignored when the configuration slot is busy (RMAP(0)_AB(0..1)_STATUS[STATUS0] = 1). */
        uint64_t start1                : 1;  /**< [  1:  1](R/W/H) Write 1 to start processing the job in configuration slot 1. This bit auto-clears.
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a00000ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a00008ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
/**
 * Register (RSL) rmap#_ab#_eco
 *
 * INTERNAL: RMAP ECO Register
 */
union cavm_rmapx_abx_eco
{
    uint64_t u;
    struct cavm_rmapx_abx_eco_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_rmapx_abx_eco_s cn; */
};
typedef union cavm_rmapx_abx_eco cavm_rmapx_abx_eco_t;

static inline uint64_t CAVM_RMAPX_ABX_ECO(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_ABX_ECO(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=1))
        return 0x87e041a00010ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
    __cavm_csr_fatal("RMAPX_ABX_ECO", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_RMAPX_ABX_ECO(a,b) cavm_rmapx_abx_eco_t
#define bustype_CAVM_RMAPX_ABX_ECO(a,b) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_ABX_ECO(a,b) "RMAPX_ABX_ECO"
#define busnum_CAVM_RMAPX_ABX_ECO(a,b) (a)
#define arguments_CAVM_RMAPX_ABX_ECO(a,b) (a),(b),-1,-1

/**
 * Register (RSL) rmap#_ab#_error_enable0
 *
 * RMAP Error Enable 0 Register
 * This register enables error reporting for RMAP(0)_AB(0..1)_ERROR_SOURCE0 register.
 */
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a00040ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a00048ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a00030ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
union cavm_rmapx_abx_error_source1
{
    ...
    struct cavm_rmapx_abx_error_source1_s
    {
        ...
        uint64_t tc_error              : 1;  /**< [ 32: 32](R/W1C/H) Error within multiplexing, interleaving and scrambling sub-block. See
                                                                 RMAP(0)_AB(0..1)_TC_ERROR for additional error information. */
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a00038ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a02000ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a02008ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
 ...
 * This register stores the 11 job configuration word for slot 0.
 */
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a02050ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
 ...
 * This register stores the 12 job configuration word for slot 0.
 */
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a02058ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a02010ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a02018ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a02020ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a02028ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a02030ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a02038ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a02040ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
 ...
 * This register stores the 10 job configuration word for slot 0.
 */
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a02048ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a04000ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a04008ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a04050ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a04058ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a04010ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a04018ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a04020ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a04028ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a04030ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a04038ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a04040ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a04048ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a06000ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a06008ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a06050ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a06058ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a06010ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a06018ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a06020ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a06028ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a06030ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a06038ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a06040ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a06048ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a08000ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a08008ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a08050ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a08058ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a08010ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a08018ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a08020ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a08028ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a08030ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a08038ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a08040ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a08048ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
/**
 * Register (RSL) rmap#_ab#_scratch
 *
 * INTERNAL: Scratch Register
 */
union cavm_rmapx_abx_scratch
{
    uint64_t u;
    struct cavm_rmapx_abx_scratch_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_rmapx_abx_scratch_s cn; */
};
typedef union cavm_rmapx_abx_scratch cavm_rmapx_abx_scratch_t;

static inline uint64_t CAVM_RMAPX_ABX_SCRATCH(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_ABX_SCRATCH(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=1))
        return 0x87e041a00080ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
    __cavm_csr_fatal("RMAPX_ABX_SCRATCH", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_RMAPX_ABX_SCRATCH(a,b) cavm_rmapx_abx_scratch_t
#define bustype_CAVM_RMAPX_ABX_SCRATCH(a,b) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_ABX_SCRATCH(a,b) "RMAPX_ABX_SCRATCH"
#define busnum_CAVM_RMAPX_ABX_SCRATCH(a,b) (a)
#define arguments_CAVM_RMAPX_ABX_SCRATCH(a,b) (a),(b),-1,-1
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a00018ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a01040ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
union cavm_rmapx_abx_tc_error
{
    ...
    struct cavm_rmapx_abx_tc_error_s
    {
        ...
        uint64_t core_err              : 1;  /**< [  8:  8](R/W1C/H) invalid configuration, the block is aborted. See RMAP(0)_AB(0..1)_TC_CONFIG_ERR_FLAGS. */
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a01038ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
        uint64_t error_mask            : 32; /**< [ 31:  0](R/W) The contents of RMAP(0)_AB(0..1)_TC_ERROR are masked with this register. When an
                                                                 error occurs, it is reported in RMAP(0)_AB(0..1)_ERROR_SOURCE1[TC_ERROR] only when
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a01030ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a01010ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
{
    if ((a==0) && (b<=1))
        return 0x87e041a01000ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
...
/**
 * Register (RSL) rmap#_ab#_tc_main_start
 *
 * INTERNAL: TC Start Register
 *
 * TC1860 Main Start Register
 */
union cavm_rmapx_abx_tc_main_start
{
    uint64_t u;
    struct cavm_rmapx_abx_tc_main_start_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_rmapx_abx_tc_main_start_s cn; */
};
typedef union cavm_rmapx_abx_tc_main_start cavm_rmapx_abx_tc_main_start_t;

static inline uint64_t CAVM_RMAPX_ABX_TC_MAIN_START(uint64_t a, uint64_t b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_ABX_TC_MAIN_START(uint64_t a, uint64_t b)
{
    if ((a==0) && (b<=1))
        return 0x87e041a01008ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1);
    __cavm_csr_fatal("RMAPX_ABX_TC_MAIN_START", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_RMAPX_ABX_TC_MAIN_START(a,b) cavm_rmapx_abx_tc_main_start_t
#define bustype_CAVM_RMAPX_ABX_TC_MAIN_START(a,b) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_ABX_TC_MAIN_START(a,b) "RMAPX_ABX_TC_MAIN_START"
#define busnum_CAVM_RMAPX_ABX_TC_MAIN_START(a,b) (a)
#define arguments_CAVM_RMAPX_ABX_TC_MAIN_START(a,b) (a),(b),-1,-1

/**
 * Register (RSL) rmap#_ab#_tc_status#
 *
 * INTERNAL: TC Status Register
 *
 * TC1860 status register
 */
union cavm_rmapx_abx_tc_statusx
{
    uint64_t u;
    struct cavm_rmapx_abx_tc_statusx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_rmapx_abx_tc_statusx_s cn; */
};
typedef union cavm_rmapx_abx_tc_statusx cavm_rmapx_abx_tc_statusx_t;

static inline uint64_t CAVM_RMAPX_ABX_TC_STATUSX(uint64_t a, uint64_t b, uint64_t c) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_ABX_TC_STATUSX(uint64_t a, uint64_t b, uint64_t c)
{
    if ((a==0) && (b<=1) && (c<=1))
        return 0x87e041a01020ll + 0x80000ll * ((a) & 0x0) + 0x10000ll * ((b) & 0x1) + 8ll * ((c) & 0x1);
    __cavm_csr_fatal("RMAPX_ABX_TC_STATUSX", 3, a, b, c, 0, 0, 0);
}

#define typedef_CAVM_RMAPX_ABX_TC_STATUSX(a,b,c) cavm_rmapx_abx_tc_statusx_t
#define bustype_CAVM_RMAPX_ABX_TC_STATUSX(a,b,c) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_ABX_TC_STATUSX(a,b,c) "RMAPX_ABX_TC_STATUSX"
#define busnum_CAVM_RMAPX_ABX_TC_STATUSX(a,b,c) (a)
#define arguments_CAVM_RMAPX_ABX_TC_STATUSX(a,b,c) (a),(b),(c),-1
