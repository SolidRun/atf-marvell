 ...
 *
 * MDAB Block Configuration Register
...
union cavm_mdabx_block_config
{
    ...
    struct cavm_mdabx_block_config_s
    {
        ...
        uint32_t pflt_en               : 1;  /**< [ 16: 16](RO/H) Indicates if the PFilter function is enabled */
    ...
    /* struct cavm_mdabx_block_config_s cn; */
};
...
union cavm_mdabx_dac_ctrl
{
    ...
    /* struct cavm_mdabx_dac_ctrl_s cn10ka; */
    ...
    struct cavm_mdabx_dac_ctrl_cnf10kb
    {
        ...
        uint32_t edp_wr_req_limit      : 2;  /**< [ 17: 16](R/W) Limit the number of outstanding EDP write requests.
                                                                 ...
                                                                 0x3 = 3/4 of max requests. */
        uint32_t reserved_5_15         : 11;
        uint32_t en_dspclk_gate        : 1;  /**< [  4:  4](R/W/H) This Bit is functional for MASI/ASIP only.
...
union cavm_mdabx_dac_err_log_src
{
    ...
    /* struct cavm_mdabx_dac_err_log_src_s cn10ka; */
...
union cavm_mdabx_dsp_fyi
{
    ...
    /* struct cavm_mdabx_dsp_fyi_s cn10ka; */
...
union cavm_mdabx_dspintr_bar
{
    ...
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t rsl_acc_bar           : 14; /**< [ 31: 18](R/W) Base address for RSL access to internal memory space of a DSP. The window size is 256KB (fixed).L
                                                                 Lower boundry is {RSL_ACC_BAR,19'h0}, upper boundry  {RSL_ACC_BAR,19'h7FFFF}. */
...
union cavm_mdabx_err_int_ena_w1c
{
    ...
    struct cavm_mdabx_err_int_ena_w1c_s
    {
        ...
        uint32_t dac_epdp_err          : 1;  /**< [  4:  4](R/W1C/H) DSP complex iFetch/iDMA master port errors. */
    ...
    /* struct cavm_mdabx_err_int_ena_w1c_s cn10ka; */
...
union cavm_mdabx_err_int_ena_w1s
{
    ...
    struct cavm_mdabx_err_int_ena_w1s_s
    {
        ...
        uint32_t dac_epdp_err          : 1;  /**< [  4:  4](R/W1S/H) DSP complex iFetch/iDMA master port errors. */
    ...
    /* struct cavm_mdabx_err_int_ena_w1s_s cn10ka; */
...
union cavm_mdabx_err_int_int0_ena
{
    ...
    struct cavm_mdabx_err_int_int0_ena_s
    {
        ...
        uint32_t dac_epdp_err          : 1;  /**< [  4:  4](R/W) DSP complex iFetch/iDMA master port errors. */
    ...
    /* struct cavm_mdabx_err_int_int0_ena_s cn10ka; */
...
union cavm_mdabx_err_int_intvec_ena
{
    ...
    /* struct cavm_mdabx_err_int_intvec_ena_s cn10ka; */
...
union cavm_mdabx_err_int_nmi_ena
{
    ...
    /* struct cavm_mdabx_err_int_nmi_ena_s cn10ka; */
...
union cavm_mdabx_err_int_sum
{
    ...
    struct cavm_mdabx_err_int_sum_s
    {
        ...
        uint32_t filter_err            : 1;  /**< [ 17: 17](R/W1C/H) FDEQ filter error.
                                                                 Internal:
                                                                 FIXME -- make all PFLT bits conditional for F95N */
        uint32_t coprocessor_err       : 1;  /**< [ 16: 16](R/W1C/H) LFSR co-processor error. */
        uint32_t reserved_8_15         : 8;
        uint32_t dac_err               : 1;  /**< [  7:  7](R/W1C/H) DAC errors. */
        uint32_t dac_ipb_err           : 1;  /**< [  6:  6](R/W1C/H) Instruction Prefetch Buffer Error. */
    ...
    /* struct cavm_mdabx_err_int_sum_s cn10ka; */
...
union cavm_mdabx_err_int_sum_w1s
{
    ...
    /* struct cavm_mdabx_err_int_sum_w1s_s cn10ka; */
...
union cavm_mdabx_int_sel
{
    ...
    /* struct cavm_mdabx_int_sel_s cn10ka; */
...
union cavm_mdabx_interrupt_active
{
    ...
    struct cavm_mdabx_interrupt_active_s
    {
        ...
        uint32_t wr_dma_slice_fifo_oflow : 1;/**< [ 15: 15](RO/H) Indicates the RD_DMA_SLICE_FIFO_OFLOW interrupt is active. */
...
union cavm_mdabx_ipb_ctl
{
    ...
    /* struct cavm_mdabx_ipb_ctl_s cn10ka; */
...
{
    if (((a<=54) || ((a>=64)&&(a<=74)) || ((a>=80)&&(a<=81))) && (b<=1))
...
union cavm_mdabx_lfsr_cnt
{
    ...
    /* struct cavm_mdabx_lfsr_cnt_s cn10ka; */
...
union cavm_mdabx_pfault_info_hi
{
    ...
    /* struct cavm_mdabx_pfault_info_hi_s cn10ka; */
...
union cavm_mdabx_pfault_info_lo
{
    ...
    /* struct cavm_mdabx_pfault_info_lo_s cn10ka; */
...
union cavm_mdabx_pflt_buffer_xfr_sts
{
    ...
    /* struct cavm_mdabx_pflt_buffer_xfr_sts_s cn10ka; */
...
union cavm_mdabx_pflt_input_xfr_sts
{
    ...
    /* struct cavm_mdabx_pflt_input_xfr_sts_s cn10ka; */
...
union cavm_mdabx_pflt_pmem_position
{
    ...
    /* struct cavm_mdabx_pflt_pmem_position_s cn10ka; */
...
union cavm_mdabx_pflt_rs_cfg
{
    ...
    /* struct cavm_mdabx_pflt_rs_cfg_s cn10ka; */
...
union cavm_mdabx_pflt_run
{
    ...
    struct cavm_mdabx_pflt_run_s
    {
        ...
        uint32_t run                   : 1;  /**< [  0:  0](R/W/H) When written from 0 to 1, filter mode is enabled and the internal
                                                                 ...
                                                                 filter job completes. If this bit is written from 1 to 0 by software, filter
                                                                 operation will immediately stop and bypass mode will be enabled.
                                                                 Any remaining buffered data inside PMEM Filter will be discarded.
                                                                 Software must stop all RD-DMA operations before clearing this bit. */
#else /* Word 0 - Little Endian */
        uint32_t run                   : 1;  /**< [  0:  0](R/W/H) When written from 0 to 1, filter mode is enabled and the internal
                                                                 state of PMEM filter is cleared and initialized for a new job based upon
                                                                 configuration. Note that all PMEM Filter configuration must be written
    ...
    /* struct cavm_mdabx_pflt_run_s cn10ka; */
...
union cavm_mdabx_proc_ctl
{
    ...
    /* struct cavm_mdabx_proc_ctl_s cn10ka; */
    ...
    struct cavm_mdabx_proc_ctl_cnf10kb
    {
        ...
        uint32_t sb_req                : 1;  /**< [ 30: 30](R/W) An assertion of this bit, in a case where a DSP core is in light sleep, would
                                                                 cause transition to stand by. */
...
union cavm_mdabx_proc_debug
{
    ...
    /* struct cavm_mdabx_proc_debug_s cn10ka; */
...
union cavm_mdabx_proc_status
{
    ...
    /* struct cavm_mdabx_proc_status_s cn10ka; */
    /* struct cavm_mdabx_proc_status_s cnf10ka; */
...
{
    if (((a<=54) || ((a>=64)&&(a<=74)) || ((a>=80)&&(a<=81))) && (b<=3))
 ...
 * This register contains the upper 32 bits bits of the 64-bit BCN timer = {N1\<63:24\>, N2\<23:0\>}.
 * When the PSM detects a 10 ms frame interval (ie: BCN N2\<23:0\> wraps to zero),
 * the PSM broadcasts the PSM_TIMER_N1_N2_VAL[N1]\<63:24\> value which is latched into
 * {MDAB()_PSM_TIMER_HI[BCN_HI], MDAB()_PSM_TIMER_LO[BCN_LO]}.
 */
union cavm_mdabx_psm_timer_hi
{
    ...
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t bcn_hi                : 32; /**< [ 31:  0](RO/H) When the PSM detects a 10 ms frame interval (ie: BCN N2\<23:0\> wraps to zero), the PSM broadcasts
                                                                 the 40-bit BCN N1\<63:24\> timer = PSM_TIMER_N1_N2_VAL[N1]\<63:24\>
                                                                 where the N1\<63:32\> value is latched into [BCN_HI]. */
#else /* Word 0 - Little Endian */
        uint32_t bcn_hi                : 32; /**< [ 31:  0](RO/H) When the PSM detects a 10 ms frame interval (ie: BCN N2\<23:0\> wraps to zero), the PSM broadcasts
                                                                 the 40-bit BCN N1\<63:24\> timer = PSM_TIMER_N1_N2_VAL[N1]\<63:24\>
                                                                 where the N1\<63:32\> value is latched into [BCN_HI]. */
 ...
 *
 * MDAB PSM Timer Broadcast Register
 * This register contains the lower 32 bits bits of the 64-bit BCN timer = {N1\<63:24\>, N2\<23:0\>}.
 * When the PSM detects a 10 ms frame interval (ie: N2\<23:0\> wraps to zero), the PSM broadcasts
 * the PSM_TIMER_N1_N2_VAL[N1]\<63:24\> value which is latched into
 * {MDAB()_PSM_TIMER_HI[BCN_HI], MDAB()_PSM_TIMER_LO[BCN_LO]}.
 * NOTE: The full 64-bit BCN Timer formed from those two registers
 * (MDAB()_PSM_TIMER_LO,MDAB()_PSM_TIMER_HI) are passed
 * to the DSP PC Trace Real Time Trace Timestamp.
 */
union cavm_mdabx_psm_timer_lo
{
    ...
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t bcn_lo                : 8;  /**< [ 31: 24](RO/H) When the PSM detects a 10 ms frame interval (ie: N2\<23:0\> wraps to zero), the PSM broadcasts
                                                                 the 40-bit BCN N1\<63:24\> timer = PSM_TIMER_N1_N2_VAL[N1]\<63:24\>
                                                                 where the N1\<31:24\> value is latched into [BCN_LO]. */
        uint32_t bcn_lsb               : 24; /**< [ 23:  0](R/W/H) "When the PSM detects a 10ms frame interval (ie: N2\<23:0\> wraps to zero), the PSM broadcasts
                                                                 the 40-bit BCN N1\<63:24\> Timer = PSM_TIMER_N1_N2_VAL[N1]\<63:24\> where the N1\<63:24\> value is
                                                                 latched into the {PSM_TIMER_HI[BCN_HI], PSM_TIMER_LO[BCN_LO]} CSR fields.
                                                                 The PSM broadcast event will also clear the BCN_LSB field to zero which represents the
                                                                 BCN N2\<23:0\> subframe interval timer.
                                                                 Thereafter, the BCN_LSB is a free running counter that is incremented every dspclk cycle.
                                                                 Software NOTES:
                                                                   1) The PSM_TIMER_N1_N2_VAL[N2]\<23:0\> value represents the # of [bcn_clk * 4] = (1.2288GHz) cycles
                                                                   within the 10ms frame. Since the dspclk(max=1.2GHz) is guaranteed to be slower than the
                                                                   bcn_clk*4(1.2288GHz), each DSP's local BCN_LSB\<23:0\> will be an 'approximation' of the
                                                                   N2 system time offset value (within the 10ms interval).
                                                                   2) Software will have to convert the BCN_LSB\<23:0\> value which represents #of dspclks to # of
                                                                   [bcn_clks*4] based on dspclk frequency. When Software wants to read the full 64b BCN_TIMER value
                                                                   (from the 2x 32b CSRs), it must first read the PSM_TIMER_LO CSR (which locks
                                                                 down the PSM_TIMER_HI
                                                                   into a redundant CSR for subsequent reads). This is done to avoid a future PSM broadcast
                                                                   event from over-writing the PSM_TIMER_HI CSR between the 2x CSR reads.
                                                                   BCN_TIMER_N1_N2:
                                                                     - N1\<63:24\>          = { PSM_TIMER_HI[BCN_HI\<63:32\>], PSM_TIMER_LO[BCN_LO\<31:24\> }
                                                                     - N2\<23:0\>             = PSM_TIMER_LO[BCN_LSB\<23:0\>]"

                                                                 Internal:
                                                                 "These bits are generated by a local counter running in the DSP Freq to allow finer
                                                                 granularity of the BCN timer (in #of dspclks). The BCN_LSB will be loaded with zero
...
union cavm_mdabx_rd_fifo_status
{
    ...
    struct cavm_mdabx_rd_fifo_status_s
    {
        ...
        uint32_t slice_fifo_psh_cnt    : 8;  /**< [  7:  0](RO/H) This count field provides the number of slice FIFO pushes since the last
...
union cavm_mdabx_rmp_dflt_win_addr_low
{
    ...
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t laddr                 : 20; /**< [ 31: 12](R/W) The override value of remapped address bits[31:N] of the
                                                                 address targeting system memory.
                                                                 Where N stands for the first bit in the system BAR size which is 1'b0. */
...
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_11_31        : 21;
        uint32_t wr_pack_pend          : 1;  /**< [ 10: 10](RO/H) Write PMEM packer response pending. */
        uint32_t rd_pack_pend          : 1;  /**< [  9:  9](RO/H) Read PMEM packer response pending. */
...
union cavm_mdabx_sec_int_ena_w1c
{
    ...
    /* struct cavm_mdabx_sec_int_ena_w1c_s cn10ka; */
...
union cavm_mdabx_sec_int_ena_w1s
{
    ...
    /* struct cavm_mdabx_sec_int_ena_w1s_s cn10ka; */
...
union cavm_mdabx_sec_int_int1_ena
{
...
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_17_31        : 15;
        uint32_t lfsr_job_done         : 1;  /**< [ 16: 16](R/W) If enabled, LFSR_JOB_DONE event is reported to DSP INT1. 0x1 - Enable, 0x0 - Disable. */
        uint32_t reserved_9_15         : 7;
        uint32_t cti_int               : 1;  /**< [  8:  8](R/W) Reserved. */
        uint32_t reserved_2_7          : 6;
        uint32_t qman_irq              : 1;  /**< [  1:  1](R/W) Reserved. */
    ...
    /* struct cavm_mdabx_sec_int_int1_ena_s cn10ka; */
...
union cavm_mdabx_sec_int_intvec_ena
{
...
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_17_31        : 15;
        uint32_t lfsr_job_done         : 1;  /**< [ 16: 16](R/W) If enabled, LFSR_JOB_DONE event is reported to DSP INTVEC. 0x1 - Enable, 0x0 - Disable. */
        uint32_t reserved_9_15         : 7;
        uint32_t cti_int               : 1;  /**< [  8:  8](R/W) Reserved. */
        uint32_t reserved_2_7          : 6;
        uint32_t qman_irq              : 1;  /**< [  1:  1](R/W) Reserved. */
    ...
    /* struct cavm_mdabx_sec_int_intvec_ena_s cn10; */
    /* struct cavm_mdabx_sec_int_intvec_ena_s cn10ka; */
    /* struct cavm_mdabx_sec_int_intvec_ena_s cnf10ka; */
    struct cavm_mdabx_sec_int_intvec_ena_cnf10kb
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_17_31        : 15;
        uint32_t lfsr_job_done         : 1;  /**< [ 16: 16](R/W) Reserved. */
...
union cavm_mdabx_sec_int_nmi_ena
{
...
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_17_31        : 15;
        uint32_t lfsr_job_done         : 1;  /**< [ 16: 16](R/W) If enabled, LFSR_JOB_DONE event is reported to DSP NMI. 0x1 - Enable, 0x0 - Disable. */
        uint32_t reserved_9_15         : 7;
        uint32_t cti_int               : 1;  /**< [  8:  8](R/W) Reserved. */
        uint32_t reserved_2_7          : 6;
        uint32_t qman_irq              : 1;  /**< [  1:  1](R/W) Reserved. */
    ...
    /* struct cavm_mdabx_sec_int_nmi_ena_s cn10; */
    /* struct cavm_mdabx_sec_int_nmi_ena_s cn10ka; */
    /* struct cavm_mdabx_sec_int_nmi_ena_s cnf10ka; */
    struct cavm_mdabx_sec_int_nmi_ena_cnf10kb
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_17_31        : 15;
        uint32_t lfsr_job_done         : 1;  /**< [ 16: 16](R/W) Reserved. */
...
union cavm_mdabx_sec_int_sum
{
    ...
    /* struct cavm_mdabx_sec_int_sum_s cn10ka; */
...
union cavm_mdabx_sec_int_sum_w1s
{
    ...
    /* struct cavm_mdabx_sec_int_sum_w1s_s cn10ka; */
