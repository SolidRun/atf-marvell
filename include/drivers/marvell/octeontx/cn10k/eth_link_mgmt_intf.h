...
typedef enum link_state {
	...
	ETH_LINK_STATE_RCI_REG_WRITE_FIRST = 55,
	ETH_LINK_STATE_RCI_REG_WRITE_ADDR_ACK = 56,
	ETH_LINK_STATE_RCI_REG_WRITE_MASK_ACK = 57,
	ETH_LINK_STATE_RCI_REG_WRITE_DATA_ACK = 58,
	ETH_LINK_STATE_RCI_REG_READ_FIRST = 59,
	ETH_LINK_STATE_RCI_REG_READ_ADDR_ACK = 60,
	ETH_LINK_STATE_RCI_REG_READ_DATA_ACK = 61,
	ETH_LINK_STATE_CDR_LOCK_START = 62,
