...
typedef enum link_state {
	...
	ETH_LINK_STATE_RST_CORE_FIRST_LOOP = 6,     /* States for RESET_CORE_TX/RX */
	ETH_LINK_STATE_RST_CORE = 7,
	ETH_LINK_STATE_PLL_RDY_FIRST_LOOP = 8,      /* States for PLL_READY_TX/RX */
	ETH_LINK_STATE_PLL_RDY = 9,
	ETH_LINK_STATE_SPEED_CHANGE_FINAL = 10,
	ETH_LINK_STATE_AN_RESTART = 11,             /* AN Restart */
	ETH_LINK_STATE_REMOTE_FAULT = 12,
	ETH_LINK_STATE_EXT_PHY_STATUS = 13,         /* Check external PHY status */
	ETH_LINK_STATE_RX_SIGNAL_FIRST_LOOP = 14,
	ETH_LINK_STATE_RX_SIGNAL = 15,
	ETH_LINK_STATE_RX_INIT_FIRST_LOOP = 16,
	ETH_LINK_STATE_RX_INIT = 17,
	ETH_LINK_STATE_RX_TRAIN_FIRST = 18,
	ETH_LINK_STATE_RX_TRAIN_IN_PROGRESS = 19,
	ETH_LINK_STATE_AN_START = 20,
	ETH_LINK_STATE_AN_SECOND_STAGE = 21,
	ETH_LINK_STATE_AN_FIRST_LOOP = 22,
	ETH_LINK_STATE_AN_IN_PROGRESS = 23,
	ETH_LINK_STATE_LT_FIRST_LOOP = 24,
	ETH_LINK_STATE_LT_IN_PROGRESS = 25,
	ETH_LINK_STATE_LINK_FIRST_LOOP = 26,
	...
	ETH_LINK_STATE_TXEQ_UPDATE_FIRST = 33,
	ETH_LINK_STATE_TXEQ_UPDATE_IN_PROGRESS = 34,
	ETH_LINK_STATE_TXEQ_ACK_CLR_FIRST = 35,
	ETH_LINK_STATE_TXEQ_ACK_CLR_IN_PROGRESS = 36,
	ETH_LINK_STATE_LINK_INH_TIMER_WAIT_FIRST = 37,
	ETH_LINK_STATE_LINK_INH_TIMER_WAIT = 38,
	ETH_LINK_STATE_AN_ENABLE = 39,
	ETH_LINK_STATE_AN_TX_DISABLE = 40,
	ETH_LINK_STATE_AN_LINK_STAT_CK = 41,
	ETH_LINK_STATE_AN_PARALLEL_FLT = 42,
	ETH_LINK_STATE_AN_ABILITY_DET = 43,
	ETH_LINK_STATE_AN_ACK_DETECT = 44,
	ETH_LINK_STATE_AN_COMPLETE_ACK = 45,
	ETH_LINK_STATE_AN_NP_WAIT = 46,
