...
typedef enum link_state {
	...
	ETH_LINK_STATE_RST_CORE_FIRST_LOOP,     /* States for RESET_CORE_TX/RX */
	ETH_LINK_STATE_RST_CORE,
	ETH_LINK_STATE_PLL_RDY_FIRST_LOOP,      /* States for PLL_READY_TX/RX */
	ETH_LINK_STATE_PLL_RDY,
	ETH_LINK_STATE_SPEED_CHANGE_FINAL,
	ETH_LINK_STATE_AN_RESTART,              /* AN Restart */
	ETH_LINK_STATE_REMOTE_FAULT,
	ETH_LINK_STATE_EXT_PHY_STATUS,          /* Check external PHY status */
	ETH_LINK_STATE_RX_SIGNAL_FIRST_LOOP,
	ETH_LINK_STATE_RX_SIGNAL,
	ETH_LINK_STATE_RX_INIT_FIRST_LOOP,
	ETH_LINK_STATE_RX_INIT,
